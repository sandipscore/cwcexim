...
{
    public class DndBondRepository
    {
        ...
        public void GetSpaceAvailAppCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DndSpaceAvailAppCertPdf ObjSpaceAvailCert = new DndSpaceAvailAppCertPdf();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjSpaceAvailCert.InvoiceNoDate = (Result["InvoiceNoDate"] == null ? "" : Result["InvoiceNoDate"]).ToString();
                    ObjSpaceAvailCert.Clause = (Result["Clause"] == null ? "" : Result["Clause"]).ToString();
        ...
        public void SpaceAvailabilityDetails(int SpaceappId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objBA.InvoiceNo = Result["InvoiceNo"].ToString();
                    objBA.InvoiceDate = Result["InvoiceDate"].ToString();
                    objBA.Clause = Result["Clause"].ToString();
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void AddEditBondApp(DndBondApp objBA)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = objBA.InvoiceNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.Date, Value = (objBA.InvoiceDate == null ? null : Convert.ToDateTime(objBA.InvoiceDate).ToString("yyyy-MM-dd")) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Clause", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = objBA.Clause });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_CustomSealNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = objBA.CustomSealNo==null?null: objBA.CustomSealNo.ToUpper() });
        ...
        public void AddEditBondSpaceAvailCert(DndSpaceAvailableCert ObjSpaceAvail)
        {
            ...
            try
            {
                ...
                {
                    log.Info("_DBResponse.Status :" + _DBResponse.Status);
                    _DBResponse.Status = 1;
            ...
            {
                log.Error("AddEditBondSpaceAvailCert :" + ex.StackTrace);
                _DBResponse.Status = 0;
                _DBResponse.Message = "Error";
                _DBResponse.Data = null;
            }
        ...
        public void GetSpaceAvailCertById(int SpaceappId, int Stats)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjSpaceAvail.InvoiceNo = Result["InvoiceNo"].ToString();
                    ObjSpaceAvail.InvoiceDate = Result["InvoiceDate"].ToString();
                    ObjSpaceAvail.Clause = Result["Clause"].ToString();
                    if (Stats == 1)
                    {
                        ObjSpaceAvail.SacNo = "";
        ...
        public void GetSpaceAvailCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DndSpaceAvailCertPdf ObjSpaceAvailCert = new DndSpaceAvailCertPdf();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjSpaceAvailCert.InvoiceNo = (Result["InvoiceNo"] == null ? "" : Result["InvoiceNo"]).ToString();
                    ObjSpaceAvailCert.InvoiceDate = (Result["InvoiceDate"] == null ? "" : Result["InvoiceDate"]).ToString();
                    ObjSpaceAvailCert.Clause = (Result["Clause"] == null ? "" : Result["Clause"]).ToString();
                }
                if (Status == 1)
                {
        ...
        public void AddEditBondSpaceAvailCertExt(DndSpaceAvailCertExtend ObjSpaceAvail)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllSpaceAvailCertExt()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstSpaceAvail.Add(new DndSpaceAvailCertExtend
                    {
        ...
        public void GetSacNo()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DndSpaceAvailableCert> LstSpaceAvail = new List<DndSpaceAvailableCert>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSpaceAvail.Add(new DndSpaceAvailableCert
                    {
                        SpaceappId = Convert.ToInt32(Result["SpaceappId"]),
        ...
        public void GetSpaceAvailabilityExt(int SpaceAvailCertExtId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondSpaceAvailCertExt", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            DndBondAppExtendDetails ObjSpaceAvail = new DndBondAppExtendDetails();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditBondDepositApp(DndDepositApp ObjDepositApp)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetSacNodepositDet(int SpaceappId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_SpaceappId", MySqlDbType = MySqlDbType.Int32, Value = SpaceappId });
            ...
            _DBResponse = new DatabaseResponse();
            DndDepositApp ObjSpaceAvail = new DndDepositApp();
            try
            {
                while (Result.Read())
                {
                  ...
                  //  ObjSpaceAvail.VehicleNo = Convert.ToString(Result["VehicleNo"] == null ? "" : Result["VehicleNo"]);
                    ...
                    ObjSpaceAvail.BondNo = Convert.ToString(Result["BondNo"] == null ? "" : Result["BondNo"]);
                    ObjSpaceAvail.SpaceappId = Convert.ToInt32(Result["SpaceappId"] == DBNull.Value ? 0 : Result["SpaceappId"]);
        ...
        public void GetAllDepositApp()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstDepositApp.Add(new DndDepositApp
                    {
        ...
        public void PrintDA(int DepositeAppId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DndPrintDA ObjDepositApp = new DndPrintDA();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstSAC.Add(new DndSACDet
                        {
                            SacNo = Result["SacNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstGodown.Add(new DndGodDet
                        {
        ...
        public void DeleteBondDeposit(int DepositAppId)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_DepositAppId", MySqlDbType = MySqlDbType.Int32, Value = DepositAppId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteBondDeposit", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                ...
                {
                    _DBResponse.Status = 2;
                    _DBResponse.Message = "Cannot Delete Deposit Application As It Exist In Another Page";
                    _DBResponse.Data = null;
                }
                else
                {
        ...
        public void GetBondNoForWODeliveryNew()
        {
            ...
            List<ListOfDndBondNo> LstBond = new List<ListOfDndBondNo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    {
                        LstBond.Add(new ListOfDndBondNo
                        {
        ...
        public void GetDetailsforBondNo(int DepositAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondForWO", CommandType.StoredProcedure, DParam);
            DndBondWODeli objWO = new DndBondWODeli();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void ListOfWODeli(string WoType)
        {
            ...
            List<ListOfDndBondWODeli> LstBond = new List<ListOfDndBondWODeli>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstBond.Add(new ListOfDndBondWODeli
                    {
        ...
        public void GetBondNoForWOUnloading()
        {
            ...
            List<ListOfDnd_BOENo> LstBond = new List<ListOfDnd_BOENo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstBond.Add(new ListOfDnd_BOENo
                    {
                        //WorkOrderNo = Convert.ToString(Result["WorkOrderNo"]),
                        //BondWOId = Convert.ToInt32(Result["BondWOId"])
        ...
        public void WOUnloadingDetails(int UnloadingId, string Action = "")
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objBond.Others = Result["Others"].ToString();
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
        ...
        public void AddEditWOUnloading(DndBondWOUnloading obj)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Others", MySqlDbType = MySqlDbType.VarChar, Size = 500, Value = obj.Others });
        ...
        public void PrintWOUnloading(int UnloadingId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DndBondWOUnloadingPDF ObjUnloading = new DndBondWOUnloadingPDF();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetSACNoForAdvBondPaymentSheet(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (IList<DndBondSacDetails>)DataAccess.ExecuteDynamicSet<DndBondSacDetails>("GetSACNoForBondAdvPaymentSheet");
        ...
        public void AddEditInvoice(Dnd_LoadedContainerPayment ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string CfsChargeXML, int BranchId, int Uid,
    ...
    string InvoiceType, decimal area, int InvoiceId = 0)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            Dnd_PostPaymentSheet objInvoice = new Dnd_PostPaymentSheet();
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    ...
                    while (Result.Read())
                    {
                        objInvoice.lstPrePaymentCont.Add(new Areas.Import.Models.Dnd_PreInvoiceContainer
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstPostPaymentChrg.Add(new Areas.Import.Models.Dnd_PostPaymentChrg
                        {
        ...
        public void ListOfBondInvoice(string Module, string InvoiceNo = null, string InvoiceDate = null)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<DndListOfBondInvoice> lstInvoice = new List<DndListOfBondInvoice>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstInvoice.Add(new DndListOfBondInvoice()
                    {
        ...
        public void GetWODetForDeliveryOrder(int SpaceAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondWOForDeliveryOrder", CommandType.StoredProcedure, DParam);
            DndDeliveryOrder ObjDeliOrder = new DndDeliveryOrder();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void GetDeliveryOrder(int DeliveryOrderId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderhdb.Add(new DndDeliveryOrderDtl
                        {
        ...
        public void PrintDelivery(int DeliveryAppId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjDeliveryOrder.GodownName_print = Result["GodownId"].ToString();
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderhdb.Add(new DndDeliveryOrderDtl
                        {
                            WRNo = Result["WRNo"].ToString(),
                            WRDate = Result["WRDate"].ToString(),
                            GodownName = Result["GodownId"].ToString(),
                            Units = Convert.ToInt32(Result["Units"]),
                            Weight = Convert.ToDecimal(Result["Weight"]),
                            ClosingUnits = Convert.ToInt32(Result["ClosingUnits"]),
                            ClosingWeight = Convert.ToDecimal(Result["ClosingWeight"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryPrintOrder.Add(new DndDeliveryOrderforPrint
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderPayment.Add(new DndDeliveryOrderPaymentPrint
                        {
                            SacDate = Result["SacDate"].ToString(),
                            DepositDate = Result["DepositDate"].ToString(),
                            DepositNo = Result["DepositNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstGst.Add(new DndDeliveryGSTCharge
                        {
                            SGSTAmt = Convert.ToDecimal(Result["SGSTAmt"].ToString()),
                            CGSTAmt = Convert.ToDecimal(Result["CGSTAmt"].ToString()),
                            IGSTAmt = Convert.ToDecimal(Result["IGSTAmt"].ToString()),
        ...
        public void AddEditDeliveryOrder(DndDeliveryOrder ObjDeliveryOrder, string DeliveryOrderXml)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetDepositDetForDelvOrder(int DepositAppId)
        {
            ...
            DndDeliveryOrderDtl ObjDepositNo = new DndDeliveryOrderDtl();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
            ...
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName, int InvoiceId = 0)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            DndBondPostPaymentSheet objInvoice = new DndBondPostPaymentSheet();
            List<String> Clause = new List<String>();
        ...
        public void AddEditBondDelInvoice(DndBondPostPaymentSheet ObjPostPaymentSheet, string ChargesXML, int BranchId, int Uid, string Module, decimal TotalValueOfCargo)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
