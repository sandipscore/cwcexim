...
{
    public class Dnd_GatePassRepository
    {
        ...
        /***************************/
        public void AddEditGatePass(Dnd_GatePass objGP, string XML)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_DRVName", MySqlDbType = MySqlDbType.VarChar, Size = 500, Value = objGP.DriverName });
            lstParam.Add(new MySqlParameter { ParameterName = "in_CONNO", MySqlDbType = MySqlDbType.VarChar, Value = objGP.ContactNo });
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_IsRisk", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(objGP.Risk)});
            ...
            try
            {
                ...
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = "Vessel Cut Of Time and Gate Pass Time difference less than 30 minute";
                    _DBResponse.Data = null;
                }
                else
                {
        ...
        public void GetDetailsForGatePassPrint(int GatePassId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objGP.DriverName = Result["DriverName"].ToString();
                    objGP.ContactNo=Result["ContactNo"].ToString();   
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objGP.lstDet.Add(new DndGPDet
                        {
                            ContainerNo = Result["ContainerNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objGP.lstCont.Add(new ListOfContainer
                        {
                            Container = Result["Container"].ToString(),
                            ShippingBillNo = Result["ShippingBill"].ToString(),
                        });
                    }
                }
                if (Status == 1)
        ...
        public void GetDetForGatePass(int GatePassId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objGP.DriverName = Result["DriverName"].ToString();
                    objGP.ContactNo = Result["ContactNo"].ToString();
                    objGP.Risk = Convert.ToBoolean(Result["Risk"]);
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
