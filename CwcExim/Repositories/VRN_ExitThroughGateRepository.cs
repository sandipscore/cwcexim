...
{
    public class VRN_ExitThroughGateRepository
    {
        ...
        public void AddEditExitThroughGate(VRN_ExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
        ...
        public void GetContainer()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objExitThroughGateHeader.containerList.Add(new VRN_ContainerExit
                    {
        ...
        public void GetGatePassLst()
        {
           ...
           // LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstGatePass.Add(new VRN_GatePassList
                    {
        ...
        public void AddGateEXitToDetails(VRN_ExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
            ObjExitThroughGateHeader.Uid = Uid;
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllExitThroughGate()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VRN_ExitThroughGateHeader> LstExitThroughGate = new List<VRN_ExitThroughGateHeader>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new VRN_ExitThroughGateHeader
                    {
        ...
        public void GetExitThroughGateDetails()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VRN_ExitThroughGateDetails> LstExitThroughGateDtls = new List<VRN_ExitThroughGateDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGateDtls.Add(new VRN_ExitThroughGateDetails
                    {                    
                        ExitIdHeader = Convert.ToInt32(Result["ExitIdHeader"]),
        ...
        public void GetExitThroughGate(int ExitIdHdr)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjExitThroughGateHeader.expectedTimeOfArrival= Result["expectedTimeOfArrival"].ToString();
        ...
        public void UpdateGatePassValidity(VRN_RevalidateGatePass objRevalidateGatePass)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetDTDetails(int HeaderId, string MsgType)
        {
            int Status = 0;
        ...
        public void GetCIMDTDetailsUpdateStatus(int HeaderId)
        {
            int Status = 0;
            DataSet Result = new DataSet();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
