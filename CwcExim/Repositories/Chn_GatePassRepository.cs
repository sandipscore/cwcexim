...
{
    public class Chn_GatePassRepository
    {
        ...
        public void DetailsForGP(int InvoiceId)
        {
            ...
            List<Chn_ContainerDet> lstContainerDet = new List<Chn_ContainerDet>();
            ...
            try
            {
                    ...
                    {
                    Status = 1;
                    lstContainerDet.Add(new Chn_ContainerDet
                    {
                        ...
                        VehicleNo = Convert.ToString(Result["VehicleNo"] == DBNull.Value ? "" : Result["VehicleNo"]),
                        ...
                        ImpExpName = Convert.ToString(Result["ImpExpName"]),
        ...
        public void LoadMoreListOfGatePass(int Page)
        {
            //,int UserId
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_GatePassId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
        ...
        /***************************/
        public void AddEditGatePass(CHN_GatePass objGP, string XML)
        {
        ...
        public void GetDetForGatePass(int GatePassId)
        {
            ...
            List<Chn_ContainerDet> lstCntnDet = new List<Chn_ContainerDet>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        lstCntnDet.Add(new Chn_ContainerDet
                        {
                        ...
                        ImpExpName = (Result["ImpExpName"] == null ? "" : Result["ImpExpName"]).ToString(),
        ...
        public void GetCheckCreditPeriod(int InvoiceId)
        {
            int Status = 0;
            string RetValue = "";
            string ReturnObj = "";
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("CheckCreditlimitByInvoiceId", CommandType.StoredProcedure, DParam, out RetValue, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
