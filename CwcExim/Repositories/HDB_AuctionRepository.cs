...
{
    public class HDB_AuctionRepository
    {
        ...
        {
            Areas.Import.Models.Ppg_IrnB2CDetails Obj = new Areas.Import.Models.Ppg_IrnB2CDetails();
        ...
        public void GetCargoDetailsList(string operationType, string auctionType, int Uid, int inPage)
        {
            ...
            List<HDB_AuctionNoticeDetails> LstAuctionNoticeDetails = new List<HDB_AuctionNoticeDetails>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow item in Result.Tables[0].Rows)
                    {
                        Status = 1;
                        srNo++;
                        HDB_AuctionNoticeDetails objCargoDetails = new HDB_AuctionNoticeDetails();
        ...
        public void GetAuctionNoticeOBLNoShipBill(string operationType, string auctionType, string AuctionNo, int Uid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<HDB_AuctionNoticeItemDetails> LstAuctionNoticeDetails = new List<HDB_AuctionNoticeItemDetails>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
        ...
        public HDB_AuctionNoticePrintViewModel GetAuctionNoticeDataToPrint(int AuctionNoticeDtlId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            HDB_AuctionNoticePrintViewModel auctionNoticePrintViewModel = new HDB_AuctionNoticePrintViewModel();
            auctionNoticePrintViewModel.ParticularsOfGoodsList = new List<HDB_ParticularsOfGoods>();
            ...
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        HDB_ParticularsOfGoods objParticularsOfGoods = new HDB_ParticularsOfGoods();
            ...
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow item in Result.Tables[0].Rows)
                    {
                        ...
                        {
                            HDB_MarkForNotice objMarkForNotice = new HDB_MarkForNotice();
                            objMarkForNotice.MarkForNoticeDetailsList = new List<HDB_MarkForNoticeDetails>();
                            ...
                            HDB_MarkForNoticeDetails objMarkForNoticeDetails = new HDB_MarkForNoticeDetails();
        ...
        public void GetAllDespatchForNotice(int branchId)
        {
            ...
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        LstMarkForNotice.Add(new HDB_MarkForNotice
                        {
        ...
        public void UpdateDespatch(HDB_Despatch vm)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllDespatch(int branchId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<HDB_Despatch> LstDespatchNotice = new List<HDB_Despatch>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        LstDespatchNotice.Add(new HDB_Despatch
                        {
        ...
        public void GetAllShipbillOBLFor(int Flag)
        {
            ...
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        LstNocDetails.Add(new HDB_NocDetails
                        {
        ...
        public void AddEditNOCDetails(HDB_NocDetails vm, int BranchID, int CRby)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow item in Result.Tables[0].Rows)
                    {
                        ...
                        {
                            HDB_MarkedNotice objMarkedNotice = new HDB_MarkedNotice();
                            objMarkedNotice.MarkedNoticeDetailsList = new List<HDB_MarkedNoticeDetails>();
                            objMarkedNotice.LOTNo = Convert.ToString(item["LOTNo"]);
                            objMarkedNotice.MarkedOn = Convert.ToString(item["MarkedOn"]);

                            HDB_MarkedNoticeDetails objMarkedNoticeDetails = new HDB_MarkedNoticeDetails();
        ...
        public void GetBIDList(int branchId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    model.BIDDetail.Add(new HDB_BIDInfo { BIDId = Convert.ToInt32(Result["BidIdHdr"]), BIDNo = Convert.ToString(Result["BidNo"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void SaveEMDReceived(HDB_EMDReceived ObjEMDReceived, string xml)
        {
            try
            {
        ...
        public void GetEMDReceivedList()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<HDB_EMDReceived> LstEMDReceived = new List<HDB_EMDReceived>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
        ...
        public void GetAuctionPrintData(int BIDId)
        {
            ...
            try
            {
                ...
                _DBResponse = new DatabaseResponse();
                HDB_AuctionInvoicePrint objAuctionInvoicePrint = new HDB_AuctionInvoicePrint();
                ...
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        HDB_AuctionAccDetails objAuctionAccDetails = new HDB_AuctionAccDetails();
                    ...
                    {
                        HDB_ContainerDetails objContainerDetails = new HDB_ContainerDetails();
                    ...
                    {
                        HDB_ConatinerCharge objConatinerCharge = new HDB_ConatinerCharge();
        ...
        public void GetBidPartyAndDetails()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Areas.Auction.Models.HDB_PartyDetails> lstPartyDetails = new List<Areas.Auction.Models.HDB_PartyDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstPartyDetails.Add(new Areas.Auction.Models.HDB_PartyDetails
                    {
        ...
        public void GetListShippBillOBLByNOC(int Flag)//,int PartyID
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<HDB_AucBidFinalizationDtl> lstAucBidFinalizationDtl = new List<HDB_AucBidFinalizationDtl>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstAucBidFinalizationDtl.Add(new HDB_AucBidFinalizationDtl
                    {
        ...
        public void SaveBid(HDB_AucBidFinalizationHdr ObjAucBidFinalizationHdr, int Uid, int BranchId)
        {
            ...
            DateTime dttt = DateTime.ParseExact(ObjAucBidFinalizationHdr.RefDate, "yyyy-MM-dd", CultureInfo.InvariantCulture);
            ...
            try
            {
                ...
                else if (Result == 20)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Status = 0;
                    _DBResponse.Message = "EMD paid and Update not allowed";
                }
                else
                {
                    _DBResponse.Data = null;
        ...
        public void GetBidLIst(int id)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstAucBidFinalizationHdr.Add(new HDB_AucBidFinalizationHdr
                    {
                        //Convert.ToInt32(Result["PartyId"] == DBNull.Value ? 0 : Result["PartyId"]),
        ...
        #endregion
        public void GenericBulkInvoiceDetailsForPrint(HDB_AuctionInvoiceViewModel ObjBulkInvoiceReport)
        {
        ...
        public void GetRefNoForDestruction(int Flag)
        {
            try
            {
                ...
                try
                {
                    ...
                    _DBResponse = new DatabaseResponse();
                    List<HDB_DestructionViewModel> lstDestruction = new List<HDB_DestructionViewModel>();
                    if (Result != null && Result.Tables[0].Rows.Count > 0)
                    {
                        Status = 1;
                        foreach (DataRow dr in Result.Tables[0].Rows)
                        {
                            lstDestruction.Add(new HDB_DestructionViewModel
                            {
        ...
        public void SaveDestruction(HDB_DestructionViewModel vm, int uid)
        {
        ...
        public void GetDestructionGatePassDetails(int ID)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<HDB_DestructionGatepassViewModel> lstDestruction = new List<HDB_DestructionGatepassViewModel>();
            int Status = 0;
            try
            {
                while (result.Read())
                {
                    Status = 1;
                    lstDestruction.Add(new HDB_DestructionGatepassViewModel
                    {
