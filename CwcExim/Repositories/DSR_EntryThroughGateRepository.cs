...
{
    public class DSR_EntryThroughGateRepository
    {
        ...
        public void AddEditEntryThroughGateCBT(DSREntryThroughGate ObjEntryThroughGate)
        {
            //if(ObjEntryThroughGate.EntryDateTime != null && ObjEntryThroughGate.EntryDateTime != "")
            //{ }
            //if (ObjEntryThroughGate.ReferenceDate != null && ObjEntryThroughGate.ReferenceDate != "")
        ...
        public void AddEditEntryThroughGate(DSREntryThroughGate ObjEntryThroughGate)
        {
            //if(ObjEntryThroughGate.EntryDateTime != null && ObjEntryThroughGate.EntryDateTime != "")
            //{ }
            //if (ObjEntryThroughGate.ReferenceDate != null && ObjEntryThroughGate.ReferenceDate != "")
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_TransportMode", MySqlDbType = MySqlDbType.Int32, Size = 1, Value = ObjEntryThroughGate.TransportMode });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerLoadType", MySqlDbType = MySqlDbType.VarChar, Size = 3, Value = ObjEntryThroughGate.ContainerLoadType });//in_OperationType
            LstParam.Add(new MySqlParameter { ParameterName = "in_TransportFrom", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjEntryThroughGate.TransportFrom });

            LstParam.Add(new MySqlParameter { ParameterName = "in_CBT", MySqlDbType = MySqlDbType.Bit, Value = ObjEntryThroughGate.IsCBT});//in_OperationType
            LstParam.Add(new MySqlParameter { ParameterName = "in_TPNo", MySqlDbType = MySqlDbType.VarChar, Size = 45, Value = ObjEntryThroughGate.TPNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Odc", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.IsOdc});
            LstParam.Add(new MySqlParameter { ParameterName = "in_OCFSCode", MySqlDbType = MySqlDbType.VarChar, Value = (ObjEntryThroughGate.OCFSCode == null ? "" : ObjEntryThroughGate.OCFSCode) });
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.IsOdc = Convert.ToInt32(Result["Ct_ODC"]);
                     ...
                     ObjEntryThroughGate.TransportFrom = Convert.ToInt32(Result["PortId"]);
                    ObjEntryThroughGate.GrossWeight = Convert.ToDecimal(Result["Gross_Wt"]);
                        ObjEntryThroughGate.ContainerLoadType = Result["ContainerLoadType"].ToString();
                        ObjEntryThroughGate.ShippingLineSealNo = Result["ShippingLineNo"].ToString();
                        ObjEntryThroughGate.ShippingLineId = Convert.ToInt32(Result["ShippingLineId"] == DBNull.Value ? 0 : Result["ShippingLineId"]);
                   // }
        ...
        public void GetLoadedContData(int LoadContainerRefId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSRLoadedContainerListWithData> lstLoadedContainerListWithData = new List<DSRLoadedContainerListWithData>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstLoadedContainerListWithData.Add(new DSRLoadedContainerListWithData
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        ...
                        OCFSCode= Result["CFSCode"].ToString(),
        ...
        public void ListOfShippingLine()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<DSREntryThroughGateShipping> lstShippingList = new List<DSREntryThroughGateShipping>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstShippingList.Add(new DSREntryThroughGateShipping
                    {
        ...
        public void ListOfCHA()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<DSREntryThroughGateCHA> lstCHAList = new List<DSREntryThroughGateCHA>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstCHAList.Add(new DSREntryThroughGateCHA
                    {
        ...
        public void GetContainerByRoad()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllContainerByRoad", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<container> Lstcontainer = new List<container>();
            try
            {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LoadContainerReferenceLst.Add(new LoadContainerReferenceNumberList
                    {
                        ...
                        LoadedReq = Convert.ToString(Result["LoadedReq"])
                    });
        ...
        public void GetEntryThroughGate(int EntryId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.OperationType = Result["OperationType"].ToString();
                    ObjEntryThroughGate.TransportMode = Convert.ToInt32(Result["TransportMode"].ToString());
                    ObjEntryThroughGate.TransportFrom = Convert.ToInt32(Result["TransportFrom"]);                    
                    ObjEntryThroughGate.ContainerLoadType = Result["ContainerLoadType"].ToString();
        ...
        public void GetDetForExportAddVehicle(int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSR_AddExportVehicle ObjEntryThroughGate = new DSR_AddExportVehicle();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditEntryThroughGateVehicle(DSR_AddExportVehicle ObjEntryThroughGate)
        {
        ...
        public void GetVehicleDtlbyEntryId(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstVehicle.Add(new DSR_AddExportVehicle
                    {
                        EntryId = Convert.ToInt32(Result["EntryId"]),
        ...
        public void AddEditEntryThroughGateBond(DSR_EntryThroughGateBond ObjEntryThroughGate)
        {
            DateTime? ReferenceDt = null;
            var Entrydt = (dynamic)null;
            var SysDateTime = (dynamic)null;
