...
{
    public class HDB_GatePassRepository
    {
        ...
        /***************************/
        public void AddEditGatePass(HDB_GatePass objGP, string XML)
        {
        ...
        public void GetDetailsForGatePassPrint(int GatePassId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objGP.GodownName = Result["GodownName"].ToString();
