...
{
    public class DNODE_RateRepository
    {
        ...
        public void AddEditMstRateFees(DNDMiscCharge objStorage, int Uid)
        {
        ...
        public void GetAllMiscRateFees(int StorageChargeId)
        {
            ...
            IList<DNDMiscCharge> lstRateFees = null;
            DNDMiscCharge objSC = null;
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                ...
                {
                    lstRateFees = new List<DNDMiscCharge>();
                    while (result.Read())
                    {
                        Status = 1;
                        lstRateFees.Add(new DNDMiscCharge
                        {
                ...
                else
                {
                    ...
                    while (result.Read())
                    {
                        ...
                        objSC.IsITP = Convert.ToBoolean(result["IsITP"]);
                    }
                }
