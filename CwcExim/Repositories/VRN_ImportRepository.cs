...
{
    public class VRN_ImportRepository
    {
        ...
        public void GetYardPaymentSheet(string InvoiceDate, int AppraisementId, string InvoiceType, string ContainerXML,string Movement, int InvoiceId,int OTHours, int PartyId, int PayeeId, int isdirect, string SEZ,int ReeferHours)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddEditInvoice(VRN_InvoiceYard ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML,string ChargesBreakupXML,
           ...
           string Module,string Movement,int ReeferHours=0, string CargoXML = "")
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
       ...
       string Module, string CargoXML = "")
        ...
        public void AddEditSingleMergeDeliveryApplication(VRN_MergeDeliveryIssueViewModel ObjDeliveryApp,
        ...
        public void GetDeliveryPaymentSheetSingle(string InvoiceType, int DestuffingAppId,string DeliveryDate, string ExportUnder, int InvoiceId, string XMLText,  int PartyId,int PayeeId,int OTHours = 0,int OblFlag=0,int Movement=0,int Distance=0, int IsBond=0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_DestuffingAppId", MySqlDbType = MySqlDbType.Int32, Value = DestuffingAppId });
