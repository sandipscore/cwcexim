...
{
    public class DSR_RateRepository
    {
        ...
        public void AddEditMstRateFees(DSRStorageCharge objStorage, int Uid)
        {
        ...
        public void ListOfSACCode()
        {
            ...
            IList<DSRSac> lstSac = new List<DSRSac>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void ListOfChargeName()
        {
            ...
            IList<DSRMiscCharge> LstOfChargeName = new List<DSRMiscCharge>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstOfChargeName.Add(new DSRMiscCharge
                    {
        ...
        public void GetAllMiscRateFees(int StorageChargeId)
        {
            ...
            IList<DSRStorageCharge> lstRateFees = null;
            DSRStorageCharge objSC = null;
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                ...
                {
                    lstRateFees = new List<DSRStorageCharge>();
                    while (result.Read())
                    {
                        Status = 1;
                        lstRateFees.Add(new DSRStorageCharge
                        {
