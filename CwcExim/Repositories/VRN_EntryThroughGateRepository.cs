...
{ 
    public class VRN_EntryThroughGateRepository
    {
        ...
        public void AddEditEntryThroughGateCBT(VRN_EntryThroughGate ObjEntryThroughGate, string XML, string ContClass)
        {
        ...
        public void AddEditEntryThroughGate(VRN_EntryThroughGate ObjEntryThroughGate)
        {
        ...
        public void GetAllEntryThroughGate()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstEntryThroughGate.Add(new VRN_EntryThroughGate
                    {
        ...
        public void GetReferenceNumber()
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjReferenceNumber.ReferenceList.Add(new VRN_CCINList
                    {
        ...
        public void GetEntryThroughGate(int EntryId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjEntryThroughGate.listAddRef.Add(new VRN_AddMoreRefForCCIN
                        {
        ...
        public void GetDetForExportAddVehicle(int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_AddExportVehicle ObjEntryThroughGate = new VRN_AddExportVehicle();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditEntryThroughGateVehicle(VRN_AddExportVehicle ObjEntryThroughGate)
        {
        ...
        public void GetVehicleDtlbyEntryId(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstVehicle.Add(new VRN_AddExportVehicle
                    {
                        EntryId = Convert.ToInt32(Result["EntryId"]),
        ...
        public void AddEditEntryThroughGateBond(VRN_EntryThroughGateBond ObjEntryThroughGate)
        {
            DateTime? ReferenceDt = null;
            var Entrydt = (dynamic)null;
            var SysDateTime = (dynamic)null;
