...
{
    public class DSRExitThroughGateRepository
    {
        ...
        public void AddEditExitThroughGate(DSRExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
        ...
        public void GetContainer()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objExitThroughGateHeader.containerList.Add(new DSRcontainerExit
                    {
        ...
        public void GetGatePassLstPending()
        {
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GatePassListPending", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstGatePass.Add(new DSRGatePassList
                    {
        ...
        public void AddGateEXitToDetails(DSRExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
            ObjExitThroughGateHeader.Uid = Uid;
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void DeleteExitThroughGate(int ExitId)
        {
            ...
            try
            {
               ...
               else if (Result == 3)
                {
                    ...
                    _DBResponse.Message = "Unble to Delete!ICD Number Exists in Factory Destuffing";
                    _DBResponse.Data = null;
                }
                else
                {
        ...
        public void GetAllExitThroughGate()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSRExitThroughGateHeader> LstExitThroughGate = new List<DSRExitThroughGateHeader>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new DSRExitThroughGateHeader
                    {
        ...
        public void GetAllExitThroughGateListSearchByContainerNo(string ContainerNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllExitThroughGateSeachByContainerNo", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<DSRExitThroughGateHeader> LstExitThroughGate = new List<DSRExitThroughGateHeader>();
            try
            {
        ...
        public void GetExitThroughGateDetails()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSRExitThroughGateDetails> LstExitThroughGateDtls = new List<DSRExitThroughGateDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGateDtls.Add(new DSRExitThroughGateDetails
                    {                    
                        ExitIdHeader = Convert.ToInt32(Result["ExitIdHeader"]),
        ...
        public void GetDetailsForGateExitMail(string LineId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSREntryThroughGateMail objMail = new DSREntryThroughGateMail();
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Result.NextResult())
                    {
                        while (Result.Read())
                        {
                            objMail.lstExcelData.Add(new DSRExcelData()
                            {
        ...
        public void GetDetailsForGateExitMailPIL(string LineId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSREntryThroughGateMailPIL objMail = new DSREntryThroughGateMailPIL();
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Result.NextResult())
                    {
                        while (Result.Read())
                        {
                            objMail.lstExcelData.Add(new DSRExcelDataPIL()
                            {
        ...
        public void ContainerForGAtePass(int gatePassId)
        {
            ...
            IList<DSRcontainerAgainstGp> LstcontainerAgainstGp = new List<DSRcontainerAgainstGp>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstcontainerAgainstGp.Add(new DSRcontainerAgainstGp
                    {
        ...
        public void GetGatePassLstToRevalidate()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSRRevalidateGatePass> LstRevalidateGatePass = new List<DSRRevalidateGatePass>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstRevalidateGatePass.Add(new DSRRevalidateGatePass
                    {
        ...
        public void UpdateGatePassValidity(DSRRevalidateGatePass objRevalidateGatePass)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstcontainerAgainstGp.Add(new DSRcontainerAgainstGp
                    {
                        ...
                        Location = Result["Location"].ToString() == null ? "" : Result["Location"].ToString(),
        ...
        public void AddEditExitThroughGateCBT(DSRGateExitCBT ObjExitThroughGateHeader, int Uid)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_GateExitDateTime", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(ObjExitThroughGateHeader.GateExitDateTime).ToString("yyyy-MM-dd HH:mm:ss") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CBTNo", MySqlDbType = MySqlDbType.VarChar, Value = ObjExitThroughGateHeader.CBTNo });
        ...
        public void GetAllExitThroughGateCBT()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSRGateExitCBT> LstExitThroughGate = new List<DSRGateExitCBT>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new DSRGateExitCBT
                    {
                        GateExitNo = Result["GateExitNo"].ToString(),
                        GateExitDateTime = Result["GateExitDateTime"].ToString(),
        ...
        public void EditViewExitThroughGateCBT(int ExitId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSRGateExitCBT ObjExitThroughGate = new DSRGateExitCBT();
            try
            {
                while (Result.Read())
                {
