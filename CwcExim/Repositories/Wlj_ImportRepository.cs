...
{
    public class Wlj_ImportRepository
    {
        ...
        public void GetOBLContainer(String OBLNo)
        {
            ...
            try
            {
                ...
                WljCustomAppraisement objOBLEntry = new WljCustomAppraisement();
                //List<OblEntryDetails> OblEntryDetailsList = new List<OblEntryDetails>();
                if (Result != null && Result.Tables.Count > 0)
                {
                    Status = 1;
                    foreach (DataRow dr in Result.Tables[0].Rows)
                    {
                        WljCustomAppraisementOBLCont objOBLCont = new WljCustomAppraisementOBLCont();
                        objOBLCont.CFSCode = Convert.ToString(dr["CFSCode"]);
                        objOBLCont.ContainerNo = Convert.ToString(dr["ContainerNo"]);
                        objOBLEntry.WljCustomAppraisementCont.Add(objOBLCont);
                    }
                }
                if (Status == 1)
                {
                    ...
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = objOBLEntry.WljCustomAppraisementCont;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void GetBOEDetail(String BOENo)
        {
            ...
            try
            {
                ...
                WljCustomAppraisementBOECont objOBLCont = new WljCustomAppraisementBOECont();
                if (Result != null && Result.Tables.Count > 0)
                {
        ...
        public void AddEditSealCutting(Wlj_SealCutting Obj,string ChargesBreakupXML, int BranchId, int Uid, string OBLXML)
        {
            try
            {
                List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddEditImpJO(Wlj_JobOrder objJO, string XML = null)
        {
        ...
        #region Tally Sheet
        public void AddEditTallySheet(Wlj_TallySheet Obj, string XML, int BranchId)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetTallySheet(int BranchId, int TallySheetId,int Uid)
        {
            ...
            try
            {
                ...
                {
                    Wlj_TallySheet objTS = new Wlj_TallySheet();
        ...
        public void GetAllCustomAppraisementApp()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstAppraisement.Add(new WljCustomAppraisement
                    {
        ...
        public void GetCustomAppraisement(int CustomAppraisementId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjAppraisement.LstAppraisementPpg.Add(new WljCustomAppraisementDtl
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjAppraisement.LstCustomAppraisementOrdDtl.Add(new WljCustomAppraisementOrdDtl
                        {
        ...
        public void AddEditCustomAppraisement(WljCustomAppraisement ObjAppraisement,string AppraisementXML,string CAOrdXML)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetContnrNoForCustomAppraise()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WljCustomAppraisementDtl> LstAppraisement = new List<WljCustomAppraisementDtl>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstAppraisement.Add(new WljCustomAppraisementDtl
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString()
                    });
        ...
        public void AddEditDestuffingEntry(WljDestuffingEntry ObjDestuffing, string DestuffingEntryXML /*, string GodownXML, string ClearLcoationXML */, int BranchId, int Uid)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetDestuffingEntry(int DestuffingEntryId, int BranchId, string Action)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDestuffing.lstDtl.Add(new Wlj_DestuffingEntryDtl
                        {
        ...
        public void GetAllDestuffingEntry(int Page,int UId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstDestuffing.Add(new Wlj_DestuffingList
                    {
        ...
        public void GetDestuffEntryForPrint(int DestuffingEntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Wlj_DestuffingSheet ObjDestuffing = new Wlj_DestuffingSheet();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDestuffing.lstDtl.Add(new Wlj_DestuffingSheetDtl
                        {
        ...
        public void GetYardPaymentSheet(string InvoiceDate, int AppraisementId, string InvoiceType, string ContainerXML, int InvoiceId,int OTHours, int PartyId, int PayeeId, int isdirect,string SEZ)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            WLJInvoiceYard objInvoice = new WLJInvoiceYard();
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstPostPaymentChrg.Add(new WLJPostPaymentChrg
                        {
                            ChargeId = Convert.ToInt32(Result["OperationId"]),
                            Clause = Result["ChargeType"].ToString(),
                            ChargeType = Result["ChargeType"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objInvoice.lstPostPaymentChrgBreakup.Add(new WLJPostPaymentChargebreakupdate
                        {
                            ChargeId = Convert.ToInt32(Result["OperationId"]),
                            Clause = Result["ChargeType"].ToString(),
                            ChargeType = Result["ChargeType"].ToString(),
        ...
        public void AddEditInvoice(WLJInvoiceYard ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML,string ChargesBreakupXML,
            int BranchId, int Uid, int Direct, string SEZ,
        ...
        public void ListOfYardInvoice(string Module, string InvoiceNo = null, string InvoiceDate = null)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<CwcExim.Areas.Export.Models.CHNListOfExpInvoice> lstExpInvoice = new List<CwcExim.Areas.Export.Models.CHNListOfExpInvoice>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstExpInvoice.Add(new CwcExim.Areas.Export.Models.CHNListOfExpInvoice()
                    {
        ...
        public void ListOfIssueParty()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Wlj_DeliveryOrdDtl> LstStuffing = new List<Wlj_DeliveryOrdDtl>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new Wlj_DeliveryOrdDtl
                    {
        ...
        public void GetDeliveryApplication(int DeliveryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Wlj_DeliverApplication ObjDeliveryApp = new Wlj_DeliverApplication();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryApp.LstDeliveryAppDtl.Add(new Wlj_DeliveryApplicationDtl
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryApp.LstDeliveryordDtl.Add(new Wlj_DeliveryOrdDtl
                        {
                            OrderId = Convert.ToInt32(Result["OrderId"]),
                            DeliveryNo = Result["DeliveryNo"].ToString(),
                            IssuedBy = (Result["DoIssueBy"] == null ? "" : Result["DoIssueBy"]).ToString(),
        ...
        public void GetBOELineNoDetForDelivery(int DestuffingEntryDtlId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Wlj_DeliveryApplicationDtl ObjDeliveryApp = new Wlj_DeliveryApplicationDtl();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetBOEForDeliveryPaymentSheet(int DestuffingAppId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetDeliveryApplicationForImpPaymentSheet", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<Wlj_PaymentSheetBOE> objPaymentSheetBOE = new List<Wlj_PaymentSheetBOE>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentSheetBOE.Add(new Wlj_PaymentSheetBOE()
                    {
                        CFSCode = Convert.ToString(Result["CFSCode"]),
       ...
       string Module, string CargoXML = "")
        ...
        #region Issue Slip
        public void AddEditIssueSlip(WLJ_IssueSlip ObjIssueSlip)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddEditMergeIssueSlip(MergeDeliveryIssueViewModelWaluj ObjIssueSlip)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            Wlj_mergedet pdet = new Wlj_mergedet();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        public void GetIssueSlip(int IssueSlipId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjIssueSlip.LstContainer.Add(new WLJ_IssueSlipContainer
                        {
                            CFSCode = Result["CFSCode"].ToString(),
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = (Result["Size"] == null ? "" : Result["Size"]).ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjIssueSlip.LstCargo.Add(new WLJ_IssueSlipCargo
                        {
                            OBLNo = (Result["OBLNo"] == null ? "" : Result["OBLNo"]).ToString(),
                            CargoDescription = (Result["CargoDescription"] == null ? "" : Result["CargoDescription"]).ToString(),
        ...
        public void GetAllIssueSlip()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstIssueSlip.Add(new WLJ_IssueSlip
                    {
        ...
        public void GetIssueSlipForPreview(int IssueSlipId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjIssueSlip.LstIssueSlipRpt.Add(new WLJ_IssueSlipReport
                        {
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = Result["Size"].ToString(),
                            Vessel = (Result["Vessel"] == null ? "" : Result["Vessel"]).ToString(),
        ...
        #region OBL Entry
        public void GetContainerListForOBL(string CFSCode = "")
        {
            int Status = 0;
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_CFSCode", MySqlDbType = MySqlDbType.String, Value = CFSCode });
        ...
        public void GetCFSCodeWiseOBLDetails(string CFSCode, string ContainerNo, string ContainerSize, string IGM_No, string IGM_Date, int OBLEntryId)
        {
            ...
            try
            {
                ...
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow dr in Result.Tables[1].Rows)
                    {
                        Wlj_OblEntryDetails objOBLEntryDetails = new Wlj_OblEntryDetails();
                        objOBLEntryDetails.icesContId = Convert.ToInt32(dr["icesContId"]);
                        objOBLEntryDetails.OBL_No = Convert.ToString(dr["OBL_NO"]);
                        objOBLEntryDetails.OBL_Date = Convert.ToString(dr["OBL_DATE"]);
                        objOBLEntryDetails.LineNo = Convert.ToString(dr["LINE_NO"].ToString());
        ...
        public void AddEditOBLEntryLCL(Wlj_OblEntry objOBL, string XmlText)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_OBLId", MySqlDbType = MySqlDbType.Int32, Value = objOBL.Id });
        ...
        public void GetAllOblEntryLCL(int Page)
        {
            ...
            try
            {
                ...
                List<Wlj_OblEntry> OblEntryList = new List<Wlj_OblEntry>();
        ...
        public void GetOblEntryLCLDetailsByOblEntryId(int OblEntryId)
        {
            ...
            int Status = 0;
            Wlj_OblEntry objOBLEntry = new Wlj_OblEntry();
            IList<Wlj_OblEntryDetails> lstOBLEntryDetails = new List<Wlj_OblEntryDetails>();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        lstOBLEntryDetails.Add(new Wlj_OblEntryDetails
                        {
                            OBLEntryId = Convert.ToInt32(Result["OblEntry_DtlId"]),
                            OBL_No = Convert.ToString(Result["OBL_NO"]),
                            OBL_Date = Convert.ToString(Result["OBL_DATE"]),
        ...
        public void GetListOfOBLWiseContainerSearch(string Obl)
        {
            ...
            try
            {
                ...
                List<Wlj_OBLWiseContainerEntry> OblEntryList = new List<Wlj_OBLWiseContainerEntry>();
        ...
        public void GetOBLWiseContainerDetails(string OBLNo)
        {
            ...
            try
            {
                ...
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow dr in Result.Tables[1].Rows)
                    {
                        Wlj_OBLWiseContainerEntryDetails objOBLEntryDetails = new Wlj_OBLWiseContainerEntryDetails();
        ...
        public void AddEditOBLWiseContainerEntry(Wlj_OBLWiseContainerEntry objOBL, string XmlText)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void AddEditMergeDeliveryApplication(MergeDeliveryIssueViewModelWaluj ObjDeliveryApp, string DeliveryXml, String ObjDeliveryOrd)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
        ...
        public void AddEditSingleMergeDeliveryApplication(MergeDeliveryIssueViewModelWaluj ObjDeliveryApp, string DeliveryXml, String ObjDeliveryOrd)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_SEZ", MySqlDbType = MySqlDbType.VarChar, Value = ObjDeliveryApp.SEZ });
        ...
        public void GetAllDeliveryMergeApplication(int Page, int Uid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Wlj_MergeDeliveryApplicationList> LstDeliveryApp = new List<Wlj_MergeDeliveryApplicationList>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstDeliveryApp.Add(new Wlj_MergeDeliveryApplicationList
                    {
        ...
        public void GetDeliveryPaymentSheetSingle(string InvoiceType, int DestuffingAppId,string SEZ,string DeliveryDate, int InvoiceId, string XMLText, int PartyId,int PayeeId,int OTHours = 0,int OblFlag=0,int Movement=0,int Distance=0, int IsBond=0,string ExportUnder="")
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_DestuffingAppId", MySqlDbType = MySqlDbType.Int32, Value = DestuffingAppId });
            ...
            Wlj_InvoiceGodown objInvoice = new Wlj_InvoiceGodown();
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstInvoiceCargo.Add(new Wlj_InvoiceCargo
                        {
                            BOENo = Result["BOENo"].ToString(),
                            BOEDate = Result["BOEDate"].ToString(),
                            BOLDate = Result["BOLDate"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objInvoice.lstPostPaymentChrgBreakup.Add(new Wlj_DeliPostPaymentChargebreakupdate
                        {
                            ChargeId = Convert.ToInt32(Result["OperationId"]),
                            Clause = Result["ChargeType"].ToString(),
                            ChargeType = Result["ChargeType"].ToString(),
        ...
        {
            Wlj_IrnB2CDetails Obj = new Wlj_IrnB2CDetails();
