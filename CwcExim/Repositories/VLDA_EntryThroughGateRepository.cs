...
{
    public class VLDA_EntryThroughGateRepository
    {
        ...
        public void AddEditEntryThroughGateCBT(WfldEntryThroughGate ObjEntryThroughGate)
        {
            ...
            if (ObjEntryThroughGate.ReferenceNo != null)
            {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_TransportFrom", MySqlDbType = MySqlDbType.VarChar, Size = 50, Value = ObjEntryThroughGate.TransportFrom });
        ...
        public void AddEditEntryThroughGate(WfldEntryThroughGate ObjEntryThroughGate)
        {
            //if(ObjEntryThroughGate.EntryDateTime != null && ObjEntryThroughGate.EntryDateTime != "")
            //{ }
            //if (ObjEntryThroughGate.ReferenceDate != null && ObjEntryThroughGate.ReferenceDate != "")
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_CHAId", MySqlDbType = MySqlDbType.Int32, Size = 30, Value = ObjEntryThroughGate.CHAId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CHAName", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.CHAName });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ForwarderId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjEntryThroughGate.ForwarderId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Forwarder", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.Forwarder });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo1", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = (ObjEntryThroughGate.ContainerNo1 == null ? "" : ObjEntryThroughGate.ContainerNo1) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Size", MySqlDbType = MySqlDbType.VarChar, Size = 4, Value = ObjEntryThroughGate.Size });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContClass", MySqlDbType = MySqlDbType.VarChar, Size = 20, Value = ObjEntryThroughGate.ContClass });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Reefer", MySqlDbType = MySqlDbType.Bit, Value = ObjEntryThroughGate.Reefer });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CustomSealNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.CustomSealNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ShippingLineSealNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.ShippingLineSealNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_VehicleNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.VehicleNo });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_CBT", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.IsCBT ? 1 : 0 });//in_OperationType
            LstParam.Add(new MySqlParameter { ParameterName = "in_TPNo", MySqlDbType = MySqlDbType.VarChar, Size = 45, Value = ObjEntryThroughGate.TPNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Odc", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.IsOdc ? 1 : 0 });

            LstParam.Add(new MySqlParameter { ParameterName = "in_OnWeel", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.OnWheel ? 1 : 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Bond", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.Bond ? 1 : 0 });


            // Newly Added on 25-04-2024//
            LstParam.Add(new MySqlParameter { ParameterName = "in_OnAccuntid", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjEntryThroughGate.OnAccountId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_OnAccunt", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.OnAccount });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Transpoter", MySqlDbType = MySqlDbType.VarChar, Size = 11, Value = ObjEntryThroughGate.Transpoter });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BKNO", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.BKNO });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SealNo", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.SealNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Type", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.Type });

            LstParam.Add(new MySqlParameter { ParameterName = "in_AccountholderId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjEntryThroughGate.AccountholderId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Accountholder", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.Accountholder });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ExporterId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjEntryThroughGate.ExporterId });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Driver", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.Driver });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Vessel", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.Vessel });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ViaNo", MySqlDbType = MySqlDbType.VarChar, Size = 11, Value = ObjEntryThroughGate.ViaNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_POD", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.POD });
            LstParam.Add(new MySqlParameter { ParameterName = "in_POL", MySqlDbType = MySqlDbType.VarChar, Size = 11, Value = ObjEntryThroughGate.POL });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SBNO", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.SBNO });
            LstParam.Add(new MySqlParameter { ParameterName = "in_AgentSeal", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.AgentSeal });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Netweight", MySqlDbType = MySqlDbType.Decimal, Value = Convert.ToDecimal(ObjEntryThroughGate.Netweight) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_TrainNo", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.TrainNo});
            ...
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();//AddEditEntryThroughGate
        ...
        public void DeleteEntryThroughGate(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Entry Deleted Successfully";  // "Record Of Entry Through Gate Deleted Successfully"
                    _DBResponse.Data = GeneratedClientId;
                }
                else if (Result == 3)
                {
        ...
        public void GetAllEntryThroughGate()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstEntryThroughGate.Add(new WfldEntryThroughGate
                    {
        ...
        public void GetAllEntryThroughGateSearchListPage(int Page, string OperationType, string ContainerType, string ContainerNo)
        {
            ...
            if (OperationType == "Bond")
                Result = DataAccess.ExecuteDataReader("bondgateinsearch", CommandType.StoredProcedure, DParam);
            else
                Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateListPageSearch", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<WfldEntryThroughGate> LstEntryThroughGate = new List<WfldEntryThroughGate>();
            try
            {
        ...
        public void GetAllEntryThroughTrainListPage(int Page)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Empty", MySqlDbType = MySqlDbType.VarChar, Value = null });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = Page });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Module", MySqlDbType = MySqlDbType.VarChar, Size = 5, Value = "" });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateListPage", CommandType.StoredProcedure, DParam);
        ...
        public void GetAllEntryThroughGateCBTListPage(int Page)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerType", MySqlDbType = MySqlDbType.VarChar, Value = "" });
        ...
        public void GetAllEntryThroughGateCBTSearchListPage(int Page, string ContainerNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo", MySqlDbType = MySqlDbType.VarChar, Value = ContainerNo });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateCBTListPageSearch", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<WfldEntryThroughGate> LstEntryThroughGate = new List<WfldEntryThroughGate>();
            try
            {
        ...
        public void GetReferenceNumberforExportCBT()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetReferenceNumberExportCBT", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
        ...
        public void GetReferenceNumberDetforExportCBT(int Id)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetReferenceDetExportCBT", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();

            CCINList ObjReferenceNumber = new CCINList();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjReferenceNumber.CCINDate = Convert.ToString(Result["CCINDate"]);
                    ObjReferenceNumber.ShippingLineId = int.Parse(Convert.ToString(Result["ShippingLineId"]));
                    ObjReferenceNumber.ShippingLine = Result["ShippingLine"].ToString();
                    ObjReferenceNumber.NoOfUnits = Convert.ToString(Result["Package"]);
                    ObjReferenceNumber.Weight = Convert.ToString(Result["Weight"]);
                    ObjReferenceNumber.CargoType = Convert.ToInt32(Result["CargoType"]);
                    ObjReferenceNumber.CHAId = int.Parse(Convert.ToString(Result["CHAId"]));
                    ObjReferenceNumber.CHAName = Result["CHA"].ToString();
        ...
        public void GetEntryThroughGate(int EntryId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.ShippingLineId = Convert.ToInt32(Result["ShippingLineId"]);
                    ObjEntryThroughGate.CHAName = Result["CHAName"].ToString();
                    ObjEntryThroughGate.Forwarder = Result["ForwarderConsolidator"].ToString();
                    ObjEntryThroughGate.ContClass = Result["ContClass"].ToString();
                    ...
                    ObjEntryThroughGate.OnWheel = Convert.ToBoolean(Result["OnWeel"]);
                    ObjEntryThroughGate.Bond = Convert.ToBoolean(Result["Bond"]);
                    //----Newly Added----//
                    ObjEntryThroughGate.OnAccountId = Convert.ToInt32(Result["OnAccountId"]);
                    ObjEntryThroughGate.OnAccount = Result["OnAccount"].ToString();
                    ObjEntryThroughGate.BKNO = Result["BKNo"].ToString();
                    ObjEntryThroughGate.SealNo = Result["SealNo"].ToString();
                    ObjEntryThroughGate.Type = Result["Type"].ToString();
                    ObjEntryThroughGate.Transpoter= Result["Transporter"].ToString();
                    ObjEntryThroughGate.AccountholderId = Convert.ToInt32(Result["AccountholderId"]);
                    ObjEntryThroughGate.Accountholder = Result["Accountholder"].ToString();
                    ObjEntryThroughGate.ExporterId = Convert.ToInt32(Result["ExporterId"]);
                    ObjEntryThroughGate.Exporter = Result["Exporter"].ToString();
                    ObjEntryThroughGate.Driver = Result["Driver"].ToString();
                    ObjEntryThroughGate.Vessel = Result["Vessel"].ToString();
                    ObjEntryThroughGate.ViaNo = Result["ViaNo"].ToString();
                    ObjEntryThroughGate.POD = Result["POD"].ToString();
                    ObjEntryThroughGate.POL = Result["POL"].ToString();
                    ObjEntryThroughGate.SBNO = Result["SBNO"].ToString();
                    ObjEntryThroughGate.AgentSeal = Result["AgentSeal"].ToString();
                    ObjEntryThroughGate.Netweight = Convert.ToDecimal(Result["Netweight"].ToString());
                    ObjEntryThroughGate.TrainNo= Result["TrainNo"].ToString();
                    //----Newly Added----//
                }
                if (Status == 1)
                {
        ...
        public void GetDetForExportAddVehicle(int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLD_AddExportVehicle ObjEntryThroughGate = new WFLD_AddExportVehicle();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditEntryThroughGateVehicle(WFLD_AddExportVehicle ObjEntryThroughGate)
        {
        ...
        public void GetVehicleDtlbyEntryId(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstVehicle.Add(new WFLD_AddExportVehicle
                    {
                        EntryId = Convert.ToInt32(Result["EntryId"]),
        ...
        public void AddEditEntryThroughGateBond(Wfld_EntryThroughGateBond ObjEntryThroughGate)
        {
            DateTime? ReferenceDt = null;
            var Entrydt = (dynamic)null;
            var SysDateTime = (dynamic)null;
        ...
        public void SACDetails(int SACId)
        {
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetSACForGateBond", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
        ...
        public void ListOfTransPort()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfTransPortFrom", CommandType.StoredProcedure);
        ...
        #region Lorry Receipt
       
        public void GetPartyNameList(int Page, string PartyCode)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPartyNamesForLorryReceipt", CommandType.StoredProcedure, DParam);
            List<VLDA_PartyDetails> LstPartyDetails = new List<VLDA_PartyDetails>();
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    LstPartyDetails.Add(new VLDA_PartyDetails
                    {
        ...
        public void GetShippingLineForLorryReceipt()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetShippingLineForLorryReceipt", CommandType.StoredProcedure, DParam);
            List<VLDA_ShippingLineForLorryReceipt> LstShippingLine = new List<VLDA_ShippingLineForLorryReceipt>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstShippingLine.Add(new VLDA_ShippingLineForLorryReceipt
                    {
                        ShippingLineID = Convert.ToInt32(Result["ShippingLineId"]),
                        ShippingLineName = Result["ShippingLine"].ToString()
                    });
        ...
        public void AddEditLorryReceipt(VLDA_LorryReceipt  LR, string  XMLLorryDtl)
        {
            ...
            string GeneratedClientId = "0";
            string RetunID = "0";
            lstParam.Add(new MySqlParameter { ParameterName = "in_ID", MySqlDbType = MySqlDbType.Int32, Value =LR.ID });
            lstParam.Add(new MySqlParameter { ParameterName = "in_GRNO", MySqlDbType = MySqlDbType.VarChar, Value =LR.GRNo});
            lstParam.Add(new MySqlParameter { ParameterName = "in_LRDateTime", MySqlDbType = MySqlDbType.Datetime, Value = Convert.ToDateTime(LR.LR_DATE).ToString("yyyy-MM-dd HH:mm:ss") });
            lstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = LR.PartyID } );
            lstParam.Add(new MySqlParameter { ParameterName = "in_PartyName", MySqlDbType = MySqlDbType.VarChar, Value = LR.PartyName });                    
            lstParam.Add(new MySqlParameter { ParameterName = "in_Consignee", MySqlDbType = MySqlDbType.VarChar, Value = LR.Consignee });
            lstParam.Add(new MySqlParameter { ParameterName = "in_ShippingLine", MySqlDbType = MySqlDbType.VarChar, Value =LR.ShippingLine });
            lstParam.Add(new MySqlParameter { ParameterName = "in_ShippingLineID", MySqlDbType = MySqlDbType.Int32, Value = LR.ShippingLineID });
            lstParam.Add(new MySqlParameter { ParameterName = "in_StuffingPoint", MySqlDbType = MySqlDbType.VarChar, Value = LR.StuffingPoint });
            lstParam.Add(new MySqlParameter { ParameterName = "in_BookingNo", MySqlDbType = MySqlDbType.VarChar, Value = LR.BookingNo });
            lstParam.Add(new MySqlParameter { ParameterName = "in_FromLocation", MySqlDbType = MySqlDbType.VarChar, Value =LR.TransportFrom });
            lstParam.Add(new MySqlParameter { ParameterName = "in_ToLocation", MySqlDbType = MySqlDbType.VarChar, Value = LR.TransportTo });
            lstParam.Add(new MySqlParameter { ParameterName = "in_BOENo", MySqlDbType = MySqlDbType.VarChar, Value = LR.BOE });
            lstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceNo", MySqlDbType = MySqlDbType.Text, Value = LR.InvoiceNo });
            lstParam.Add(new MySqlParameter { ParameterName = "in_Remarks", MySqlDbType = MySqlDbType.VarChar, Value = LR.Remarks });           
            lstParam.Add(new MySqlParameter { ParameterName = "in_XML", MySqlDbType = MySqlDbType.Text, Value = XMLLorryDtl });
            lstParam.Add(new MySqlParameter { ParameterName = "in_UID", MySqlDbType = MySqlDbType.Text, Value = LR.Uid });         
            ...
            IDataParameter[] DParam = lstParam.ToArray();
            int Result = DA.ExecuteNonQuery("AddEditLorryReceipt", CommandType.StoredProcedure, DParam, out GeneratedClientId, out RetunID);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1 || Result == 2)
                {
                    ...
                    _DBResponse.Message = (Result == 1) ? "Lorry Receipt Saved Successfully : " + GeneratedClientId : "Lorry Receipt Updated Successfully";
                    _DBResponse.Status = Result;
                ...
                {
                    _DBResponse.Data = null;
                    _DBResponse.Message = "Lorry Receipt can not be generated";
                    _DBResponse.Status = 0;
                }
                else
                {
        ...
        public void GetAllLorryReceiptDetails()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllLorryRequest", CommandType.StoredProcedure, DParam);
            List<VLDA_LorryReceipt> LstLR = new List<VLDA_LorryReceipt>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstLR.Add(new VLDA_LorryReceipt
                    {
                        ShippingLine = Convert.ToString(Result["ShippingLine"]),
                        TransportFrom = Convert.ToString(Result["FromLocation"]),
                        TransportTo = Convert.ToString(Result["ToLocation"]),
                        StuffingPoint = Convert.ToString(Result["StuffingPoint"]),
                        LR_DATE = Convert.ToString(Result["LRDateTime"]),
                        LorryId=Convert.ToInt32(Result["ID"])
        ...
        public void GetLorryReceiptForEdit(int LorryId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_LorryId", MySqlDbType = MySqlDbType.Int32, Value = LorryId });
            IDataParameter[] DParam = { };
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();

            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetLorryReceiptForEdit", CommandType.StoredProcedure, DParam);
            List<VLDA_LorryReceiptDtl> LstLRDtl = new List<VLDA_LorryReceiptDtl>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objLr.GRNo = Convert.ToString(Result["GRNo"]);
                    objLr.LR_DATE = Convert.ToString(Result["LRDateTime"]);
                    objLr.PartyName = Convert.ToString(Result["PartyName"]);
                    objLr.PartyID = Convert.ToInt32(Result["PartyId"]);
                    objLr.Consignee = Convert.ToString(Result["Consignee"]);
                    objLr.ShippingLine = Convert.ToString(Result["ShippingLine"]);
                    objLr.ShippingLineID = Convert.ToString(Result["ShippingLineID"]);
                    objLr.StuffingPoint = Convert.ToString(Result["StuffingPoint"]);
                    objLr.BookingNo = Convert.ToString(Result["BookingNo"]);
                    objLr.TransportFrom = Convert.ToString(Result["FromLocation"]);
                    objLr.TransportTo = Convert.ToString(Result["ToLocation"]);
                    objLr.BOE = Convert.ToString(Result["BOENo"]);
                    objLr.InvoiceNo = Convert.ToString(Result["InvoiceNo"]);
                    objLr.Remarks = Convert.ToString(Result["Remarks"]);
                    objLr.ID = Convert.ToInt32(Result["ID"]);
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        LstLRDtl.Add(new VLDA_LorryReceiptDtl
                        {
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToInt32(Result["Size"]),
                            TareWt = Convert.ToInt32(Result["TareWt"]),
                            Weight = Convert.ToInt32(Result["Weight"]),
                            VehicleNo = Convert.ToString(Result["VehicleNo"]),
                            SealNo = Convert.ToString(Result["SealNo"]),
                            RemarksBooking = Convert.ToString(Result["RemarksBooking"])
                            
                        });
                    }
                    objLr.lstLRDtl = LstLRDtl;
                }
        ...
        public void DeleteLorryReceipt(int LorryId)
        {
            string GeneratedClientId = "0";
            string ReturnVal = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ID", MySqlDbType = MySqlDbType.Int32, Value = LorryId });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Value = 0,Direction = ParameterDirection.Output });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.VarChar, Size = 100, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteLorryReceipt", CommandType.StoredProcedure, DParam, out GeneratedClientId,out ReturnVal);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                ...
                {
                    _DBResponse.Status = 0;
                    _DBResponse.Message = "Record Entry would not deleted.";
