...
{
    public class DSR_InvoiceRepository
    {
        ...
        public void GetSCInvoiceDetailsForPrint(int InvoiceId, string InvoiceType = "IMPSC")
        {
            ...
            DSR_invoiceSealCutting objPaymentSheet = new DSR_invoiceSealCutting();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstContainersSealCutting.Add(new DSR_InvoiceContainerSealCutting()
                        {
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstChargesSealCutting.Add(new DSR_InvoiceChargeSealCutting()
                        {
        ...
        public void GetInvoiceDetailsForPrintByNo(string InvoiceNo, string InvoiceType = "IMPYard")
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSRInvoiceYard objPaymentSheet = new DSRInvoiceYard();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetFCLToLCLConversionInvoiceDtlForPrint(int InvoiceId, string InvoiceType = "IMPFCLLCL")
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSRInvoiceFCLToLCLConversion objPaymentSheet = new DSRInvoiceFCLToLCLConversion();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstContainersFCLToLCLConversion.Add(new DSRInvoiceContainerFCLToLCLConversion()
                        {
                            CfsCode = Convert.ToString(Result["CFSCode"]),
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToString(Result["Size"]),
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstChargesFCLToLCLConversion.Add(new DSRInvoiceChargeFCLToLCLConversion()
                        {
                            ChargeSD = Convert.ToString(Result["OperationSDesc"]),
                            ChargeDesc = Convert.ToString(Result["OperationDesc"]),
                            HsnCode = Convert.ToString(Result["SACCode"]),
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objPaymentSheet.TotalIGST = Convert.ToDecimal(Result["TotalIGST"]);
                        objPaymentSheet.TotalAmt = Convert.ToDecimal(Result["InvoiceAmt"]);
                        objPaymentSheet.ExportUnder = Result["irn"].ToString();
                        objPaymentSheet.ApproveOn= Result["SignedQRCode"].ToString();
                        objPaymentSheet.ShippingLineName = Result["SupplyType"].ToString();
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.lstBounceChequeDtl.Add(new DSRBounceChequeDtl()
                        {                            
                            BncChequeNo = Convert.ToString(Result["BncChequeNo"]),
                            BncChequeDate = Convert.ToString(Result["BncChequeDate"]),
                            BncChequeAmt = Convert.ToDecimal(Result["BncChequeAmt"]),
                            BounceDate = Convert.ToString(Result["BounceDate"]),
