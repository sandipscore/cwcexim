...
{
    public class LNSM_MasterRepository
    {
        ...
        public void GetEximTrader(int EximTraderId)
        {
            ...
            List<LNSM_EximTraderAddress> listadd = new List<LNSM_EximTraderAddress>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEximTrader.Agent = Convert.ToBoolean(Result["Agent"] == DBNull.Value ? 0 : Result["Agent"]);
                    ObjEximTrader.RailOperator = Convert.ToBoolean(Result["RailOperator"] == DBNull.Value ? 0 : Result["RailOperator"]);
                    ObjEximTrader.Consignee = Convert.ToBoolean(Result["Consignee"] == DBNull.Value ? 0 : Result["Consignee"]);
                    ObjEximTrader.Consignor = Convert.ToBoolean(Result["Consignor"] == DBNull.Value ? 0 : Result["Consignor"]);
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        LNSM_EximTraderAddress ObjEximTraderAdd = new LNSM_EximTraderAddress();

                        ObjEximTraderAdd.EximAddress = (Result["Address"] == null ? "" : Result["Address"]).ToString();

                        ObjEximTraderAdd.EximTraderId =Convert.ToInt32 (Result["EximTraderId"] == null ? "" : Result["EximTraderId"]);
                        ObjEximTraderAdd.Country = (Result["Country"] == null ? "" : Result["Country"]).ToString();
                        ObjEximTraderAdd.State = (Result["State"] == null ? "" : Result["State"]).ToString();
                        ObjEximTraderAdd.City = (Result["City"] == null ? "" : Result["City"]).ToString();
                        ObjEximTraderAdd.Pin = (Result["Pin"] == null ? "" : Result["Pin"]).ToString();
                        ObjEximTraderAdd.Phone = (Result["Phone"] == null ? "" : Result["Phone"]).ToString();
                        ObjEximTraderAdd.ContactPerson = (Result["ContactPerson"] == null ? "" : Result["ContactPerson"]).ToString();
                        ObjEximTraderAdd.EmailId = (Result["EmailId"] == null ? "" : Result["EmailId"]).ToString();
                        ObjEximTraderAdd.MobNo = (Result["MobNo"] == null ? "" : Result["MobNo"]).ToString();
                        ObjEximTraderAdd.PAN = (Result["PAN"] == null ? "" : Result["PAN"]).ToString();
                        ObjEximTraderAdd.GST = (Result["GST"] == null ? "" : Result["GST"]).ToString();



                        
                        listadd.Add(ObjEximTraderAdd);

                    }
                    ObjEximTrader.AddressList = listadd;
                }
        ...
        public void GetGetAllEximTraderPartyCode(string PartyCode)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    EmailSplit = ((Result["Email"] == null ? "" : Result["Email"]).ToString()).Trim().Split(',');
                    // var Email = string.Join("\n ", EmailSplit);
                    LstEximTrader.Add(new LNSM_EximTrader
                    {
                        EximTraderId = Convert.ToInt32(Result["EximTraderId"]),
                        EximTraderName = Result["EximTraderName"].ToString(),
                        // Email=string.Join("\r\n ", EmailSplit),
