...
{
    public class Wfld_EntryThroughGateRepository
    {
        ...
        public void AddEditEntryThroughGate(WfldEntryThroughGate ObjEntryThroughGate)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_GatewayPortCode", MySqlDbType = MySqlDbType.VarChar, Size = 100, Value = ObjEntryThroughGate.GatewayPortCode });
            LstParam.Add(new MySqlParameter { ParameterName = "in_OriginPortCode", MySqlDbType = MySqlDbType.VarChar, Size = 50, Value = ObjEntryThroughGate.OriginPortCode });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SMTPNo", MySqlDbType = MySqlDbType.String, Value = ObjEntryThroughGate.SMTPNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SMTP_Date", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(ObjEntryThroughGate.SMTP_Date) });
        ...
        public void GetEntryThroughGate(int EntryId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.GatewayPortCode = Result["GatewayPortCode"].ToString();
                    ObjEntryThroughGate.OriginPortCode = Result["OriginPortCode"].ToString();
                    ObjEntryThroughGate.SMTPNo = Result["SMTPNo"].ToString();
                    ObjEntryThroughGate.SMTP_Date = Result["SMTP_Date"].ToString();
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
