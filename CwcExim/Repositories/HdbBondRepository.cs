...
{
    public class HdbBondRepository
    {
        ...
        public void GetSpaceAvailAppCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            HdbSpaceAvailAppCertPdf ObjSpaceAvailCert = new HdbSpaceAvailAppCertPdf();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditBondApp(HdbBondApp objBA)
        {
        ...
        public void AddEditBondSpaceAvailCert(HdbSpaceAvailableCert ObjSpaceAvail)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Stats == 1)
                    {
                        ...
                        ObjSpaceAvail.ValidUpto = Convert.ToDateTime(DateTime.Now).AddDays(27).ToString("dd/MM/yyyy"); // changed to 28 from 13  by Rahul 14-10-2024
                    }
                    else
                    {
        ...
        public void GetSpaceAvailCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            HdbSpaceAvailCertPdf ObjSpaceAvailCert = new HdbSpaceAvailCertPdf();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditBondSpaceAvailCertExt(HdbSpaceAvailCertExtend ObjSpaceAvail)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllSpaceAvailCertExt()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstSpaceAvail.Add(new HdbSpaceAvailCertExtend
                    {
        ...
        public void GetSacNo()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<HdbSpaceAvailableCert> LstSpaceAvail = new List<HdbSpaceAvailableCert>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSpaceAvail.Add(new HdbSpaceAvailableCert
                    {
                        SpaceappId = Convert.ToInt32(Result["SpaceappId"]),
        ...
        public void GetSpaceAvailabilityExt(int SpaceAvailCertExtId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondSpaceAvailCertExt", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            HdbBondAppExtendDetails ObjSpaceAvail = new HdbBondAppExtendDetails();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditBondDepositApp(HdbDepositApp ObjDepositApp)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetSacNodepositDet(int SpaceappId,int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            HdbDepositApp ObjSpaceAvail = new HdbDepositApp();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetAllVehicle(string SacNo,int SacId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllDepositApp()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstDepositApp.Add(new HdbDepositApp
                    {
        ...
        public void PrintDA(int DepositeAppId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            HdbPrintDA ObjDepositApp = new HdbPrintDA();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstSAC.Add(new HdbSACDet
                        {
                            SacNo = Result["SacNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstGodown.Add(new HdbGodDet
                        {
        ...
        public void GetBondNoForWODeliveryNew()
        {
            ...
            List<ListOfHdbBondNo> LstBond = new List<ListOfHdbBondNo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Convert.ToInt32(Result["DepositAppId"].ToString()) > 0)
                        {
                        LstBond.Add(new ListOfHdbBondNo
                        {
        ...
        public void GetDetailsforBondNo(int DepositAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondForWO", CommandType.StoredProcedure, DParam);
            HdbBondWODeli objWO = new HdbBondWODeli();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void ListOfWODeli(string WoType)
        {
            ...
            List<ListOfHdbBondWODeli> LstBond = new List<ListOfHdbBondWODeli>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstBond.Add(new ListOfHdbBondWODeli
                    {
        ...
        public void GetBondNoForWOUnloading()
        {
            ...
            List<ListOfHdb_BOENo> LstBond = new List<ListOfHdb_BOENo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstBond.Add(new ListOfHdb_BOENo
                    {
                        //WorkOrderNo = Convert.ToString(Result["WorkOrderNo"]),
                        //BondWOId = Convert.ToInt32(Result["BondWOId"])
        ...
        public void GetBondNoForWOUnloadingDet(int DepositAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondNoUnloading", CommandType.StoredProcedure, DParam);
            HdbBOENoDetails objBOE = new HdbBOENoDetails();
            _DBResponse = new DatabaseResponse();
        ...
        public void AddEditWOUnloading(HdbBondWOUnloading obj)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void PrintWOUnloading(int UnloadingId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            HdbBondWOUnloadingPDF ObjUnloading = new HdbBondWOUnloadingPDF();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetSACNoForAdvBondPaymentSheet(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (IList<HdbBondSacDetails>)DataAccess.ExecuteDynamicSet<HdbBondSacDetails>("GetSACNoForBondAdvPaymentSheet");
        ...
        public void AddEditInvoice(Hdb_LoadedContainerPayment ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string CfsChargeXML, int BranchId, int Uid,
        ...
        public void GetBondAdvancePaymentSheet(string InvoiceDate, int DestuffingAppId, int DeliveryType, string DestuffingAppNo, string DestuffingAppDate, int PartyId, string PartyName,
    ...
    string InvoiceType,decimal area, int InvoiceId = 0,int No=0,string ExportUnder="")
        ...
        public void GetWOForDeliveryOrder()
        {
            ...
            List<ListOfHdbWorkOrderNo> LstWONo = new List<ListOfHdbWorkOrderNo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    { 
                        LstWONo.Add(new ListOfHdbWorkOrderNo
                        {
                            SacNo = Convert.ToString(Result["SacNo"]),
                            SpaceappId = Convert.ToInt32(Result["SpaceAppId"]),
                            BondNo = Convert.ToString(Result["BondNo"]),
        ...
        public void GetWODetForDeliveryOrder(int SpaceAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondWOForDeliveryOrder", CommandType.StoredProcedure, DParam);
            HdbDeliveryOrder ObjDeliOrder = new HdbDeliveryOrder();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstBond.Add(new ListOfDeliveryOrder
                    {
                        ...
                        BondNo = Convert.ToString(Result["BondNo"]),
                        BondDate = Convert.ToString(Result["BondDate"]),
                        SACNo = Convert.ToString(Result["SacNo"]),
                        SACDate = Convert.ToString(Result["SacDate"]),
                    });
                }
        ...
        public void GetDeliveryOrder(int DeliveryOrderId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderhdb.Add(new HdbDeliveryOrderDtl
                        {
        ...
        public void PrintDelivery(int DeliveryAppId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryPrintOrder.Add(new HdbDeliveryOrderforPrint
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderPayment.Add(new HdbDeliveryOrderPaymentPrint
                        {
                            SacDate = Result["SacDate"].ToString(),
                            DepositDate = Result["DepositDate"].ToString(),
                            DepositNo = Result["DepositNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstGst.Add(new HdbDeliveryGSTCharge
                        {
                            SGSTAmt = Convert.ToDecimal(Result["SGSTAmt"].ToString()),
                            CGSTAmt = Convert.ToDecimal(Result["CGSTAmt"].ToString()),
                            IGSTAmt = Convert.ToDecimal(Result["IGSTAmt"].ToString()),
        ...
        public void AddEditDeliveryOrder(HdbDeliveryOrder ObjDeliveryOrder, string DeliveryOrderXml)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetDepositDetForDelvOrder(int DepositAppId)
        {
            ...
            HdbDeliveryOrderDtl ObjDepositNo = new HdbDeliveryOrderDtl();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
            ...
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter,string CHAName,string ExportUnder, int InvoiceId = 0)
        {
           ...
           LstParam.Add(new MySqlParameter { ParameterName = "in_UptoDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(UptoDate)});
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            HdbBondPostPaymentSheet objInvoice = new HdbBondPostPaymentSheet();
            List<String> Clause = new List<String>();
        ...
        public void AddEditBondDelInvoice(HdbBondPostPaymentSheet ObjPostPaymentSheet, string ChargesXML, int BranchId, int Uid, string Module,decimal TotalValueOfCargo)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetSACNoForUnlodBondPaymentSheet(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (IList<HdbBondSacDetails>)DataAccess.ExecuteDynamicSet<HdbBondSacDetails>("GetSACForBondUnloading");
    ...
    string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId, string PayeeName,int CasualLabour,
    string InvoiceType, decimal area,int UnloadingId, int InvoiceId = 0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        #region Check Credit Period 
        public void GetCheckCreditPeriod(int in_PartyId,int in_PayeeId)
        {
            int Status = 0;
            string RetValue = "";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = in_PartyId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PayeeId", MySqlDbType = MySqlDbType.Int32, Value = in_PayeeId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("CheckCreditlimitByPartyId", CommandType.StoredProcedure, DParam, out RetValue, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            HdbDepositApp ObjSpaceAvail = new HdbDepositApp();
            try
            {
                _DBResponse.Status = Convert.ToInt32(Result);
                _DBResponse.Message = "Success";
        ...
        public void GetBondNoForSacExtendPaymentSheet(int CartingAppId = 0)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            try
            {
                var objBondSacDetails = (IList<HdbBondSacDetails>)DataAccess.ExecuteDynamicSet<HdbBondSacDetails>("GetBondNoForSacExtndPaymentSheet");
        ...
        public void GetBondSACExtendPaymentSheet(string InvoiceDate, string InvoiceType, int StuffingReqId, int DeliveryType, string StuffingReqNo, string StuffingReqDate, string UptoDate, decimal Area,
            int PartyId, string PartyName, string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId, string PayeeName, int CasualLabour, int NoOfPrinting, decimal weight, decimal CIFValue, decimal Duty,
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName, string ExportUnder,string CalcType, int InvoiceId = 0)
        {
            ...
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_DeliveryDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceType", MySqlDbType = MySqlDbType.VarChar, Value = InvoiceType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_StuffingReqId", MySqlDbType = MySqlDbType.Int32, Value = StuffingReqId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_UptoDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(UptoDate) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Area", MySqlDbType = MySqlDbType.Decimal, Value = Area });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ExportUnder", MySqlDbType = MySqlDbType.VarChar, Value = ExportUnder });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CalcType", MySqlDbType = MySqlDbType.VarChar, Value = CalcType });
            ...
            HdbBondPostPaymentSheet objInvoice = new HdbBondPostPaymentSheet();
            List<String> Clause = new List<String>();
            DataSet ds = DataAccess.ExecuteDataSet("GetSACExtendPaymentSheet", CommandType.StoredProcedure, DParam);
            //IDataReader Result = DataAccess.ExecuteDataReader("GetBondDelPaymentSheet", CommandType.StoredProcedure, DParam);
            try
            {
        ...
        public void AddEditInvoiceBondExtend(HdbBondPostPaymentSheet ObjPostPaymentSheet, string ChargesXML, int BranchId, int Uid, string Module, decimal TotalValueOfCargo)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_CalcType", MySqlDbType = MySqlDbType.VarChar, Value = ObjPostPaymentSheet.CalcType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BondValue", MySqlDbType = MySqlDbType.Decimal, Value = ObjPostPaymentSheet.CIFValue });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BondDuty", MySqlDbType = MySqlDbType.Decimal, Value = ObjPostPaymentSheet.Duty });
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DA.ExecuteNonQuery("AddEditInvoiceBondExtend", CommandType.StoredProcedure, DParam, out GeneratedClientId, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
