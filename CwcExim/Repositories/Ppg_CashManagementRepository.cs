...
{
    public class Ppg_CashManagementRepository
    {
        ...
        public void GetChequeDetail(int partyid,string ChequeNo)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    model.Add(new ChequeDetail { Id = Convert.ToInt32(Result["Id"]),
                        Cheque = Result["SdNo"].ToString(),
       ...
       string Module, string CargoXML = "")
        ...
        public void AddDirectPaymentVoucher(Ppg_DirectOnlinePayment objDOP, int uid)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetOnlinePayAckList(int uid, long OrderId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Ppg_DirectOnlinePayment> objDOPList = new List<Ppg_DirectOnlinePayment>();
            Ppg_DirectOnlinePayment objDOP = new Ppg_DirectOnlinePayment();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objDOP = new Ppg_DirectOnlinePayment();
        ...
        public void AddEditOnlinePaymentAgainstInvoice(Ppg_OnlinePaymentAgainstInvoice objDOP, int uid, string XML)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_OnlinePayAckId", MySqlDbType = MySqlDbType.Int32, Value = objDOP.OnlinePayAckId });
        ...
        public void GetOnlinePaymentAgainstInvoice(int uid, string SearchValue = "",int Pages = 0)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_SearchValue", MySqlDbType = MySqlDbType.VarChar, Value = SearchValue });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Pages", MySqlDbType = MySqlDbType.Int32, Value = Pages });
            ...
            _DBResponse = new DatabaseResponse();
            List<Ppg_OnlinePaymentAgainstInvoice> lstCashReceipt = new List<Ppg_OnlinePaymentAgainstInvoice>();
            int Status = 0;
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstCashReceipt.Add(new Ppg_OnlinePaymentAgainstInvoice
                    {
        ...
        public void AcknowledgementViewList(string FromDate, string ToDate, int Uid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Ppg_AcknowledgementViewList> lstReceipt = new List<Ppg_AcknowledgementViewList>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    lstReceipt.Add(new Ppg_AcknowledgementViewList
                    {
                        // PeriodFrom=Convert.ToString(Result["FromDate"])
