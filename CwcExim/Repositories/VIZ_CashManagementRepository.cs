...
{
    public class VIZ_CashManagementRepository
    {
        ...
        public void GetPartyList()
        {
            ...
            var model = new VIZ_CashReceiptModel();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    model.PartyDetail.Add(new VIZ_Party { PartyId = Convert.ToInt32(Result["PartyId"]), PartyName = Convert.ToString(Result["PartyName"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetCashRcptDetails(int PartyId, string PartyName, string Type = "INVOICE")
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    model.PayByDetail.Add(new VIZ_PayBy
                    {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        model.CashReceiptInvoiveMappingList.Add(new VIZ_CashReceiptInvoiveMapping
                        {
        ...
        // ADD Cash Receipt
        public void AddCashReceipt(VIZ_CashReceiptModel ObjCashRcpt, string xml)
        {
            string GeneratedClientId = "0";
            string ReceiptNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetCashReceiptList()
        {
            ...
            List<VIZ_CashReceiptModel> lstCashReceipt = new List<VIZ_CashReceiptModel>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstCashReceipt.Add(new VIZ_CashReceiptModel
                    {
        ...
        public void AddCreditNote(VIZ_CreditNote objCR, string XML, string CRDR)
        {
            string ReturnObj = "";
            string Id = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetMiscInvoiceAmount(string purpose, string purposecode,string SAC,float GST,string InvoiceType, int PartyId, decimal Amount,string SEZ )
        {
            ...
            _DBResponse = new DatabaseResponse();
            VIZ_MiscInv Obj = new VIZ_MiscInv();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddMiscInv(VIZ_MiscPostModel ObjPostPaymentSheet, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
        ...
        public void GetPaymentPartyMisc(int ptype)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VIZ_PaymentPartyName> objPaymentPartyName = new List<VIZ_PaymentPartyName>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new VIZ_PaymentPartyName()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
        ...
        public void ListOfMiscInvoice(string Module, string InvoiceNo = null, string InvoiceDate = null)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VIZ_ListOfMiscInvoice> lstExpInvoice = new List<VIZ_ListOfMiscInvoice>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstExpInvoice.Add(new VIZ_ListOfMiscInvoice()
                    {
                        InvoiceId = Convert.ToInt32(Result["InvoiceId"]),
                        InvoiceNo = Convert.ToString(Result["InvoiceNo"]),
                        InvoiceDate = Convert.ToString(Result["InvoiceDate"]),
        ...
        public void GetAllOAAddMoneyList(string ReceiptNo="")
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddDirectPaymentVoucher(VIZ_DirectOnlinePayment objDOP, int uid)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetOnlinePayAckList(int uid, long OrderId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VIZ_DirectOnlinePayment> objDOPList = new List<VIZ_DirectOnlinePayment>();
            VIZ_DirectOnlinePayment objDOP = new VIZ_DirectOnlinePayment();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objDOP = new VIZ_DirectOnlinePayment();
        ...
        public void AddEditOnlinePaymentAgainstInvoice(VIZ_OnlinePaymentAgainstInvoice objDOP, int uid, string XML)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_OnlinePayAckId", MySqlDbType = MySqlDbType.Int32, Value = objDOP.OnlinePayAckId });
        ...
        public void GetOnlinePaymentAgainstInvoice(string SearchValue = "", int Pages = 0)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VIZ_OnlinePaymentAgainstInvoice> lstCashReceipt = new List<VIZ_OnlinePaymentAgainstInvoice>();
            int Status = 0;
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstCashReceipt.Add(new VIZ_OnlinePaymentAgainstInvoice
                    {
        ...
        public void AcknowledgementViewList(string FromDate, string ToDate, int Uid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VIZ_AcknowledgementViewList> lstReceipt = new List<VIZ_AcknowledgementViewList>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    lstReceipt.Add(new VIZ_AcknowledgementViewList
                    {
                        // PeriodFrom=Convert.ToString(Result["FromDate"])
