...
{
    public class Wfld_ImportRepository
    {  
        ...
        public void GetOblEntryDetailsByOblEntryId(int OblEntryId)
        {
            ...
            IList<Wfld_OblEntryDetails> lstOBLEntryDetails = new List<Wfld_OblEntryDetails>();
            try
            {
                while (Result.Read())
                {
                    ...
                    //objOBLEntry.GatewayPortCode = Convert.ToString(Result["GatewayPortCode"]);
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        lstOBLEntryDetails.Add(new Wfld_OblEntryDetails
                        {
                            ...
                            ContainerSize = Convert.ToString(Result["Container_Size"]),
                            IGM_No = Convert.ToString(Result["IGM_No"]),
                            ...
                            PortCodeOrigin = Convert.ToString(Result["OriginPortCode"]),
                            GatewayPortCode = Convert.ToString(Result["GatewayPortCode"])
                        });
                    }
                }
        ...
        public void GetOBLDetails(string CFSCode, string ContainerNo, string ContainerSize, int OBLEntryId)
        {
            DataSet Result = new DataSet();
            int Status = 0;
            try
            {
                ...
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Wfld_OblEntryDetails objOBLEntryDetails = new Wfld_OblEntryDetails();
                        ...
                        objOBLEntryDetails.ContainerSize = Convert.ToString(dr["Container_Size"]);
                        objOBLEntryDetails.IGM_No = Convert.ToString(dr["IGM_No"]);
                        objOBLEntryDetails.IGM_Date = Convert.ToString(dr["IGM_Date"]);
                        ...
                        objOBLEntryDetails.GatewayPortCode = Convert.ToString(dr["GatewayPortCode"]);
        ...
        public void AddEditOBLEntry(Wfld_OblEntry objOBL, string XmlText)
        {
            ...
            //lstParam.Add(new MySqlParameter { ParameterName = "in_GatewayPortCode", MySqlDbType = MySqlDbType.String, Value = objOBL.GatewayPortCode });   
                     
            lstParam.Add(new MySqlParameter { ParameterName = "in_DtlXml", MySqlDbType = MySqlDbType.Text, Value = XmlText });
            log.Info("AddEditOBLEntry:-" + " OBL XML : " + XmlText);
        ...
        public void GetAllOblEntry(int Page)
        {
            ...
            try
            {
                ...
                List<Wfld_OblEntry> OblEntryList = new List<Wfld_OblEntry>();
        ...
        public void ListOfPortCodeOriginForPage(string PortCode, int Page = 0)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] Dparam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetOriginPortCodeForPage", CommandType.StoredProcedure, Dparam);
            _DBResponse = new DatabaseResponse();
            IList<TransformList> LstOriginPortCode = new List<TransformList>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstOriginPortCode.Add(new TransformList
                    {
                        PortId = Convert.ToInt32(Result["PortId"]),
                ...
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = new { LstOriginPortCode, State };
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void AddEditInvoice(WFLDInvoiceYard ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML, string ChargesBreakupXML,
        ...
        public void GetBOEForDeliveryPaymentSheet(int DestuffingAppId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetDeliveryApplicationForImpPaymentSheet", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<WFLDPaymentSheetBOE> objPaymentSheetBOE = new List<WFLDPaymentSheetBOE>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentSheetBOE.Add(new WFLDPaymentSheetBOE()
                    {
                        CFSCode = Convert.ToString(Result["CFSCode"]),
                        LineNo = Convert.ToString(Result["LineNo"]),
        ...
        public void AddEditInvoiceGodown(WFLDInvoiceGodown ObjPostPaymentSheet, string Sez, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML,
       ...
       string Module, string CargoXML = "")
        ...
        public void AddEditEmptyContPaymentSheet(WFLDInvoiceYard ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML, string ChargesBreakupXML,
        ...
        public void AddEditSingleMergeDeliveryApplication(WFLDMergeDeliveryIssueViewModel ObjDeliveryApp,
        ...
        public void UpdateSingleMergeDeliveryApplication(WFLD_DeliverApplication ObjDeliveryApp,
            string DeliveryAppDtlXml, string DeliveryOrdDtlXml,
            string lstPrePaymentContXML, string lstPostPaymentContXML,
                  string lstPostPaymentChrgXML, string lstContWiseAmountXML,
                  string lstOperationCFSCodeWiseAmountXML, string lstPostPaymentChrgBreakupXML, string lstInvoiceCargoXML, string DeliveryGodownDtlXml)
        ...
        public void GetPortOfCallForPage(string PortCode, int Page = 0)
        {
            ...
            IList<CwcExim.Areas.Export.Models.PortOfCall> lstPortOfCall = new List<CwcExim.Areas.Export.Models.PortOfCall>();
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstPortOfCall.Add(new CwcExim.Areas.Export.Models.PortOfCall
                    {
        ...
        public void GetNextPortOfCallForPage(string PortCode, int Page = 0)
        {
            ...
            IList<CwcExim.Areas.Export.Models.PortOfCall> lstNextPortOfCall = new List<CwcExim.Areas.Export.Models.PortOfCall>();
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstNextPortOfCall.Add(new CwcExim.Areas.Export.Models.PortOfCall
                    {
                        PortOfCallId = Convert.ToInt32(Result["PortOfCallId"]),
                        PortOfCallName = Convert.ToString(Result["PortOfCallName"]),
                        PortOfCallCode = Convert.ToString(Result["PortOfCallCode"])
