...
{
    public class Dnode_AuctionRepository
    {
        ...
        public void GetBIDListForInvoice(int BidID)
        {
           ...
           List<Dnd_EMDReceived> lstBidDetails = new List<Dnd_EMDReceived>();
            int Status = 0;
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstBidDetails.Add(new Dnd_EMDReceived
                    {
        ...
        public void GetBIDDetailsForInvoice(int BIDId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetOBLShipBillForInvoice", CommandType.StoredProcedure, DParam);
            var model = new Dnd_AuctionInvoice();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        public void GetAuctionCharges(int BidId, int InvoiceId, string InvoiceDate, string FreeUpTo,string HSNCode, decimal CustomDuty, decimal OT, decimal ValuersCharge, decimal AuctionCharge, decimal MISC)
        {
        ...
        public void AddEditInvoice(Dnd_AuctionInvoice objAuctionInvoice)
        {
        ...
        public void AddEditAuctionInvoice(Dnd_AuctionInvoice objAuctionInvoice)
        {
            int GeneratedInvoiceId = 0;
            string GeneratedInvoiceNo = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetAssessmentList()
        {
            ...
            List<Dnd_AuctionInvoice> lstBidDetails = new List<Dnd_AuctionInvoice>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstBidDetails.Add(new Dnd_AuctionInvoice
                    {                        
                        BIDNo = Convert.ToString(Result["BidNo"]),                    
        ...
        public void GetInvoiceList(string FromDate, string ToDate, string invoiceType)
        {
            ...
            IList<Dnd_invoiceLIst> LstInvoice = new List<Dnd_invoiceLIst>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstInvoice.Add(new Dnd_invoiceLIst
                    {
        ...
        public void ModuleListWithInvoice(Dnd_BulkInvoiceReport ObjBulkInvoiceReport)
        {
