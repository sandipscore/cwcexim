...
{
    public class PpgInvoiceRepository
    {
        ...
        public void GetSCInvoiceDetailsForPrint(int InvoiceId, string InvoiceType = "IMPSC")
        {
            ...
            _DBResponse = new DatabaseResponse();
            PpgInvoiceSealCutting objPaymentSheet = new PpgInvoiceSealCutting();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstContainersSealCutting.Add(new PpgInvoiceContainerSealCutting()
                        {
                            CfsCode = Convert.ToString(Result["CFSCode"]),
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToString(Result["Size"]),
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstChargesSealCutting.Add(new PpgInvoiceChargeSealCutting()
                        {
                            ChargeSD = Convert.ToString(Result["OperationSDesc"]),
                            ChargeDesc = Convert.ToString(Result["OperationDesc"]),
                            HsnCode = Convert.ToString(Result["SACCode"]),
        ...
        public void GetFCLToLCLConversionInvoiceDtlForPrint(int InvoiceId, string InvoiceType = "IMPFCLLCL")
        {
            ...
            _DBResponse = new DatabaseResponse();
            PpgInvoiceFCLToLCLConversion objPaymentSheet = new PpgInvoiceFCLToLCLConversion();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstContainersFCLToLCLConversion.Add(new PpgInvoiceContainerFCLToLCLConversion()
                        {
                            CfsCode = Convert.ToString(Result["CFSCode"]),
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToString(Result["Size"]),
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        objPaymentSheet.LstChargesFCLToLCLConversion.Add(new PpgInvoiceChargeFCLToLCLConversion()
                        {
                            ChargeSD = Convert.ToString(Result["OperationSDesc"]),
                            ChargeDesc = Convert.ToString(Result["OperationDesc"]),
                            HsnCode = Convert.ToString(Result["SACCode"]),
