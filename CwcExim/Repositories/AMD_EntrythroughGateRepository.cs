...
{
    public class AMD_EntryThroughGateRepository
    {
        public void GetAllPickupLocation()
        {
            ...
            List<AMDPickupModel> LstPickUp = new List<AMDPickupModel>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstPickUp.Add(new AMDPickupModel
                    {
        ...
        public void ListOfShippingLinePartyCode(string PartyCode, int Page = 0)
        {
            ...
            IList<AMD_ShippingLineForPage> lstShippingLine = new List<AMD_ShippingLineForPage>();
            _DBResponse = new DatabaseResponse();
            try
            {
                bool State = false;
        ...
        public void ListOfChaForPage(string PartyCode, int Page = 0)
        {
            ...
            IList<AMD_CHAForPage> lstCHA = new List<AMD_CHAForPage>();
            _DBResponse = new DatabaseResponse();
            try
            {
                bool State = false;
        ...
        public void AddEditEntryThroughGateCBT(AMD_EntryThroughGate ObjEntryThroughGate, string XML, string ContClass)
        {
        ...
        public void AddEditEntryThroughGate(AMD_EntryThroughGate ObjEntryThroughGate)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Purpose", MySqlDbType = MySqlDbType.VarChar, Size = 60, Value = ObjEntryThroughGate.Purpose });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ForwarderName", MySqlDbType = MySqlDbType.VarChar, Size = 50, Value = ObjEntryThroughGate.ForwarderName });
            LstParam.Add(new MySqlParameter { ParameterName = "in_StuffType", MySqlDbType = MySqlDbType.VarChar, Size = 60, Value = ObjEntryThroughGate.StuffType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_OldCfsCode", MySqlDbType = MySqlDbType.VarChar, Size = 60, Value = ObjEntryThroughGate.OldCfsCode });
            LstParam.Add(new MySqlParameter { ParameterName = "in_TransportMode", MySqlDbType = MySqlDbType.Int32, Size = 1, Value = ObjEntryThroughGate.TransportMode });
        ...
        public void GetAutoPopulateData(string ContainerNumber)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.ReferenceDate = Result["ReferenceDate"] == DBNull.Value ? null : Convert.ToDateTime(Result["ReferenceDate"]).ToString("dd/MM/yyyy");
        ...
        public void GetAllEntryThroughGate()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstEntryThroughGate.Add(new AMD_EntryThroughGate
                    {
        ...
        public void GetAllEntryThroughGateCBTListPage(string Module, int Page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_EntryId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Empty", MySqlDbType = MySqlDbType.VarChar, Value = null });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = Page });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Module", MySqlDbType = MySqlDbType.VarChar, Size = 20, Value = Module });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerType", MySqlDbType = MySqlDbType.VarChar, Size = 20, Value = "" });
        ...
        public void GetAllEntryThroughGateSearchListPage(int Page, string OperationType, string ContainerType, string ContainerNo)
        {
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateSearchListPage", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<AMD_EntryThroughGate> LstEntryThroughGate = new List<AMD_EntryThroughGate>();
            try
            {
        ...
        public void GetAllEntryThroughGateCBTSearchListPage(string Module, int Page, string ContainerNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo", MySqlDbType = MySqlDbType.VarChar, Value = ContainerNo });
        ...
        public void GetReferenceNumber()
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjReferenceNumber.ReferenceList.Add(new AMD_CCINList
                    {
        ...
        public void GetEntryThroughGate(int EntryId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjEntryThroughGate.listAddRef.Add(new AMD_AddMoreRefForCCIN
                        {
        ...
        public void GetDetForExportAddVehicle(int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            AMD_AddExportVehicle ObjEntryThroughGate = new AMD_AddExportVehicle();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditEntryThroughGateVehicle(AMD_AddExportVehicle ObjEntryThroughGate)
        {
        ...
        public void GetVehicleDtlbyEntryId(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstVehicle.Add(new AMD_AddExportVehicle
                    {
                        EntryId = Convert.ToInt32(Result["EntryId"]),
        ...
        public void AddEditEntryThroughGateBond(AMD_EntryThroughGateBond ObjEntryThroughGate)
        {
            DateTime? ReferenceDt = null;
            var Entrydt = (dynamic)null;
            var SysDateTime = (dynamic)null;
        ...
        public void GetLoadedContDataForBtt(int LoadContainerRefId)
        {
            //ContainerNumber = ContainerNumber.Trim();
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
