...
{
    public class kdl_CWCGatePassRepository
    {
        ...
        public void AddEditGatePass(kdlCWCGatePass objGP, string XML, string VehicleXml)
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_GatePassDate", MySqlDbType = MySqlDbType.DateTime, Value = GatePassDate });
            ...
            //lstParam.Add(new MySqlParameter { ParameterName = "in_DepartureDate", MySqlDbType = MySqlDbType.DateTime, Value = (objGP.DepartureDate != null ? Convert.ToDateTime(objGP.DepartureDate).ToString() : objGP.DepartureDate) });
            //lstParam.Add(new MySqlParameter { ParameterName = "in_ArrivalDate", MySqlDbType = MySqlDbType.DateTime, Value = objGP.ArrivalDate != null ? Convert.ToDateTime(objGP.ArrivalDate).ToString() : objGP.ArrivalDate });
