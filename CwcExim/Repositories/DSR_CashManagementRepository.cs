...
{    
    public class DSR_CashManagementRepository
    {
        ...
        public void GetPaymentVoucherCreateInfo()
        {
            ...
            var model = new DSR_PaymentVoucherCreateInfoModel();
            int Status = 0;
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    model.GstStateCode=Result["GstStateCode"].ToString();
                    model.StateName= Result["StateName"].ToString();
                    model.CompanyAddress= Result["CompanyAddress"].ToString();
                    model.CityName= Result["CityName"].ToString();
                    model.PanNo= Result["Pan"].ToString();
                }
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        model.Expenses.Add(new DSRExpenses { HeadId = Convert.ToInt32(Result["HeadId"]), HeadCode = Result["HeadCode"].ToString(), HeadName = Result["HeadName"].ToString() });
                    }
                }
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        model.ExpHSN.Add(new DSRExpHSN { HSNCode = Result["HSNCode"].ToString(), ExpCode = Result["ExpCode"].ToString() });
                    }
                }
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        model.HSN.Add(new DSRHSN { HSNId = Convert.ToInt32(Result["HSNId"]), HSNCode = Result["HSNCode"].ToString(), GST = Convert.ToDecimal(Result["GST"]) });
                    }
                }
                if (Result.NextResult())
                {
        ...
        public void AddNewPaymentVoucher(DSR_NewPaymentValucherModel m)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "In_RoundOff", MySqlDbType = MySqlDbType.Decimal, Value = m.RoundOff });
            LstParam.Add(new MySqlParameter { ParameterName = "In_TAmount", MySqlDbType = MySqlDbType.Decimal, Value = m.TotalAmount });
            LstParam.Add(new MySqlParameter { ParameterName = "In_PayAmount", MySqlDbType = MySqlDbType.Decimal, Value = m.PayableAmount });//TotalAmount
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "In_ExpDtl", MySqlDbType = MySqlDbType.Text, Value = Utility.CreateXML(JsonConvert.DeserializeObject<IList<DSRExpensesDetails>>(m.ExpensesJson)) });
        ...
        public void GetPaymentVoucherList(string SearchValue,int Page)
        {           
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            _DBResponse = new DatabaseResponse();
            DSR_NewPaymentValucherModel ObjPaymentVou = null;
            List < DSR_NewPaymentValucherModel > lstPaymentVou = new List<DSR_NewPaymentValucherModel>();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjPaymentVou = new DSR_NewPaymentValucherModel();
                    ObjPaymentVou.PVHeadId = Convert.ToInt32(Result["PVHeadId"] == DBNull.Value ? 0 : Result["PVHeadId"]);
                    ObjPaymentVou.Party = Convert.ToString(Result["PartyName"]);
        ...
        public void GetAmountForPaymentVoucher(string Purpose)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Purpose", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = Purpose });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAmountForPaymentVoucher", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            DSR_NewPaymentValucherModel ObjSR = new DSR_NewPaymentValucherModel();

            while (Result.Read())
            {
                Status = 1;
                ObjSR.Amt = Convert.ToDecimal(Result["Amt"] == null ? "" : Result["Amt"]);
        ...
        public void GetPartyDetails()
        {
            ...
            IList<DSR_PartyDetails> model = new List<DSR_PartyDetails>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    model.Add(new DSR_PartyDetails { Id = Convert.ToInt32(Result["Id"]), Name = Result["Name"].ToString(), Address = Result["Address"].ToString(), Folio = Result["Folio"].ToString(), Balance = Convert.ToDecimal(Result["Balance"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetAddMoneyToPDList(int Page)
        {
            ...
            DSRAddMoneyToPDModel ObjAddMoneyToPD = null;
            List<DSRAddMoneyToPDModel> lstAddMoneyToPD = new List<DSRAddMoneyToPDModel>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    ObjAddMoneyToPD = new DSRAddMoneyToPDModel();
                    //ObjAddMoneyToPD.PartyName = Convert.ToString(Result["PartyName"]);
                    ObjAddMoneyToPD.ReceiptNo = Convert.ToString(Result["ReceiptNo"]);
                    ObjAddMoneyToPD.TransDate = Convert.ToString(Result["ReceiptDate"] == null ? "" : Result["ReceiptDate"]);
        ...
        public void GetAddMoneyToPDList(string ReceiptNo)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
        ...
        public void GetPartyList()
        {
            ...
            var model = new DSR_CashReceiptModel();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    model.PartyDetail.Add(new DSRParty { PartyId = Convert.ToInt32(Result["PartyId"]), PartyName = Convert.ToString(Result["PartyName"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetCashPartyList()
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            DParam = lstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllPartyCashforPaymentReceipt", CommandType.StoredProcedure, DParam);
            var model = new DSR_CashReceiptModel();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
        ...
        public void GetCashRcptDetails(int PartyId, string PartyName, string Type = "INVOICE")
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    model.PayByDetail.Add(new DSRPayBy
                    {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        model.PdaAdjustdetail.Add(new DSRPdaAdjust
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        model.CashReceiptInvoiveMappingList.Add(new DSRCashReceiptInvoiveMapping
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        model.BalOnAccount = Convert.ToDecimal(Result["ClosingOAAmount"]);
                    }
                }
        ...
        // ADD Cash Receipt
        public void AddCashReceipt(DSR_CashReceiptModel ObjCashRcpt, string xml)
        {
            string GeneratedClientId = "0";
            string ReceiptNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_OnAcDepositAmt", MySqlDbType = MySqlDbType.Decimal, Value = Convert.ToDecimal(ObjCashRcpt.OnAcDepositAmt) });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "ReturnObj", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = "0" });
        ...
        public void GetCashReceiptList(string ReceiptNo)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstCashReceipt.Add(new DSR_CashReceiptModel
                    {
        ...
        public void GetReceivedVoucherCreateInfo()
        {
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            //IDataReader Result = DataAccess.ExecuteDataReader("GetReceiptVoucherCreateInfo"); 
            IDataReader Result = DataAccess.ExecuteDataReader("GetReceiptVoucherCreateInfo", CommandType.StoredProcedure);

            var model = new DSR_ReceiptVoucherModel();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    model.CompanyGSTNo = Result["GST"].ToString();
                    model.GstStateCode = Result["GstStateCode"].ToString();
                    model.StateName = Result["StateName"].ToString();
                    model.CompanyAddress = Result["CompanyAddress"].ToString();
                    model.CityName = Result["CityName"].ToString();
        ...
        public void AddNewReceiptVoucher(DSR_ReceiptVoucherModel m)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetReceiptVoucherList(int Page)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            lstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            ...
            DSR_ReceiptVoucherModel ObjRcptVou = null;
            List<DSR_ReceiptVoucherModel> lstRcptVou = new List<DSR_ReceiptVoucherModel>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            string State = "0";
            try
            {
                ...
                {
                    Status = 1;
                    ObjRcptVou = new DSR_ReceiptVoucherModel();
        ...
        public void GetReceiptVoucherList(string VoucherNo)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            lstParam.Add(new MySqlParameter { ParameterName = "in_VoucherNo", MySqlDbType = MySqlDbType.VarChar, Size = 45, Value = VoucherNo });
            DParam = lstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetReceiptVoucherListBySearch", CommandType.StoredProcedure, DParam);
            DSR_ReceiptVoucherModel ObjRcptVou = null;
            List<DSR_ReceiptVoucherModel> lstRcptVou = new List<DSR_ReceiptVoucherModel>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
        ...
        public void GetInvoiceDetailsForCreaditNote(int InvoiceId,String CRDR)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
        ...
        public void AddCreditNote(DSRCreditNote objCR, string XML, string CRDR)
        {
            string ReturnObj = "";
            string Id = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            try
            {
                ...
                {
                    DBResponse.Status = 2;
                    _DBResponse.Message = "Credit Note Amount can not be greater than invoice Amount, Generated Amount-" + ReturnObj;
                    _DBResponse.Data = ReturnObj;
                }
                else if (Result == 3)
                {
        ...
        public void GetInvoiceDetailsForDeditNote(int InvoiceId)
        {
            ...
            DSRInvoiceDetails objInv = new DSRInvoiceDetails();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        public void GetChargesListForCrDb(int InvoiceId)
        {
            ...
            List<DSRChargeNameCrDb> objChrgs = new List<DSRChargeNameCrDb>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    objChrgs.Add(new DSRChargeNameCrDb
                    {
        ...
        {
            DSR_IrnB2CDetails Obj = new DSR_IrnB2CDetails();
        ...
        public void GetPaymentPartyBncCheque()
        {
            DataSet Result = new DataSet();
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            Result = DataAccess.ExecuteDataSet("GetPaymentParty", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            IList<DSR_PaymentPartyName> objPaymentPartyName = new List<DSR_PaymentPartyName>();
            DSRBounceChk modal = new DSRBounceChk();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        foreach (DataRow Ret in Result.Tables[0].Rows)
                        {
                            objPaymentPartyName.Add(new DSR_PaymentPartyName()
                            {
                                PartyId = Convert.ToInt32(Ret["CHAId"]),
                                PartyName = Convert.ToString(Ret["CHAName"]),
                                Address = Convert.ToString(Ret["Address"]),
                                State = Convert.ToString(Ret["StateName"]),
                                StateCode = Convert.ToString(Ret["StateCode"]),
                                GSTNo = Convert.ToString(Ret["GSTNo"])
                            });
                        }
                    }
                    if (Result.Tables[1].Rows.Count > 0)
                    {
                        ...
                        modal.BouncedCheque = Convert.ToDecimal(Result.Tables[1].Rows[0]["Bounce_Amt"]);
                    }
                }
                DSR_PaymentPartyNameGroup gm = new Areas.CashManagement.Models.DSR_PaymentPartyNameGroup();
                gm.partylist = objPaymentPartyName.ToList();
                gm.bouncecheck = modal;
                //while (Result.Read())
                //{
                //    Status = 1;
                //    objPaymentPartyName.Add(new DSR_PaymentPartyName()
        ...
        public void AddEditCashCollectionChq(DSR_CashColAgnBncChq objCC)
        {
            string Status = "0";
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_ExportUnder", MySqlDbType = MySqlDbType.VarChar, Size = 500, Value = objCC.SEZ });
            ...
            _DBResponse = new DatabaseResponse();
            DSR_cashBncChqInvoice invobj = new DSR_cashBncChqInvoice();
            try
            {
                if (Result == 1)
                {
        ...
        public void GetBounceChequeInvoiceList(string CashReceiptDate,string CashReceiptNumber)
        {
            int Status = 0;
            if (!string.IsNullOrEmpty(CashReceiptDate))
                CashReceiptDate = Convert.ToDateTime(CashReceiptDate).ToString("yyyy-MM-dd");
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_CashReceiptDate", MySqlDbType = MySqlDbType.Text, Value = CashReceiptDate });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CashReceiptNumber", MySqlDbType = MySqlDbType.Text, Value = CashReceiptNumber });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBncChequeInvoicesList", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<DSR_CashColAgnBncChq> objBncChequeDetails = new List<DSR_CashColAgnBncChq>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objBncChequeDetails.Add(new DSR_CashColAgnBncChq()
                    {
                        ImpExpChaId = Convert.ToInt32(Result["ImpExpChaId"]),
                        CashColAgnBncChqDate = Result["CashCollectionDate"].ToString(),
                        Invoice_No = Result["InvoiceNo"].ToString(),
                        ImpExpChaName = Convert.ToString(Result["ImpExpChaName"]),
                        ChequeAmt = Convert.ToDecimal(Result["ChequeAmt"]),
                        ChequeDDNo = Convert.ToString(Result["ChequeDDNo"]),
                        ChequeDate = Convert.ToString(Result["ChequeDate"]),
                        OtherCharges = Convert.ToDecimal(Result["OtherCharges"]),
                        PayMode= Convert.ToString(Result["PayMode"]),
                        ReceiptNo = Convert.ToString(Result["ReceiptNo"])
                ...
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = objBncChequeDetails;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void RefundFromPDA(DSR_AddMoneyToPDModelRefund m, int Uid)
        {
        ...
        public void GetPartyDetailsRefund()
        {
            ...
            IList<DSR_RefundMoneyFromPD> model = new List<DSR_RefundMoneyFromPD>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    model.Add(new DSR_RefundMoneyFromPD
                    {
                        Id = Convert.ToInt32(Result["Id"]),
        ...
        public void GetSDRefundList()
        {
            ...
            List<DSR_SDRefundList> SdList = new List<DSR_SDRefundList>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    SdList.Add(new DSR_SDRefundList
                    {
        ...
        public void GetMiscInvoiceAmount(string purpose, string InvoiceType, int PartyId, decimal Amount,string SEZ)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_SacCode", MySqlDbType = MySqlDbType.VarChar, Value = purpose});            
        ...
        public void PurposeListForMiscInvc()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstPurpose.Add(new SelectListItem { Text = result["ChargesName"].ToString(), Value = result["SacCode"].ToString() });
                }
                if (Status == 1)
                {
        ...
        public void AddMiscInv(DSRMiscPostModel ObjPostPaymentSheet, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ChargeType", MySqlDbType = MySqlDbType.VarChar, Value = ObjPostPaymentSheet.ChargeType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SEZ", MySqlDbType = MySqlDbType.VarChar, Value = ObjPostPaymentSheet.SezValue });
        ...
        public void GetPaymentPartyMisc()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<DSRPaymentPartyName> objPaymentPartyName = new List<DSRPaymentPartyName>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new DSRPaymentPartyName()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
        ...
        public void ListOfMiscInvoice(string Module, string InvoiceNo = null, string InvoiceDate = null)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<DSRListOfMiscInvoice> lstExpInvoice = new List<DSRListOfMiscInvoice>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstExpInvoice.Add(new DSRListOfMiscInvoice()
                    {
                        InvoiceId = Convert.ToInt32(Result["InvoiceId"]),
                        InvoiceNo = Convert.ToString(Result["InvoiceNo"]),
                        InvoiceDate = Convert.ToString(Result["InvoiceDate"]),
        ...
        public void GetYardInvoiceDetailsForEdit(int InvoiceId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            decimal hours = 0;
            DSRInvoiceYard objPostPaymentSheet = new DSRInvoiceYard();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objPostPaymentSheet.lstPostPaymentChrg.Add(new DSRPostPaymentChrg()
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentCont.Add(new DSRPostPaymentContainer()
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToString(Result["Size"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstContWiseAmount.Add(new DSRContainerWiseAmount()
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstOperationCFSCodeWiseAmount.Add(new DSROperationCFSCodeWiseAmount
                        {
        ...
        public void GetDeliInvoiceDetailsForEdit(int InvoiceId)
        {
            ...
            DSRInvoiceGodown objPostPaymentSheet = new DSRInvoiceGodown();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstInvoiceCargo.Add(new DSRInvoiceCargo
                        {
        ...
        public void GetFumigation(string FumigationChargeType, string InvoiceType, int PartyId, string size, string LineXML)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSR_FumigationInvoice ObjEntryThroughGate = new DSR_FumigationInvoice();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditFumigationInv(DSR_FumigationInvoice ObjPostPaymentSheet, String ChemicalData, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
            string dt = Convert.ToDateTime(ObjPostPaymentSheet.DeliveryDate).ToString("yyyy-MM-dd hh:mm");
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetPaymentParty()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<DSR_RentParty> objPaymentPartyName = new List<DSR_RentParty>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new DSR_RentParty()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
                        Address = Convert.ToString(Result["Address"]),
                        ...
                        GSTNo = Convert.ToString(Result["GSTNo"]), 
                        SacCode= Convert.ToString(Result["SacCode"]),
                        GSTPer= Convert.ToString(Result["Gst"]),
        ...
        public void AddEditRentInv(DSR_RentInvoice ObjPostPaymentSheet, String RentData, String ChargeData, int BranchId, int Uid, string month, int year, string Module)
        {
            string GeneratedClientId = "0";
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DA.ExecuteNonQuery("AddEditRentInvoice", CommandType.StoredProcedure, DParam, out GeneratedClientId, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                ...
                {                    
                    _DBResponse.Data = GeneratedClientId;
                    _DBResponse.Status = -1;                   
                    _DBResponse.Message = "Rent Invoice Entry For this Month already exists. Populate data.";
                }
                else
                {
                    _DBResponse.Data = null;
        ...
        public void GetRentDet(string Mon, int Yr, int flg)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            DSR_RentInvoice objInvoice = new DSR_RentInvoice();
            ...
            try
            {
                ...
                {
                    Status = 1;                    
                    objInvoice.lstRentDetails.Add(new DSRRentDetails
                    {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstRentInvoiceCharge.Add(new DSR_RentInvoiceCharge
                        {
                            Date = Result["InvoiceDate"].ToString(),
        ...
        public void GetRentInvoicesList(int Page)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetRentInvoicesList", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<DSRRentDetails> objRentPartyName = new List<DSRRentDetails>();
            try
            {
                string State = "0";
                while (Result.Read())
                {
                    Status = 1;
                    objRentPartyName.Add(new DSRRentDetails()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
                        GSTNo = Convert.ToString(Result["GstNo"]),                       
                        StateCode = Convert.ToString(Result["ComStateCode"]),                        
                        amount = Convert.ToDecimal(Result["Amount"]),
                        cgst = Convert.ToDecimal(Result["CGST"]),
                        sgst = Convert.ToDecimal(Result["SGST"]),
                        igst = Convert.ToDecimal(Result["IGST"]),                       
                ...
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = State;
                    _DBResponse.Data = objRentPartyName;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void GetRentInvoicesList(string InvoiceNo)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetRentInvoicesListBySearch", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<DSRRentDetails> objRentPartyName = new List<DSRRentDetails>();
            try
            {
        ...
        #region Reservation
        public void GetReservationParties(string month, int year)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetReservationPaymentParty", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<DSRReservationPartyDetails> objPaymentPartyName = new List<DSRReservationPartyDetails>();
            try
            {
                while (Result.Read())
                {
                    ...
                    Status = 1;
                    objPaymentPartyName.Add(new DSRReservationPartyDetails()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
        ...
        public void CreateReservationInvoices(string month, int year,int pid, int mode,string invdt,string SEZ)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Month", MySqlDbType = MySqlDbType.VarChar, Value = month });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Year", MySqlDbType = MySqlDbType.Int32, Value = year });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = pid });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Mode", MySqlDbType = MySqlDbType.Int32, Value = mode });
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvDate", MySqlDbType = MySqlDbType.Date, Value = invdt });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SEZ", MySqlDbType = MySqlDbType.VarChar, Value = SEZ });
            IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GenerateReservationInvoices", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<DSRReservationPartyDetails> objResInvoices = new List<DSRReservationPartyDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objResInvoices.Add(new DSRReservationPartyDetails()
                    {
                        InvoiceDate = Result["InvoiceDate"].ToString(),
                        ReservationId= Convert.ToInt32(Result["ReservationId"]),
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName =Convert.ToString(Result["PartyName"]),
                        GodownId = Convert.ToInt32(Result["GodownId"]),
                        ...
                        SacCode=Convert.ToString(Result["SacCode"]),
                        Rate = Convert.ToDecimal(Result["Rate"]),
                        Mnth=Convert.ToString(Result["iMonth"]),
                        Yr = Convert.ToInt32(Result["iYear"]),
        ...
        public void AddEditInvoiceReservation(string dtlsXml, string type, int BranchId, int userid, string month, string year,string SEZ)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetReservationInvoicesList(string InvoiceNo = null, string InvoiceDate = null)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            if (InvoiceDate != null) InvoiceDate = Convert.ToDateTime(InvoiceDate).ToString("yyyy-MM-dd");
            ...
            //List<MySqlParameter> LstParam = new List<MySqlParameter>();
            //IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetReservationInvoicesList", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<DSRReservationPartyDetails> objPaymentPartyName = new List<DSRReservationPartyDetails>();
            try
            {
                while (Result.Read())
                {
                    ...
                    objPaymentPartyName.Add(new DSRReservationPartyDetails()
                    {
                        ...
                        ComStateCode = Convert.ToString(Result["ComStateCode"]),
                        //IsCashReceipt = Convert.ToInt32(Result["IsCashReceipt"]),
                        Mnth=Convert.ToString(Result["Mnth"]),
                        Yr = Convert.ToInt32(Result["Yr"]),
                    });
                }
                if (Status == 1)
                {
        ...
        public void GetMstBank()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<DSR_Bank> objBankList = new List<DSR_Bank>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objBankList.Add(new DSR_Bank()
                    {
        ...
        public void GetCargoShiftingDetailsInv(int CargoShiftingId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Areas.Export.Models.DSRInvoiceCargoShifting objPostPaymentSheet = new Areas.Export.Models.DSRInvoiceCargoShifting();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstShippingDet.Add(new Areas.Export.Models.DSRCargoShiftingShipBillDetails
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentChrg.Add(new Areas.Export.Models.DSRPostPaymentChrgShifting()
                        {
                            ChargeId = objPostPaymentSheet.lstPostPaymentChrg.Count + 1,
                            Clause = Convert.ToString(Result["Clause"]),
                            ChargeType = Convert.ToString(Result["ChargeType"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstOperationCFSCodeWiseAmount.Add(new Areas.Export.Models.DSROperationCFSCodeWiseAmountCS
                        {
                            CFSCode = Result["CFSCode"].ToString(),
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = Result["Size"].ToString(),
        ...
        public void GetContainerList()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSR_Container> LstStuffing = new List<DSR_Container>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new DSR_Container
                    {
        ...
        public void ListOfChargesName()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSRCharge> LstStuffing = new List<DSRCharge>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new DSRCharge
                    {
        ...
        public void GetDebitInvoice(string InvoiceType, int PartyId, decimal TotalChrgAmount, string Charges,string SEZ)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceType", MySqlDbType = MySqlDbType.VarChar, Value = InvoiceType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = PartyId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Amount", MySqlDbType = MySqlDbType.Decimal, Value = TotalChrgAmount });
            ...
            _DBResponse = new DatabaseResponse();
            DSR_DebitInvoice ObjDebitInvoice = new DSR_DebitInvoice();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjDebitInvoice.TotalChrgAmount = Convert.ToDecimal(Result["SUM"]);
                    ObjDebitInvoice.CGST = Convert.ToDecimal(Result["CGSTAmt"]);
                    ObjDebitInvoice.SGST = Convert.ToDecimal(Result["SGSTAmt"]);
                    ObjDebitInvoice.IGST = Convert.ToDecimal(Result["IGSTAmt"]);
                    ObjDebitInvoice.IGSTPER = Convert.ToDecimal(Result["IGSTPer"]);

                    ObjDebitInvoice.CGSTPER = Convert.ToDecimal(Result["CGSTPER"]);
                    ObjDebitInvoice.SGSTPER = Convert.ToDecimal(Result["SGSTPER"]);                   
                    ObjDebitInvoice.Round_up = Convert.ToDecimal(Result["Round_Up"]);
                    ObjDebitInvoice.Total = Convert.ToDecimal(Result["NetAmt"]);
                ...
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = ObjDebitInvoice;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void AddEditDebitInvoice(DSR_DebitInvoice ObjPostPaymentSheet, String ChemicalData, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
            string dt = Convert.ToDateTime(ObjPostPaymentSheet.DeliveryDate).ToString("yyyy-MM-dd hh:mm");
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchID", MySqlDbType = MySqlDbType.Int32, Value = BranchId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Module", MySqlDbType = MySqlDbType.VarChar, Value = Module });
            LstParam.Add(new MySqlParameter { ParameterName = "in_FromDate", MySqlDbType = MySqlDbType.Date, Value = Convert.ToDateTime(ObjPostPaymentSheet.FromDate).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ToDate", MySqlDbType = MySqlDbType.Date, Value = Convert.ToDateTime(ObjPostPaymentSheet.ToDate).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SEZ", MySqlDbType = MySqlDbType.VarChar, Value = Convert.ToString(ObjPostPaymentSheet.SEZ1) });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = GeneratedClientId });
        ...
        public void GetContainerDebitInvoiceList()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetContainerDebitInvoiceList", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            IList<DSR_DebitInvoice> objPaymentPartyName = new List<DSR_DebitInvoice>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new DSR_DebitInvoice()
                    {
                        InvoiceId =Convert.ToInt32(Result["InvoiceId"]),
                        InvoiceNo = Result["InvoiceNo"].ToString(),
                        PartyName = Convert.ToString(Result["PartyName"]),
                        DeliveryDate = Convert.ToString(Result["InvoiceDate"]),
        ...
        public void GetContainerDebitInvoiceDetails(int InvoiceId) 
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
            IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetContainerDebitInvoiceDetails", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            DSR_DebitInvoice objPaymentPartyName = new DSR_DebitInvoice();
            try
            {
                while (Result.Read())
                {
                    ...
                    objPaymentPartyName.InvoiceId = Convert.ToInt32(Result["InvoiceId"]);
                    objPaymentPartyName.InvoiceNo = Result["InvoiceNo"].ToString(); 
                    objPaymentPartyName.DeliveryDate = Convert.ToString(Result["DeliveryDate"]);
                    objPaymentPartyName.PartyId = Convert.ToInt32(Result["PartyId"]); 
                    objPaymentPartyName.PartyName = Convert.ToString(Result["PartyName"]);
                    objPaymentPartyName.PayeeId = Convert.ToInt32(Result["PayeeId"]); 
                    objPaymentPartyName.PayeeName = Convert.ToString(Result["PartyName"]);
                    objPaymentPartyName.GSTNo = Convert.ToString(Result["PartyGSTNo"]);
                    objPaymentPartyName.Remarks = Result["Remarks"].ToString(); 
                    objPaymentPartyName.CGST = Convert.ToDecimal(Result["TotalCGST"]);
                    objPaymentPartyName.SGST = Convert.ToDecimal(Result["TotalSGST"]);
                    objPaymentPartyName.IGST = Convert.ToDecimal(Result["TotalIGST"]);
                    objPaymentPartyName.Round_up = Convert.ToDecimal(Result["RoundUp"]);
                    objPaymentPartyName.Total = Convert.ToDecimal(Result["AllTotal"]);
                    objPaymentPartyName.StateCode = Convert.ToString(Result["PartyStateCode"]); 
                    objPaymentPartyName.OperationType = Convert.ToString(Result["OperationType"]);
                    objPaymentPartyName.InvoiceType = Convert.ToString(Result["InvoiceType"]); 
                    objPaymentPartyName.Container = Convert.ToString(Result["Container"]);
                    objPaymentPartyName.Size = Convert.ToString(Result["Size"]);
                    objPaymentPartyName.TotalChrgAmount = Convert.ToDecimal(Result["Amount"]);
                    objPaymentPartyName.CFSCD= Convert.ToString(Result["CFSCode"]);
        ...
        public void GetContainerMovementInvoiceDetailsForEdit(int InvoiceId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            //PpgInvoiceYard objPostPaymentSheet = new PpgInvoiceYard();
            Areas.Export.Models.DSR_MovementInvoice objPostPaymentSheet = new Areas.Export.Models.DSR_MovementInvoice();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentChrg.Add(new Areas.Export.Models.DSRPostPaymentChrg()
                        {
                            ChargeId = objPostPaymentSheet.lstPostPaymentChrg.Count + 1,
                            Clause = Convert.ToString(Result["Clause"]),
                            ChargeType = Convert.ToString(Result["ChargeType"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentCont.Add(new Areas.Export.Models.DSRPostPaymentContainer
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToString(Result["Size"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstContWiseAmount.Add(new Areas.Export.Models.DSRContainerWiseAmount
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                            EntryFee = Convert.ToDecimal(Result["EntryFee"]),
                            CstmRevenue = Convert.ToDecimal(Result["CstmRevenue"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstOperationCFSCodeWiseAmount.Add(new Areas.Export.Models.DSROperationCFSCodeWiseAmount
                        {
                            CFSCode = Result["CFSCode"].ToString(),
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = Result["Size"].ToString(),
        ...
        public void EditContainerMovementInvoice(Areas.Export.Models.DSR_MovementInvoice ObjPostPaymentSheet,
        ...
        // ADD Cash Receipt
        public void AddCashReceiptSD(DSR_CashReceiptModel ObjCashRcpt, string xml)
        {
            string GeneratedClientId = "0";
            string ReceiptNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetPartyDetail(string PartyCode, int Page = 0)
        {
            ...
            _DBResponse = new DatabaseResponse();
            DSR_ChequeReturn LstEximTrader = new DSR_ChequeReturn();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstEximTrader.lstCheque.Add(new DSR_ChequeDetails
                    {
        ...
        public void GetChequeNo(int PartyId)
        {
            ...
            IList<DSR_ChequeDetail> model = new List<DSR_ChequeDetail>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    model.Add(new DSR_ChequeDetail
                    {
                        Id = Convert.ToInt32(Result["Id"]),
        ...
        public void GetChequeDetails(string ChequeNo)
        {
            ...
            IList<DSR_Cheques> model = new List<DSR_Cheques>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        public void GetAllChequeReturn()
        {
            ...
            try
            {
                ...
                List<DSR_ChequeReturn> PartyWiseTDSDepositList = new List<DSR_ChequeReturn>();
                ...
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        DSR_ChequeReturn objPartyWiseTDSDeposit = new DSR_ChequeReturn();
        ...
        #region BankDeposit
        public void AddEditBankDeposit(DSRBankDeposit Obj, int Uid = 0)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Draft", MySqlDbType = MySqlDbType.Decimal, Value = Obj.Draft });
            LstParam.Add(new MySqlParameter { ParameterName = "in_DepSlipNo", MySqlDbType = MySqlDbType.VarChar, Value = Obj.DepSlipNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BankId", MySqlDbType = MySqlDbType.Int32, Value = Obj.BankId });
        ...
        public void GetBankDepositList(string SearchValue)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            DParam = lstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            lstParam.Add(new MySqlParameter { ParameterName = "in_SearchValue", MySqlDbType = MySqlDbType.Int32, Value = SearchValue });
            IDataReader Result = DataAccess.ExecuteDataReader("GetBankDepositList", CommandType.StoredProcedure, DParam);
            List<DSRBankDeposit> lstBankDeposit = new List<DSRBankDeposit>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstBankDeposit.Add(new DSRBankDeposit
                    {
                        Id = Convert.ToInt32(Result["Id"]),
                        ...
                        Draft = Convert.ToDecimal(Result["Draft"]),
                        DepSlipNo = Result["DepSlipNo"].ToString(),
                        AccountNo= Result["AccountNo"].ToString(),
                        BankId=Convert.ToInt32(Result["BankId"]),
        ...
        public void GetBankAccount(int BranchId)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = BranchId });
            IDataParameter[] DParam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBankAccountList", CommandType.StoredProcedure, DParam);
            List<DSRBankDetails> lstBankAccount = new List<DSRBankDetails>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    lstBankAccount.Add(new DSRBankDetails
                    {
                        BankId = Convert.ToInt32(Result["BankId"]),
                        AccountNo = Result["AccountNo"].ToString(),
                    });
                ...
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = lstBankAccount.ToList();
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void GetNEFTForBankDeposit(DateTime dt)
        {
            ...
            DSRBankDeposit obj = new DSRBankDeposit();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        //public void GetDepositDetails(string DepositDate)
        //{
        //    int Status = 0;
        //    if (DepositDate != null) DepositDate = Convert.ToDateTime(DepositDate).ToString("yyyy-MM-dd");
        //    DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        //    List<MySqlParameter> lstParam = new List<MySqlParameter>();
        //    lstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Date, Value = DepositDate });

        //    IDataParameter[] Dparam = lstParam.ToArray();
        //    IDataReader Result = DataAccess.ExecuteDataReader("GetGSTforSClick", CommandType.StoredProcedure, Dparam);
        //    DepositAmountDetails lstDDetails = new DepositAmountDetails();
        //    _DBResponse = new DatabaseResponse();
        //    try
        //    {
        //        bool State = false;
        ...
        public void OAGetEximTrader(string PartyCode, int Page = 0)
        {
            ...
            DSROASearchEximTraderData objSD = new DSROASearchEximTraderData();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objSD.lstExim.Add(new DSROAListOfEximTrader
                    {
                        EximTraderId = Convert.ToInt32(Result["EximTraderId"]),
        ...
        public void AddOAAddMoney(DSROAAddMoney ObjSD, string xml)
        {
            string ReturnObj = "";
            string Param = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();            
        ...
        public void GetAllOAAddMoneyList()
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            DParam = lstParam.ToArray();
            ...
            DSROAAddMoney ObjAddMoneyToOA = null;
            List<DSROAAddMoney> lstAddMoneyToOA = new List<DSROAAddMoney>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    ObjAddMoneyToOA = new DSROAAddMoney();                    
                    ObjAddMoneyToOA.ReceiptNo = Convert.ToString(Result["ReceiptNo"]);
                    ObjAddMoneyToOA.TransDate = Convert.ToString(Result["ReceiptDate"] == null ? "" : Result["ReceiptDate"]);

                    lstAddMoneyToOA.Add(ObjAddMoneyToOA);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetOAAddMoneyByReceiptNo(string ReceiptNo)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            DParam = lstParam.ToArray();
        ...
        public void GetRevenueStampPurchase(string PurchaseDate, int Page)
        {
            int Status = 0;

            if (PurchaseDate != null) PurchaseDate = Convert.ToDateTime(PurchaseDate).ToString("yyyy-MM-dd");
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_RSPurchaseId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PurchaseDate", MySqlDbType = MySqlDbType.Date, Value = PurchaseDate});
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetRevenueStampPurchase", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstRevenueStamp.Add(new DSRRevenueStamp
                    {
                        
                        PurchaseDate = Result["RSPurchaseDate"].ToString(),
                        PurchaseAmount = Convert.ToDecimal(Result["RSPurchaseAmt"]),
                        RSPurchaseId = Convert.ToInt32(Result["RSPurchaseId"])
                    });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = lstRevenueStamp;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void GetRevenueStampPurchaseById(int RSPurchaseId, int Page, string PurchaseDate = null)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_RSPurchaseId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = RSPurchaseId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PurchaseDate", MySqlDbType = MySqlDbType.Date, Value = PurchaseDate });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    ObjRevenueStamp.PurchaseDate = Result["RSPurchaseDate"].ToString();
                    ObjRevenueStamp.PurchaseAmount = Convert.ToDecimal(Result["RSPurchaseAmt"]);
                    ObjRevenueStamp.RSPurchaseId = Convert.ToInt32(Result["RSPurchaseId"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = ObjRevenueStamp;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void AddEditRevenueStampPurchase(DSRRevenueStamp ObjRevenueStamp)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_RSPurchaseId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjRevenueStamp.RSPurchaseId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_RSPurchaseDate", MySqlDbType = MySqlDbType.VarChar, Value = Convert.ToDateTime(ObjRevenueStamp.PurchaseDate).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_RSPurchaseAmount", MySqlDbType = MySqlDbType.Decimal, Value = ObjRevenueStamp.PurchaseAmount });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjRevenueStamp.Uid });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddEditRevenueStampPurchase", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = ObjRevenueStamp.RSPurchaseId == 0 ? "Revenue Stamp Purchase Saved Successfully" : "Revenue Stamp Purchase Updated Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
        ...
        public void DeleteRevenueStampPurchase(int RSPurchaseId)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_RSPurchaseId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = RSPurchaseId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteRevenueStampPurchase", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Revenue Stamp Purchase Deleted Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
        ...
        public void AddDirectPaymentVoucher(DSR_DirectOnlinePayment objDOP, int uid)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetOnlinePayAckList(int uid, long OrderId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSR_DirectOnlinePayment> objDOPList = new List<DSR_DirectOnlinePayment>();
            DSR_DirectOnlinePayment objDOP = new DSR_DirectOnlinePayment();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objDOP = new DSR_DirectOnlinePayment();
        ...
        public void GetOnlineConfirmPayment(decimal TotalAmt, long OrderId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLD_DirectOnlinePayment> objDOPList = new List<WFLD_DirectOnlinePayment>();
            WFLD_DirectOnlinePayment objDOP = new WFLD_DirectOnlinePayment();
            try
            {
        ...
        public void AddEditOnlinePaymentAgainstInvoice(DSR_OnlinePaymentAgainstInvoice objDOP, int uid, string XML)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_OnlinePayAckId", MySqlDbType = MySqlDbType.Int32, Value = objDOP.OnlinePayAckId });
        ...
        public void GetOnlinePaymentAgainstInvoice(string SearchValue = "", int Pages = 0)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSR_OnlinePaymentAgainstInvoice> lstCashReceipt = new List<DSR_OnlinePaymentAgainstInvoice>();
            int Status = 0;
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstCashReceipt.Add(new DSR_OnlinePaymentAgainstInvoice
                    {
        ...
        public void AcknowledgementViewList(string FromDate, string ToDate, int Uid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DSR_AcknowledgementViewList> lstReceipt = new List<DSR_AcknowledgementViewList>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    lstReceipt.Add(new DSR_AcknowledgementViewList
                    {
                        // PeriodFrom=Convert.ToString(Result["FromDate"])
