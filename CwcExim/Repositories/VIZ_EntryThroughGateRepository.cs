...
{
    public class VIZ_EntryThroughGateRepository
    {
        ...
        public void AddEditEntryThroughGateCBT(VIZ_EntryThroughGate ObjEntryThroughGate)
        {
        ...
        public void AddEditEntryThroughGate(VIZ_EntryThroughGate ObjEntryThroughGate)
        {
        ...
        public void DeleteEntryThroughGate(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Entry Deleted Successfully"; 
                    _DBResponse.Data = GeneratedClientId;
                }
                else if (Result == 3)
                {
        ...
        public void GetLoadedContData(int LoadContainerRefId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VIZ_LoadedContainerListWithData> lstLoadedContainerListWithData = new List<VIZ_LoadedContainerListWithData>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstLoadedContainerListWithData.Add(new VIZ_LoadedContainerListWithData
                    {
        ...
        public void ListOfShippingLine()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VIZ_EntryThroughGateShipping> lstShippingList = new List<VIZ_EntryThroughGateShipping>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstShippingList.Add(new VIZ_EntryThroughGateShipping
                    {
        ...
        public void ListOfCHA()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VIZ_EntryThroughGateCHA> lstCHAList = new List<VIZ_EntryThroughGateCHA>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstCHAList.Add(new VIZ_EntryThroughGateCHA
                    {
        ...
        public void GetAllEntryThroughGate()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstEntryThroughGate.Add(new VIZ_EntryThroughGate
                    {
        ...
        public void GetDetForExportAddVehicle(int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VIZ_AddExportVehicle ObjEntryThroughGate = new VIZ_AddExportVehicle();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditEntryThroughGateVehicle(VIZ_AddExportVehicle ObjEntryThroughGate)
        {
        ...
        public void GetVehicleDtlbyEntryId(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstVehicle.Add(new VIZ_AddExportVehicle
                    {
                        EntryId = Convert.ToInt32(Result["EntryId"]),
        ...
        public void AddEditEntryThroughGateBond(VIZ_EntryThroughGateBond ObjEntryThroughGate)
        {
            DateTime? ReferenceDt = null;
            var Entrydt = (dynamic)null;
            var SysDateTime = (dynamic)null;
        ...
        public void ListOfTransPortname()
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("ListOfTransPortFrom", CommandType.StoredProcedure, DParam);
