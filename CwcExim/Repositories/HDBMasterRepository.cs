...
{
    public class HDBMasterRepository
    {
        ...
        public void AddEditEximTrader(HDBEximTrader ObjEximTrader)
        {
        ...
        public void GetAllEximTrader()
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstEximTrader.Add(new HDBEximTrader
                    {
        ...
        public void AddSDOpening(HDBSDOpening ObjSD, string xml)
        {
            //string GeneratedClientId = "0";
        ...
        public void GetAllSDOpening()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<HDBSDOpening> LstPDAOpening = new List<HDBSDOpening>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstPDAOpening.Add(new HDBSDOpening
                    {
        ...
        public void GetSDOpening(int SDID)
            {
                ...
                IDataReader Result = DataAccess.ExecuteDataReader("GetMstSDOpening", CommandType.StoredProcedure, DParam);
                _DBResponse = new DatabaseResponse();
                HDBSDOpening LstSDOpening = new HDBSDOpening();
                try
                {
                    while (Result.Read())
                    {
        ...
        #region PORT
        public void AddEditPort(HDBPort ObjPort)
            {
                string GeneratedClientId = "0";
                List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            public void AddBank(HDBBank ObjBank)
            {
                string GeneratedClientId = "0";
                List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            public void GetLedger()
            {
                ...
                _DBResponse = new DatabaseResponse();
                IList<HDBLedgerNameModel> objPaymentPartyName = new List<HDBLedgerNameModel>();
                try
                {
                    while (Result.Read())
                    {
                        Status = 1;
                        objPaymentPartyName.Add(new HDBLedgerNameModel()
                        {
            ...
            public void AddSac(HDBSac ObjSac)
            {
                string GeneratedClientId = "0";
                List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            #region HT Charges
            public void AddEditHTCharges(HDBHTCharges objHT, int Uid,String ChargeListXML)
            {
                /*
                ...
                */
                ...
                lstParam.Add(new MySqlParameter { ParameterName = "in_IsReefer", MySqlDbType = MySqlDbType.Int32, Value = objHT.IsReefer });
        ...
        public void GetSlabData(string Size, string ChargesFor)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            ...
            HDBHTCharges Obj = new HDBHTCharges();
            int Status = 0;
            try
            {
                while (result.Read())
                {
                    Status = 1;
                    Obj.LstWeightSlab.Add(new WeightSlab
                    {
                ...
                if (result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        Obj.LstDistanceSlab.Add(new DistanceSlab
                        {
                ...
                if (result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        Obj.LstCBMSlab.Add(new CBMSlab
                        {
                            CbmSlabId = Convert.ToInt32(result["CBMSlabId"].ToString()),
                            FromCBMSlab = Convert.ToInt32(result["FromCBMSlab"].ToString()),
                            ToCBMSlab = Convert.ToInt32(result["ToCBMSlab"]),
                            chkCBMSlab = false,
                            Size = Convert.ToString(result["Size"]),
                        });
                    }
        ...
        public void GetHTSlabChargesDtl(int HTChargesID)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<ChargeList> LstCharge = new List<ChargeList>();
            int Status = 0;
            try
            { 
        ...
        public void GetAllHTCharges()
        {
                ...
                try
                {
                    ...
                    {
                        Status = 1;
                        lstCharges.LstviewList.Add(new viewList
                        {
                ...
                if (result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        lstCharges.LstWeightSlab.Add(new WeightSlab
                        {
                            WeightSlabId = Convert.ToInt32(result["WeightSlabId"].ToString()),
                            FromWeightSlab = Convert.ToInt32(result["FromWeightSlab"].ToString()),
                            ToWeightSlab = Convert.ToInt32(result["ToWeightSlab"]),
                ...
                if (result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        lstCharges.LstDistanceSlab.Add(new DistanceSlab
                        {
                            DistanceSlabId = Convert.ToInt32(result["DistanceSlabId"].ToString()),
                            FromDistanceSlab = Convert.ToInt32(result["FromDistanceSlab"].ToString()),
                            ToDistanceSlab = Convert.ToInt32(result["ToDistanceSlab"]),
        ...
        public void AddEditMiscellaneous(HDBMiscellaneous ObjMiscellaneous)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllMiscellaneous()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstMiscellaneous.Add(new HDBMiscellaneous
                    {
        ...
        public void AddEditStorageCharge(HDBStorageCharge ObjStorage)
            {
                string GeneratedClientId = "0";
                List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            public void GetAllStorageCharge()
            {
                ...
                List<HDBStorageCharge> LstStorageCharge = new List<HDBStorageCharge>();
                _DBResponse = new DatabaseResponse();
                try
                {
                    while (Result.Read())
                    {
                        Status = 1;
                        LstStorageCharge.Add(new HDBStorageCharge
                        {
            ...
            public void GetStorageCharge(int StorageChargeId)
            {
                ...
                IDataReader Result = DataAccess.ExecuteDataReader("GetMstStorageCharge", CommandType.StoredProcedure, DParam);
                _DBResponse = new DatabaseResponse();
            HDBStorageCharge ObjStorage = new HDBStorageCharge();
                try
                {
                    while (Result.Read())
                    {
        ...
        #endregion
        #region Yard
        public void AddEditYard(HDBYardVM ObjYard, string LocationXML, string DelLocationXML)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetYard(int YardId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjYard.LstYard.Add(new HDBYardWiseLocation
                        {
                            LocationId = Convert.ToInt32(Result["LocationId"]),
        ...
        #endregion
        #region Operation
        public void AddMstOperation(HDBOperation objOper)
        {
            string id = "0";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetAllMstOperation()
        {
            ...
            IList<HDBOperation> lstOP = new List<HDBOperation>();
            int Status = 0;
            try
            {
                while (result.Read())
        ...
        public void ViewMstOperation(int OperationId)
        {
            ...
            IDataParameter[] dparam = lstparam.ToArray();
            IDataReader result = DA.ExecuteDataReader("ViewMstOperation", CommandType.StoredProcedure, dparam);
            HDBOperation objOP = new HDBOperation();
            int Status = 0;
            try
            {
                while (result.Read())
        ...
        #endregion
        #region Weighment
        public void AddEditMstWeighment(HDBCWCWeighment objCW, int Uid)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetWeighmentDet(int WeighmentId)
        {
            ...
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            IList<HDBCWCWeighment> lstWeighment = null;
            HDBCWCWeighment objCWC = null;
            try
            {
                if (WeighmentId == 0)
                {
                    lstWeighment = new List<HDBCWCWeighment>();
                    while (result.Read())
                    {
                        Status = 1;
                        lstWeighment.Add(new HDBCWCWeighment
                        {
        ...
        #endregion
        #region Entry Fees
        public void AddEditMstEntryFees(HDBCWCEntryFees objEF, int Uid)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetAllEntryFees(int EntryFeeId)
        {
            ...
            IList<HDBCWCEntryFees> lstEntryFees = null;
            HDBCWCEntryFees objEF = null;
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                if (EntryFeeId == 0)
                {
                    lstEntryFees = new List<HDBCWCEntryFees>();
                    while (result.Read())
                    {
                        Status = 1;
                        lstEntryFees.Add(new HDBCWCEntryFees
                        {
        ...
        #endregion
        #region Ground Rent
        public void AddEditMstGroundRent(HDBCWCChargesGroundRent objCR, int Uid)
        {
            List<MySqlParameter> lstparam = new List<MySqlParameter>();
        ...
        public void GetAllGroundRentDet()
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<HDBCWCChargesGroundRent> objList = new List<HDBCWCChargesGroundRent>();
            try
            {
                while (result.Read())
                {
                    Status = 1;
                    objList.Add(new HDBCWCChargesGroundRent
                    {
        ...
        public void GetGroundRentDet(int GroundRentId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            HDBCWCChargesGroundRent objGR = null;
            try
            {
                while (result.Read())
                {
                    Status = 1;
                    objGR = new HDBCWCChargesGroundRent();
        ...
        #endregion
        #region Reefer
        public void AddEditMstReefer(HDBCWCReefer objRef)
        {
            List<MySqlParameter> lstparam = new List<MySqlParameter>();
        ...
        #endregion
        #region Insurance
        public void AddEditInsurance(HDBInsurance ObjInsurance)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllInsurance()
        {
            ...
            List<HDBInsurance> LstInsurance = new List<HDBInsurance>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstInsurance.Add(new HDBInsurance
                    {
        ...
        #endregion
        #region TDS
        public void AddEditMstTds(HDBCWCTds objTds)
        {
            List<MySqlParameter> lstparam = new List<MySqlParameter>();
        ...
        #endregion
        #region godown
        public void AddEditGodown(HDBGodownVM ObjGodown, string LocationXML, string DelLocationXML)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetGodown(int GodownId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjGodown.LstLocation.Add(new HDBGodownWiseLocation
                        {
                            LocationId = Convert.ToInt32(Result["LocationId"]),
                            GodownId = Convert.ToInt32(Result["GodownId"]),
                            LocationName = Result["LocationName"].ToString(),
        ...
        public void GetFranchiseCharge(int franchisechargeid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            HDBCWCFranchiseCharges objFcs = new HDBCWCFranchiseCharges();
            try
            {
                while (result.Read())
                {
        ...
        public void AddEditMstFranchiseCharges(HDBCWCFranchiseCharges objFC, int Uid)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetAllFranchiseCharges()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objList.Add(new HDBCWCFranchiseCharges
                    {
        ...
        #endregion
        #region Chemical
        public void AddEditChemical(HDBChemical ObjChem)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            try
            {
                ...
                {
                    _DBResponse.Status = 3;
                    _DBResponse.Message = "Chemical Name Already Exist in Another Page";
                    _DBResponse.Data = null;
                }
                else
                {
        ...
        public void DeleteChemical(int ChemicalId)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ChemicalId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ChemicalId });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteChemicalMaster", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Chemical Name Deleted Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
                else if (Result == 2)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Message = "Chemical Name Can't be Deleted as It Is Used In Another Page";
                    _DBResponse.Status = 2;
                }
                else if (Result == 3)
                {
        ...
        public void GetAllChemical()
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstChemical", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<HDBChemical> LstYard = new List<HDBChemical>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstYard.Add(new HDBChemical
                    {
        ...
        #endregion
        #region HoliDay
        public void AddEditHoliDay(HDBHoliday ObjChem)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_holidayId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjChem.Id });
            LstParam.Add(new MySqlParameter { ParameterName = "in_holiday_desc", MySqlDbType = MySqlDbType.VarChar, Value = ObjChem.Discription });
          //  LstParam.Add(new MySqlParameter { ParameterName = "in_Branch_Id", MySqlDbType = MySqlDbType.Int32, Value = ObjChem.BranchId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddEditMstHoliday", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = ObjChem.Id == 0 ? "Chemical Details Saved Successfully" : "Chemical Details Updated Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
                else if (Result == 2)
                {
        ...
        public void DeleteHoliDay(int Id)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_holidayId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = Id });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteMstHoliday", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Holiday Details Deleted Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
                else
                {
        ...
        public void GetHoliDay(int Id)
        {
            int Status = 0;
            List<MySqlParameter> LstParm = new List<MySqlParameter>();
            LstParm.Add(new MySqlParameter { ParameterName = "in_holidayId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = Id });
            IDataParameter[] DParam = { };
            DParam = LstParm.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstHoliday", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    ObjYard.Id = Convert.ToInt32(Result["holiday_id"]);
                    ObjYard.Discription = Result["holiday_desc"].ToString();
                    ObjYard.Date = (Convert.ToDateTime((Result["holiday_date"]))).ToString();
        ...
        public void GetAllHoliDay()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_holidayId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstHoliday", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<HDBHoliday> LstYard = new List<HDBHoliday>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstYard.Add(new HDBHoliday
                    {
                        Id = Convert.ToInt32(Result["holiday_id"]),
                        Discription = Result["holiday_desc"].ToString()
                    });
                }
                if (Status == 1)
                {
        ...
        #region Ledger Code Details
        public void AddEditLedgerCode(LedgerCodeDetails ObjPort)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_LedgerId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjPort.LedgerCodeId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_FinancialYear", MySqlDbType = MySqlDbType.VarChar, Value = ObjPort.FinancialYear });
            LstParam.Add(new MySqlParameter { ParameterName = "in_LedgerCode", MySqlDbType = MySqlDbType.VarChar, Value = ObjPort.LedgerCode });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddEditLedgerCode", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = ObjPort.LedgerCodeId == 0 ? "Ledger Code Details Saved Successfully" : "Ledger Code Details Updated Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
                else if (Result == 2)
                {
                    _DBResponse.Status = 2;
                    _DBResponse.Message = "Ledger Code Already Exists";
                    _DBResponse.Data = null;
                }
                else if (Result == 3)
                {
        ...
        public void DeleteLedgerCode(int LedgerCodeId)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_LedgerCodeId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = LedgerCodeId });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteLedgerCode", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Ledger Code Details Deleted Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
                else if (Result == 2)
                {
        ...
        public void GetAllLedgerCode()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_LedgerCodeId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = 0 });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstLedgerCode", CommandType.StoredProcedure, DParam);
            List<LedgerCodeDetails> LstLedger = new List<LedgerCodeDetails>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstLedger.Add(new LedgerCodeDetails
                    {
                        FinancialYear = Convert.ToString(Result["FinancialYear"]),
                        LedgerCode = Convert.ToString(Result["LedgerCode"]),
                        LedgerCodeId = Convert.ToInt32(Result["LedgerCodeId"]),
                    });
                }
                if (Status == 1)
                {
        ...
        public void GetLedgerCode(int LedgerCodeId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_LedgerCodeId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = LedgerCodeId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            LedgerCodeDetails Ledger = new LedgerCodeDetails();
            _DBResponse = new DatabaseResponse();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstLedgerCode", CommandType.StoredProcedure, DParam);
            try
            {
                while (Result.Read())
                {
                    ...
                    Ledger.FinancialYear = Convert.ToString(Result["FinancialYear"]);
                    Ledger.LedgerCode = Convert.ToString(Result["LedgerCode"]);
                    Ledger.LedgerCodeId = Convert.ToInt32(Result["LedgerCodeId"]);
