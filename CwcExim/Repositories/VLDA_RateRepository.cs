...
{
    public class VLDA_RateRepository
    {
        ...
        public void AddEditMstRateFees(WFLDStorageCharge objStorage, int Uid)
        {
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_CommodityType", MySqlDbType = MySqlDbType.Int32, Value = objStorage.CommodityType, Size = 2 });
        ...
        public void ListOfSACCode()
        {
            ...
            IList<WFLDSac> lstSac = new List<WFLDSac>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void ListOfChargeName()
        {
            ...
            IList<WFLDMiscCharge> LstOfChargeName = new List<WFLDMiscCharge>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstOfChargeName.Add(new WFLDMiscCharge
                    {
        ...
        public void GetAllMiscRateFees(int StorageChargeId)
        {
            ...
            IList<WFLDStorageCharge> lstRateFees = null;
            WFLDStorageCharge objSC = null;
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                ...
                {
                    lstRateFees = new List<WFLDStorageCharge>();
                    while (result.Read())
                    {
                        Status = 1;
                        lstRateFees.Add(new WFLDStorageCharge
                        {
                            ...
                            CommodityType = Convert.ToInt32(result["CommodityType"].ToString())
                        });
                    }
                }
                else
                {
                    objSC = new WFLDStorageCharge();
                    while (result.Read())
                    {
                        Status = 2;
                        ...
                        objSC.CommodityType = Convert.ToInt32(result["CommodityType"].ToString());
                    }
                }
        ...
        public void AddEditMstRateFeesForEximTraders(WFLDStorageCharge objStorage, int Uid)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_StorageChargeId", MySqlDbType = MySqlDbType.Int32, Value = objStorage.StorageChargeId });
            ...
            IDataParameter[] dparam = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int result = DA.ExecuteNonQuery("AddEditMstRateFeesForEximTraders", CommandType.StoredProcedure, dparam);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (result == 1 || result == 2)
        ...
        public void GetAllMiscRateFeesForEximTraders(int StorageChargeId)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_StorageChargeId", MySqlDbType = MySqlDbType.Int32, Value = StorageChargeId });
            IDataParameter[] dparam = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("GetMstMiscRateFeesForEximTraders", CommandType.StoredProcedure, dparam);
            IList<WFLDStorageCharge> lstRateFees = null;
            WFLDStorageCharge objSC = null;
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                ...
                else
                {
                    ...
                    while (result.Read())
                    {
                        ...
                        objSC.PartyName = Convert.ToString(result["PartyName"]);
                    }
                }
                if (Status == 1 || Status == 2)
                {
