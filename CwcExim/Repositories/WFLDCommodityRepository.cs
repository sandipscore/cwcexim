...
{
    public class WFLDCommodityRepository
    {
        ...
        public void AddEditCommodity(WFLDCommodity ObjCommodity)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ReadymadeGarments", MySqlDbType = MySqlDbType.Bit, Value = ObjCommodity.ReadymadeGarments });
        ...
        public void GetAllCommodity(int Page)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstCommodity.Add(new WFLDCommodity{
        ...
        public void GetCommodity(int CommodityId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjCommodity.ReadymadeGarments = Convert.ToBoolean(Result["ReadymadeGarments"] == DBNull.Value ? 0 : Result["ReadymadeGarments"]);
