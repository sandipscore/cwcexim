...
{
    public class LGS_ReportRepository
    {
        ...
        public void DTRForPrint(string DTRDate,string DTRTODate)
        {
            int Status = 0;
            IDataParameter[] DParam = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void DTRForExport(string DTRDate, string DTRToDate)
        {
            int Status = 0;
            IDataParameter[] DParam = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    try
                    {
                        ...
                        DataTable lstGateInInfo = ds.Tables[6];
                        ...
                        if (lstCargoShifting.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow item in lstCargoShifting.Rows)
                            {
                                ...
                                obj3.CFSCode= Convert.ToString(item["CFSCode"].ToString());
                        ...
                        if (lstBTTDetails.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow item in lstBTTDetails.Rows)
                            {
                                ...
                                obj5.GR = Convert.ToString(item["GR"].ToString());
                        ...
                        if (lstGateInInfo.Rows.Count > 0)
                        {
                            List<LNSM_GateInInformation> ListDtls = new List<LNSM_GateInInformation>();
                            foreach (DataRow item in lstGateInInfo.Rows)
                            {
                                LNSM_GateInInformation obj7 = new LNSM_GateInInformation();
                                obj7.CFSCode = Convert.ToString(item["CFSCode"].ToString());
                                obj7.GateInDate = Convert.ToString(item["GateInDate"].ToString());
                                obj7.GateInTime = Convert.ToString(item["GateInTime"]);
                                obj7.Cont_CBT = Convert.ToString(item["Cont_CBT"].ToString());
                                obj7.ContSize = Convert.ToInt32(item["ContSize"].ToString());
                                obj7.VehicleNo = Convert.ToString(item["VehicleNo"].ToString());
                                obj7.ModeOfTransport = Convert.ToString(item["ModeOfTransport"].ToString());
                                obj7.ShippingLine = Convert.ToString(item["ShippingLine"].ToString());
                                obj7.ContLoadType = Convert.ToString(item["ContLoadType"].ToString());
                                obj7.OperationType = Convert.ToString(item["OperationType"].ToString());
                                obj7.CustomSealNo = Convert.ToString(item["CustomSealNo"].ToString());
                                obj7.OtherSealNo = Convert.ToString(item["OtherSealNo"].ToString());
                                obj7.TrainReceivedFrom = Convert.ToString(item["TrainReceivedFrom"].ToString());
                                obj7.ContType = Convert.ToString(item["ContType"].ToString());

                                ListDtls.Add(obj7);
                            }
                            LNSM_obj.lstGateInInfo = ListDtls;
                            Status = 1;
                        }
                    }
                    catch (Exception EX)
