...
{
    public class VLDAExitThroughGateRepository
    {
        ...
        public void AddEditExitThroughGate(WFLDExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
        ...
        public void GetContainer()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objExitThroughGateHeader.containerList.Add(new WFLDcontainerExit
                    {
        ...
        public void AddGateEXitToDetails(WFLDExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
            ObjExitThroughGateHeader.Uid = Uid;
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllExitThroughGate()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLDExitThroughGateHeader> LstExitThroughGate = new List<WFLDExitThroughGateHeader>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new WFLDExitThroughGateHeader
                    {
        ...
        public void GetExitThroughGateDetails()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLDExitThroughGateDetails> LstExitThroughGateDtls = new List<WFLDExitThroughGateDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGateDtls.Add(new WFLDExitThroughGateDetails
                    {
                        ExitIdHeader = Convert.ToInt32(Result["ExitIdHeader"]),
        ...
        public void GetDetailsForGateExitMail(string LineId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDEntryThroughGateMail objMail = new WFLDEntryThroughGateMail();
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Result.NextResult())
                    {
                        while (Result.Read())
                        {
                            objMail.lstExcelData.Add(new WFLDExcelData()
                            {
        ...
        public void GetDetailsForGateExitMailPIL(string LineId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDEntryThroughGateMailPIL objMail = new WFLDEntryThroughGateMailPIL();
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Result.NextResult())
                    {
                        while (Result.Read())
                        {
                            objMail.lstExcelData.Add(new WFLDExcelDataPIL()
                            {
        ...
        public void ContainerForGAtePass(int gatePassId)
        {
            ...
            IList<WFLDcontainerAgainstGp> LstcontainerAgainstGp = new List<WFLDcontainerAgainstGp>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstcontainerAgainstGp.Add(new WFLDcontainerAgainstGp
                    {
