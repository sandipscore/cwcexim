...
{
    public class VLDA_CashManagementRepository
    {
        ...
        public void GetPaymentVoucherCreateInfo()
        {
            ...
            var model = new WFLD_PaymentVoucherCreateInfoModel();
            int Status = 0;
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        model.Expenses.Add(new WFLDExpenses { HeadId = Convert.ToInt32(Result["HeadId"]), HeadCode = Result["HeadCode"].ToString(), HeadName = Result["HeadName"].ToString(), BalanceinHand = Convert.ToDecimal(Result["Amount"]) });
                    }
                }
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        model.ExpHSN.Add(new WFLDExpHSN { HSNCode = Result["HSNCode"].ToString(), ExpCode = Result["ExpCode"].ToString() });
                    }
                }
                if (Result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        model.HSN.Add(new WFLDHSN { HSNId = Convert.ToInt32(Result["HSNId"]), HSNCode = Result["HSNCode"].ToString(), GST = Convert.ToDecimal(Result["GST"]) });
                    }
                }
                if (Result.NextResult())
                {
        ...
        public void AddNewPaymentVoucher(WFLD_NewPaymentValucherModel m)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "In_InvoiceNo", MySqlDbType = MySqlDbType.VarChar, Size = 50, Value = m.InvoiceNo });
            LstParam.Add(new MySqlParameter { ParameterName = "In_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = DateTime.ParseExact(m.InvoiceDate, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture) });
            LstParam.Add(new MySqlParameter { ParameterName = "In_TAmount", MySqlDbType = MySqlDbType.Decimal, Value = m.TotalAmount });
            LstParam.Add(new MySqlParameter { ParameterName = "In_Hand", MySqlDbType = MySqlDbType.Decimal, Value = 0 });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "In_ExpDtl", MySqlDbType = MySqlDbType.Text, Value = Utility.CreateXML(JsonConvert.DeserializeObject<IList<WFLDExpensesDetails>>(m.ExpensesJson)) });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "In_Purpose", MySqlDbType = MySqlDbType.VarChar, Size = 50, Value = m.txtPurpose });
            ...
            try
            {
                ...
                else if (Result == 2)
                {
                    ...
                    _DBResponse.Message = "Total Amount Should Be More Than Amount In Hand";
                    _DBResponse.Data = null;
                }
                else
                {
        ...
        public void GetPaymentVoucherList(string SearchValue = "")
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLD_NewPaymentValucherModel> lstPaymentVou = new List<WFLD_NewPaymentValucherModel>();
            while (Result.Read())
            {

                Status = 1;
                lstPaymentVou.Add(new WFLD_NewPaymentValucherModel
                {
                    PVHeadId = Convert.ToInt32(Result["PVHeadId"] == DBNull.Value ? 0 : Result["PVHeadId"]),
                    VoucherNo = Convert.ToString(Result["VoucherNo"]),
                    PaymentDate = Convert.ToString(Result["VoucherDate"] == null ? "" : Result["VoucherDate"]),
                    TotalAmount = Convert.ToDecimal(Result["TotalAmount"] == DBNull.Value ? 0 : Result["TotalAmount"]),
                    ReceiptVoucherNo = Convert.ToString(Result["ReceiptVoucherNo"])
                });
        ...
        //    lstParam.Add(new MySqlParameter { ParameterName = "in_SearchValue", MySqlDbType = MySqlDbType.VarChar, Value = SearchValue });
        //    IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentVoucherList", CommandType.StoredProcedure, DParam);
        //    WFLD_NewPaymentValucherModel ObjPaymentVou = null;
        //    List<WFLD_NewPaymentValucherModel> lstPaymentVou = new List<WFLD_NewPaymentValucherModel>();
        //    int Status = 0;
        //    _DBResponse = new DatabaseResponse();
        //    try
        ...
        //        {
        //            Status = 1;
        //            ObjPaymentVou = new WFLD_NewPaymentValucherModel();
           ...
           // LstParam.Add(new MySqlParameter { ParameterName = "In_Uid", MySqlDbType = MySqlDbType.Int32, Value = ((Login)HttpContext.Current.Session["LoginUser"]).Uid });
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstSeal.InvoiceNo = Convert.ToString(Result["InvoiceNo"] == null ? "" : Result["InvoiceNo"]);
                    LstSeal.InvoiceDate = Convert.ToString(Result["InvoiceDate"] == null ? "" : Result["InvoiceDate"]);
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        LstSeal.expcharges.Add(new WFLDExpensesDetails
                        {
        ...
        public void GetAmountForPaymentVoucher(int HeadId, string Purpose)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_HeadId", MySqlDbType = MySqlDbType.Int32, Value = HeadId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Purpose", MySqlDbType = MySqlDbType.VarChar, Value = Purpose });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetReceiptVoucherWiseAmount", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
        ...
        public void AddMoneyToPD(int partyId, DateTime transDate, string xml, string Remarks)
        {
            string GeneratedClientId = "0";
            string RecNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAddMoneyToPDList()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstCashReceipt.Add(new WFLD_CashReceiptModel
                    {
        ...
        #region onaccount
        //public void GetOnAccountBalance(int PartyId)
        //{
        //    List<MySqlParameter> lstParam = new List<MySqlParameter>();
        //    lstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = PartyId });
        //    IDataParameter[] DParam = { };
        //    DParam = lstParam.ToArray();
        //    DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        //    IDataReader Result = DataAccess.ExecuteDataReader("GetOnAcBalanceByPartyId", CommandType.StoredProcedure, DParam);
        //    var model = new WFLD_CashReceiptModel();
        //    int Status = 0;
        //    _DBResponse = new DatabaseResponse();
        //    try
        //    {
        ...
        //        else
        //        {
        //            model.BalOnAccount = 0;
        //            _DBResponse.Status = 1;
        //            _DBResponse.Message = "NoData";                   
        //            _DBResponse.Data = model;
        //        }
        //    }
        //    catch (Exception ex)
        ...
        public void GetPartyList()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    model.PartyDetail.Add(new WFLDParty { PartyId = Convert.ToInt32(Result["PartyId"]), PartyName = Convert.ToString(Result["PartyName"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetPartyListCashreceipt(string PartyCode)
        {
            if (PartyCode == null)
                PartyCode = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllPartyCashRecptListPartycode", CommandType.StoredProcedure, DParam);
            WFLDParty WFLDPartymodel = new WFLDParty();
            List<WFLDParty> model = new List<WFLDParty>();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    model.Add(new WFLDParty { PartyId = Convert.ToInt32(Result["PartyId"]), PartyName = Convert.ToString(Result["PartyName"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetCashRcptDetails(int PartyId, string PartyName, string Type = "INVOICE")
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    model.PayByDetail.Add(new WFLDPayBy
                    {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        model.PdaAdjustdetail.Add(new WFLDPdaAdjust
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        model.CashReceiptInvoiveMappingList.Add(new WFLDCashReceiptInvoiveMapping
                        {
        ...
        // ADD Cash Receipt
        public void AddCashReceipt(WFLD_CashReceiptModel ObjCashRcpt, string xml)
        {
            string GeneratedClientId = "0";
            string ReceiptNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddNewReceiptVoucher(WFLD_ReceiptVoucherModel m)
        {
            string GeneratedClientId = "0";
            String VoucherNo = "";
            int id = 0;
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ExpenseId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(m.ExpenseId) });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddReceiptVoucher", CommandType.StoredProcedure, DParam, out GeneratedClientId, out VoucherNo);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    ...
                    var data = new { VoucherNo = VoucherNo, id = Convert.ToInt32(GeneratedClientId) };
                    //_DBResponse.Data = data;
                    _DBResponse.Status = 1;
        ...
        public void GetReceiptVoucherList()
        {
            ...
            WFLD_ReceiptVoucherModel ObjRcptVou = null;
            List<WFLD_ReceiptVoucherModel> lstRcptVou = new List<WFLD_ReceiptVoucherModel>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    ObjRcptVou = new WFLD_ReceiptVoucherModel();
        ...
        public void ReceiptVoucherPrint(int ReceiptId)
        {
            string GeneratedClientId = "0";
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("ReceiptVoucherPrint", CommandType.StoredProcedure, DParam);
            // Kol_NewPaymentValucherModel ObjPayment = null;
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstSeal.CompanyName = Convert.ToString(Result["CompanyName"] == null ? "" : Result["CompanyName"]);
                    LstSeal.CompanyAddress = Convert.ToString(Result["CompanyAddress"] == null ? "" : Result["CompanyAddress"]);
                    LstSeal.VoucherNo = Convert.ToString(Result["VoucherNo"]);
                    LstSeal.PaymentDate = Convert.ToString(Result["VoucherDate"] == null ? "" : Result["VoucherDate"]);
                    LstSeal.Purpose = Convert.ToString(Result["Purpose"] == null ? "" : Result["Purpose"]);
                    LstSeal.Amount = Convert.ToDecimal(Result["Amount"] == DBNull.Value ? 0 : Result["Amount"]);
                    LstSeal.InstrumentNo = Convert.ToString(Result["InstrumentNo"]);
                    LstSeal.InstrumentDate = Convert.ToString(Result["InstrumentDate"]);
                    LstSeal.Narration = Convert.ToString(Result["Narration"]);
                    LstSeal.ExpenseName = Convert.ToString(Result["ExpenseName"]);
                }
        ...
        public void ExpenseReceiptVoucher()
        {
            //string GeneratedClientId = "0";
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<WFLD_ExpensesDetails> LstExpense = new List<WFLD_ExpensesDetails>();
            IDataReader Result = DataAccess.ExecuteDataReader("GetExpenseHeadReceiptVoucher", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExpense.Add(new WFLD_ExpensesDetails
                    {
                        ExpId = Convert.ToInt32(Result["HeadId"]),
                        ExpenseHead = Convert.ToString(Result["HeadName"]),
                        Expensecode = Convert.ToString(Result["HeadCode"]),
        ...
        public void AddCreditNote(WFLDCreditNote objCR, string XML, string CRDR)
        {
            string ReturnObj = "";
            string Id = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objCR.PayeeName = Result["PayeeName"].ToString();
        ...
        public void GetInvoiceDetailsForDeditNote(int InvoiceId)
        {
            ...
            WFLDInvoiceDetails objInv = new WFLDInvoiceDetails();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        public void GetChargesListForCrDb(int InvoiceId)
        {
            ...
            List<WFLDChargeNameCrDb> objChrgs = new List<WFLDChargeNameCrDb>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    objChrgs.Add(new WFLDChargeNameCrDb
                    {
        ...
        public void GetPaymentPartyBncCheque()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<WFLD_PaymentPartyName> objPaymentPartyName = new List<WFLD_PaymentPartyName>();
            WFLDBounceChk modal = new WFLDBounceChk();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    if (Result.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            objPaymentPartyName.Add(new WFLD_PaymentPartyName()
                            {
                ...
                WFLD_PaymentPartyNameGroup gm = new Areas.CashManagement.Models.WFLD_PaymentPartyNameGroup();
        ...
        public void AddEditCashCollectionChq(WFLD_CashColAgnBncChq objCC)
        {
            string Status = "0";
            ...
            _DBResponse = new DatabaseResponse();
            WFLD_cashBncChqInvoice invobj = new WFLD_cashBncChqInvoice();
            try
            {
                if (Result == 1)
                {
        ...
        public void RefundFromPDA(WFLDAddMoneyToPDModelRefund m, int Uid)
        {

            string BankBranch = m.Bank + '#' + m.Branch;
            string iscloser = string.Empty;
            string GeneratedClientId = "0";
            string RecNo = "0";
            if (m.IsCloser == true)
                iscloser = "Y";
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "In_IsCloser", MySqlDbType = MySqlDbType.VarChar, Value = iscloser });
            LstParam.Add(new MySqlParameter { ParameterName = "In_CloserDate", MySqlDbType = MySqlDbType.VarChar, Value = m.CloserDate });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "ReturnObj", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = "0" });
            IDataParameter[] DParam = { };
            ...
            try
            {
                ...
                {
                    _DBResponse.Status = 2;
                    _DBResponse.Message = "Closure Date Should be Greater than Invoice Date ";
                    _DBResponse.Data = RecNo;
                }
                else
                {
        ...
        public void GetPartyDetailsRefund()
        {
            ...
            IList<WFLDRefundMoneyFromPD> model = new List<WFLDRefundMoneyFromPD>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    model.Add(new WFLDRefundMoneyFromPD
                    {
                        Id = Convert.ToInt32(Result["Id"]),
        ...
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_SdcloserId", MySqlDbType = MySqlDbType.Int32, Value = SDAcId });
            ...
            try
            {
                ...
                {
                    Status = 1;
                    ObjSD.PDAACId = Convert.ToInt32(result["SdCloserId"]);
                    ...
                    ObjSD.ISClosure = Convert.ToString(result["isSDClosed"]);
        ...
        public void GETSDBalance(string PartyId)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = PartyId });
            IDataParameter[] Dparam = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("GetSdBal", CommandType.StoredProcedure, Dparam);
            //ViewSDRefund ObjSD = new ViewSDRefund();
            WFLDRefundMoneyFromPD ObjSD = new WFLDRefundMoneyFromPD();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    ObjSD.Balance = (Convert.ToDecimal(result["Balance"]));
                }
        ...
        public void GetSDRefundList()
        {
            ...
            List<WFLDSDRefundList> SdList = new List<WFLDSDRefundList>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    SdList.Add(new WFLDSDRefundList
                    {
                        SDCloserId = Convert.ToInt32(Result["SdCloserId"]),
                        PartyId = Convert.ToInt32(Result["PartyId"]),
        ...
        public void AddMiscInv(WFLDMiscPostModel ObjPostPaymentSheet, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
        ...
        public void GetPaymentPartyMisc(int ptype)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<WFLDPaymentPartyName> objPaymentPartyName = new List<WFLDPaymentPartyName>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new WFLDPaymentPartyName()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
        ...
        public void ListOfMiscInvoice(string Module, string InvoiceNo = null, string InvoiceDate = null, int Page = 0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            _DBResponse = new DatabaseResponse();
            IList<WFLDListOfMiscInvoice> lstExpInvoice = new List<WFLDListOfMiscInvoice>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstExpInvoice.Add(new WFLDListOfMiscInvoice()
                    {
                        InvoiceId = Convert.ToInt32(Result["InvoiceId"]),
                        InvoiceNo = Convert.ToString(Result["InvoiceNo"]),
                        InvoiceDate = Convert.ToString(Result["InvoiceDate"]),
        ...
        public void ListLoadMoreMiscInvoice(string Module, string InvoiceNo = null, string InvoiceDate = null, int Page = 0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetYardInvoiceDetailsForEdit(int InvoiceId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            decimal hours = 0;
            WFLDInvoiceYard objPostPaymentSheet = new WFLDInvoiceYard();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objPostPaymentSheet.lstPostPaymentChrg.Add(new WFLDPostPaymentChrg()
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentCont.Add(new WFLDPostPaymentContainer()
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToString(Result["Size"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstContWiseAmount.Add(new WFLDContainerWiseAmount()
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstOperationCFSCodeWiseAmount.Add(new WFLDOperationCFSCodeWiseAmount
                        {
        ...
        public void GetDeliInvoiceDetailsForEdit(int InvoiceId)
        {
            ...
            WFLDInvoiceGodown objPostPaymentSheet = new WFLDInvoiceGodown();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstInvoiceCargo.Add(new WFLDInvoiceCargo
                        {
        ...
        public void GetFumigation(string FumigationChargeType, string InvoiceType, int PartyId, string size, string LineXML)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLD_FumigationInvoice ObjEntryThroughGate = new WFLD_FumigationInvoice();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditFumigationInv(WFLD_FumigationInvoice ObjPostPaymentSheet, String ChemicalData, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
        ...
        public void GetPaymentParty()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<WFLD_RentParty> objPaymentPartyName = new List<WFLD_RentParty>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new WFLD_RentParty()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
                        Address = Convert.ToString(Result["Address"]),
        ...
        public void AddEditRentInv(WFLD_RentInvoice ObjPostPaymentSheet, String RentData, String ChargeData, int BranchId, int Uid, string month, int year, string Module)
        {
            string GeneratedClientId = "0";
        ...
        public void GetRentDet(string Mon, int Yr, int flg, int PartyCode)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            WFLD_RentInvoice objInvoice = new WFLD_RentInvoice();
            ...
            try
            {
                ...
                while (Result.Read())
                {
                    objInvoice.lstPrePaymentCont.Add(new WFLDRentDetails
                    {
                        ...
                        SEZ = Convert.ToString(Result["SupplyType"])
        ...
        public void CreateReservationInvoices(string month, int year, int pid, int mode)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddEditInvoiceReservation(string dtlsXml, string type, int BranchId, int userid, string month, string year)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddEditInvoiceReservationIndividual(WFLD_ReservationIndividual obj, string dtlsXml, int BranchId, int userid, string module)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetReservationInvoicesList()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            _DBResponse = new DatabaseResponse();
            IList<WFLD_ReservationDetails> objPaymentPartyName = new List<WFLD_ReservationDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new WFLD_ReservationDetails()
                    {
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyName = Convert.ToString(Result["PartyName"]),
                        GstNo = Convert.ToString(Result["GSTNo"]),
        ...
        public void GetMstBank()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<WFLD_Bank> objBankList = new List<WFLD_Bank>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objBankList.Add(new WFLD_Bank()
                    {
        ...
        public void GetCargoShiftingDetailsInv(int CargoShiftingId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Areas.Export.Models.WFLDInvoiceCargoShifting objPostPaymentSheet = new Areas.Export.Models.WFLDInvoiceCargoShifting();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstShippingDet.Add(new Areas.Export.Models.WFLDCargoShiftingShipBillDetails
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentChrg.Add(new Areas.Export.Models.WFLDPostPaymentChrgShifting()
                        {
                            ChargeId = objPostPaymentSheet.lstPostPaymentChrg.Count + 1,
                            Clause = Convert.ToString(Result["Clause"]),
                            ChargeType = Convert.ToString(Result["ChargeType"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstOperationCFSCodeWiseAmount.Add(new Areas.Export.Models.WFLDOperationCFSCodeWiseAmountCS
                        {
                            CFSCode = Result["CFSCode"].ToString(),
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = Result["Size"].ToString(),
        ...
        public void GetContainerList(string containerno, int Page = 0)
        {
            int Status = 0;
            // DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            // int Status = 0;
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetContForDebitInv", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<WFLD_Container> LstStuffing = new List<WFLD_Container>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new WFLD_Container
                    {
                        ...
                        ContType = Result["ContType"].ToString(),
        ...
        public void ListOfChargesName()
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("MiscChargesForInv", CommandType.StoredProcedure);
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    {
                        OperationCode = Result["SacCode"].ToString(),
                        ChargeName = Result["ChargeName"].ToString()
        ...
        public void GetAmountForCharges(String cname, String size, string Fromdt, string todt, string CFSCode, string ContainerNo, string DelDate, String Optype, String ConType)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_DeliveryDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(DelDate).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Optype", MySqlDbType = MySqlDbType.VarChar, Value = Optype });

            LstParam.Add(new MySqlParameter { ParameterName = "in_ConType", MySqlDbType = MySqlDbType.VarChar, Value = ConType });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetChargesAmountforDebitInvoice", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            Decimal Amount = 0;
            try
            {
        ...
        public void GetDebitInvoice(string InvoiceType, int PartyId, decimal TotalChrgAmount, string Charges, string SEZ)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLD_DebitInvoice ObjEntryThroughGate = new WFLD_DebitInvoice();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditDebitInvoice(WFLD_DebitInvoice ObjPostPaymentSheet, String ChemicalData, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
            string dt = Convert.ToDateTime(ObjPostPaymentSheet.DeliveryDate).ToString("yyyy-MM-dd hh:mm");
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetPartyList(string PartyCode, int Page = 0)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLD_ContainerModel LstEximTrader = new WFLD_ContainerModel();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstEximTrader.lstExim.Add(new WFLD_PartyDet
                    {
        ...
        public void GetContainerMovementInvoiceDetailsForEdit(int InvoiceId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            //PpgInvoiceYard objPostPaymentSheet = new PpgInvoiceYard();
            Areas.Export.Models.WFLD_MovementInvoice objPostPaymentSheet = new Areas.Export.Models.WFLD_MovementInvoice();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentChrg.Add(new Areas.Export.Models.WFLDPostPaymentChrg()
                        {
                            ChargeId = objPostPaymentSheet.lstPostPaymentChrg.Count + 1,
                            Clause = Convert.ToString(Result["Clause"]),
                            ChargeType = Convert.ToString(Result["ChargeType"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstPostPaymentCont.Add(new Areas.Export.Models.WFLDPostPaymentContainer
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                            ContainerNo = Convert.ToString(Result["ContainerNo"]),
                            Size = Convert.ToString(Result["Size"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstContWiseAmount.Add(new Areas.Export.Models.WFLDContainerWiseAmount
                        {
                            CFSCode = Convert.ToString(Result["CFSCode"]),
                            EntryFee = Convert.ToDecimal(Result["EntryFee"]),
                            CstmRevenue = Convert.ToDecimal(Result["CstmRevenue"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objPostPaymentSheet.lstOperationCFSCodeWiseAmount.Add(new Areas.Export.Models.WFLDOperationCFSCodeWiseAmount
                        {
                            CFSCode = Result["CFSCode"].ToString(),
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = Result["Size"].ToString(),
        ...
        public void EditContainerMovementInvoice(Areas.Export.Models.WFLD_MovementInvoice ObjPostPaymentSheet,
        ...
        // ADD Cash Receipt
        public void AddCashReceiptSD(WFLD_CashReceiptModel ObjCashRcpt, string xml)
        {
            string GeneratedClientId = "0";
            string ReceiptNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        #region BankDeposit
        public void AddEditBankDeposit(WFLDBankDeposit Obj, string varXml, int Uid = 0)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ReceivedDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(Obj.ReceivedDate) });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = Uid });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = 0 });

            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DA.ExecuteNonQuery("AddEditBankDeposit", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                ...
                {
                    _DBResponse.Data = "Online payment already saved for this deposit date";
                    _DBResponse.Status = 3;
                    _DBResponse.Message = "Online payment already saved for this deposit date";
                }
                else
                {
                    _DBResponse.Data = null;
        ...
        public void GetBankDepositList()
        {
            ...
            List<WFLDBankDeposit> lstBankDeposit = new List<WFLDBankDeposit>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstBankDeposit.Add(new WFLDBankDeposit
                    {


                        Idd = Convert.ToInt32(Result["Id"]),
                        Id = Convert.ToInt32(Result["Idd"]),
        ...
        public void GetBankDepositListById(int id)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            lstParam.Add(new MySqlParameter { ParameterName = "in_Id", MySqlDbType = MySqlDbType.Int32, Value = id });
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBankDepositList", CommandType.StoredProcedure, DParam);
            WFLDBankDeposit lstBankDeposit = new WFLDBankDeposit();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    lstBankDeposit.Idd = Convert.ToInt32(Result["Id"]);
                    lstBankDeposit.Id = Convert.ToInt32(Result["Id"]);
                    lstBankDeposit.DepositDate = Result["DepositDate"].ToString();
                    lstBankDeposit.ReceivedDate = Result["ReceivedDate"].ToString();
                    ...
                    lstBankDeposit.Draft = Convert.ToDecimal(Result["Draft"]);
                    lstBankDeposit.DepSlipNo = Result["DepSlipNo"].ToString();
                    lstBankDeposit.BankId = Convert.ToInt32(Result["BankId"]);
                    //lstBankDeposit.AccountNo = Result["AccountNo"].ToString(); 
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        lstBankDeposit.ExpensesDetails.Add(new WFLDExpenses
                        {
                            HeadId = Convert.ToInt32(Result["ExpenseHeadId"]),
                            RefundAmount = Convert.ToInt32(Result["ReturnAmount"]),
                            HeadName = Convert.ToString(Result["ExpenseHead"]),
                            ReceiptId = Convert.ToInt32(Result["ReceiptId"]),
                            VoucherNo = Convert.ToString(Result["VoucherNo"]),
        ...
        public void GetBankAccount()
        {
            ...
            List<WFLDBankDetails> lstBankAccount = new List<WFLDBankDetails>();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    //WFLDBankDetails item = new WFLDBankDetails();
                    // item.BankId = Convert.ToInt32(Result["BankId"]);
                    // item.AccountNo = Result["AccountNo"].ToString();
                    // lstBankAccount.Add(item);
                    ...
                    lstBankAccount.Add(new WFLDBankDetails
                    {
                        BankId = Convert.ToInt32(Result["BankId"]),
        ...
        public void GetNEFTForBankDeposit(DateTime dt)
        {
            ...
            WFLDBankDeposit obj = new WFLDBankDeposit();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        #region Temporary Advance Closure
        public void GetAmount(string TransactionDate)
        {
            ...
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            LstParam.Add(new MySqlParameter { ParameterName = "In_TranDateTime", MySqlDbType = MySqlDbType.Date, Value = TransactionDate });
            IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAmountInHand", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            //TemporaryAdvClosour objPaymentPartyName = new TemporaryAdvClosour();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetAmountOfTemporary(string TransactionDate)
        {
            ...
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            LstParam.Add(new MySqlParameter { ParameterName = "In_TranDateTime", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(TransactionDate).ToString("yyyy-MM-dd") });

            IDataParameter[] DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAmountOfTemporary", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            //TemporaryAdvClosour objPaymentPartyName = new TemporaryAdvClosour();
            try
            {
        ...
        public void SaveTemporaryAdvance(TemporaryAdvClosour obj)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();

            LstParam.Add(new MySqlParameter { ParameterName = "in_Date", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(obj.Date).ToString("yyyy-MM-dd HH:mm:ss") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Amount", MySqlDbType = MySqlDbType.Decimal, Value = obj.Amount });
            LstParam.Add(new MySqlParameter { ParameterName = "in_AmountTrans", MySqlDbType = MySqlDbType.Decimal, Value = obj.AmountTrans });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = ((Login)System.Web.HttpContext.Current.Session["LoginUser"]).Uid });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });

            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DA.ExecuteNonQuery("SaveTemporaryAdvanceClosure", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                ...
                else if (Result == 2)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Status = 0;
                    _DBResponse.Message = "Transfer Amount cannot greater than  Amount in Hand.";
                }
                else
                {
                    _DBResponse.Data = null;
        ...
        public void OAGetEximTrader(string PartyCode, int Page = 0)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_PartyCode", MySqlDbType = MySqlDbType.VarChar, Size = 20, Value = PartyCode });
            lstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] Dparam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstEximTraderForMstOnAcAddMoney", CommandType.StoredProcedure, Dparam);
            WFLDOASearchEximTraderData objSD = new WFLDOASearchEximTraderData();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objSD.lstExim.Add(new WFLDOAListOfEximTrader
                    {
                        EximTraderId = Convert.ToInt32(Result["EximTraderId"]),
        ...
        public void AddOAAddMoney(WFLDOAAddMoney ObjSD, string xml)
        {
            string ReturnObj = "";
            string Param = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllOAAddMoneyList(string ReceiptNo = "", int Page = 0)
        {
            ...
            List<WFLDOAAddMoney> lstAddMoneyToOA = new List<WFLDOAAddMoney>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstAddMoneyToOA.Add(new WFLDOAAddMoney
                    {
        ...
        //        {
        //            Status = 1;
        //            ObjAddMoneyToOA = new WFLDOAAddMoney();
        ...
        #region Adjust Through On Account

        public void GetOnAccountPartyList()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            // lstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] Dparam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetOnAccountPartyListAdjustInvoice", CommandType.StoredProcedure);
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstWFLDOAListOfEximTrader.Add(new WFLDOAListOfEximTrader
                    {
                ...
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = lstWFLDOAListOfEximTrader;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void GetOnAccountCashRcptDetails(int PartyId, string PartyName, string Type = "INVOICE")
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = PartyId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_Type", MySqlDbType = MySqlDbType.VarChar, Value = Type });
            ...
            DParam = lstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetCshDtlsAgnstOnAccountParty", CommandType.StoredProcedure, DParam);

            var model = new WFLD_PaymentAdjustThroughOnAccount();
            model.PartyId = PartyId;
            model.PartyName = PartyName;
            model.PayBy = PartyName;
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    ...
                    {
                        model.BalOnAccount = Convert.ToDecimal(Result["ClosingOAAmount"]);
                        model.RemainingOnAccountBal = Convert.ToDecimal(Result["ClosingOAAmount"]);
                    }
                }
        ...
        public void AddEditInvoiceAdjustThroughOnAccount(WFLD_PaymentAdjustThroughOnAccount ObjCashRcpt)
        {
            string GeneratedClientId = "0";
            string ReceiptNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "ReturnObj", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = "0" });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CashReceiptInvoiveMappingListSubmit", MySqlDbType = MySqlDbType.VarChar, Value = ObjCashRcpt.CashReceiptInvoiveMappingListSubmit });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddEditInvoiceAdjustThroughOnAcc", CommandType.StoredProcedure, DParam, out GeneratedClientId, out ReceiptNo);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    var data = new { ReceiptNo = ReceiptNo, CashReceiptId = Convert.ToInt32(GeneratedClientId) };
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Invoice Adjust Through On Account Successfully.";
                    _DBResponse.Data = data;
                }
                else if (Result == 2)
                {
        ...
        public void GetOnAccountReceiptList()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            // lstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] Dparam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetOnAccountList", CommandType.StoredProcedure);
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstONAccountReceipt.Add(new WFLD_PaymentAdjustThroughOnAccount
                    {
                        InvoiceNo = Convert.ToString(Result["InvoiceNo"]),
                        InvoiceValue = Convert.ToDecimal(Result["AdjustmentValue"]),
                        PartyName = Convert.ToString(Result["EximTraderName"]),
                        ReceiptNo = Convert.ToString(Result["OnAccReceiptNo"]),
                        ReceiptDate = Convert.ToString(Result["OnAccReceiptDate"]),
                        PayByTraderId = Convert.ToInt32(Result["OnAccId"]),
                    });
                }
                ...
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = lstONAccountReceipt;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void GetGodownListforReservation(String SpaceType)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLD_Godown> LstStuffing = new List<WFLD_Godown>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new WFLD_Godown
                    {
        ...
        public void AddEditReservationInvoice(PPG_DebitInvoice ObjPostPaymentSheet, String ChemicalData, int BranchId, int Uid, string Module)
        {
            string GeneratedClientId = "0";
            string dt = Convert.ToDateTime(ObjPostPaymentSheet.DeliveryDate).ToString("yyyy-MM-dd hh:mm");
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        #region SD Withdrawal



        public void WithdrawalFromPDA(HDB_AddMoneyToPDModelRefund m, int Uid, string XML)
        {
        ...
        public void GetPartyDetailsWithdrawal()
        {
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPDPartyDetailsForRefund");
        ...
        public void ViewSDWithdrawal(int SDAcId)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetSDWithdrawalList()
        {
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("SDRefundList");
        ...
        public void AddDirectPaymentVoucher(WFLD_DirectOnlinePayment objDOP, int uid)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetOnlinePayAckList(int uid, long OrderId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objDOP = new WFLD_DirectOnlinePayment();
        ...
        public void AddEditOnlinePaymentAgainstInvoice(WFLD_OnlinePaymentAgainstInvoice objDOP, int uid, string XML)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_OnlinePayAckId", MySqlDbType = MySqlDbType.Int32, Value = objDOP.OnlinePayAckId });
        ...
        public void GetOnlinePaymentAgainstInvoice(string SearchValue = "", int Pages = 0)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLD_OnlinePaymentAgainstInvoice> lstCashReceipt = new List<WFLD_OnlinePaymentAgainstInvoice>();
            int Status = 0;
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstCashReceipt.Add(new WFLD_OnlinePaymentAgainstInvoice
                    {
        ...
        public void AcknowledgementViewList(string FromDate, string ToDate, int Uid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLD_AcknowledgementViewList> lstReceipt = new List<WFLD_AcknowledgementViewList>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    lstReceipt.Add(new WFLD_AcknowledgementViewList
                    {
                        // PeriodFrom=Convert.ToString(Result["FromDate"])
