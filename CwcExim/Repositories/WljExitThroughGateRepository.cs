...
{
    public class WljExitThroughGateRepository
    {
        ...
        public void AddEditExitThroughGate(WljExitThroughGateHeader ObjExitThroughGateHeader, int Uid, String SCMTRXML)
        {
        ...
        public void GetContainer()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objExitThroughGateHeader.containerList.Add(new WljcontainerExit
                    {
        ...
        public void GetGatePassLst()
        {
           ...
           // LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstGatePass.Add(new WljGatePassList
                    {
        ...
        public void AddGateEXitToDetails(WljExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
            ObjExitThroughGateHeader.Uid = Uid;
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllExitThroughGate()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WljExitThroughGateHeader> LstExitThroughGate = new List<WljExitThroughGateHeader>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new WljExitThroughGateHeader
                    {
        ...
        public void GetExitThroughGateDetails()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WljExitThroughGateDetails> LstExitThroughGateDtls = new List<WljExitThroughGateDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGateDtls.Add(new WljExitThroughGateDetails
                    {                    
                        ExitIdHeader = Convert.ToInt32(Result["ExitIdHeader"]),
        ...
        public void UpdateGatePassValidity(WljRevalidateGatePass objRevalidateGatePass)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
