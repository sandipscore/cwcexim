...
{ 
    public class Dnd_EntryThroughGateRepository
    {
        ...
        public void AddEditEntryThroughGateCBT(DndEntryThroughGate ObjEntryThroughGate,string XML,string ContClass)
        {
         ...
         */
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = (ObjEntryThroughGate.ContainerNo == null ? "" : ObjEntryThroughGate.ContainerNo.ToUpper()) });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo1", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = (ObjEntryThroughGate.ContainerNo1 == null ? "" : ObjEntryThroughGate.ContainerNo1.ToUpper()) });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_CustomSealNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.CustomSealNo == null ? "" : ObjEntryThroughGate.CustomSealNo.ToUpper() });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ShippingLineSealNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.ShippingLineSealNo == null ? "" : ObjEntryThroughGate.ShippingLineSealNo.ToUpper() });
            LstParam.Add(new MySqlParameter { ParameterName = "in_VehicleNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.ContainerNo1 == null ? "" : ObjEntryThroughGate.ContainerNo1.ToUpper() });
            ...
            //LstParam.Add(new MySqlParameter { ParameterName = "in_ActualGrossWeight", MySqlDbType = MySqlDbType.Decimal, Value = Convert.ToDecimal(ObjEntryThroughGate.ActualGrossWeight) });
        ...
        public void AddEditEntryThroughGate(DndEntryThroughGate ObjEntryThroughGate,string ContClass="")
        {
            //if(ObjEntryThroughGate.EntryDateTime != null && ObjEntryThroughGate.EntryDateTime != "")
            //{ }
            //if (ObjEntryThroughGate.ReferenceDate != null && ObjEntryThroughGate.ReferenceDate != "")
            ...
            */
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Size", MySqlDbType = MySqlDbType.VarChar, Size = 4, Value = ObjEntryThroughGate.Size });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Reefer", MySqlDbType = MySqlDbType.Bit, Value = ObjEntryThroughGate.Reefer });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CustomSealNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.CustomSealNo==null?null: ObjEntryThroughGate.CustomSealNo.ToUpper() });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ShippingLineSealNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.ShippingLineSealNo==null?null : ObjEntryThroughGate.ShippingLineSealNo.ToUpper() });
            LstParam.Add(new MySqlParameter { ParameterName = "in_VehicleNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.VehicleNo.ToUpper() });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ChallanNo", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = ObjEntryThroughGate.ChallanNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CargoDescription", MySqlDbType = MySqlDbType.VarChar, Size = 1000, Value = ObjEntryThroughGate.CargoDescription });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CargoType", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjEntryThroughGate.CargoType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_NoOfPackages", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.NoOfPackages });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_CBT", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.IsCBT ? 1 : 0 });//in_OperationType
            LstParam.Add(new MySqlParameter { ParameterName = "in_ODC", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.IsOdc ? 1 : 0 });//in_OperationType
            LstParam.Add(new MySqlParameter { ParameterName = "in_TPNo", MySqlDbType = MySqlDbType.VarChar, Size = 45, Value = ObjEntryThroughGate.TPNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContClass", MySqlDbType = MySqlDbType.VarChar, Size = 45, Value =ContClass });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ExportType", MySqlDbType = MySqlDbType.VarChar, Size = 45, Value = ObjEntryThroughGate.ExportType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_IsScan", MySqlDbType = MySqlDbType.Int32, Value = ObjEntryThroughGate.IsScan? 1:0 });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output });
            LstParam.Add(new MySqlParameter { ParameterName = "ReturnObj", MySqlDbType = MySqlDbType.VarChar, Size = 100, Direction = ParameterDirection.Output });
        ...
        public void AddEditContainerBackEntryThroughGate(DndEntryThroughGate ObjEntryThroughGate, string ContClass = "")
        {
            //if(ObjEntryThroughGate.EntryDateTime != null && ObjEntryThroughGate.EntryDateTime != "")
            //{ }
            //if (ObjEntryThroughGate.ReferenceDate != null && ObjEntryThroughGate.ReferenceDate != "")
            ...
            */
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddEditConatinerBackEntryThroughGate", CommandType.StoredProcedure, DParam, out GeneratedClientId, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1 || Result == 2)
        ...
        public void GetVehicleTime()
        {
            ...
            //DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetVehicleDateTime", CommandType.StoredProcedure, null);
            _DBResponse = new DatabaseResponse();
            DndEntryThroughGate objEntryThroughGate = new DndEntryThroughGate();
            try
            {
        ...
        public void GetAutoPopulateData(string ContainerNumber)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.IsScan = Convert.ToBoolean(Result["IsScanning"]);
                    if (Convert.ToInt32(HttpContext.Current.Session["BranchId"]) == 1)
                    {
                        ObjEntryThroughGate.CustomSealNo = Convert.ToString(Result["SealNo"]);
                    }
                    else if (Convert.ToInt32(HttpContext.Current.Session["BranchId"]) == 8)
                    {
                        ObjEntryThroughGate.CustomSealNo = Convert.ToString(Result["SealNo"]);
        ...
        public void GetLoadedContData(int LoadContainerRefId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Dnd_LoadedContainerListWithData> lstLoadedContainerListWithData = new List<Dnd_LoadedContainerListWithData>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstLoadedContainerListWithData.Add(new Dnd_LoadedContainerListWithData
                    {
                        ...
                        ShippingSealNo = Result["ShippingSealNo"].ToString(),
                        TareWt = Convert.ToDecimal(Result["TareWt"]),
                        ContClass=Convert.ToString(Result["ContClass"])
        ...
        public void GetAllEntryThroughGate()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstEntryThroughGate.Add(new DndEntryThroughGate
                    {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstEntryThroughGate.Add(new DndEntryThroughGate
                    {
                        ...
                        InvoiceId = Convert.ToInt32(Result["InvoiceId"]),
                        InvoiceNo = Result["InvoiceNo"].ToString(),
                        NoOfPackages = Convert.ToInt32(Result["ActualPackages"]),
                        Size = Result["Size"].ToString(),
                    });
                }
                if (Status == 1)
        ...
        public void GetAllEntryThroughGateListPageForBond(int Page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_EntryId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
           // LstParam.Add(new MySqlParameter { ParameterName = "tmode", MySqlDbType = MySqlDbType.Int32, Value = 2 });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateListPageForBond", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<DndEntryThroughGate> LstEntryThroughGate = new List<DndEntryThroughGate>();
            try
            {
        ...
        public void GetReferenceNumber()
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjReferenceNumber.ReferenceList.Add(new Dnd_CCINList
                    {
        ...
        public void GetEntryThroughGate(int EntryId)
        {
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ViewEditEntryThroughGateImport", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            DndEntryThroughGate ObjEntryThroughGate = new DndEntryThroughGate();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.GrossWeight = Convert.ToDecimal(Result["GrossWeight"].ToString());
                    //ObjEntryThroughGate.ActualGrossWeight = Convert.ToDecimal(Result["ActualGrossWeight"].ToString());
                    ...
                    ObjEntryThroughGate.IsScan = Convert.ToInt32(Result["Scanning"]) == 1 ? true : false; ;
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjEntryThroughGate.listAddRef.Add(new Dnd_AddMoreRefForCCIN
                        {
        ...
        public void GetDetForExportAddVehicle(int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Dnd_AddExportVehicle ObjEntryThroughGate = new Dnd_AddExportVehicle();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditEntryThroughGateBond(Dnd_EntryThroughGateBond ObjEntryThroughGate)
        {
            DateTime? ReferenceDt = null;
            var Entrydt = (dynamic)null;
            var SysDateTime = (dynamic)null;
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo1", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = (ObjEntryThroughGate.ContainerNo == null ? "" : ObjEntryThroughGate.ContainerNo.ToUpper()) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Size", MySqlDbType = MySqlDbType.VarChar, Size = 4, Value = ObjEntryThroughGate.Size });
        ...
        public void GetVehicleDtlbyEntryId(int EntryId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstVehicle.Add(new Dnd_AddExportVehicle
                    {
                        EntryId = Convert.ToInt32(Result["EntryId"]),
                        ...
                        VehicleEntryDt = Result["EntryDate"].ToString(),
                        VehicleEntryTime = Result["EntryTime"].ToString()
                    });
                }
                if (Status == 1)
                {
        ...
        public void GetContainerByBackToTown()
        {
            int Status = 0;
             DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetContainerForBackToTown", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            List<ContainerBackToTown> LstContainer = new List<ContainerBackToTown>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstContainer.Add(new ContainerBackToTown
                    {
                        ID = Convert.ToInt32(Result["ID"]),
                        ContainerNo = Result["ContainerNo"].ToString(),
                        OpCode= Result["Opcode"].ToString()
        ...
        public void GetCFSByBackToTown(String OpType,int ID)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_OpCode", MySqlDbType = MySqlDbType.VarChar, Value = OpType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ID", MySqlDbType = MySqlDbType.Int32, Value = ID });

            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetCfsCodeForBackToTown", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<ContainerBackToTown> LstCFSCode = new List<ContainerBackToTown>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstCFSCode.Add(new ContainerBackToTown
                    {
                        CFSCode = Result["CFSCode"].ToString()
        ...
        public void GetRefNoByBackToTown(String OpType, String CFSCode)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_OpCode", MySqlDbType = MySqlDbType.VarChar, Value = OpType });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetRefForBackToTown", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<RefNoBackToTown> LstRefNo = new List<RefNoBackToTown>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstRefNo.Add(new RefNoBackToTown
                    {
                        ID = Convert.ToInt32(Result["ID"]),
        ...
        public void GetRefNoDetByBackToTown(String OpType, int Id)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ID", MySqlDbType = MySqlDbType.Int32, Value = Id });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetRefDetForBackToTown", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            Dnd_CCINList RefNo = new Dnd_CCINList();
            try
            {
                if (Result.Read())
                {
                    Status = 1;
                    RefNo.ShippingLineId = Convert.ToInt32(Result["ShippingLineId"]);
                    RefNo.CHAId = Convert.ToInt32(Result["CHAID"]);
                    RefNo.NoOfUnits = Result["Package"].ToString();
                    RefNo.Weight = Result["Weight"].ToString();
        ...
        public void GetPrintSealCutting(int EntryId, string OperationType, string ContainerType, string StuffType)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Dnd_GateEntrySealCutting> LstEntryThroughGate = new List<Dnd_GateEntrySealCutting>();
            try
            {
                while (Result.Read())
                {
                    ...
                    {
                        LstEntryThroughGate.Add(new Dnd_GateEntrySealCutting
                        {
        ...
        public void SearchGateEntry(string ContainerNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("SearchGateEntry", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<DndEntryThroughGate> LstEntryThroughGate = new List<DndEntryThroughGate>();
            try
            {
        ...
        public void SearchCBTGateEntry(string ContainerNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo", MySqlDbType = MySqlDbType.VarChar, Value = ContainerNo });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("SearchCBTGateEntry", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<DndEntryThroughGate> LstEntryThroughGate = new List<DndEntryThroughGate>();
            try
            {
        ...
        //public void GetContainerBySpecialOperation()
        //{
        //    int Status = 0;
        //    List<MySqlParameter> LstParam = new List<MySqlParameter>();
        //    LstParam.Add(new MySqlParameter { ParameterName = "in_", MySqlDbType = MySqlDbType.VarChar, Value = CFSCode });
        //    DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        //    IDataReader Result = DataAccess.ExecuteDataReader("GetContainerForSpecialOperation", CommandType.StoredProcedure);
        //    _DBResponse = new DatabaseResponse();
        //    List<SpecialOperationGateEntry> LstContainer = new List<SpecialOperationGateEntry>();
        //    try
        //    {
        //        while (Result.Read())
        //        {
        //            Status = 1;
        //            LstContainer.Add(new SpecialOperationGateEntry
        //            {
        ...
        //    }
        //}
        public void GetRefNoForSpecialOperation()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetRefForSpecialOperation", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstContainer.Add(new RefNoSpecialOperation
                    {
                        ID = Convert.ToInt32(Result["ID"]),
                        RefNo = Result["RefNo"].ToString(),
                        CFSCode= Result["CFSCode"].ToString(),
        ...
        public void AddEditContainerSpecialEntryThroughGate(DndEntryThroughGate ObjEntryThroughGate, string ContClass = "")
        {
            //if(ObjEntryThroughGate.EntryDateTime != null && ObjEntryThroughGate.EntryDateTime != "")
            //{ }
            //if (ObjEntryThroughGate.ReferenceDate != null && ObjEntryThroughGate.ReferenceDate != "")
            ...
            */
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddEditContSpecEntryThroughGate", CommandType.StoredProcedure, DParam, out GeneratedClientId, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1 || Result == 2)
        ...
        public void GetRefNoDetBySpecialOperation(string CFSCode)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_CFSCode", MySqlDbType = MySqlDbType.VarChar, Value = CFSCode });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetRefNoDetBySpecialOperation", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            DndEntryThroughGate RefNo = new DndEntryThroughGate();
            try
            {
                if (Result.Read())
                {
                    ...
                    RefNo.ShippingLineId = Convert.ToInt32(Result["ShippingLineId"]);
                    RefNo.ShippingLine = (Result["ShippingLine"]).ToString();
                    RefNo.CHAName = (Result["CHAName"]).ToString();
                    RefNo.ContainerLoadType = Result["ContainerLoadType"].ToString();
                    RefNo.ContainerNo1 = Result["ContainerClass"].ToString();
                    RefNo.CustomSealNo = (Result["CustomSealNo"]).ToString();
                    RefNo.ShippingLineSealNo = Result["ShippingLineSealNo"].ToString();
                    RefNo.ContainerNo1 = Result["ContainerClass"].ToString();
                    RefNo.VehicleNo = (Result["VehicleNo"]).ToString();
                    RefNo.CargoDescription = Result["CargoDescription"].ToString();
                    RefNo.Cargo = Result["Cargotype"].ToString();
                    RefNo.Size = Result["Size"].ToString();
                    RefNo.NoOfPackages = Convert.ToInt32(Result["NoOfPackages"]);
                    RefNo.GrossWeight = Convert.ToDecimal(Result["GrossWeight"]);
                    RefNo.ReferenceDate = Result["ReferenceDate"].ToString();
                    RefNo.IsOdc = Convert.ToBoolean(Result["ODC"]);
                    RefNo.ExportType = Result["ExportType"].ToString();
                    // RefNo.ContainerNo = Result["ContainerNo"].ToString();
                    // RefNo.CFSCode = Result["CFSCode"].ToString();
        ...
        public void GetSpecialEntryThroughGateListPage(int Page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = Page });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetSpecialEntryThroughGateListPage", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<DndEntryThroughGate> LstEntryThroughGate = new List<DndEntryThroughGate>();
            try
            {
        ...
        public void GetEntryThroughGateSpecialOperation(int EntryId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_EntryId", MySqlDbType = MySqlDbType.Int32, Value = EntryId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ViewEditEntryThroughGateSpecial", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            DndEntryThroughGate ObjEntryThroughGate = new DndEntryThroughGate();
            string ContainerClass = "";
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEntryThroughGate.EntryId = Convert.ToInt32(Result["EntryId"]);
                    ObjEntryThroughGate.ContainerNo = Result["ContainerNo"].ToString();
                    ObjEntryThroughGate.CFSCode = Result["OldCFSCode"].ToString();
                    ObjEntryThroughGate.NewCFSCode = Result["NewCFSCode"].ToString();
                    ObjEntryThroughGate.GateInNo = Result["GateInNo"].ToString();
                    //ObjEntryThroughGate.EntryDateTime = Result["EntryDateTime"].ToString();
                    ObjEntryThroughGate.EntryDateTime = Convert.ToString(Result["EntryDateTime"] == null ? "" : Result["EntryDateTime"]);
                    ObjEntryThroughGate.SystemDateTime = Convert.ToString(Result["SystemDateTime"]);
        ...
        public void DeleteVehicleEntry(int EntryDtlId, int EntryId)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_EntryDtlId", MySqlDbType = MySqlDbType.Int32, Value = EntryDtlId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_EntryId", MySqlDbType = MySqlDbType.Int32, Value = EntryId });
            ...
            _DBResponse = new DatabaseResponse();
            int result = DA.ExecuteNonQuery("DeleteVehicleEntry", CommandType.StoredProcedure, Dparam);
            try
            {
                if (result == 1)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Message = "vehicle Deleted Successfully.";
                    _DBResponse.Status = 1;
                }
                else if (result == 2)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Message = "Vehicle Can't be Deleted as Carting Done.";
                    _DBResponse.Status = 2;
                }
                else if (result == 3)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Message = "Vehicle Can't be Deleted as Stuffing Request Done.";
                    _DBResponse.Status = 2;
                }
                else if (result == 4)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Message = "Vehicle Can't be Deleted as Full Carting Done.";
                    _DBResponse.Status = 2;
                }
                else
                {
