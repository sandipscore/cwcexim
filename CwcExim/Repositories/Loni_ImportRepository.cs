...
{
    public class Loni_ImportRepository
    {
        ...
        public void GetOBLContainer(String OBLNo)
        {
            ...
            try
            {
                ...
                PpgCustomAppraisement objOBLEntry = new PpgCustomAppraisement();
                //List<OblEntryDetails> OblEntryDetailsList = new List<OblEntryDetails>();
                if (Result != null && Result.Tables.Count > 0)
                {
                    Status = 1;
                    foreach (DataRow dr in Result.Tables[0].Rows)
                    {
                        PPGCustomAppraisementOBLCont objOBLCont = new PPGCustomAppraisementOBLCont();
                        objOBLCont.CFSCode = Convert.ToString(dr["CFSCode"]);
                        objOBLCont.ContainerNo = Convert.ToString(dr["ContainerNo"]);
                        objOBLEntry.PPGCustomAppraisementCont.Add(objOBLCont);
                    }
                }
                if (Status == 1)
                {
                    ...
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = objOBLEntry.PPGCustomAppraisementCont;
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void GetListOfOBLEntryByContainerNo(string ContainerNo)
        {
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfOBLEntryByContainerNo", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
        ...
        public void AddEditSealCutting(SealCutting Obj, string ChargesBreakupXML, int BranchId, int Uid, string OBLXML, string IPAddress)
        {
            try
            {
                List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        internal void GetInvoiceDtlForSealCutting(string trancastionDate, string gateInDate, string containerNo, string size, int cHAShippingLineId, string CFSCode, int oBLType, int CargoType)
        {
            ...
            try
            {
                ...
                while (result.Read())
                {
                    ...
                    {
                        ObjSC.DTFIGSTPer = Convert.ToDecimal(result["IGSTPer"].ToString());
                        ObjSC.DTFCGSTPer = Convert.ToDecimal(result["CGSTPer"].ToString());
                        ObjSC.DTFSGSTPer = Convert.ToDecimal(result["SGSTPer"]);
                        ObjSC.CBTDTF = Convert.ToDecimal(result["GroundRent"]);
                        ObjSC.DTFCGST = Convert.ToDecimal(result["CGST"]);
                        ObjSC.DTFSGST = Convert.ToDecimal(result["SGST"]);
                        ObjSC.DTFIGST = Convert.ToDecimal(result["IGST"]);
                        ObjSC.DTFTotalAmount = Convert.ToDecimal(result["TotalAmount"]);
                    }
                ...
                ObjSC.TotalSGST = ObjSC.SGST + ObjSC.DTFSGST;
                ObjSC.TotalIGST = ObjSC.IGST + ObjSC.DTFIGST;
                ObjSC.InvoiceAmt = ObjSC.TotalAmount + ObjSC.DTFTotalAmount;
        ...
        public void GetListOfSealCuttingDetails(int Page)
        {
            ...
            try
            {
                ...
                {
                    List<SealCutting> lstSealCutting = new List<SealCutting>();
                    lstSealCutting = (from DataRow dr in ds.Tables[0].Rows
                                      select new SealCutting()
                                      {
            ...
            try
            {
                ...
                if (result.NextResult())
                {
                    while (result.Read())
                    {
                        ...
                        ObjSC.lstObldt.Add(new Areas.Import.Models.SealCutting
                        {
                ...
                if (result.NextResult())
                {
                    List<ppgSealPostPaymentChargebreakupdate> lstdtl = new List<ppgSealPostPaymentChargebreakupdate>();
                    while (result.Read())
                    {
                        lstdtl.Add(new ppgSealPostPaymentChargebreakupdate
                        {
                            ChargeId = Convert.ToInt32(result["OperationId"]),
                            Clause = result["ChargeType"].ToString(),
                            ChargeType = result["ChargeType"].ToString(),
        ...
        public void GetImportJODetailsFrPrint(int ImpJobOrderId)
        {
            ...
            try
            {
                while (result.Read())
                {
                    ...
                    objMdl.PortName = result["PortName"].ToString();
                }
                if (result.NextResult())
                {
                    while (result.Read())
                    {
                        objMdl.lstDet.Add(new PPGPrintJOModelDet
                        {
                            ...
                            WagonNo = result["WagonNo"].ToString(),
                            LineSealNo = result["LineSealNo"].ToString(),
                            TareWt = Convert.ToDecimal(result["TareWt"]),
                            CargoWt = Convert.ToDecimal(result["CargoWt"]),
                            TPNo = result["SmtpNo"].ToString(),
            ...
            try
            {
                while (result.Read())
                {
                    ...
                    lstDtl.Add(new PPG_TrainDtl
                    {
                        ...
                        CargoType = (result["Genhaz"] == null ? "" : result["Genhaz"]).ToString(),
        ...
        public void GetContnrDetForCustomAppraise(string CFSCode, string LineNo)
        {
            ...
            _DBResponse = new DatabaseResponse();
            PpgCustomAppraisement ObjAppraisement = new PpgCustomAppraisement();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetAllCustomAppraisementApp()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<PpgCustomAppraisement> LstAppraisement = new List<PpgCustomAppraisement>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstAppraisement.Add(new PpgCustomAppraisement
                    {
        ...
        public void GetCustomAppraisement(int CustomAppraisementId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjAppraisement.LstAppraisementPpg.Add(new PpgCustomAppraisementDtl
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjAppraisement.LstCustomAppraisementOrdDtl.Add(new PPGCustomAppraisementOrdDtl
                        {
        ...
        public void AddEditCustomAppraisement(PpgCustomAppraisement ObjAppraisement, string AppraisementXML, string CAOrdXML)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetContnrNoForCustomAppraise()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<PpgCustomAppraisementDtl> LstAppraisement = new List<PpgCustomAppraisementDtl>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstAppraisement.Add(new PpgCustomAppraisementDtl
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString()
                    });
        ...
        public void NewCustomeAppraisement(int Skip)
        {
            ...
            IList<PPG_ListOfCustAppraismentAppr> lstApproval = new List<PPG_ListOfCustAppraismentAppr>();
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            bool State = false;
            try
            {
                ...
                {
                    Status = 1;
                    lstApproval.Add(new PPG_ListOfCustAppraismentAppr
                    {
        ...
        public void GetCstmAppraiseApplication(int CstmAppraiseAppId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            PPG_Custom_AppraiseApproval ObjAppraisement = new PPG_Custom_AppraiseApproval();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjAppraisement.LstAppraisementDtl.Add(new PpgCustomAppraisementDtl
                        {
                            CustomAppraisementDtlId = Convert.ToInt32(Result["CustomAppraisementDtlId"]),
                            ContainerNo = Result["ContainerNo"].ToString(),
                            CFSCode = (Result["CFSCode"] == null ? "" : Result["CFSCode"]).ToString(),
        ...
        public void AddEditDestuffingEntry(PpgDestuffingEntry ObjDestuffing, string DestuffingEntryXML /*, string GodownXML, string ClearLcoationXML */, int BranchId, int Uid)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetDestuffingEntry(int DestuffingEntryId, int BranchId, string Action)
        {
            ...
            _DBResponse = new DatabaseResponse();
            PpgDestuffingEntry ObjDestuffing = new PpgDestuffingEntry();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDestuffing.lstDtl.Add(new Ppg_DestuffingEntryDtl
                        {
        ...
        public void GetAllDestuffingEntry(int Page, int UId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Ppg_DestuffingList> LstDestuffing = new List<Ppg_DestuffingList>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstDestuffing.Add(new Ppg_DestuffingList
                    {
        ...
        public void GetContrDetForDestuffingEntry(int TallySheetId, int BranchId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Ppg_DestuffingEntryDtl> lstdynamic = new List<Ppg_DestuffingEntryDtl>();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstdynamic.Add(new Ppg_DestuffingEntryDtl
                    {
        ...
        public void GetDestuffEntryForPrint(int DestuffingEntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Ppg_DestuffingSheet ObjDestuffing = new Ppg_DestuffingSheet();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDestuffing.lstDtl.Add(new Ppg_DestuffingSheetDtl
                        {
        ...
        #region Yard Invoice
        public void GetYardPaymentSheet(string InvoiceDate, int AppraisementId, string InvoiceType, string ContainerXML, int InvoiceId, int OTHours, int PartyId, int PayeeId, int isdirect, string SEZ)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddEditInvoice(PpgInvoiceYard ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML, string ChargesBreakupXML,
            int BranchId, int Uid, int Direct,
      ...
      string Module, string CargoXML = "")
        ...
        public void GetIRNB2CForYard(String InvoiceNo)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    Obj.InvoiceNo = Convert.ToString(Result["DocNo"]);
                    Obj.InvoiceDate = Convert.ToString(Result["DocDt"]);
                    ...
                    Obj.InvoiceValue = Convert.ToInt32(Result["TotInvVal"]);
        ...
        public void ListOfIssueParty()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<PPGDeliveryOrdDtl> LstStuffing = new List<PPGDeliveryOrdDtl>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new PPGDeliveryOrdDtl
                    {
        ...
        public void GetDeliveryApplication(int DeliveryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            PPG_DeliverApplication ObjDeliveryApp = new PPG_DeliverApplication();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryApp.LstDeliveryAppDtl.Add(new PPGDeliveryApplicationDtl
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryApp.LstDeliveryordDtl.Add(new PPGDeliveryOrdDtl
                        {
                            OrderId = Convert.ToInt32(Result["OrderId"]),
                            DeliveryNo = Result["DeliveryNo"].ToString(),
                            IssuedBy = (Result["DoIssueBy"] == null ? "" : Result["DoIssueBy"]).ToString(),
        ...
        public void GetBOELineNoForDelivery(int DestuffingId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<BOELineNoList> LstBOELineNo = new List<BOELineNoList>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstBOELineNo.Add(new BOELineNoList
                    {
        ...
        public void GetBOELineNoDetForDelivery(int DestuffingEntryDtlId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            PPGDeliveryApplicationDtl ObjDeliveryApp = new PPGDeliveryApplicationDtl();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjDeliveryApp.ContainerNo = Convert.ToString(Result["ContainerNo"] == DBNull.Value ? "" : Result["ContainerNo"]);

                    ObjDeliveryApp.Size = Convert.ToString(Result["Size"] == DBNull.Value ? "" : Result["Size"]);
                    ObjDeliveryApp.CFSCode = Convert.ToString(Result["CFSCode"] == DBNull.Value ? "" : Result["CFSCode"]);
        ...
        public void GetPaymentPartyForEditImport()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentPartyForEditImport", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            IList<PaymentPartyName> objPaymentPartyName = new List<PaymentPartyName>();
            try
            {
        ...
        public void GetPaymentPartyForEditImportFCL()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentPartyForEditImportFCL", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            IList<PaymentPartyName> objPaymentPartyName = new List<PaymentPartyName>();
            try
            {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objInvoice.PartyId = PartyId;
                        objInvoice.CHAName = Result["CHAName"].ToString();
                        objInvoice.PartyName = PartyName;
                        objInvoice.PartyGST = PartyGST;
                        objInvoice.RequestId = Convert.ToInt32(Result["DestuffingId"]);
                        objInvoice.RequestNo = Result["DestuffingNo"].ToString();
                        objInvoice.RequestDate = Result["DestuffingDate"].ToString();
                        objInvoice.PartyAddress = PartyAddress;
                        objInvoice.PartyStateCode = PartyStateCode;
                        objInvoice.PartyState = PartyState;
                        objInvoice.PartyGstNo = PartyGST;
                        objInvoice.PayeeId = PayeeId;

                        objInvoice.PayeeName = PayeeName;
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstInvoiceCargo.Add(new PpgInvoiceCargo
                        {
                            BOENo = Result["BOENo"].ToString(),
                            BOEDate = Result["BOEDate"].ToString(),
                            BOLDate = Result["BOLDate"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objInvoice.lstPostPaymentChrgBreakup.Add(new ppgDeliPostPaymentChargebreakupdate
                        {
                            ChargeId = Convert.ToInt32(Result["OperationId"]),
                            Clause = Result["ChargeType"].ToString(),
                            ChargeType = Result["ChargeType"].ToString(),
       ...
       string ChargesBreakupXML, int BranchId, int Uid,
        ...
        public void AddEditInvoiceGodownMerge(PPGInvoiceGodown ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML,
       string ChargesBreakupXML, int BranchId, int Uid,
       string Module, string CargoXML = "")
        {
            string GeneratedClientId = "0";
        ...
        public void GetPartyPdaDetailsForFCLtoLCL(string Size, int PartyPdaId, int ContainerClassId, String CFSCode, string SEZ)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            ...
            try
            {
                ...
                if (result.NextResult())
                {
                    while (result.Read())
                    {
                        ...
                        ObjSC.LOLOperationId = result["LOLOperationId"] == DBNull.Value ? 0 : Convert.ToInt32(result["LOLOperationId"]);
                        ObjSC.LOLChargeType = Convert.ToString(result["LOLChargeType"]);
                        ObjSC.LOLChargeName = Convert.ToString(result["LOLChargeName"]);
                        ObjSC.LOLCharge = result["LOLAmount"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLAmount"]);
                        ObjSC.LOLCGSTCharge = result["LOLCGSTAmt"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLCGSTAmt"]);
                        ObjSC.LOLSGSTCharge = result["LOLSGSTAmt"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLSGSTAmt"]);
                        ObjSC.LOLIGSTCharge = result["LOLIGSTAmt"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLIGSTAmt"]);
                        ObjSC.LOLIGSTPer = result["LOLIGSTPer"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLIGSTPer"].ToString());
                        ObjSC.LOLCGSTPer = result["LOLCGSTPer"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLCGSTPer"].ToString());
                        ObjSC.LOLSGSTPer = result["LOLSGSTPer"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLSGSTPer"]);
                        ObjSC.LOLAmount = result["LOLAmount"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLAmount"]);
                        ObjSC.LOLTaxable = result["LOLTaxable"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLTaxable"]);
                        ObjSC.LOLTotalAmount = result["LOLTotal"] == DBNull.Value ? 0 : Convert.ToDecimal(result["LOLTotal"]);
                        ObjSC.LOLSACCode = Convert.ToString(result["LOLSACCode"]);
                    }
                }
                if (result.NextResult())
                {
        ...
        public void AddFCLtoLCLConversion(FCLtoLCLConversion Obj, string ChargesBreakupXML, int BranchId, int Uid)
        {
            try
            {
                ...
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLOperationId", MySqlDbType = MySqlDbType.Int32, Value = Obj.LOLOperationId });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLChargeType", MySqlDbType = MySqlDbType.VarChar, Value = Obj.LOLChargeType });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLChargeName", MySqlDbType = MySqlDbType.VarChar, Value = Obj.LOLChargeName });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLCharge", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLCharge });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLCGSTCharge", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLCGSTCharge });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLSGSTCharge", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLSGSTCharge });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLIGSTCharge", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLIGSTCharge });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLIGSTPer", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLIGSTPer });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLCGSTPer", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLCGSTPer });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLSGSTPer", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLSGSTPer });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLTotalAmount", MySqlDbType = MySqlDbType.Decimal, Value = Obj.LOLTotalAmount });
                LstParam.Add(new MySqlParameter { ParameterName = "In_LOLSACCode", MySqlDbType = MySqlDbType.VarChar, Value = Obj.LOLSACCode });
        ...
        public void ViewFCLtoLCLConversionbyId(int FCLtoLCLConversionId)
        {
            ...
            try
            {
                ...
                while (result.Read())
                {
                    ...
                    Obj.LOLCharge = Convert.ToDecimal(result["LOLCharge"]);
                    Obj.LOLChargeName = Convert.ToString(result["LOLChargeName"]);
                    Obj.LOLCGSTCharge = Convert.ToDecimal(result["LOLCGSTCharge"]);
                    Obj.LOLSGSTCharge = Convert.ToDecimal(result["LOLSGSTCharge"]);
                    Obj.LOLIGSTCharge = Convert.ToDecimal(result["LOLIGSTCharge"]);
                    Obj.LOLTotalAmount = Convert.ToDecimal(result["LOLTotalAmount"]);
                    Obj.LOLIGSTPer = Convert.ToDecimal(result["LOLIGSTPer"]);
                    Obj.LOLCGSTPer = Convert.ToDecimal(result["LOLCGSTPer"]);
                    Obj.LOLSGSTPer = Convert.ToDecimal(result["LOLSGSTPer"]);
        ...
        public void GetIssueSlip(int IssueSlipId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjIssueSlip.LstContainer.Add(new ppg_IssueSlipContainer
                        {
                            CFSCode = Result["CFSCode"].ToString(),
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = (Result["Size"] == null ? "" : Result["Size"]).ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjIssueSlip.LstCargo.Add(new ppg_IssueSlipCargo
                        {
                            OBLNo = (Result["OBLNo"] == null ? "" : Result["OBLNo"]).ToString(),
                            CargoDescription = (Result["CargoDescription"] == null ? "" : Result["CargoDescription"]).ToString(),
        ...
        public void GetAllIssueSlip()
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetImpIssueSlip", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<PPG_Issueslip> LstIssueSlip = new List<PPG_Issueslip>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstIssueSlip.Add(new PPG_Issueslip
                    {
        ...
        public void GetIssueSlipForPreview(int IssueSlipId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjIssueSlip.LstIssueSlipRpt.Add(new ppg_IssueSlipReport
                        {
                            ContainerNo = Result["ContainerNo"].ToString(),
                            Size = Result["Size"].ToString(),
                            Vessel = (Result["Vessel"] == null ? "" : Result["Vessel"]).ToString(),
        ...
        public void AddEditEmptyContPaymentSheet(PpgInvoiceYard ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML, string ChargesBreakupXML,
        ...
        public void GetEmptyContPaymentSheet(string InvoiceDate, int DestuffingAppId, string InvoiceType, string ContainerXML, int InvoiceId, string InvoiceFor, int PartyId)
        {
            //int Status = 0;
            //List<MySqlParameter> LstParam = new List<MySqlParameter>();
            //LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        public void GetEmptyEditContPaymentSheet(string InvoiceDate, int DestuffingAppId, string InvoiceType, string ContainerXML, int InvoiceId, string InvoiceFor, int PartyId)
        {
            //int Status = 0;
            //List<MySqlParameter> LstParam = new List<MySqlParameter>();
            //LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        public void AddEditOBLWiseContainerEntry(OBLWiseContainerEntry objOBL, string XmlText)
        {
            string GeneratedClientId = "";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void ListOfOBLWiseContainer()
        {
            ...
            try
            {
                ...
                List<OBLWiseContainerEntry> OblEntryList = new List<OBLWiseContainerEntry>();
        ...
        public void CalculateEmptyContTransferInv(string InvoiceDate, string InvoiceType, string CFSCode, string ContainerNo, string Size, string EntryDate,
            string EmptyDate, int RefId, int PartyId, int PayeeId, int InvoiceId, string SEZ)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        public void AddEditSingleMergeDeliveryApplication(MergeDeliveryIssueViewModel ObjDeliveryApp, string DeliveryXml, String ObjDeliveryOrd)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceType", MySqlDbType = MySqlDbType.VarChar, Size = 20, Value = ObjDeliveryApp.DeliApp.InvoiceType });
            LstParam.Add(new MySqlParameter { ParameterName = "in_OTHours", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjDeliveryApp.DeliApp.OTHr });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SEZ", MySqlDbType = MySqlDbType.VarChar, Size = 11, Value = ObjDeliveryApp.DeliApp.SEZ });
            // LstParam.Add(new MySqlParameter { ParameterName = "in_ImporterId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjDeliveryApp.ImporterId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = ((Login)(HttpContext.Current.Session["LoginUser"])).Uid });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
        ...
        public void GetAllDeliveryMergeApplication(int Page, int Uid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<PPGMergeDeliveryApplicationList> LstDeliveryApp = new List<PPGMergeDeliveryApplicationList>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstDeliveryApp.Add(new PPGMergeDeliveryApplicationList
                    {
        ...
        public void GetDeliveryPaymentSheetSingle(string InvoiceType, int DestuffingAppId, string DeliveryDate, int InvoiceId, string XMLText, int PartyId, int PayeeId, string SEZ, int OTHours = 0, int OblFlag = 0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_DestuffingAppId", MySqlDbType = MySqlDbType.Int32, Value = DestuffingAppId });
        ...
        #region Importer Name Ammendment
        public void GetAllOBLNoForAmmendent()
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            //  lstParam.Add(new MySqlParameter { ParameterName = "in_TrainNo", MySqlDbType = MySqlDbType.VarChar, Value = "" });
            // lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            IDataParameter[] dpram = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("ListOfOBLforImporterAmendment", CommandType.StoredProcedure, dpram);
            IList<Ppg_ImporterAmmendment> lstOBLNo = new List<Ppg_ImporterAmmendment>();
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                while (result.Read())
                {
                    ...
                    Status = 1;
                    lstOBLNo.Add(new Ppg_ImporterAmmendment { OBLNo = result["OBL_No"].ToString(), OBLDTLId = Convert.ToInt32(result["OBLDTLID"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Data = lstOBLNo;
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                }
                else
        ...
        public void GetAllOBLNoDetForAmmendent(int OblDet)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_OblDtlId", MySqlDbType = MySqlDbType.Int32, Value = OblDet });
            // lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            IDataParameter[] dpram = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("ListOfOBLDetforImporterAmendment", CommandType.StoredProcedure, dpram);
            Ppg_ImporterAmmendment OBLDet = new Ppg_ImporterAmmendment();
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                while (result.Read())
                {
                    ...
                    OBLDet.OBLDate = result["OBLDT"].ToString();
                    OBLDet.OldImporterId = Convert.ToInt32(result["ImporterId"].ToString());
                    OBLDet.OldImporterName = result["ImporterName"].ToString();
                }
                if (Status == 1)
                {
                    _DBResponse.Data = OBLDet;
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                }
                else
        ...
        public void AddEditImpAmmendment(Ppg_ImporterAmmendment objJO)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            string Status = "0";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_OblDtlId", MySqlDbType = MySqlDbType.Int32, Value = objJO.OBLDTLId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_OblHdrId", MySqlDbType = MySqlDbType.VarChar, Size = 6, Value = objJO.OBLHDRId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_OblNo", MySqlDbType = MySqlDbType.VarChar, Value = objJO.OBLNo });
            lstParam.Add(new MySqlParameter { ParameterName = "in_OblDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(objJO.OBLDate).ToString("yyyy-mm-dd") });

            lstParam.Add(new MySqlParameter { ParameterName = "in_OldImporterId", MySqlDbType = MySqlDbType.Int32, Size = 2, Value = objJO.OldImporterId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_OldImporterName", MySqlDbType = MySqlDbType.VarChar, Value = objJO.OldImporterName });
            lstParam.Add(new MySqlParameter { ParameterName = "in_NewImporterId", MySqlDbType = MySqlDbType.Int32, Value = objJO.NewImporterId });

            lstParam.Add(new MySqlParameter { ParameterName = "in_NewImporterName", MySqlDbType = MySqlDbType.VarChar, Value = objJO.NewImporterName });
            lstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = ((Login)HttpContext.Current.Session["LoginUser"]).Uid });
            lstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Value = 0, Direction = ParameterDirection.Output });
            lstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            lstParam.Add(new MySqlParameter { ParameterName = "ReturnObj", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = ReturnObj });
            IDataParameter[] dpram = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int result = DA.ExecuteNonQuery("AddEditImporterAmmendment", CommandType.StoredProcedure, dpram, out Status, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (result == 1 || result == 2)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Status = result;
                    _DBResponse.Message = (result == 1) ? "Importer Ammendment Saved Successfully" : "Importer Ammendment Saved Successfully";
                }
                else if (result == 3)
                {
                    _DBResponse.Data = null;
        ...
        public void ListOfImporterPartyCode(string PartyCode, int Page = 0)
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            IDataParameter[] Dparam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfImporterForPage", CommandType.StoredProcedure, Dparam);
            IList<Ppg_ImporterForpage> lstimporter = new List<Ppg_ImporterForpage>();
            _DBResponse = new DatabaseResponse();
            try
            {
                bool State = false;
                ...
                {
                    Status = 1;
                    lstimporter.Add(new Ppg_ImporterForpage
                    {
                        ImporterId = Convert.ToInt32(Result["ImporterId"]),
                        ImporterName = Convert.ToString(Result["ImporterName"]),
                        PartyCode = Result["PartyCode"].ToString()
        ...
        public void GetAmenSBDetailsByAmendNO(String Amno, int Page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_AmendNo", MySqlDbType = MySqlDbType.VarChar, Size = 11, Value = Amno });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });

            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetImporterAmendmentDetailsAmendNo", CommandType.StoredProcedure, DParam);
            List<Ppg_ImporterAmmendment> LstSB = new List<Ppg_ImporterAmmendment>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSB.Add(new Ppg_ImporterAmmendment
                    {
                        AmendNo = Convert.ToString(Result["AmendNo"]),
                        AmendDate = Convert.ToString(Result["AmendDate"]),
                        OBLNo = Convert.ToString(Result["OblNo"]),
                        OldImporterName = Convert.ToString(Result["OldImporter"]),
                        NewImporterName = Convert.ToString(Result["NewImporterName"]),
        ...
        #region  Container Size and Shipping Line Ammendment
        public void GetAllContainerNoForAmmendent()
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            //  lstParam.Add(new MySqlParameter { ParameterName = "in_TrainNo", MySqlDbType = MySqlDbType.VarChar, Value = "" });
            // lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            IDataParameter[] dpram = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("ListOfContainerforAmendment", CommandType.StoredProcedure, dpram);
            IList<ppg_ContainerAmendment> lstContNo = new List<ppg_ContainerAmendment>();
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                while (result.Read())
                {
                    ...
                    Status = 1;
                    lstContNo.Add(new ppg_ContainerAmendment { ContainerNo = result["ContainerNo"].ToString(), FormOneDetailId = Convert.ToInt32(result["FormOneDetailId"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Data = lstContNo;
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                }
                else
        ...
        public void GetAlContainernoDetForAmmendent(int FormDetId)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_FormDetId", MySqlDbType = MySqlDbType.Int32, Value = FormDetId });
            // lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            IDataParameter[] dpram = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("ListOfContainerDetforAmendment", CommandType.StoredProcedure, dpram);
            ppg_ContainerAmendment ContainerDet = new ppg_ContainerAmendment();
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                while (result.Read())
                {
                    ...
                    ContainerDet.OldContainerSize = result["ContainerSize"].ToString();
                    ContainerDet.OldShippingLineId = Convert.ToInt32(result["ShippingLineId"].ToString());
                    ContainerDet.OldShippingLineName = result["ShippingLineName"].ToString();
                }
                if (Status == 1)
                {
        ...
        public void AddEditContainerAmmendment(ppg_ContainerAmendment objJO)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            string Status = "0";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_FormOneDetailId", MySqlDbType = MySqlDbType.Int32, Value = objJO.FormOneDetailId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_FormOneId", MySqlDbType = MySqlDbType.Int32, Value = objJO.FormOneId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_ContainerNo", MySqlDbType = MySqlDbType.VarChar, Value = objJO.ContainerNo });
            lstParam.Add(new MySqlParameter { ParameterName = "in_AmendDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(objJO.AmendDate).ToString("yyyy-mm-dd") });

            lstParam.Add(new MySqlParameter { ParameterName = "in_OldContainerSize", MySqlDbType = MySqlDbType.VarChar, Size = 10, Value = objJO.OldContainerSize });
            lstParam.Add(new MySqlParameter { ParameterName = "in_NewContainerSize", MySqlDbType = MySqlDbType.VarChar, Size = 10, Value = objJO.newContainerSize });

            lstParam.Add(new MySqlParameter { ParameterName = "in_OldShippingLineId", MySqlDbType = MySqlDbType.Int32, Value = objJO.OldShippingLineId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_OldShippingLineName", MySqlDbType = MySqlDbType.VarChar, Size = 200, Value = objJO.OldShippingLineName });

            lstParam.Add(new MySqlParameter { ParameterName = "in_newShippingLineId", MySqlDbType = MySqlDbType.Int32, Value = objJO.newShippingLineId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_NewShippingLineName", MySqlDbType = MySqlDbType.VarChar, Size = 200, Value = objJO.NewShippingLineName });
            ...
            IDataParameter[] dpram = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int result = DA.ExecuteNonQuery("AddEditContainerAmmendment", CommandType.StoredProcedure, dpram, out Status, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (result == 1 || result == 2)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Status = result;
                    _DBResponse.Message = (result == 1) ? "Container details Ammendment Saved Successfully" : "Container details Saved Successfully";
                }
                else if (result == 3)
                {
                    _DBResponse.Data = null;
        ...
        public void GetAmenContainerNoByAmendNO(String Amno)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_AmendNo", MySqlDbType = MySqlDbType.VarChar, Size = 11, Value = Amno });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetContainerAmendmentDetailsAmendNo", CommandType.StoredProcedure, DParam);
            List<ppg_ContainerAmendment> LstSB = new List<ppg_ContainerAmendment>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSB.Add(new ppg_ContainerAmendment
                    {
                        AmendNo = Convert.ToString(Result["AmendNo"]),
                        AmendDate = Convert.ToString(Result["AmendDate"]),
                        ContainerNo = Convert.ToString(Result["ContainerNo"]),
                        OldContainerSize = Convert.ToString(Result["OldSize"]),
                        newContainerSize = Convert.ToString(Result["NewSize"]),
                        OldShippingLineName = Convert.ToString(Result["OldShippingLineName"]),
                        NewShippingLineName = Convert.ToString(Result["NewShippingLineName"])
        ...
        public void ListOfShippingLineForAmendment()
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            // lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            IDataParameter[] dparam = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader result = DA.ExecuteDataReader("ListOfShippingLineForAmendment", CommandType.StoredProcedure);
            IList<ShippingLine> lstShippingLineName = new List<ShippingLine>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstShippingLineName.Add(new ShippingLine
                    {
                        ShippingLineId = Convert.ToInt32(result["ShippingLineId"]),
                        ShippingLineName = result["ShippingLineName"].ToString()
                    });
                ...
                if (Status == 1)
                {
                    _DBResponse.Data = lstShippingLineName;
                    _DBResponse.Message = "Success";
                    _DBResponse.Status = 1;
                }
                else
        ...
        public void GetInvoiceForEdit(string Module)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<PpgEditInvoiceList> objInvoiceList = new List<PpgEditInvoiceList>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objInvoiceList.Add(new PpgEditInvoiceList()
                    {
                        InvoiceId = Convert.ToInt32(Result["InvoiceId"]),
                        InvoiceNo = Convert.ToString(Result["InvoiceNo"]),
        ...
        #region Edit Empty Container Invoice

        public void GetEmptyContInvoiceDetailsForEdit(int InvoiceId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
        ...
        public void GetEmptyContTransferInvoiceDetailsForEdit(int InvoiceId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetEmptyContTransInvoiceDetailsForEdit", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            decimal hours = 0;
            PpgInvoiceYard objPostPaymentSheet = new PpgInvoiceYard();
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objPostPaymentSheet.FromShippingLine = Convert.ToString(Result["FromShippingLine"]);
                        objPostPaymentSheet.ToShippingLine = Convert.ToString(Result["ToShippingLine"]);
        ...
        #region edit FCL to LCL conversion
        public void GetFCLLCLInvoiceDetailsForEdit(int InvoiceId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetFCLLCLInvoiceDetailsForEdit", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            decimal hours = 0;
            PpgInvoiceYard objPostPaymentSheet = new PpgInvoiceYard();
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        objPostPaymentSheet.ContainerNo = Convert.ToString(Result["ContainerNo"]);
                        objPostPaymentSheet.Size = Convert.ToString(Result["Size"]);
                        objPostPaymentSheet.ToShippingId = Convert.ToInt32(Result["ShippingLineId"]);
                        objPostPaymentSheet.ToShippingLine = Convert.ToString(Result["ShippingLine"]);
                        objPostPaymentSheet.ContainerClassId = Convert.ToInt32(Result["ContainerClassId"]);
        ...
        public void CalculateFCLToLCLInv(string Size, int PartyPdaId, int ContainerClassId, string CFSCode, int InvoiceId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            ...
            _DBResponse = new DatabaseResponse();
            PpgInvoiceYard objInvoice = new PpgInvoiceYard();
            DataSet ds = DataAccess.ExecuteDataSet("CalculateFCLToLCLForEdit", CommandType.StoredProcedure, DParam);
            try
            {
        ...
        public void AddEditFCLToLCLPaymentSheetForEdit(PpgInvoiceYard ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML, string ChargesBreakupXML,
       int BranchId, int Uid,
      string Module, string CargoXML = "")
        {
            string GeneratedClientId = "0";
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DA.ExecuteNonQuery("AddEditLCLFCLPaymentSheetforEdit", CommandType.StoredProcedure, DParam, out GeneratedClientId, out ReturnObj);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
