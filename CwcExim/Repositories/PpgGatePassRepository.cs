...
{
    public class PpgGatePassRepository
    {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        lstCntnDet.Add(new PPG_ContainerDet
                        {
                            ...
                            ElwbTareWeight = Convert.ToDecimal(Result["ElwbTareWeight"] == DBNull.Value ? 0 : Result["ElwbTareWeight"]),
                            ElwbCargoWeight = Convert.ToDecimal(Result["ElwbCargoWeight"] == DBNull.Value ? 0 : Result["ElwbCargoWeight"]),
                        });
                    }
                }
