...
{
    public class Ppg_EntryThroughGateRepository
    {
        ...
        public void GetAllEntryThroughGateEmptySearchListPage(int Page, string ContainerType,string ContainerNo)
        {
            int Status = 0;
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateListPagesearch", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<PpgEntryThroughGate> LstEntryThroughGate = new List<PpgEntryThroughGate>();
            try
            {
        ...
        public void GetAllEntryThroughGateCBTListPage(int Page,string OperationType,string ContainerType)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_EntryId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateListCBTPage", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<PpgEntryThroughGate> LstEntryThroughGate = new List<PpgEntryThroughGate>();
            try
            {
        ...
        public void GetAllEntryThroughGateCBTListSearchPage(int Page, string OperationType, string ContainerType,string ContainerNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_EntryId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllEntryThroughGateListCBTPagesearch", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<PpgEntryThroughGate> LstEntryThroughGate = new List<PpgEntryThroughGate>();
            try
            {
