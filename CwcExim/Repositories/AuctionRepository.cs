...
namespace CwcExim.Repositories
{
    public class AuctionRepository
    {
        ...
        public void GetCargoDetailsList(string operationType, string auctionType, int Uid, int inPage)
        {
            ...
            List<AuctionNoticeDetails> LstAuctionNoticeDetails = new List<AuctionNoticeDetails>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow item in Result.Tables[0].Rows)
                    {
                        Status = 1;
                        srNo++;
                        AuctionNoticeDetails objCargoDetails = new AuctionNoticeDetails();
        ...
        public AuctionNoticePrintViewModel GetAuctionNoticeDataToPrint(int AuctionNoticeDtlId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            AuctionNoticePrintViewModel auctionNoticePrintViewModel = new AuctionNoticePrintViewModel();
            auctionNoticePrintViewModel.ParticularsOfGoodsList = new List<ParticularsOfGoods>();
            ...
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        ParticularsOfGoods objParticularsOfGoods = new ParticularsOfGoods();
        ...
        public void GetAllMarkForNotice(int branchId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<MarkForNotice> LstMarkForNotice = new List<MarkForNotice>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow item in Result.Tables[0].Rows)
                    {
                        ...
                        {
                            MarkForNotice objMarkForNotice = new MarkForNotice();
                            objMarkForNotice.MarkForNoticeDetailsList = new List<MarkForNoticeDetails>();
                            ...
                            MarkForNoticeDetails objMarkForNoticeDetails = new MarkForNoticeDetails();
        ...
        public void GetAllDespatchForNotice(int branchId)
        {
            ...
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        LstMarkForNotice.Add(new MarkForNotice
                        {
        ...
        public void UpdateDespatch(Despatch vm)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllShipbillOBLFor(int Flag)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<NocDetails> LstNocDetails = new List<NocDetails>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    {
                        Status = 1;
                        LstNocDetails.Add(new NocDetails
                        {
        ...
        public void AddEditNOCDetails(NocDetails vm, int BranchID, int CRby)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAuctionMarkedNoticeList()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<MarkedNotice> LstMarkedNotice = new List<MarkedNotice>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow item in Result.Tables[0].Rows)
                    {
                        ...
                        {
                            MarkedNotice objMarkedNotice = new MarkedNotice();
                            objMarkedNotice.MarkedNoticeDetailsList = new List<MarkedNoticeDetails>();
                            objMarkedNotice.LOTNo = Convert.ToString(item["LOTNo"]);
                            objMarkedNotice.MarkedOn = Convert.ToString(item["MarkedOn"]);

                            MarkedNoticeDetails objMarkedNoticeDetails = new MarkedNoticeDetails();
        ...
        public void GetBIDList(int branchId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    model.BIDDetail.Add(new BIDInfo { BIDId = Convert.ToInt32(Result["BidIdHdr"]), BIDNo = Convert.ToString(Result["BidNo"]) });
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void SaveEMDReceived(EMDReceived ObjEMDReceived, string xml)
        {
            try
            {
        ...
        public void GetEMDReceivedList()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<EMDReceived> LstEMDReceived = new List<EMDReceived>();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
        ...
        public void GetBidPartyAndDetails()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Areas.Auction.Models.PartyDetails> lstPartyDetails = new List<Areas.Auction.Models.PartyDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstPartyDetails.Add(new Areas.Auction.Models.PartyDetails
                    {
        ...
        public void SaveBid(AucBidFinalizationHdr ObjAucBidFinalizationHdr, int Uid, int BranchId)
        {
        ...
        public void GetBidLIst(int id)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstAucBidFinalizationHdr.Add(new AucBidFinalizationHdr
                    {
                        //Convert.ToInt32(Result["PartyId"] == DBNull.Value ? 0 : Result["PartyId"]),
        ...
        #endregion
        public void GenericBulkInvoiceDetailsForPrint(AuctionInvoiceViewModel ObjBulkInvoiceReport)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (Result != null && Result.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            lstDestruction.Add(new DestructionViewModel
                            {
        ...
        public void SaveDestruction(DestructionViewModel vm, int uid)
        {
