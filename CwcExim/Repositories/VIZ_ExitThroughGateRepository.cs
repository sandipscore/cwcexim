...
{
    public class VIZ_ExitThroughGateRepository
    {
        ...
        public void AddEditExitThroughGate(VIZ_ExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
            ...
            try
            {
                ...
                else if (Result == 4)
                {
                    ...
                    _DBResponse.Message = "For Export Gate Exit Date Cannot Be Less Than Current Date";
                }
                else
                {
                    _DBResponse.Data = null;
        ...
        public void GetContainer()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objExitThroughGateHeader.containerList.Add(new VIZ_containerExit
                    {
        ...
        public void GetGatePassLst()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstGatePass.Add(new VIZ_GatePassList
                    {
        ...
        public void AddGateEXitToDetails(VIZ_ExitThroughGateHeader ObjExitThroughGateHeader, int Uid)
        {
            ObjExitThroughGateHeader.Uid = Uid;
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllExitThroughGate()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VIZ_ExitThroughGateHeader> LstExitThroughGate = new List<VIZ_ExitThroughGateHeader>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new VIZ_ExitThroughGateHeader
                    {
        ...
        public void GetExitThroughGateSearchList(string ContainerNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetExitThroughGateHdrSearchList", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<VIZ_ExitThroughGateHeader> LstExitThroughGate = new List<VIZ_ExitThroughGateHeader>();
            try
            {
        ...
        public void GetExitThroughGateDetails()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VIZ_ExitThroughGateDetails> LstExitThroughGateDtls = new List<VIZ_ExitThroughGateDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGateDtls.Add(new VIZ_ExitThroughGateDetails
                    {
                        ExitIdHeader = Convert.ToInt32(Result["ExitIdHeader"]),
        ...
        public void GetDetailsForGateExitMail(string LineId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VIZ_EntryThroughGateMail objMail = new VIZ_EntryThroughGateMail();
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Result.NextResult())
                    {
                        while (Result.Read())
                        {
                            objMail.lstExcelData.Add(new VIZ_ExcelData()
                            {
        ...
        public void GetDetailsForGateExitMailPIL(string LineId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VIZ_EntryThroughGateMailPIL objMail = new VIZ_EntryThroughGateMailPIL();
            try
            {
                while (Result.Read())
                {
                    ...
                    if (Result.NextResult())
                    {
                        while (Result.Read())
                        {
                            objMail.lstExcelData.Add(new VIZ_ExcelDataPIL()
                            {
        ...
        public void ContainerForGAtePass(int gatePassId)
        {
            ...
            IList<VIZ_containerAgainstGp> LstcontainerAgainstGp = new List<VIZ_containerAgainstGp>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstcontainerAgainstGp.Add(new VIZ_containerAgainstGp
                    {
        ...
        public void GetGatePassLstToRevalidate()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLDRevalidateGatePass> LstRevalidateGatePass = new List<WFLDRevalidateGatePass>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstRevalidateGatePass.Add(new WFLDRevalidateGatePass
                    {
        ...
        public void UpdateGatePassValidity(WFLDRevalidateGatePass objRevalidateGatePass)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetGatePassLstPending()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstGatePass.Add(new WFLDGatePassList
                    {
                        GatePassId = Convert.ToInt32(Result["GatePassId"].ToString()),
                        GatePassNo = Result["GatePassNo"].ToString(),
                        GatePassDate = Result["GatePassDate"].ToString(),
        ...
        public void AddEditExitThroughGateCBT(WFLDGateExitCBT ObjExitThroughGateHeader, int Uid)
        {
        ...
        public void GetAllExitThroughGateCBT()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLDGateExitCBT> LstExitThroughGate = new List<WFLDGateExitCBT>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new WFLDGateExitCBT
                    {
                        GateExitNo = Result["GateExitNo"].ToString(),
                        GateExitDateTime = Result["GateExitDateTime"].ToString(),
        ...
        public void EditViewExitThroughGateCBT(int ExitId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDGateExitCBT ObjExitThroughGate = new WFLDGateExitCBT();
            try
            {
                while (Result.Read())
                {
