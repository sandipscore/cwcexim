...
{
    public class WFLDBondRepository
    {
        ...
        public void ListOfSpaceAvailability(int Page,string Search)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstApp.Add(new WFLDListOfBondApp
                    {
        ...
        public void GetSpaceAvailAppCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDSpaceAvailAppCertPdf ObjSpaceAvailCert = new WFLDSpaceAvailAppCertPdf();
            try
            {
                while (Result.Read())
                {
        ...
        public void SpaceAvailabilityDetails(int SpaceappId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objBA.Noofpackage = Convert.ToInt32(Result["Noofpackage"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void AddEditBondApp(WFLDBondApp objBA)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Noofpackage", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = objBA.Noofpackage });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.VarChar, Value = 0, Size = 50, Direction = ParameterDirection.Output });
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        public void LoadReservationDetails(int CHAId, int ImpId, int GodownId, string SpaceType)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_CHAId", MySqlDbType = MySqlDbType.Int32, Value = CHAId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_ImpId", MySqlDbType = MySqlDbType.Int32, Value = ImpId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_GodownId", MySqlDbType = MySqlDbType.Int32, Value = GodownId });
            lstParam.Add(new MySqlParameter { ParameterName = "in_SpaceType", MySqlDbType = MySqlDbType.VarChar, Value = SpaceType });
            IDataParameter[] dparam = lstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();            
            IDataReader Result = DataAccess.ExecuteDataReader("GetReservationDetailsBond", CommandType.StoredProcedure, dparam);
            _DBResponse = new DatabaseResponse();
            WFLDBondApp objBA = new WFLDBondApp();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;                    
                    objBA.SpaceReservedCHA = Convert.ToDecimal(Result["SpaceRemainingCHA"]);
                    objBA.SpaceReservedIMP = Convert.ToDecimal(Result["SpaceRemainingIMP"]);
                    objBA.NetSpaceReservedCHA = Convert.ToDecimal(Result["NetSpaceRemainingCHA"]);
                    objBA.NetSpaceReservedIMP = Convert.ToDecimal(Result["NetSpaceRemainingIMP"]);
        ...
        public void AddEditBondSpaceAvailCert(WFLDSpaceAvailableCert ObjSpaceAvail)
        {
        ...
        public void GetSpaceAvailCertById(int SpaceappId, int Stats)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjSpaceAvail.Noofpackage = Convert.ToInt32(Result["Noofpackage"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetSpaceAvailCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDSpaceAvailCertPdf ObjSpaceAvailCert = new WFLDSpaceAvailCertPdf();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjSpaceAvailCert.SpaceType = Result["SpaceType"].ToString();
        ...
        public void AddEditBondSpaceAvailCertExt(WFLDSpaceAvailCertExtend ObjSpaceAvail)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllSpaceAvailCertExt()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstSpaceAvail.Add(new WFLDSpaceAvailCertExtend
                    {
        ...
        public void GetSacNo()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<WFLDSpaceAvailableCert> LstSpaceAvail = new List<WFLDSpaceAvailableCert>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSpaceAvail.Add(new WFLDSpaceAvailableCert
                    {
                        SpaceappId = Convert.ToInt32(Result["SpaceappId"]),
        ...
        public void GetSpaceAvailabilityExt(int SpaceAvailCertExtId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondSpaceAvailCertExt", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            WFLDBondAppExtendDetails ObjSpaceAvail = new WFLDBondAppExtendDetails();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditBondDepositApp(WFLDDepositApp ObjDepositApp)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_BondBOEDate", MySqlDbType = MySqlDbType.Date, Value = (string.IsNullOrEmpty(ObjDepositApp.BondBOEDate)?null:Convert.ToDateTime(ObjDepositApp.BondBOEDate).ToString("yyyy/MM/dd")) });
        ...
        public void GetSacNodepositDet(int SpaceappId, int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDDepositApp ObjSpaceAvail = new WFLDDepositApp();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjSpaceAvail.AppliedDuty = Convert.ToDecimal(Result["AppliedDuty"]);
                    ObjSpaceAvail.AppliedValue = Convert.ToDecimal(Result["AppliedValue"]);
                    ObjSpaceAvail.RemDuty = Convert.ToDecimal(Result["RemDuty"]);
                    ObjSpaceAvail.RemValue = Convert.ToDecimal(Result["RemValue"]);
        ...
        public void GetAllDepositApp(int Page,string Search)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstDepositApp.Add(new WFLDDepositApp
                    {
        ...
        public void GetDepositApp(int DepositAppId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjDepositApp.RemDuty = Convert.ToDecimal(Result["RemDuty"]);
                    ObjDepositApp.RemValue = Convert.ToDecimal(Result["RemValue"]);
                    ObjDepositApp.AppliedValue = Convert.ToDecimal(Result["AppliedValue"]);
                    ObjDepositApp.AppliedDuty = Convert.ToDecimal(Result["AppliedDuty"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void PrintDA(int DepositeAppId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDPrintDA ObjDepositApp = new WFLDPrintDA();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstSAC.Add(new WFLDSACDet
                        {
                            SacNo = Result["SacNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstGodown.Add(new WFLDGodDet
                        {
        ...
        public void GetBondNoForWOUnloadingNew()
        {
            int status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondForWOUnloading", CommandType.StoredProcedure, DParam);
            List<ListOfWFLDBondNo> LstBond = new List<ListOfWFLDBondNo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    {
                        LstBond.Add(new ListOfWFLDBondNo
                        {
        ...
        public void GetBondNoForWODeliveryNew()
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_DepositAppId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_WoType", MySqlDbType = MySqlDbType.VarChar, Size = 1, Value = "" });
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        public void GetDetailsforBondNo(int DepositAppId,string WoType)
        {
            int status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondForWO", CommandType.StoredProcedure, DParam);
            WFLDBondWODeli objWO = new WFLDBondWODeli();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    status = 1;
                    objWO.DepositAppId = Convert.ToInt32(Result["DepositAppId"]);//[SpaceappId]
                    objWO.BondDate = Convert.ToString(Result["BondBOEDate"]);//[BondDate]
        ...
        public void ListOfWODeli(string WoType,int Page,string Search)
        {
            int status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            ...
            List<ListOfWFLDBondWODeli> LstBond = new List<ListOfWFLDBondWODeli>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstBond.Add(new ListOfWFLDBondWODeli
                    {
        ...
        public void ListWOForUnloading(string WoType,int Page,string Search)
        {
            int status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
        ...
        public void ListOfWODeliDetails(int BondWOId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objWO.Units = Convert.ToInt32(Result["Units"]);
                    objWO.Weight = Convert.ToDecimal(Result["Weight"]);
                    objWO.RemainingUnits = Convert.ToInt32(Result["RemainingUnits"]);
                    objWO.RemainingWeight = Convert.ToDecimal(Result["RemainingWeight"]);
        ...
        public void AddEditWODeliDetails(int BondWOId, int DepositAppId, string WorkOrderDate, string DeliveryNo, int CargoUnits, decimal CargoWeight, 
            string WOType,string BondNo,string BondDate,string SacNo,string SacDate,string WRNo, string WRDate,string GodownName,string CargoDescription)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BondWOId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = BondWOId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_DepositAppId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = DepositAppId });//[SpaceappId]
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_BondDate", MySqlDbType = MySqlDbType.Date, Value = Convert.ToDateTime(BondDate).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SacNo", MySqlDbType = MySqlDbType.VarChar, Value = SacNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SacDate", MySqlDbType = MySqlDbType.Date, Value = Convert.ToDateTime(SacDate).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_WRNo", MySqlDbType = MySqlDbType.VarChar, Value = WRNo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_WRDate", MySqlDbType = MySqlDbType.Date, Value = Convert.ToDateTime(WRDate).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_GodownName", MySqlDbType = MySqlDbType.VarChar, Value = GodownName });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CargoDescription", MySqlDbType = MySqlDbType.VarChar, Value = CargoDescription });
        ...
        public void GetBondNoForWOUnloading()
        {
            ...
            List<ListOfWFLD_BOENo> LstBond = new List<ListOfWFLD_BOENo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstBond.Add(new ListOfWFLD_BOENo
                    {
                        //WorkOrderNo = Convert.ToString(Result["WorkOrderNo"]),
                        //BondWOId = Convert.ToInt32(Result["BondWOId"])
        ...
        public void GetBondNoForWOUnloadingDet(int DepositAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondNoUnloading", CommandType.StoredProcedure, DParam);
            WFLDBOENoDetails objBOE = new WFLDBOENoDetails();
            WFLDBondApp objBA = new WFLDBondApp();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objBOE.AppliedArea = Convert.ToDecimal(Result["AppliedArea"]);
                    objBOE.AppliedAreaReserved = Convert.ToDecimal(Result["AppliedAreaReserved"]);                   
                ...
                if (status == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Success";
                    _DBResponse.Data = new { BOE = objBOE, lstGodown, Net = objBA };
                }
                else
                {
                    _DBResponse.Status = 0;
        ...
        public void ListForWOUnloading(int Page,string Search)
        {
            int status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
        ...
        public void WOUnloadingDetails(int UnloadingId, string Action = "")
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objBond.AppliedArea = Convert.ToDecimal(Result["AppliedArea"]);
                    objBond.RemArea = Convert.ToDecimal(Result["RemArea"]);
                    objBond.AppliedAreaReserved = Convert.ToDecimal(Result["AppliedAreaReserved"]);
                    objBond.AreaOccupiedReserved = Convert.ToDecimal(Result["AreaOccupiedReserved"]);
                    objBond.AreaOccupiedReservedOrg = Convert.ToDecimal(Result["AreaOccupiedReserved"]);
                    objBond.RemAreaReserved = Convert.ToDecimal(Result["RemAreaReserved"]);
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        var SpaceReservedCHA = Convert.ToDecimal(Result["SpaceRemainingCHA"]);
                        var SpaceReservedIMP = Convert.ToDecimal(Result["SpaceRemainingIMP"]);
                        var NetSpaceReservedCHA = Convert.ToDecimal(Result["NetSpaceRemainingCHA"]);
                        var NetSpaceReservedIMP = Convert.ToDecimal(Result["NetSpaceRemainingIMP"]);

                        if(SpaceReservedCHA > 0)
                        {
                            objBond.NetSpaceReq = NetSpaceReservedCHA;
                            objBond.NetSpaceRemaining = SpaceReservedCHA ;
                            objBond.NetSpaceRemainingCalc = SpaceReservedCHA;
                        }
                        else
                        {
                            objBond.NetSpaceReq = NetSpaceReservedIMP;
                            objBond.NetSpaceRemaining = SpaceReservedIMP;
                            objBond.NetSpaceRemainingCalc = SpaceReservedIMP;
                        }
        ...
        public void AddEditWOUnloading(WFLDBondWOUnloading obj)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            obj.UnloadedDate = DateTime.ParseExact(obj.UnloadedDate, "dd/MM/yyyy HH:mm", System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_UnloadedDate", MySqlDbType = MySqlDbType.DateTime, Value = obj.UnloadedDate });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_AreaOccupiedReserved", MySqlDbType = MySqlDbType.Decimal, Value = obj.AreaOccupiedReserved });
        ...
        public void PrintWOUnloading(int UnloadingId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            WFLDBondWOUnloadingPDF ObjUnloading = new WFLDBondWOUnloadingPDF();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetSACNoForAdvBondPaymentSheet(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (IList<WFLDBondSacDetails>)DataAccess.ExecuteDynamicSet<WFLDBondSacDetails>("GetSACNoForBondAdvPaymentSheet");
        ...
        public void AddEditInvoice(WFLD_LoadedContainerPayment ObjPostPaymentSheet,int Vno, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string CfsChargeXML, int BranchId, int Uid,
            string Module, int BillToParty, string CargoXML = "")
        {
            ...
            try
            {
                ...
                else if (Result == 3)
                {
                    ...
                    _DBResponse.Message = "Payment Invoice have not generated due to low Balance";
                }
                else if (Result == 33)
                {
                    _DBResponse.Data = null;
        ...
        public void GetBondAdvancePaymentSheet(string DeliveryDate,string InvoiceDate, int DestuffingAppId, int DeliveryType, string DestuffingAppNo, string DestuffingAppDate, int PartyId, string PartyName,
    ...
    string InvoiceType, decimal area, int InvoiceId = 0, int No = 0, string ExportUnder = "")
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            WFLD_PostPaymentSheet objInvoice = new WFLD_PostPaymentSheet();
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    ...
                    while (Result.Read())
                    {
                        objInvoice.lstPrePaymentCont.Add(new WFLD_PreInvoiceContainer
                        {
                        ...
                        objInvoice.lstPostPaymentCont.Add(new WFLD_PostPaymentContainer
                        {
                            ContainerNo = Result["ContainerNo"] == System.DBNull.Value ? "" : Result["ContainerNo"].ToString(),
                            CFSCode = Result["CFSCode"] == System.DBNull.Value ? "" : Result["CFSCode"].ToString(),
                            ArrivalDate = Result["ArrivalDate"] == System.DBNull.Value ? "" : Result["ArrivalDate"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstPostPaymentChrg.Add(new WFLD_PostPaymentChrg
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstContWiseAmount.Add(new WFLD_ContainerWiseAmount
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstOperationCFSCodeWiseAmount.Add(new WFLD_OperationCFSCodeWiseAmount
                        {
                            InvoiceId = InvoiceId,
                            CFSCode = Result["CFSCode"].ToString(),
        ...
        public void ListofSACPaymentSheet(int Page, string InvoiceNo,string InvoiceDate)
        {
            int Status = 0;
            InvoiceDate = (InvoiceDate == null ? null : DateTime.ParseExact(InvoiceDate, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd"));
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ListofSACPaymentSheet", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstApp.Add(new WfldSACInvoiceList
                    {
        ...
        public void GetPaymentPayerForPage(string PartyCode, int Page = 0)
        {
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] Dparam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentPayerForBondPage", CommandType.StoredProcedure, Dparam);
        ...
        public void GetPaymentPartyForPage(string PartyCode, int Page = 0)
        {
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            IDataParameter[] Dparam = lstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentPartyForBondPage", CommandType.StoredProcedure, Dparam);
        ...
        public void GetWOForDeliveryOrder()
        {
            ...
            List<ListOfWFLDWorkOrderNo> LstWONo = new List<ListOfWFLDWorkOrderNo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    {
                        LstWONo.Add(new ListOfWFLDWorkOrderNo
                        {
                            SacNo = Convert.ToString(Result["SacNo"]),
                            SpaceappId = Convert.ToInt32(Result["SpaceAppId"]),
                            BondNo = Convert.ToString(Result["BondNo"]),
        ...
        public void GetWODetForDeliveryOrder(int SpaceAppId, string BondNo = "")
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondWOForDeliveryOrder", CommandType.StoredProcedure, DParam);
            WFLDDeliveryOrder ObjDeliOrder = new WFLDDeliveryOrder();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void GetAllDeliveryOrder(int Page,string Search)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstBond.Add(new ListOfDeliveryOrder
                    {
                        ...
                        SACNo = Convert.ToString(Result["SACNo"]),
                        SACDate = Convert.ToString(Result["SACDate"]),
                        BondNo = Convert.ToString(Result["BondNo"]),
                    });
                }
                if (Status == 1)
        ...
        public void GetDeliveryOrder(int DeliveryOrderId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderhdb.Add(new WFLDDeliveryOrderDtl
                        {
                            ...
                            AreasReserved = Convert.ToDecimal(Result["AreaAppliedReserved"]),
                            ClosingAreasReserved = Convert.ToInt32(Result["ClosingAreasReserved"]),
                        });
                    }
                }
        ...
        public void PrintDelivery(int DeliveryAppId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryPrintOrder.Add(new WFLDDeliveryOrderforPrint
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderPayment.Add(new WFLDDeliveryOrderPaymentPrint
                        {
                            SacDate = Result["SacDate"].ToString(),
                            DepositDate = Result["DepositDate"].ToString(),
                            DepositNo = Result["DepositNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstGst.Add(new WFLDDeliveryGSTCharge
                        {
                            SGSTAmt = Convert.ToDecimal(Result["SGSTAmt"].ToString()),
                            CGSTAmt = Convert.ToDecimal(Result["CGSTAmt"].ToString()),
                            IGSTAmt = Convert.ToDecimal(Result["IGSTAmt"].ToString()),
        ...
        public void AddEditDeliveryOrder(WFLDDeliveryOrder ObjDeliveryOrder, string DeliveryOrderXml)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ObjDeliveryOrder.DeliveryOrderDate = DateTime.ParseExact(ObjDeliveryOrder.DeliveryOrderDate, "dd/MM/yyyy HH:mm", System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_DeliveryOrderDate", MySqlDbType = MySqlDbType.DateTime, Value = ObjDeliveryOrder.DeliveryOrderDate });
        ...
        public void GetDepositDetForDelvOrder(int DepositAppId)
        {
            ...
            WFLDDeliveryOrderDtl ObjDepositNo = new WFLDDeliveryOrderDtl();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjDepositNo.ClosingAreasReserved = Convert.ToDecimal(Result["ClosingAreasReserved"]);
        ...
        public void GetBondDelPaymentSheet(string DeliveryDate,string InvoiceDate, string InvoiceType, int StuffingReqId, int DeliveryType, string StuffingReqNo, string StuffingReqDate, string UptoDate, decimal Area,
            ...
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName, string ExportUnder, int InvoiceId = 0, int NoOfVahical = 0)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            WFLDBondPostPaymentSheet objInvoice = new WFLDBondPostPaymentSheet();
            List<String> Clause = new List<String>();
            ...
            try
            {
                ...
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    objInvoice.IsLocalGST = Convert.ToInt32(row["IsLocalGST"]);
                }
        ...
        public void AddEditBondDelInvoice(WFLDBondPostPaymentSheet ObjPostPaymentSheet, string ChargesXML, int BranchId, int Uid, string Module,int Vno, decimal TotalValueOfCargo,int BillToParty)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetSACNoForUnlodBondPaymentSheet(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (IList<WFLDBondSacDetails>)DataAccess.ExecuteDynamicSet<WFLDBondSacDetails>("GetSACForBondUnloading");
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    ...
                    while (Result.Read())
                    {
                        ...
                        objInvoice.StorageFromDate = Result["StorageFromDate"].ToString();
                        objInvoice.StorageToDate = Result["StorageToDate"].ToString();
                        objInvoice.CalcArea = Convert.ToDecimal(Result["CalcArea"]);
                        objInvoice.InsuranceFromDate = Result["InsuranceFromDate"].ToString();
                        objInvoice.InsuranceToDate = Result["InsuranceToDate"].ToString();
                        objInvoice.CalcCIFValue = Convert.ToDecimal(Result["CalcCIFValue"]);
                        objInvoice.CalcDuty = Convert.ToDecimal(Result["CalcDuty"]);
        ...
        public void GetSACNoForUnlodBondPaymentSheetRemaining(int CartingAppId = 0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        
            LstParam.Add(new MySqlParameter { ParameterName = "DeliveryOrderId", MySqlDbType = MySqlDbType.Int32, Value = CartingAppId });
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondDeliveryPaymentSheetRemainging", CommandType.StoredProcedure, DParam);
            WFLDBondRemaining ObjDepositNo = new WFLDBondRemaining();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;                   
                    ObjDepositNo.ClosingUnits = Convert.ToInt32(Result["ClosingUnits"]);
                    ObjDepositNo.ClosingWeight = Convert.ToInt32(Result["ClosingWeight"]);
                    ObjDepositNo.ClosingArea = Convert.ToDecimal(Result["ClosingArea"]);
                    ObjDepositNo.ClosingValue = Convert.ToDecimal(Result["ClosingValue"]);
                    ObjDepositNo.ClosingDuty = Convert.ToDecimal(Result["ClosingDuty"]);
        ...
        public void AddEditBondUnloadingInvoice(WFLD_LoadedContainerPayment ObjPostPaymentSheet, int Vno, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string CfsChargeXML, int BranchId, int Uid,
            string Module, int BillToParty, string CargoXML = "")
        {
            //  var cfsCodeWiseHtRate = HttpContext.Current.Session["lstCfsCodewiseRateHT"];
            //  string cfsCodeWiseHtRateXML = UtilityClasses.Utility.CreateXML(cfsCodeWiseHtRate);
            ...
            // LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceHtml", MySqlDbType = MySqlDbType.Text, Value = ObjPostPaymentSheet.InvoiceHtml });
            //Sac delivery detail
            LstParam.Add(new MySqlParameter { ParameterName = "in_StorageFromDate", MySqlDbType = MySqlDbType.Date, Value = ObjPostPaymentSheet.StorageFromDate });
            LstParam.Add(new MySqlParameter { ParameterName = "in_StorageToDate", MySqlDbType = MySqlDbType.Date, Value = ObjPostPaymentSheet.StorageToDate });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Area", MySqlDbType = MySqlDbType.Decimal, Value = ObjPostPaymentSheet.CalcArea });
            LstParam.Add(new MySqlParameter { ParameterName = "in_InsuranceFromDate", MySqlDbType = MySqlDbType.Date, Value = ObjPostPaymentSheet.InsuranceFromDate });
            LstParam.Add(new MySqlParameter { ParameterName = "in_InsuranceToDate", MySqlDbType = MySqlDbType.Date, Value = ObjPostPaymentSheet.InsuranceToDate });
            LstParam.Add(new MySqlParameter { ParameterName = "in_CIFValue", MySqlDbType = MySqlDbType.Decimal, Value = ObjPostPaymentSheet.CalcCIFValue });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Duty", MySqlDbType = MySqlDbType.Decimal, Value = ObjPostPaymentSheet.CalcDuty });
        ...
        public void GetPaymentPayer()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentPayer", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            IList<CwcExim.Areas.Export.Models.PaymentPartyName> objPaymentPartyName = new List<CwcExim.Areas.Export.Models.PaymentPartyName>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaymentPartyName.Add(new CwcExim.Areas.Export.Models.PaymentPartyName()
                    {
                        PartyId = Convert.ToInt32(Result["CHAId"]),
                        PartyName = Convert.ToString(Result["CHAName"]),
        ...
        public void AddEditAdvanceBondInvoiceOptional(WFLD_LoadedContainerPayment ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string CfsChargeXML, int BranchId, int Uid,
            string Module,int BillToParty, string CargoXML = "")
        {
            //  var cfsCodeWiseHtRate = HttpContext.Current.Session["lstCfsCodewiseRateHT"];
            //  string cfsCodeWiseHtRateXML = UtilityClasses.Utility.CreateXML(cfsCodeWiseHtRate);
        ...
        public void ListOfSACForAmend()
        {
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("bondAmendSacDtl", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<dynamic> lstApp = new List<dynamic>();
            try
            {
                while (Result.Read())
                {
        ...
        public void SACAmendDetails(int SpaceappId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_SpaceappId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = SpaceappId });
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objApp.objBondAmend.SACNo = Result["SacNo"].ToString();
                    objApp.objBondAmend.SpaceappId = Convert.ToInt32(Result["SpaceappId"]);
                    objApp.objBondAmend.OldUOM = Convert.ToString(Result["OldUOM"]);
                    objApp.objBondAmend.NewUOM = Convert.ToString(Result["NewUOM"]);
                    if(!string.IsNullOrEmpty(Result["DepositNo"].ToString()))
                    {
                        objApp.lstBondAmendDtl.Add(new WfldBondAmendmentDtl
                        {
                            DepositNo = Convert.ToString(Result["DepositNo"]),
                            DepositDate = Convert.ToString(Result["DepositDate"]),
                            BondNo = Convert.ToString(Result["BondNo"]),
                            OldUnits = Convert.ToInt32(Result["OldUnits"]),
                            NewUnits = Convert.ToInt32(Result["NewUnits"]),
                            OldWeight = Convert.ToDecimal(Result["OldWeight"]),
                            NewWeight = Convert.ToDecimal(Result["NewWeight"]),
                            DepositAppId = Convert.ToInt32(Result["DepositAppId"]),
                            UnloadingId = Convert.ToInt32(Result["UnloadingId"]),
                        });
                    }
        ...
        public void AddEditBondAmendment(WfldBondAmendmentViewNodel objBA,string XML)
        {
            string ApplicationNo = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_AmendDate", MySqlDbType = MySqlDbType.DateTime, Value =DateTime.ParseExact(objBA.AmendDate,"dd/MM/yyyy",CultureInfo.InvariantCulture).ToString("yyyy-MM-dd") });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SpaceappId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = objBA.objBondAmend.SpaceappId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_OldUOM", MySqlDbType = MySqlDbType.VarChar, Value = objBA.objBondAmend.OldUOM });
            LstParam.Add(new MySqlParameter { ParameterName = "in_NewUOM", MySqlDbType = MySqlDbType.VarChar, Value = objBA.objBondAmend.NewUOM });
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("AddEditBondAmendment", CommandType.StoredProcedure, DParam, out ApplicationNo);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = (Result == 1) ? "Bond Amendment Saved Successfully" : "Bond Application Updated Successfully";
                    _DBResponse.Data = ApplicationNo;
                }
                else
                {
        ...
        public void ListOfBondAmendment(int Page, string Search)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = Page });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Search", MySqlDbType = MySqlDbType.VarChar, Value = Search });
            LstParam.Add(new MySqlParameter { ParameterName = "in_AmendNo", MySqlDbType = MySqlDbType.VarChar, Value = "" });
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfBondAmend", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstApp.Add(new WfldBondAmendmentList
                    {
                        AmendNo = Convert.ToString(Result["AmendNo"]),
                        AmendDate = Result["AmendDate"].ToString(),
                        SACNo = Result["SacNo"].ToString(),
                        SACDate = Result["SacDate"].ToString()
                    });
                }
        ...
        public void ViewBondAmendment(string AmendNo)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Value = -1 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Search", MySqlDbType = MySqlDbType.VarChar, Value = "" });
            LstParam.Add(new MySqlParameter { ParameterName = "in_AmendNo", MySqlDbType = MySqlDbType.VarChar, Value = AmendNo });
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfBondAmend", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objApp.AmendNo = Convert.ToString(Result["AmendNo"]);
                    objApp.AmendDate = Convert.ToString(Result["AmendDate"]);
                    objApp.objBondAmend.SACNo= Convert.ToString(Result["SACNo"]);
                    objApp.objBondAmend.SpaceappId = Convert.ToInt32(Result["SpaceappId"]);
                    objApp.objBondAmend.OldUOM = Convert.ToString(Result["OldUOM"]);
                    objApp.objBondAmend.NewUOM = Convert.ToString(Result["NewUOM"]);
                    if(!string.IsNullOrEmpty(Result["DepositNo"].ToString()))
