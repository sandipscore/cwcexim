...
{
    public class VRN_BondRepository
    {
        ...
        public void ListOfSpaceAvailability()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstApp.Add(new VRN_ListOfBondApp
                    {
        ...
        public void GetSpaceAvailAppCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_SpaceAvailAppCertPdf ObjSpaceAvailCert = new VRN_SpaceAvailAppCertPdf();
            try
            {
                while (Result.Read())
                {
        ...
        public void AddEditBondApp(VRN_BondApp objBA)
        {
        ...
        public void AddEditBondSpaceAvailCert(VRN_SpaceAvailableCert ObjSpaceAvail)
        {
        ...
        public void GetSpaceAvailCert(int Status, int Skip)
        {
            ...
            List<VRN_ListOfBondApp> LstSpaceAvail = new List<VRN_ListOfBondApp>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstSpaceAvail.Add(new VRN_ListOfBondApp
                    {
                        SpaceappId = Convert.ToInt32(Result["SpaceappId"]),
                        ApplicationNo = Convert.ToString(Result["ApplicationNo"]),
        ...
        public void GetSpaceAvailCertForPrint(int SpaceappId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_SpaceAvailCertPdf ObjSpaceAvailCert = new VRN_SpaceAvailCertPdf();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetBondAdvancePaymentSheet(string InvoiceDate,string ExportUnder, int DestuffingAppId, int DeliveryType, string DestuffingAppNo, string DestuffingAppDate, int PartyId, string PartyName,
    ...
    string InvoiceType, decimal area, int InvoiceId = 0, int No = 0,int OTHour = 0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            VRN_PostPaymentSheet objInvoice = new VRN_PostPaymentSheet();
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstPostPaymentChrg.Add(new VRN_PostPaymentCharge
                        {
        ...
        public void GetSACNoForAdvBondPaymentSheet(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (IList<VRN_BondSacDetails>)DataAccess.ExecuteDynamicSet<VRN_BondSacDetails>("GetSACNoForBondAdvPaymentSheet");
        ...
        public void AddEditInvoice(VRN_PostPaymentSheet ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string CfsChargeXML, int BranchId, int Uid,
        ...
        public void GetPaymentPayerForPage(string PartyCode, int Page = 0)
        {
            ...
            IList<ImpPartyForpage> lstPayer = new List<ImpPartyForpage>();
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstPayer.Add(new ImpPartyForpage
                    {
        ...
        public void GetSacNoForDepositApp()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstDepositApp.Add(new VRN_DepositApp
                    {
        ...
        public void GetAllVehicle(string SacNo)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VRN_VehicleForBondDeposit> LstVehicle = new List<VRN_VehicleForBondDeposit>();
            try
            {
                while (Result.Read())
                ...
                {
                    Status = 1;
                    LstVehicle.Add(new VRN_VehicleForBondDeposit
                    {
        ...
        public void AddEditBondDepositApp(VRN_DepositApp ObjDepositApp)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetSacNodepositDet(int SpaceappId, int EntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_DepositApp ObjSpaceAvail = new VRN_DepositApp();
            try
            {
                while (Result.Read())
                {
        ...
        public void PrintDA(int DepositeAppId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_PrintDA ObjDepositApp = new VRN_PrintDA();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstSAC.Add(new VRN_SACDet
                        {
                            SacNo = Result["SacNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDepositApp.lstGodown.Add(new VRN_GodDet
                        {
        ...
        public void DeleteBondDepositApp(int DepositAppId)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteDepositApp", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = "Deposit Application Deleted Successfully";
                    _DBResponse.Data = null;
                }
                else if (Result == 2)
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = "Cannot Delete Bond Deposit Application";
                    _DBResponse.Data = null;
                }
                else if (Result == 3)
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = "Cannot Delete Bond Deposit Application  As Next Step Already Done";
                    _DBResponse.Data = null;
                }
        ...
        public void GetBondNoForWOUnloading()
        {
            ...
            List<VRN_ListOfBOENo> LstBond = new List<VRN_ListOfBOENo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                ...
                {
                    status = 1;
                    LstBond.Add(new VRN_ListOfBOENo
                    {
        ...
        public void GetBondNoForWOUnloadingDet(int DepositAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondNoUnloading", CommandType.StoredProcedure, DParam);
            VRN_BOENoDetails objBOE = new VRN_BOENoDetails();
            _DBResponse = new DatabaseResponse();
        ...
        public void AddEditWOUnloading(VRN_BondWOUnloading obj)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void PrintWOUnloading(int UnloadingId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_BondWOUnloadingPDF ObjUnloading = new VRN_BondWOUnloadingPDF();
            try
            {
                while (Result.Read())
                {
        ...
        public void DeleteBondUnloadingApp(int UnloadingId)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_UnloadingId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = UnloadingId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Value = 0, Direction = ParameterDirection.Output });
            IDataParameter[] DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("DeleteUnloadingApp", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = "Unloading Application Deleted Successfully";
                    _DBResponse.Data = null;
                }
                else if (Result == 2)
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = "Cannot Delete Bond Unloading Application";
                    _DBResponse.Data = null;
                }
                else if (Result == 3)
                {
                    _DBResponse.Status = Result;
                    _DBResponse.Message = "Cannot Delete Bond Unloading Application  As Next Step Already Done";
                    _DBResponse.Data = null;
                }
        ...
        public void GetWOForDeliveryOrder()
        {
            ...
            List<VRN_ListOfWorkOrderNo> LstWONo = new List<VRN_ListOfWorkOrderNo>();
            _DBResponse = new DatabaseResponse();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    {
                        LstWONo.Add(new VRN_ListOfWorkOrderNo
                        {
        ...
        public void GetWODetForDeliveryOrder(int SpaceAppId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondWOForDeliveryOrder", CommandType.StoredProcedure, DParam);
            VRN_DeliveryOrder ObjDeliOrder = new VRN_DeliveryOrder();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void GetDeliveryOrder(int DeliveryOrderId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjDeliveryOrder.TotalArea = Convert.ToDecimal(Result["TotalArea"]);
                    ObjDeliveryOrder.TotalWeight = Convert.ToDecimal(Result["TotalWeight"]);
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderhdb.Add(new VRN_DeliveryOrderDtl
                        {
        ...
        public void PrintDelivery(int DeliveryAppId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryPrintOrder.Add(new VRN_DeliveryOrderforPrint
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstDeliveryOrderPayment.Add(new VRN_DeliveryOrderPaymentPrint
                        {
                            SacDate = Result["SacDate"].ToString(),
                            DepositDate = Result["DepositDate"].ToString(),
                            DepositNo = Result["DepositNo"].ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjDeliveryOrder.LstGst.Add(new VRN_DeliveryGSTCharge
                        {
                            SGSTAmt = Convert.ToDecimal(Result["SGSTAmt"].ToString()),
                            CGSTAmt = Convert.ToDecimal(Result["CGSTAmt"].ToString()),
                            IGSTAmt = Convert.ToDecimal(Result["IGSTAmt"].ToString()),
        ...
        public void AddEditDeliveryOrder(VRN_DeliveryOrder ObjDeliveryOrder, string DeliveryOrderXml)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetDepositNoForDelvOrder(int SpaceAppId)
        {
            ...
            List<VRN_DeliveryOrderDtl> LstDepositNo = new List<VRN_DeliveryOrderDtl>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstDepositNo.Add(new VRN_DeliveryOrderDtl
                    {
                        DepositAppId = Convert.ToInt32(Result["DepositAppId"]),
                        DepositNo = Convert.ToString(Result["DepositNo"])
                    });
        ...
        public void GetDepositDetForDelvOrder(int DepositAppId)
        {
            ...
            VRN_DeliveryOrderDtl ObjDepositNo = new VRN_DeliveryOrderDtl();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjDepositNo.UnloadedArea = Convert.ToDecimal(Result["UnloadedArea"]);
                    ObjDepositNo.UnloadedWeight = Convert.ToDecimal(Result["UnloadWeight"]);
                    ObjDepositNo.UnloadedValue = Convert.ToDecimal(Result["UnloadedValue"]);
                    ObjDepositNo.UnloadedDuty = Convert.ToDecimal(Result["UnloadedDuty"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void AddEditBondSpaceAvailCertExt(VRN_SpaceAvailCertExtend ObjSpaceAvail)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllSpaceAvailCertExt()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstSpaceAvail.Add(new VRN_SpaceAvailCertExtend
                    {
        ...
        public void GetSacNo()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VRN_SpaceAvailableCert> LstSpaceAvail = new List<VRN_SpaceAvailableCert>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSpaceAvail.Add(new VRN_SpaceAvailableCert
                    {
                        SpaceappId = Convert.ToInt32(Result["SpaceappId"]),
                        SacNo = Result["SacNo"].ToString()
                    });
        ...
        public void GetSpaceAvailabilityExt(int SpaceAvailCertExtId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetBondSpaceAvailCertExt", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            VRN_BondAppExtendDetails ObjSpaceAvail = new VRN_BondAppExtendDetails();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetBondAdvancePaymentSheetInterim(string InvoiceDate, int DestuffingAppId, int DeliveryType, string DestuffingAppNo, string DestuffingAppDate, int PartyId, string PartyName,
string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId, string PayeeName, int CasualLabour,
string InvoiceType, decimal area, int InvoiceId = 0, string ExportUnder = "")
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        public void GetSACNoForAdvBondPaymentSheetInterim(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (IList<VRN_BondSacDetails>)DataAccess.ExecuteDynamicSet<VRN_BondSacDetails>("GetSACNoForBondAdvPaymentSheeForInterim");
        ...
        public void AddEditInvoiceForBond(VRN_PostPaymentSheet ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string CfsChargeXML, int BranchId, int Uid,
       string Module, string CargoXML = "")
        {
        ...
        public void GetSACNoForDelBondPaymentSheet(int CartingAppId = 0)
        {
            ...
            try
            {
                var objBondSacDetails = (List<VRN_BondSacDetails>)DataAccess.ExecuteDynamicSet<VRN_BondSacDetails>("GetSACForBondDelivery");
        ...
        public void GetBondDelPaymentSheet(string InvoiceDate, string InvoiceType, int StuffingReqId, int DeliveryType, string StuffingReqNo, string StuffingReqDate, string UptoDate, decimal Area,
           ...
           int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName, string ExportUnder, int InvoiceId = 0, int OTHour = 0)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            VRN_BondPostPaymentSheet objInvoice = new VRN_BondPostPaymentSheet();
            List<String> Clause = new List<String>();
            ...
            try
            {
                ...
                {
                   objInvoice.PaymentMode = row["IN_MODE"].ToString();
                }
        ...
        public void AddEditBondDelInvoice(VRN_BondPostPaymentSheet ObjPostPaymentSheet, string ChargesXML, int BranchId, int Uid, string Module, decimal TotalValueOfCargo)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void ListOfBondInvoice(string Module, string InvoiceNo = null, string InvoiceDate = null)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VRN_ListOfBondInvoice> lstInvoice = new List<VRN_ListOfBondInvoice>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstInvoice.Add(new VRN_ListOfBondInvoice()
                    {
