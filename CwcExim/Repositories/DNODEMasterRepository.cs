...
{
    public class DNODEMasterRepository
    {
        ...
        public void AddEditEximTrader(DndEximTrader ObjEximTrader)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_PhoneNo1", MySqlDbType = MySqlDbType.VarChar, Value = ObjEximTrader.PhoneNo1 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PhoneNo2", MySqlDbType = MySqlDbType.VarChar, Value = ObjEximTrader.PhoneNo2 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PhoneNo3", MySqlDbType = MySqlDbType.VarChar, Value = ObjEximTrader.PhoneNo3 });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Mainline", MySqlDbType = MySqlDbType.Int32, Value = ObjEximTrader.Mainline });
        ...
        public void DeleteEximTrader(int EximTraderId)
        {
            ...
            try
            {
                ...
                {
                    _DBResponse.Status = 6;
                    _DBResponse.Message = "Cannot Delete Exim Trader as it exist in Invoice";
                    _DBResponse.Data = null;
                }
                else
                {
        ...
        public void GetEximTrader(int EximTraderId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEximTrader.Forwarder = Convert.ToBoolean(Result["ForwarderConsolidator"] == DBNull.Value ? 0 : Result["ForwarderConsolidator"]);
                    ObjEximTrader.Mainline = Convert.ToBoolean(Result["Mainline"] == DBNull.Value ? 0 : Result["Mainline"]);
                    ...
                    ObjEximTrader.PhoneNo1 = (Result["PhoneNo1"] == null ? "" : Result["PhoneNo1"]).ToString();
                    ObjEximTrader.PhoneNo2 = (Result["PhoneNo2"] == null ? "" : Result["PhoneNo2"]).ToString();
                    ObjEximTrader.PhoneNo3 = (Result["PhoneNo3"] == null ? "" : Result["PhoneNo3"]).ToString();
        ...
        public void GetAllEximTrader()
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstEximTrader.Add(new DndEximTrader
                    {
        ...
        public void GetGetAllEximTraderPartyCode(string PartyCode, int TypeOfPartyId)
        {
            int Status = 0;
            string[] EmailSplit = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_PartyCode", MySqlDbType = MySqlDbType.VarChar, Value = PartyCode });
            LstParam.Add(new MySqlParameter { ParameterName = "in_TypeOfPartyId", MySqlDbType = MySqlDbType.Int32, Value = TypeOfPartyId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        #region PORT
        public void AddEditPort(DNDPort ObjPort)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetAllPortCode(string PortCode)
        {
            int Status = 0;
           // string[] EmailSplit = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_PortCode", MySqlDbType = MySqlDbType.VarChar, Value = PortCode });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstPortCode", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<DNDPort> LstPort = new List < DNDPort >();
            try
            {
        ...
        public void GetAllPortList(int Page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_PortId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = 0 });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllPortListPageWise", CommandType.StoredProcedure, DParam);
            List<DNDPort> LstPort = new List<DNDPort>();
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        #region HT Charges
        public void AddEditHTCharges(DNDHTCharges objHT, int Uid, String ChargeListXML)
        {
            /*
            ...
            */
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Value = objHT.IsITP });
        ...
        public void GetSlabData(string Size, string ChargesFor,string OperationCode)
        {
            ...
            DNDHTCharges Obj = new DNDHTCharges();
            int Status = 0;
            try
            {
                while (result.Read())
                {
                    Status = 1;
                    Obj.LstWeightSlab.Add(new DNDWeightSlab
                    {
                ...
                if (result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        Obj.LstDistanceSlab.Add(new DNDDistanceSlab
                        {
        ...
        public void GetHTSlabChargesDtl(int HTChargesID)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<DNDChargeList> LstCharge = new List<DNDChargeList>();
            int Status = 0;
            try
            {
                ...
                {
                    Status = 1;
                    LstCharge.Add(new DNDChargeList
                    {
        ...
        public void GetAllHTCharges()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstCharges.LstviewList.Add(new DNDViewList
                    {
                ...
                if (result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        lstCharges.LstWeightSlab.Add(new DNDWeightSlab
                        {
                            WeightSlabId = Convert.ToInt32(result["WeightSlabId"].ToString()),
                            FromWeightSlab = Convert.ToInt32(result["FromWeightSlab"].ToString()),
                            ToWeightSlab = Convert.ToInt32(result["ToWeightSlab"]),
                ...
                if (result.NextResult())
                {
                    ...
                    {
                        Status = 1;
                        lstCharges.LstDistanceSlab.Add(new DNDDistanceSlab
                        {
                            DistanceSlabId = Convert.ToInt32(result["DistanceSlabId"].ToString()),
                            FromDistanceSlab = Convert.ToInt32(result["FromDistanceSlab"].ToString()),
                            ToDistanceSlab = Convert.ToInt32(result["ToDistanceSlab"]),
        ...
        public void GetHTChargesDetails(int HTChargesId)
        {
            ...
            try
            {
                while (result.Read())
                {
                    ...
                    objHt.IsITP = Convert.ToBoolean(result["IsITP"]);
                }
                if (Status == 1)
                {
        ...
        public void AddEditStorageCharge(DNDCWCStorageCharge ObjStorage)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Size = 2, Value = Convert.ToInt32(ObjStorage.IsITP) });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", Direction = ParameterDirection.Output, MySqlDbType = MySqlDbType.Int32, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", Direction = ParameterDirection.Output, MySqlDbType = MySqlDbType.Int32, Value = GeneratedClientId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
        ...
        public void GetAllStorageCharge()
        {
            ...
            List<DNDCWCStorageCharge> LstStorageCharge = new List<DNDCWCStorageCharge>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStorageCharge.Add(new DNDCWCStorageCharge
                    {
        ...
        public void GetStorageCharge(int StorageChargeId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetMstStorageCharge", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            DNDCWCStorageCharge ObjStorage = new DNDCWCStorageCharge();
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjStorage.IsITP = Convert.ToBoolean(Result["IsITP"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        #region Weighment
        public void AddEditMstWeighment(DNDCWCWeighment objCW, int Uid)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Size = 2, Value = Convert.ToInt32(objCW.IsITP) });
            lstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = Uid });
            lstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Value = 0, Direction = ParameterDirection.Output });
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
            IDataParameter[] dpram = lstParam.ToArray();
        ...
        public void GetWeighmentDet(int WeighmentId)
        {
            ...
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            IList<DNDCWCWeighment> lstWeighment = null;
            DNDCWCWeighment objCWC = null;
            try
            {
                if (WeighmentId == 0)
                {
                    lstWeighment = new List<DNDCWCWeighment>();
                    while (result.Read())
                    {
                        Status = 1;
                        lstWeighment.Add(new DNDCWCWeighment
                        {
                ...
                else
                {
                    ...
                    while (result.Read())
                    {
                        ...
                        objCWC.IsITP = Convert.ToBoolean(result["IsITP"]);
                    }
        ...
        #region Entry Fees
        public void AddEditMstEntryFees(DNODECWCEntryFees objEF, int Uid)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_ContainerSize", MySqlDbType = MySqlDbType.VarChar, Size = 4, Value = objEF.ContainerSize });
            lstParam.Add(new MySqlParameter { ParameterName = "in_SacCode", MySqlDbType = MySqlDbType.VarChar, Size = 7, Value = objEF.SacCode });
            lstParam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Size = 2, Value = Convert.ToInt32(objEF.IsITP) });
            lstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = Uid });
            lstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            IDataParameter[] dparam = lstParam.ToArray();
            DataAccessLayerBaseClass DA = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        public void GetAllEntryFees(int EntryFeeId)
        {
            ...
            IList<DNODECWCEntryFees> lstEntryFees = null;
            DNODECWCEntryFees objEF = null;
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            try
            {
                if (EntryFeeId == 0)
                {
                    lstEntryFees = new List<DNODECWCEntryFees>();
                    while (result.Read())
                    {
                        Status = 1;
                        lstEntryFees.Add(new DNODECWCEntryFees
                        {
                ...
                else
                {
                    ...
                    while (result.Read())
                    {
                        ...
                        objEF.IsITP = Convert.ToBoolean(result["IsITP"]);
                    }
                }
                if (Status == 1 || Status == 2)
                {
        ...
        #region Ground Rent
        public void AddEditMstGroundRent(DNDCWCChargesGroundRent objCR, int Uid)
        {
            List<MySqlParameter> lstparam = new List<MySqlParameter>();
            ...
            lstparam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Size = 2, Value = Convert.ToInt32(objCR.IsITP) });
        ...
        public void GetAllGroundRentDet()
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<DNDCWCChargesGroundRent> objList = new List<DNDCWCChargesGroundRent>();
            try
            {
                while (result.Read())
                {
                    Status = 1;
                    objList.Add(new DNDCWCChargesGroundRent
                    {
        ...
        public void GetGroundRentDet(int GroundRentId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            DNDCWCChargesGroundRent objGR = null;
            try
            {
                while (result.Read())
                {
                    Status = 1;
                    objGR = new DNDCWCChargesGroundRent();
                    ...
                    objGR.IsITP = Convert.ToBoolean(result["IsITP"]);
                }
                if (Status == 1)
                {
        ...
        #region Reefer
        public void AddEditMstReefer(DNDCWCReefer objRef)
        {
            List<MySqlParameter> lstparam = new List<MySqlParameter>();
            ...
            lstparam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Value = objRef.IsITP });
        ...
        public void GetReeferDet(int ReeferChrgId)
        {
            ...
            try
            {
                while (result.Read())
                {
                    ...
                    objRef.IsITP = Convert.ToBoolean(result["IsITP"]);
                }
                if (Status == 1)
                {
        ...
        #region Insurance
        public void AddEditInsurance(DNDInsurance ObjInsurance)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            LstParam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Value = ObjInsurance.IsITP });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Value = 0, Direction = ParameterDirection.Output });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
        ...
        public void GetAllInsurance()
        {
            ...
            List<DNDInsurance> LstInsurance = new List<DNDInsurance>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstInsurance.Add(new DNDInsurance
                    {
        ...
        public void GetInsurance(int InsuranceId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjInsurance.IsITP = Convert.ToBoolean(Result["IsITP"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void GetFranchiseCharge(int franchisechargeid)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            DNDCWCFranchiseCharges objFcs = new DNDCWCFranchiseCharges();
            try
            {
                while (result.Read())
                {
                    ...
                    objFcs.IsITP = Convert.ToBoolean(result["IsITP"]);
        ...
        public void AddEditMstFranchiseCharges(DNDCWCFranchiseCharges objFC, int Uid)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            ...
            lstParam.Add(new MySqlParameter { ParameterName = "in_IsITP", MySqlDbType = MySqlDbType.Int32, Size = 2, Value = Convert.ToInt32(objFC.IsITP) });
        ...
        public void GetAllFranchiseCharges()
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objList.Add(new DNDCWCFranchiseCharges
                    {
        ...
        public void GetEximTraderNew(int EximTraderId)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstEximTrader.Add(new DndEximTraderFinanceControl
                    {
                        ...
                        SDBalance = Convert.ToDecimal(Result["SDBalance"] == DBNull.Value ? 0 : Result["SDBalance"]),
                    });
                }
                if (Status == 1)
                {
        ...
        public void SearchEximFinanceControl(string EximName)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Eximname", MySqlDbType = MySqlDbType.VarChar, Value = EximName });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("SearchEximFinanceControl", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            List<DndEximTraderFinanceControl> LstEximTrader = new List<DndEximTraderFinanceControl>();
            try
            {
        ...
        public void GetEximFinanceControl(int FinanceControlId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    ObjEximTrader.GSTNo = (Result["GSTNo"] == null ? "" : Result["GSTNo"]).ToString();
                    ObjEximTrader.Tan = (Result["Tan"] == null ? "" : Result["Tan"]).ToString();
                    ObjEximTrader.SDBalance = Convert.ToDecimal(Result["SDBalance"] == DBNull.Value ? 0 : Result["SDBalance"]);
                }
                if (Status == 1)
                {
                    _DBResponse.Status = 1;
        ...
        public void AddEditEximFinanceControl(DndEximTraderFinanceControl ObjEximTrader)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void RemoveEximFinanceCreditLimit()
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Value = 0, Direction = ParameterDirection.Output });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            int Result = DataAccess.ExecuteNonQuery("RemoveEximFinanceCreditLimit", CommandType.StoredProcedure, DParam, out GeneratedClientId);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1)
                {
                    _DBResponse.Status = 1;
                    _DBResponse.Message = "Exim Trader Finance Credit Limit Remove Successfully";
                    _DBResponse.Data = GeneratedClientId;
                }
                else
                {
