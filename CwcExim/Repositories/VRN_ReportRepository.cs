...
{
    public class VRN_ReportRepository
    {
        ...
        public void GetInvoiceList(string FromDate, string ToDate, string invoiceType,int Pid)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Party", MySqlDbType = MySqlDbType.Int32, Value = Pid });
        ...
        public void GetRegisterofOutwardSupply(DateTime date1, DateTime date2,string Type)
        {
            ...
            {
                List<VRN_RegisterOfOutward> model = new List<VRN_RegisterOfOutward>();
                try
                {
                    if (ds.Tables.Count > 0)
                    {
                        model = (from DataRow dr in dt.Rows
                                 select new VRN_RegisterOfOutward()
                                 {
            ...
            {
                List<VRNRegisterOfOutwardSupplyModelCreditDebit> modelCreditDebit = new List<VRNRegisterOfOutwardSupplyModelCreditDebit>();
                try
                {
                    if (ds.Tables.Count > 0)
                    {
                        modelCreditDebit = (from DataRow dr in dt.Rows
                                 select new VRNRegisterOfOutwardSupplyModelCreditDebit()
                                 {
                                     SlNo = Convert.ToInt32(dr["SlNo"]),
                                     GST = dr["GST"].ToString(),
                                     Place = dr["Place"].ToString(),
        ...
        private string RegisterofOutwardSupplyExcelVRN(List<VRNRegisterOfOutwardSupplyModel> model, decimal InvoiceAmount, decimal CRAmount, DataTable dt)
        {
        ...
        private string RegisterofOutwardSupplyExcel(List<VRN_RegisterOfOutward> model, decimal InvoiceAmount, decimal CRAmount)
        {
            if (!System.IO.Directory.Exists(HttpContext.Current.Server.MapPath("~/Docs/Excel")))
            {
                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/Docs/Excel"));
            ...
            using (var exl = new DynamicExcel.ExcelGenerator(excelFile))
            {
                ...
                exl.AddTable<VRN_RegisterOfOutward>("A", 6, model, new[] { 6, 20, 20, 20, 12, 20, 10, 15, 20, 12, 12, 8, 14, 8, 14, 8, 14, 16, 10, 30 });
        ...
        private string RegisterofOutwardSupplyExcelCreditDebit(List<VRNRegisterOfOutwardSupplyModelCreditDebit> modelCreditDebit, decimal InvoiceAmount, decimal CRAmount, string date1, string date2, string Type)
        {
            if (!System.IO.Directory.Exists(HttpContext.Current.Server.MapPath("~/Docs/Excel")))
            {
                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/Docs/Excel"));
            ...
            using (var exl = new DynamicExcel.ExcelGenerator(excelFile))
            {
                ...
                exl.MargeCell("O5:O6", "RoundUp", DynamicExcel.CellAlignment.Middle);
                exl.MargeCell("P5:P6", "Total Invoice Value", DynamicExcel.CellAlignment.Middle);
                ...
                exl.AddTable("A", 7, modelCreditDebit, new[] { 6, 20, 20, 30, 12, 20, 20, 15, 15, 15, 14, 12, 12, 8, 14,14 });
                ...
                var rndup = modelCreditDebit.Sum(o => o.RoundUp);
                ...
                exl.AddCell("O" + (modelCreditDebit.Count + 7).ToString(), rndup.ToString(), DynamicExcel.CellAlignment.TopLeft);
                exl.AddCell("P" + (modelCreditDebit.Count + 7).ToString(), totalamt.ToString(), DynamicExcel.CellAlignment.TopLeft);
        ...
        public void DailyCashBook(string PeriodFrom, string PeriodTo)
        {
            ...
            IList<VRN_DailyCashBook> LstDailyCashBook = new List<VRN_DailyCashBook>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstDailyCashBook.Add(new VRN_DailyCashBook
                    {
                        ...
                        CstmExam = Convert.ToDecimal(Result["CstmExam"]),
                        Weighment = Convert.ToDecimal(Result["Weighment"]),
                        CstmCl = Convert.ToDecimal(Result["CstmCl"]),
                        //HT = Convert.ToDecimal(Result["HT"]),
                        EGM = Convert.ToDecimal(Result["EGM"]),
                        Documentation = Convert.ToDecimal(Result["Documentation"]),
                        CBSC = Convert.ToDecimal(Result["CBSC"]),
                        EPCCh = Convert.ToDecimal(Result["EPCCh"]),
        ...
        #endregion
        public void MonthlyCashBook(VRN_MonthlyCashBook ObjDailyCashBook)
        {
...
// IDataReader Result = DataAccess.ExecuteDataReader("MonthlyCashBookReport", CommandType.StoredProcedure, DParam);
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    VRNCashBook.lstCashReceipt.Add(new VRN_DailyCashBook
                    {
                        ...
                        OTCharge = Convert.ToDecimal(Result["OT"]),
                        Other = Convert.ToDecimal(Result["Other"]),
                        Weighment = Convert.ToDecimal(Result["WHT"]),
                        TCGSTAmtSGSTAmt = Convert.ToDecimal(Result["12CGSTAmt12SGSTAmt"]),
                        CGSTAmtSGSTAmt = Convert.ToDecimal(Result["18CGSTAmt18SGSTAmt"]),
                        ...
                        // EGM = Convert.ToDecimal(Result["EGM"]),
                        Taxable = Convert.ToDecimal(Result["Taxable"]),
                        Cgst = Convert.ToDecimal(Result["18CGSTAmt"]),
                        Sgst = Convert.ToDecimal(Result["18SGSTAmt"].ToString()),
                        Igst = Convert.ToDecimal(Result["18IGSTAmt"].ToString()),
                        TCgst = Convert.ToDecimal(Result["12CGSTAmt"]),
                        TSgst = Convert.ToDecimal(Result["12SGSTAmt"].ToString()),
                        TIgst = Convert.ToDecimal(Result["12IGSTAmt"].ToString()),
                        Roundoff = Convert.ToDecimal(Result["RoundUp"]),
                        TotalCash = Convert.ToDecimal(Result["TotalCash"].ToString()),
                        TotalCheque = Convert.ToDecimal(Result["TotalChq"].ToString()),
                        TotalBank = Convert.ToDecimal(Result["TotalBank"].ToString()),
                        TotalDay = Convert.ToDecimal(Result["TotalDay"].ToString()),
                        BankCash = Convert.ToDecimal(Result["BankCash"].ToString()),
                        BankChq = Convert.ToDecimal(Result["BankChq"].ToString()),
                        //  ChqNo = Result["ChequeNo"].ToString(),
                        ...
                        //clochq = Convert.ToDecimal(Result["cloCash"]),

                        ReliazationagainstBilling = Convert.ToDecimal(Result["TotalSDAginestInvoice"]),
                        Total= Convert.ToDecimal(Result["Total"]),
                ...
                if (Result.NextResult())
                {
                    if(Result.Read())
                    {
                        VRNCashBook.StartRNo = Result["StartRNo"] == DBNull.Value ? "" : Result["StartRNo"].ToString();
                        VRNCashBook.LastRNo = Result["LastRNo"] == DBNull.Value ? "" : Result["LastRNo"].ToString();
                        VRNCashBook.TotalRNo = Result["TotalRNo"] == DBNull.Value? 0:Convert.ToInt32(Result["TotalRNo"]);
                    }
                ...
                if (Result.NextResult())
                {
                    if (Result.Read())
                    {
                        VRNCashBook.OpCash = Result["OpCash"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["OpCash"]);
                        VRNCashBook.OpChq = Result["OpChq"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["OpChq"]);
                        VRNCashBook.TotalOp = Result["TotalOp"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["TotalOp"]);
                        VRNCashBook.ReceiptCash = Result["ReceiptCash"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["ReceiptCash"]);
                        VRNCashBook.ReceiptChq = Result["ReceiptChq"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["ReceiptChq"]);
                        VRNCashBook.ReceiptBank = Result["ReceiptBank"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["ReceiptBank"]);

                        VRNCashBook.TotalReceipt = Result["TotalReceipt"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["TotalReceipt"]);
                        VRNCashBook.CashBank = Result["CashBank"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["CashBank"]);
                        VRNCashBook.ChqBank = Result["ChqBank"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["ChqBank"]);
                        VRNCashBook.TotalBank = Result["TotalBank"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["TotalBank"]);
                        VRNCashBook.ClosingCash = Result["ClosingCash"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["ClosingCash"]);
                        VRNCashBook.ClosingChq = Result["ClosingChq"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["ClosingChq"]);
                        VRNCashBook.TotalClose = Result["TotalClose"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["TotalClose"]);
        ...
        public void MonthlyCashBookOLD(VRN_MonthlyCashBook ObjDailyCashBook)
        {
            ...
            DParam = LstParam.ToArray();
            // IDataReader Result = DataAccess.ExecuteDataReader("MonthlyCashBookReport", CommandType.StoredProcedure, DParam);
            IDataReader Result = DataAccess.ExecuteDataReader("MonthlyCashBookReportOLD", CommandType.StoredProcedure, DParam);
        ...
        public void InsuranceRegister(MonthlyCashBook ObjDailyCashBook)
        {
            ...
            VRN_InsuranceRegister VRNInsReg = new VRN_InsuranceRegister();
            IList<VRN_InsuranceRegister> LsInsRes = new List<VRN_InsuranceRegister>();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LsInsRes.Add(new VRN_InsuranceRegister
                    {
        ...
        #region PV Report
        public void GetPVReportImport(VRN_PV objPV)
        {
            IDataParameter[] DParam = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<VRN_ImpPVReport> lstPV = new List<VRN_ImpPVReport>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstPV.Add(new VRN_ImpPVReport
                    {
        ...
        public void GetPVReportExport(VRN_PV objPV)
        {
            IDataParameter[] DParam = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<VRN_ExpPVReport> lstPV = new List<VRN_ExpPVReport>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstPV.Add(new VRN_ExpPVReport
                    {
        ...
        public void GetPVReportBond(VRN_PV objPV)
        {
            IDataParameter[] DParam = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<VRN_BondPVReport> lstPV = new List<VRN_BondPVReport>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstPV.Add(new VRN_BondPVReport
                    {
        ...
        public void GetImpLoadedCont(VRN_PVImpLoadedModel objPV)
        {
            IDataParameter[] DParam = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        public void GetTimeBarredReport(string AsOnDate)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<VRN_TimeBarredReport> lstPV = new List<VRN_TimeBarredReport>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstPV.Add(new VRN_TimeBarredReport
                    {
                        BondNo = Result["BondNo"].ToString(),
                        BondDate = Result["BondDate"].ToString(),
                        Importer = Result["Importer"].ToString(),
        ...
        public void VCCapacityDetails(string dtArray, string date1, string date2)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VRN_VCCapacity> LstVCCapacity = new List<VRN_VCCapacity>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstVCCapacity.Add(new VRN_VCCapacity
                    {
                        //vccapid = (Result["vccapid"] == DBNull.Value ? 0 : Convert.ToInt32(Result["vccapid"])),
                        //vcoptdate = (Result["vcoptdate"] == DBNull.Value ? DateTime.Now : Convert.ToDateTime(Result["vcoptdate"])),
        ...
        public void GetSACDetails(string FromDate, string ToDate)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<VRN_SACRegister> lstSAC = new List<VRN_SACRegister>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstSAC.Add(new VRN_SACRegister
                    {
        ...
        public void GetBondNo()
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            List<VRN_BondDetails> lstBond = new List<VRN_BondDetails>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstBond.Add(new VRN_BondDetails
                    {
                        BondNo = Result["BondNo"].ToString(),
        ...
        public void GetBondRegister(int DepositeAppId, string FromDate, string ToDate)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            VRN_BondRegister objBond = new VRN_BondRegister();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objBond.lstSACDetails.Add(new VRN_SACDetails
                    {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objBond.lstAdvPayment.Add(new VRN_SACAdvancePayment
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objBond.lstUnloadingDetails.Add(new VRN_UnloadingDetails
                        {
                            DepositappId = Convert.ToInt32(Result["DepositAppId"].ToString()),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objBond.lstDeliveryDetails.Add(new VRN_DeliveryDetails
                        {
                            DepositappId = Convert.ToInt32(Result["DepositAppId"].ToString()),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objBond.lstDeliveryPaymentDet.Add(new VRN_DeliveryPayementDetails
                        {
                            DepositappId = Convert.ToInt32(Result["DepositAppId"].ToString()),
                            InvoiceAmt = Convert.ToDecimal(Result["InvoiceAmt"]),
        ...
        public void GetGSTMISReport( string FromDate, string ToDate)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            VRN_GSTMISReport objGSTMIS = new VRN_GSTMISReport();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objGSTMIS.lstCash.Add(new VRN_CASHPDReport
                    {
                        ChargeType = Convert.ToString(Result["ChargeType"]),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objGSTMIS.lstSD.Add(new VRN_CASHPDReport
                        {
        ...
        #region Register of Outward Supply
        public void GetRegisterofOutwardSupplyVRN(DateTime date1, DateTime date2, string Type)
        {
            var LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_From", MySqlDbType = MySqlDbType.DateTime, Value = date1 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_To", MySqlDbType = MySqlDbType.DateTime, Value = date2 });
            ...
            if (Type == "Inv" || Type == "Unpaid" || Type == "CancelInv")
            {
                List<VRNRegisterOfOutwardSupplyModel> model = new List<VRNRegisterOfOutwardSupplyModel>();
                try
                {
                    ...
                    _DBResponse.Status = 0;
                    _DBResponse.Message = "No Data";
                    _DBResponse.Data = RegisterofOutwardSupplyExcelVRN(model, InvoiceAmount, CRAmount, dt);
                }
                catch (Exception ex)
                {
                    _DBResponse.Status = 0;
        ...
        #region PDSummary
        public void PdSummaryReport(VRN_PdSummary ObjPdSummaryReport, int type = 1)
        {
            ...
            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("PdSummaryReport", CommandType.StoredProcedure, DParam);
            IList<VRN_PdSummary> LstPdSummaryReport = new List<VRN_PdSummary>();           
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstPdSummaryReport.Add(new VRN_PdSummary
                    {
                        PartyName = Result["PartyName"].ToString(),
                        Amount = Result["Amount"].ToString()
        ...
        public void GetAllPartyForSDDet(string PartyCode, int Page)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VRN_PartyForSDDet> LstParty = new List<VRN_PartyForSDDet>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstParty.Add(new VRN_PartyForSDDet
                    {
                        Party = Result["Party"].ToString(),
        ...
        public void GetSDDetStatement(int PartyId, string Fdt, String Tdt)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_SDDetailsStatement SDResult = new VRN_SDDetailsStatement();
            try
            {
        ...
        public void GetBillCumSDLedgerReport(int partyId, string fromdate, string todate, string comname, string address)
        {
            ...
            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("BillCumSDLedger", CommandType.StoredProcedure, DParam);
            VRN_BillCumSDLedger LedgerObj = new VRN_BillCumSDLedger();
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ...
                        LedgerObj.lstDetails.Add(new VRN_BillCumSDLedgerDetails
                        {
                            Sr = Convert.ToInt32(Result["Sr"]),
                            Col1 = Convert.ToString(Result["Col1"]),
                            Col2 = Convert.ToString(Result["Col2"]),
        ...
        public void GetPDAStatement(int Month, int Year)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRN_SDStatement ObjSDStatement = new VRN_SDStatement();
            try
            {
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow dr in Result.Tables[0].Rows)
                    {
                        ObjSDStatement.LstSD.Add(new VRN_SDList
                        {
        ...
        public void GetSDRefundReceiptDetails(string JournalNo)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRNSDDetailsStatement SDResult = new VRNSDDetailsStatement();
            int isSDParty = 0;
            try
            {
                Status = 1;
        ...
        public void PdBalanceSummaryReport(PdSummary ObjPdSummaryReport, int type = 1)
        {
            ...
            List<VRNPDSummaryModel> model = new List<VRNPDSummaryModel>();
            try
            {
        ...
        private string GetPDSummaryExcel(List<VRNPDSummaryModel> model, DataTable dt, string datevalue)
        {
            if (!System.IO.Directory.Exists(HttpContext.Current.Server.MapPath("~/Docs/Excel")))
            {
                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/Docs/Excel"));
        ...
        public void GetPartyLedgerStatement(int PartyId, string Fdt, string Tdt)
        {
            ...
            _DBResponse = new DatabaseResponse();
            VRNPartyLedger OAResult = new VRNPartyLedger();
            try
            {
                ...
                if (Result != null && Result.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow dr in Result.Tables[1].Rows)
                    {
                        OAResult.LstOnAccountDtl.Add(new VRNLedgerStatementList
                        {
                    ...
                    {
                        OAResult.LstOnSum.Add(new VRNSummary
                        {
                            ReceiptNo = Convert.ToString(dr["ReceiptNo"]),
                            Total = Convert.ToDecimal(dr["Total"])
                            //  Narration = Convert.ToString(dr["Narration"]),
        ...
        #region Consolidated Party Ledger Statement
        public void PdConsolidateReport(PdSummary ObjPdSummaryReport)
        {
            ...
            List<VRN_PartyLedCons> model = new List<VRN_PartyLedCons>();
            try
            {
        ...
        private string PLedgerConsolidateExcel(List<VRN_PartyLedCons> model, DataTable dt, string datevalue)
        {
            if (!System.IO.Directory.Exists(HttpContext.Current.Server.MapPath("~/Docs/Excel")))
            {
                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/Docs/Excel"));
        ...
        #endregion
        #region Party Wise Unpaid Invoice
        public void PartyWiseUnpaidAmt(int PartyId, string AsOnDate)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_PartyId", MySqlDbType = MySqlDbType.Int32, Value = PartyId });
        ...
        public void GetPayeeNameforUnpaidInv()
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            IDataParameter[] DParam = { };
            DParam = lstParam.ToArray();
        ...
        #region Bulk Invoice Report
        public void GetPaymentPartyforBulkReport()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentPartyforBulkReport", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
        ...
        #region BulkDebit/CreaditNote
        public void PrintDetailsForBulkCRNoteReport(string PeriodFrom, string PeriodTo, string CRDR)
        {
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
            lstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            lstParam.Add(new MySqlParameter { ParameterName = "in_FromDate", MySqlDbType = MySqlDbType.DateTime, Value = PeriodFrom });
        ...
        #region Collection Report
        public void CollectionReportVRN(VRN_CollectionReport ObjCollectionReport)
        {
            ...
            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("CollectionReport", CommandType.StoredProcedure, DParam);
           VRN_FinalCollectionReportTotal LstCollectionReport = new VRN_FinalCollectionReportTotal();
            // CollectionReportTotal objCollectionReportTotal = new CollectionReportTotal();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstCollectionReport.listCollectionReport.Add(new VRN_CollectionReport
                    {
                        Date = Result["DateFormatted"].ToString(),
                        Cash = Result["Cash"].ToString(),
                        Bank = Result["Cheque"].ToString(),//bank has data for cheque see view
        ...
        public void GetAllSB()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VRN_SBQuery> LstSB = new List<VRN_SBQuery>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSB.Add(new VRN_SBQuery
                    {
        ...
        public void SBQueryReport(int id, string sbno, string sbdate)
        {
            ...
            VRN_SBQuery LstSBQueryReport = new VRN_SBQuery();
            // CollectionReportTotal objCollectionReportTotal = new CollectionReportTotal();
            _DBResponse = new DatabaseResponse();
            try
            {
        ...
        public void ServiceCodeWiseInvDtls(Hdb_ServiceCodeWiseInvDtls ObjServiceCodeWiseInvDtls)
        {
            ...
            //LstParam.Add(new MySqlParameter { ParameterName = "in_Registered", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjInvoiceReportDetails.Registered });
             ...
             LstParam.Add(new MySqlParameter { ParameterName = "in_SAC", MySqlDbType = MySqlDbType.VarChar, Value = "" });
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstInvoiceReportDetails.Add(new VRN_ServiceCodeWiseInvDtls
                    {
        ...
        public void GetEmptyCont(VRN_PVImpLoadedModel objPV)
        {
            IDataParameter[] DParam = { };
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            IList<VRN_PVReportImpEmptyCont> lstPV = new List<VRN_PVReportImpEmptyCont>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstPV.Add(new VRN_PVReportImpEmptyCont
                    {
                        CompanyLocation = Result["CompanyLocation"].ToString(),
                        CompanyBranch = Result["CompanyBranch"].ToString(),
        ...
        #endregion
        #region ContainerOutReport
        public void ContainerOutReport(ContainerOutReport ObjContainerOutReport)
        {
            int sizeTwenty = 0;
            int sizeFourty = 0;
            DateTime dtfrom = DateTime.ParseExact(ObjContainerOutReport.PeriodFrom, "dd/MM/yyyy", CultureInfo.InvariantCulture);
        ...
        public void GetRegisterofEInvoice(DateTime date1, DateTime date2)
        {
            ...
            List<VRNRegisterOfEInvoiceModel> model = new List<VRNRegisterOfEInvoiceModel>();
            try
            {
        ...
        private string RegisterofEInvoiceExcel(List<VRNRegisterOfEInvoiceModel> model, DataTable dt)
        {
            if (!System.IO.Directory.Exists(HttpContext.Current.Server.MapPath("~/Docs/Excel")))
            {
                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/Docs/Excel"));
        ...
        public void GetBulkIrnDetails()
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            VRN_BulkIRN objInvoice = new VRN_BulkIRN();
            ...
            try
            {
                while (Result.Read())
                {
                    objInvoice.lstPostPaymentChrg.Add(new VRN_BulkIRNDetails
                    {
                        InvoiceId = Convert.ToInt32(Result["InvoiceId"]),
                        InvoiceNo = Result["InvoiceNo"].ToString(),
                        InvoiceDate = Result["InvoiceDate"].ToString(),
        ...
        public void GetUnRealizedInvSummary(string AsOnDt)
        {
            int Status = 0;
            string dt = "";
            string dt1 = "";
        ...
        public void GetE04DetailById(int ID)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            Vrn_E04Report objE04Report = new Vrn_E04Report();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetE04DetailSearch(string SB_No, string SB_Date, string Exp_Name)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Vrn_E04Report> LstE04Report = new List<Vrn_E04Report>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstE04Report.Add(new Vrn_E04Report
                    {
                        ID = Convert.ToInt32(Result["ID"]),
                        CUSTOM_CD = Result["CUSTOM_CD"].ToString(),
                        SB_NO = Result["SB_NO"].ToString(),
        ...
        public void GetAllContainerNoForContstufserach(string cont, int Page = 0)
        {
            ...
            List<Vrn_ContStufAckSearch> LstStuffing = new List<Vrn_ContStufAckSearch>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new Vrn_ContStufAckSearch
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString(),
                    });
        ...
        public void GetAllShippingBillNoForContstufserach(string shipbill, int Page)
        {
            ...
            _DBResponse = new DatabaseResponse();
            // List<StuffingRequestDtl> LstStuffing = new List<StuffingRequestDtl>();
            List<Vrn_ContStufAckSearch> LstStuff = new List<Vrn_ContStufAckSearch>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstStuff.Add(new Vrn_ContStufAckSearch
                    {
                        shippingbillno = Result["ShippingBillNo"].ToString(),
                        shippingbilldate = Result["ShippingBillDate"].ToString(),
                        // ShippingLine = Result["ShippingLine"].ToString()
        ...
        public void GetStufAckResult(string container, string shipbill, string cfscode)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    Lststufack.Add(new Vrn_ContStufAckRes
                    {
        ...
        public void GetGatePassNoDPForAckSearch(string GatePassNo, int Page = 0)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDPGPAck.Add(new Vrn_GatePassDPAckSearch
                    {
        ...
        public void GetContainerNoForDPAckSearch(string ContainerNo, int Page)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDPContACK.Add(new Vrn_ContDPAckSearch
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString(),
        ...
        public void GetDPAckSearch(int GatePassId, string ContainerNo, int GatePassDetailId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Vrn_DPAckRes> Lststufack = new List<Vrn_DPAckRes>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    Lststufack.Add(new Vrn_DPAckRes
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
        ...
        public void GetGatePassNoDTForAckSearch(string GatePassNo, int Page = 0)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDTGPAck.Add(new Vrn_GatePassDTAckSearch
                    {
                        GatePassId = Convert.ToInt32(Result["GatePassId"]),
                        GatePassNo = Convert.ToString(Result["GatePassNo"])
                    });
        ...
        public void GetContainerNoForDTAckSearch(string ContainerNo, int Page)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDTContACK.Add(new Vrn_ContDTAckSearch
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString(),
                    });
        ...
        public void GetDTAckSearch(int GatePassId, string ContainerNo)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Vrn_DTAckRes> Lststufack = new List<Vrn_DTAckRes>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    Lststufack.Add(new Vrn_DTAckRes
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        Reason = Result["Reason"].ToString(),
                        Status = Result["Status"].ToString(),
