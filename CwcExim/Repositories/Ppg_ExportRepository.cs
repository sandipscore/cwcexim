...
{
    public class Ppg_ExportRepository
    {
        ...
        public void AddEditContainerStuffing(PPG_ContainerStuffing ObjStuffing, string ContainerStuffingXML, string GREOperationCFSCodeWiseAmtXML, string GREContainerWiseAmtXML,
        ...
        public void GetAllContainerStuffing(int Uid)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstStuffing.Add(new PPG_ContainerStuffing
                    {
        ...
        public void GetContainerStuffForPrint(int ContainerStuffingId)
        {
            ...
            PPG_ContainerStuffing ObjStuffing = new PPG_ContainerStuffing();
            PPG_ContainerStuffingDtl lstcont = new PPG_ContainerStuffingDtl();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjStuffing.LstppgCharge.Add(new PPG_ContainerStuffingCharge
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjStuffing.LstppgShipDtl.Add(new PPG_ShippingBillNo
                        {
            ...
            try
            {
                ...
                if (result.NextResult())
                {
                    while (result.Read())
                    {
                        ...
                        ObjCS.lstPostPaymentChrgBreakup.Add(new ppgGRLPostPaymentChargebreakupdate
                        {
        ...
        public void AddEditCartingRegister(Ppg_CartingRegister objCR, string XML /*, string LocationXML,string ClearLocation=null*/)
        {
            string OutParam = "0";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetAllCartingForPage(int Uid,int page) //, string ListOrEntry = "")
        {
            DataSet Result = new DataSet();
            int Status = 0;
            try
            {
                ...
                List<Ppg_CartingRegister> CartingList = new List<Ppg_CartingRegister>();

                if (Result != null && Result.Tables.Count > 0)
                {
                    foreach (DataRow dr in Result.Tables[0].Rows)
                    {
                        Ppg_CartingRegister objCarting = new Ppg_CartingRegister();
        ...
        public void GetAllRegisterDetails(int Uid)
        {
            ...
            List<Ppg_CartingRegister> lstCR = new List<Ppg_CartingRegister>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstCR.Add(new Ppg_CartingRegister
                    {
                        CartingRegisterId = Convert.ToInt32(result["CartingRegisterId"]),
                        CartingRegisterNo = result["CartingRegisterNo"].ToString(),
                        CartingAppId = Convert.ToInt32(result["CartingAppId"]),
        ...
        public void GetAppDetForCartingRegister(int CartingAppId, int BranchId)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjCarting.lstRegisterDtl.Add(new Ppg_CartingRegisterDtl
                        {
                            CartingAppDtlId = Convert.ToInt32(Result["CartingAppDtlId"]),
                            ShippingBillNo = Result["ShippingBillNo"].ToString(),
                            ShippingDate = Result["ShippingBillDate"].ToString(),
            ...
            string InvoiceType, int DestLocationIdiceId, int Partyid, string ctype, int pvalue, decimal trv, string cargotype, int InvoiceId = 0)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objInvoice.lstPostPaymentChrgBreakup.Add(new ppgCMPostPaymentChargebreakupdate
                        {
                            ChargeId = Convert.ToInt32(Result["OperationId"]),
                            Clause = Result["ChargeType"].ToString(),
                            ChargeType = Result["ChargeType"].ToString(),
     ...
     string Module, string CargoXML = "")
        ...
        public void GetConDetForMovement(int ContainerStuffingDtlId, String ContNo)
        {
            ...
            try
            {
                if (Result.Read())
                {
                    ...
                    ObjInternalMovement.POD = Result["POD"].ToString();
                    ObjInternalMovement.sid = Convert.ToInt32(Result["ShippingLineId"].ToString());
                    ObjInternalMovement.Sline = Result["MainLine"].ToString();
                    ObjInternalMovement.LocationId = Convert.ToInt32(Result["PolId"].ToString());
                    ObjInternalMovement.ElwbTareWeight = Result["ElwbTareWeight"] == System.DBNull.Value ? 0 : Convert.ToDecimal(Result["ElwbTareWeight"].ToString());
                    ObjInternalMovement.ElwbCargoWeight = Result["ElwbCargoWeight"] == System.DBNull.Value ? 0 : Convert.ToDecimal(Result["ElwbCargoWeight"].ToString());
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
        ...
        public void AddEditBTTCargoEntry(BTTCargoEntry ObjBTT, string StuffingXML, int BranchId, int Uid)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_OperationType", MySqlDbType = MySqlDbType.VarChar, Value = ObjBTT.Flag });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = BranchId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_UId", MySqlDbType = MySqlDbType.Int32, Value = Uid });
        ...
        public void GetCartingAppList(int BTTCargoEntryId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_BTTCargoEntryId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = 0 });            
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    lstBTTCartingList.Add(new BTTCartingList()
                    {
                        ...
                        CHAId = Convert.ToInt32(Result["CHAId"]),
                        Flag = Convert.ToString(Result["Flag"]),
        ...
        public void GetCartingDetailList(int CartingAppId,string Flag)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_CartingAppId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = CartingAppId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Flag", MySqlDbType = MySqlDbType.VarChar, Size = 11, Value = Flag });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        public void GetLoadedPaymentSheetInvoice(int ContainerStuffingId, String InvoiceDate,
           string InvoiceType, String contxml, int PayeeId, int PartyId,int LocationId, int InvoiceId = 0,string SEZ="")
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ContainerXML", MySqlDbType = MySqlDbType.Text, Value = contxml });
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceType", MySqlDbType = MySqlDbType.VarChar, Value = InvoiceType });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "In_DestLocationId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(LocationId) });
        ...
        public void AddEditInvoiceContLoaded(PPG_MovementInvoice ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML,
          ...
          string Module,string SEZ, string CargoXML = "")
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Module", MySqlDbType = MySqlDbType.VarChar, Value = Module });
            LstParam.Add(new MySqlParameter { ParameterName = "in_SEZ", MySqlDbType = MySqlDbType.VarChar, Value = SEZ });
            LstParam.Add(new MySqlParameter { ParameterName = "in_MoveTo", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(ObjPostPaymentSheet.MoveToId)});
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "GeneratedClientId", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = GeneratedClientId });
            LstParam.Add(new MySqlParameter { ParameterName = "ReturnObj", MySqlDbType = MySqlDbType.VarChar, Direction = ParameterDirection.Output, Value = ReturnObj });
            IDataParameter[] DParam = LstParam.ToArray();
        ...
        public void GetInvoiceDetailsForContLoadedPrintByNo(string InvoiceNo, string InvoiceType = "EXPLod")
        {
            ...
            _DBResponse = new DatabaseResponse();
            PPG_MovementInvoice objPaymentSheet = new PPG_MovementInvoice();
            try
            {
                while (Result.Read())
                {
        ...
        public void ListOfLoadedInv(int Page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_Page", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = Page });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("ContLoadedInvoiceList", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
        ...
        public void GetLoadContDetails(int LoadContReqId)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objDet.Via = Convert.ToString(Result["Via"]);
                    objDet.Origin = Convert.ToString(Result["Origin"]);
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objDet.lstContDtl.Add(new Ppg_LoadContReqDtl
                        {
        ...
        public void AddEditLoadContDetails(PPG_LoadContReq objLoadContReq, string XML)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_Origin", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = objLoadContReq.Origin });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Via", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = objLoadContReq.Via });
            LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_ExamType", MySqlDbType = MySqlDbType.VarChar, Size = 30, Value = objLoadContReq.CustomExaminationType });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Value = 0, Direction = ParameterDirection.Output });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
        ...
        public void GetLoadedContPrint(int LoadContReqId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_LoadContReqId", MySqlDbType = MySqlDbType.VarChar, Value = LoadContReqId });
          //  LstParam.Add(new MySqlParameter { ParameterName = "in_BranchId", MySqlDbType = MySqlDbType.Int32, Value = Convert.ToInt32(HttpContext.Current.Session["BranchId"]) });
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("LoadCntReqPrint", CommandType.StoredProcedure, DParam);
            PPG_LoadContReq objDet = new PPG_LoadContReq();
            Ppg_LoadContReqDtl lstcont = new Ppg_LoadContReqDtl();
            _DBResponse = new DatabaseResponse();  
            try
            {
                while (Result.Read())
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objDet.lstppgContDtl.Add(new Ppg_LoadContReqDtl
                        {
                            LoadContReqDetlId = Convert.ToInt32(Result["LoadContReqDetlId"]),
                            ExporterId = Convert.ToInt32(Result["ExporterId"]),
                            ShippingLineId = Convert.ToInt32(Result["ShippingLineId"] == DBNull.Value ? 0 : Result["ShippingLineId"]),
        ...
        public void GetBTTPaymentSheet(string InvoiceDate, int AppraisementId, string InvoiceType,int PartyId, string ContainerXML, int InvoiceId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        public void AddEditCargoShiftInvoice(PpgInvoiceCargoShifting ObjPostPaymentSheet, string ChargesXML, string ChargesBreakXML, string OperationCfsCodeWiseAmtXML,
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        obj.lstContDetailsRRCD.Add(new PpgPostPaymentContainerRRCD
                        {
                            ...
                            CIFValue = Convert.ToDecimal(Result["CIFValue"]),
                            Duty = Convert.ToDecimal(Result["Duty"]),
                            ElwbTareWeight = Convert.ToDecimal(Result["ElwbTareWeight"]),
                            ElwbCargoWeight = Convert.ToDecimal(Result["ElwbCargoWeight"])
                        });
                    }
                }
                if (Result.NextResult())
        ...
        public void AddEditShipAmendment(Ppg_AmendmentViewModel vm)
        {
        ...
        public void GetAmenSBDetailsByAmendNO(string AmendNO)
        {
            ...
            List<Ppg_AmendmentViewModel> LstSB = new List<Ppg_AmendmentViewModel>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSB.Add(new Ppg_AmendmentViewModel
                    {
        ...
        public void GetShipbillAmendDet(int id)
        {
            ...
            IDataParameter[] Dparam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfShipBillAmned", CommandType.StoredProcedure, Dparam);
            Ppg_AmendmentViewModel LstSB = new Ppg_AmendmentViewModel();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSB = (new Ppg_AmendmentViewModel
                    {
                        ID = Convert.ToInt32(Result["id"]),
                        AmendNo = Convert.ToString(Result["AmendNo"]),
                        Date = Convert.ToDateTime(Result["AmendDate"]),
        ...
        public void CargoShiftingNoForApproval()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_CargoShiftingId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = ((Login)HttpContext.Current.Session["LoginUser"]).Uid });
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataParameter[] Dparam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("GetShiftingNoForAppr", CommandType.StoredProcedure, Dparam);
            List<dynamic> LstApproval = new List<dynamic>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void CargoShiftingDetForApproval(int CargoShiftingId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void AddEditCargoShiftingApproval(int CargoShiftingId, int IsApproved, string ShiftingDate)
        {
            ShiftingDate = DateTime.ParseExact(ShiftingDate, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd");
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_CargoShiftingId", MySqlDbType = MySqlDbType.Int32, Value = CargoShiftingId });
            LstParam.Add(new MySqlParameter { ParameterName = "in_IsApproved", MySqlDbType = MySqlDbType.Int32, Value = IsApproved });
            LstParam.Add(new MySqlParameter { ParameterName = "in_ShiftingDt", MySqlDbType = MySqlDbType.VarChar, Value = ShiftingDate });
            LstParam.Add(new MySqlParameter { ParameterName = "in_Uid", MySqlDbType = MySqlDbType.Int32, Value = ((Login)HttpContext.Current.Session["LoginUser"]).Uid });
            LstParam.Add(new MySqlParameter { ParameterName = "RetValue", MySqlDbType = MySqlDbType.Int32, Direction = ParameterDirection.Output, Value = 0 });
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataParameter[] Dparam = LstParam.ToArray();
            int Result = DataAccess.ExecuteNonQuery("AddEditCargoShiftApproval", CommandType.StoredProcedure, Dparam);
            _DBResponse = new DatabaseResponse();
            try
            {
                if (Result == 1 || Result == 2)
                {
                    _DBResponse.Data = null;
                    _DBResponse.Message = (Result == 1) ? "Cargo Shifting Approval Saved Successfully" : "Cargo Shifting Approval Updated Successfully";
                    _DBResponse.Status = Result;
                }
                else
                {
        ...
        public void ListofCargoShiftingApproved()
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_CargoShiftingId", MySqlDbType = MySqlDbType.Int32, Value = 0 });
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataParameter[] Dparam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfCargoShiftAppr", CommandType.StoredProcedure, Dparam);
            ...
            try
            {
                ...
                {
                    Status = 1;
                    objAppr.Add(new Ppg_CargoShiftingApproval
                    {
                        CargoShiftingId = Convert.ToInt32(Result["CargoShiftingId"]),
                        ShiftingNo = Convert.ToString(Result["ShiftingNo"]),
                        ShiftingDt = Convert.ToString(Result["ShiftingDt"]),
                        InvoiceNo = Convert.ToString(Result["InvoiceNo"]),
                        FromGodownName = Convert.ToString(Result["FromGodownName"]),
                        ToGodownName = Convert.ToString(Result["ToGodownName"])
                    });
        ...
        public void CargoShiftingApprovalDet(int CargoShiftingId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_CargoShiftingId", MySqlDbType = MySqlDbType.Int32, Value = CargoShiftingId });
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    objAppr.PayeeName = Convert.ToString(Result["PayeeName"]);
                    objAppr.ShiftingType = Convert.ToString(Result["ShiftingType"]);
                    objAppr.IsApproved = Convert.ToInt32(Result["IsApproved"]);
                }
                if (Result.NextResult())
                {
                    while (Result.Read())
        ...
        #endregion
        #region Edit Loaded Container Payment Sheet
        public void GetLoadedContainerInvoiceDetailsForEdit(int InvoiceId)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceId", MySqlDbType = MySqlDbType.Int32, Value = InvoiceId });
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetLoaedContainerInvoiceDetailsForEdit", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            decimal hours = 0;
        ...
        public void GetPaymentPartyforBTTEdit()
        {
            int Status = 0;
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetPaymentPartyExportforBTTEdit", CommandType.StoredProcedure);
            _DBResponse = new DatabaseResponse();
            IList<PaymentPartyName> objPaymentPartyName = new List<PaymentPartyName>();
            try
            {
