...
{
    public class VRN_ExportRepository
    {
        ...
        public void GetCCINShippingLineForPage(string PartyCode, int Page = 0)
        {
            ...
            List<VRN_ShippingLineForPage> LstShippingLine = new List<VRN_ShippingLineForPage>();
            // ShippingLine LstShippingLine = new ShippingLine();
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    LstShippingLine.Add(new VRN_ShippingLineForPage
                    {
                        ShippingLineId = Convert.ToInt32(Result["ShippingLineId"]),
                        ShippingLineName = Result["ShippingLine"].ToString(),
        ...
        public void GetVehicleForCCIN()
        {
            ...
            List<VRN_CCINEntry> LstSB = new List<VRN_CCINEntry>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void AddEditCCINEntry(VRN_CCINEntry objCCINEntry)
        {
        ...
        public void GetAllCCINEntryForPage(int Page) //, string ListOrEntry = "")
        {
            ...
            try
            {
                ...
                List<VRN_CCINEntry> CCINEntryList = new List<VRN_CCINEntry>();
        ...
        public void GetCcinEntrySlipForPrint(string ccin)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjStuffing.Lstshed.Add(new VRN_ShedEntries
                        {
        ...
        public void AddEditCartingRegister(VRN_CartingRegister objCR, string XML /*, string LocationXML,string ClearLocation=null*/)
        {
            string OutParam = "0";
            List<MySqlParameter> lstParam = new List<MySqlParameter>();
        ...
        public void GetAllRegisterDetails(int Uid)
        {
            ...
            List<VRN_CartingRegister> lstCR = new List<VRN_CartingRegister>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstCR.Add(new VRN_CartingRegister
                    {
        ...
        public void GetRegisterDetails(int CartingRegisterId, int Uid, string Purpose = null)
        {
            ...
            try
            {
                ...
                if (result.NextResult())
                {
                    while (result.Read())
                    {
                        objCR.lstRegisterDtl.Add(new VRN_CartingRegisterDtl
                        {
                ...
                if (result.NextResult())
                {
                    while (result.Read())
                    {
                        objCR.lstShortCargoDetails.Add(new VRN_ShortCargoDetails
                        {
        ...
        public void GetAppDetForCartingRegister(int CartingAppId, int BranchId)
        {
            ...
            VRN_CartingRegister ObjCarting = new VRN_CartingRegister();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjCarting.lstRegisterDtl.Add(new VRN_CartingRegisterDtl
                        {
                            CartingAppDtlId = Convert.ToInt32(Result["CartingAppDtlId"]),
                            ShippingBillNo = Result["ShippingBillNo"].ToString(),
                            ShippingDate = Result["ShippingBillDate"].ToString(),
        ...
        public void GetAllCartingEntryForSearch(int Page, string searchtext)
        {
            ...
            try
            {
                ...
                List<VRN_CartingRegister> CartingList = new List<VRN_CartingRegister>();
        ...
        public void ShppingLineReservedGodown(int EximTraderId)
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataParameter[] Dparam = LstParam.ToArray();
            IDataReader result = DataAccess.ExecuteDataReader("GetReservDetOfShippingline", CommandType.StoredProcedure, Dparam);
        ...
        public void AddEditStuffingRequest(VRN_StuffingRequest ObjStuffing, string StuffingXML, string StuffingContrXML)
        {
        ...
        public void GetAllStuffingRequest(int RoleId, int Uid, int Page)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstStuffing.Add(new VRN_StuffingRequest
                    {
        ...
        public void GetStuffingRequest(int StuffingReqId, int RoleId, int Uid)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjStuffing.LstStuffing.Add(new VRN_StuffingRequestDtl
                        {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjStuffing.LstStuffingContainer.Add(new VRN_StuffingReqContainerDtl
                        {
        ...
        public void GetCartRegDetForStuffingReq(int CartingRegisterId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<VRN_StuffingRequestDtl> LstStuffing = new List<VRN_StuffingRequestDtl>();
            List<VRN_StuffingReqContainerDtl> LstStuffingContr = new List<VRN_StuffingReqContainerDtl>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new VRN_StuffingRequestDtl
                    {
                        ShippingBillNo = Result["ShippingBillNo"].ToString(),
                        ShippingDate = Result["ShippingDate"].ToString(),
                        CargoDescription = (Result["CargoDescription"] == null ? "" : Result["CargoDescription"]).ToString(),
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        LstStuffingContr.Add(new VRN_StuffingReqContainerDtl
                        {
        ...
        public void GetAllContainerNo()
        {
            ...
            List<VRN_StuffingReqContainerDtl> LstStuffing = new List<VRN_StuffingReqContainerDtl>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new VRN_StuffingReqContainerDtl
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString()
                    });
        ...
        public void GetContainerNoDet(string CFSCode)
        {
            ...
            VRN_StuffingReqContainerDtl ObjStuffing = new VRN_StuffingReqContainerDtl();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void GetShippingBillNoOfCartApp(int CartingRegisterId)
        {
            ...
            IDataParameter[] DParam = { };
            DParam = LstParam.ToArray();
            List<VRN_StuffingRequestDtl> LstBillingNo = new List<VRN_StuffingRequestDtl>();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstBillingNo.Add(new VRN_StuffingRequestDtl
                    {
                        ShippingBillNo = Result["ShippingBillNo"].ToString(),
                    });
                }
        ...
        public void ShippinglineDtlAfterEmptyCont(string CFSCode)
        {
            ...
            VRN_StuffingReqContainerDtl ObjSR = new VRN_StuffingReqContainerDtl();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void AddEditContainerStuffing(VRN_ContainerStuffing ObjStuffing, string ContainerStuffingXML)//, string GREOperationCFSCodeWiseAmtXML, string GREContainerWiseAmtXML,
        ...
        public void GetContainerDetForStuffing(int StuffingReqId)
        {
            ...
            VRN_ContainerStuffingDtl ObjStuffing = new VRN_ContainerStuffingDtl();
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstStuffing.Add(new VRN_ContainerStuffingDtl
                    {
                        StuffingReqDtlId = Convert.ToInt32(Result["StuffingReqDtlId"]),
                        ContainerNo = Result["ContainerNo"].ToString(),
        ...
        public void GetAllContainerStuffing(int Uid, int Page)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    LstStuffing.Add(new VRN_ContainerStuffing
                    {
        ...
        public void GetContainerStuffing(int ContainerStuffingId, int Uid)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjStuffing.LstStuffingDtl.Add(new VRN_ContainerStuffingDtl
                        {
        ...
        public void ListOfFinalDestination(string CustodianName)
        {
            ...
            List<VRN_FinalDestination> LstCustodian = new List<VRN_FinalDestination>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstCustodian.Add(new VRN_FinalDestination
                    {
        ...
        public void ListOfStuffingNoForAmendment()
        {
            ...
            List<VRN_ContainerStuffing> Lstsr = new List<VRN_ContainerStuffing>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    Lstsr.Add(new VRN_ContainerStuffing
                    {
        ...
        public void AddEditAmendmentContainerStuffing(VRN_ContainerStuffing ObjStuffing, string ContainerStuffingXML)
        {
            string GeneratedClientId = "0";
            string ReturnObj = "0";
            var SCMTRStuffingDate = (dynamic)null;
        ...
        public void GetExportPaymentSheet(string InvoiceDate, string ExportUnder, int AppraisementId, string InvoiceType, string ContainerXML,
            int InvoiceId, int PartyId, int PayeeId, int OTHour,int ReeferHours)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetLoadContDetails(int LoadContReqId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("ListLoadCntReq", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            VRN_LoadContReq objDet = new VRN_LoadContReq();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        objDet.lstContDtl.Add(new VRN_LoadContReqDtl
                        {
        ...
        public void AddEditLoadContDetails(VRN_LoadContReq objLoadContReq, string XML)
        {
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        //mks
        public void GetLoadedPaymentSheetInvoice(int ContainerStuffingId, string InvoiceDate, string ExportUnder ,string InvoiceType, string contxml, int PayeeId, int PartyId, int InvoiceId = 0 , int OTHour=0,int OnWheelHours=0,int ReeferHours=0)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        public void AddEditInvoiceContLoaded(VRN_ExpPaymentSheet ObjPostPaymentSheet, string ContainerXML, string ChargesXML, string ContWiseChargeXML, string OperationCfsCodeWiseAmtXML,
           int BranchId, int Uid, string Module, string CargoXML = "")
        {
            string GeneratedClientId = "0";
            string ReturnObj = "";
        ...
        public void AddEditBTTCargoEntry(VRN_BTTCargoEntry ObjBTT, string StuffingXML, int BranchId, int Uid)
        {
            string GeneratedClientId = "0";
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
        ...
        public void GetBTTCargoEntry()
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VRN_BTTCargoEntry> ObjBTT = new List<VRN_BTTCargoEntry>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    ObjBTT.Add(new VRN_BTTCargoEntry()
                    {
        ...
        public void GetBTTCargoEntryById(int BTTId)
        {
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetBTTCargoEntry", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            VRN_BTTCargoEntry ObjBTT = new VRN_BTTCargoEntry();
            try
            {
                while (Result.Read())
                {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjBTT.lstBTTCargoEntryDtl.Add(new VRN_BTTCargoEntryDtl
                        {
        ...
        public void GetCartingAppList(int BTTCargoEntryId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VRN_BTTCartingList> lstBTTCartingList = new List<VRN_BTTCartingList>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstBTTCartingList.Add(new VRN_BTTCartingList()
                    {
                        ...
                        CartingDate = Convert.ToString(Result["ApplicationDate"]),
                         CartingNoWithSB = Convert.ToString(Result["CartingNoWithSB"])
                    });
                }
                if (Status == 1)
                {
        ...
        public void GetCartingDetailList(int CartingAppId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VRN_BTTCartingDetailList> lstBTTCartingDetailList = new List<VRN_BTTCartingDetailList>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    lstBTTCartingDetailList.Add(new VRN_BTTCartingDetailList()
                    {
        ...
        public void GetCargoDetBTTById(int Id)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            VRN_BTTCargoDet objBTTCargo = new VRN_BTTCargoDet();
            try
            {
        ...
        public void GetBTTPaymentSheet(string InvoiceDate, string ExportUnder , int AppraisementId, string InvoiceType, string ContainerXML, int InvoiceId,int PartyId,int OTHour)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_InvoiceDate", MySqlDbType = MySqlDbType.DateTime, Value = Convert.ToDateTime(InvoiceDate) });
        ...
        public void GetAmenSBList()
        {
            ...
            List<VRN_Amendment> LstSB = new List<VRN_Amendment>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
        ...
        public void AddEditShipAmendment(VRN_AmendmentViewModel vm)
        {
        ...
        public void GetAmenSBDetailsByAmendNO(string AmendNO)
        {
            ...
            List<VRN_AmendmentViewModel> LstSB = new List<VRN_AmendmentViewModel>();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSB.Add(new VRN_AmendmentViewModel
                    {
        ...
        public void GetShipbillAmendDet(int id)
        {
            ...
            IDataParameter[] Dparam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("ListOfShipBillAmned", CommandType.StoredProcedure, Dparam);
            VRN_AmendmentViewModel LstSB = new VRN_AmendmentViewModel();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstSB = (new VRN_AmendmentViewModel
                    {
                        ID = Convert.ToInt32(Result["id"]),
                        AmendNo = Convert.ToString(Result["AmendNo"]),
                        Date = Convert.ToDateTime(Result["AmendDate"]),
        ...
        public void ListOfShippingLineNameAmend()
        {
            ...
            IList<VRN_ShipingLine> lstShipping = new List<VRN_ShipingLine>();
            int Status = 0;
            _DBResponse = new DatabaseResponse();
            try
            {
                ...
                {
                    Status = 1;
                    lstShipping.Add(new VRN_ShipingLine
                    {
        ...
        public void GetCIMSFDetails(int ContainerStuffingId, string MsgType)
        {
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            Result = DataAccess.ExecuteDataSet("ICES_GetSCMTRStuffingDetailsV2_Randhir", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
        ...
        public void GetLoadedContainerStuffingForApproval(int LoadContReqId = 0)
        {
            ...
            _DBResponse = new DatabaseResponse();
            IList<VRN_ContainerStuffingApproval> objPaySheetStuffing = new List<VRN_ContainerStuffingApproval>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    objPaySheetStuffing.Add(new VRN_ContainerStuffingApproval()
                    {
