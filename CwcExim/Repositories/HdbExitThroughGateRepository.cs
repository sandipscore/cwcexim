...
{
    public class HdbExitThroughGateRepository
    {
        ...
        public void GetAllExitThroughGate(int page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            ...
            _DBResponse = new DatabaseResponse();
            List<HDB_ExitThroughGateHeader> LstExitThroughGate = new List<HDB_ExitThroughGateHeader>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new HDB_ExitThroughGateHeader
                    {
        ...
        public void AddEditExitThroughGateCBT(Hdb_GateExitCBT ObjExitThroughGateHeader, int Uid)
        {
            //    DateTime GatePassDate = DateTime.ParseExact(ObjExitThroughGateHeader.GatePassDate, "yyyy-MM-dd", CultureInfo.InvariantCulture);
            //  DateTime GatePassDate = Convert.ToDateTime(ObjExitThroughGateHeader.GatePassDate).ToString("yyyy-MM-dd");
        ...
        public void GetAllExitThroughGateCBT()
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Hdb_GateExitCBT> LstExitThroughGate = new List<Hdb_GateExitCBT>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstExitThroughGate.Add(new Hdb_GateExitCBT
                    {
                        GateExitNo = Result["GateExitNo"].ToString(),
                        GateExitDateTime = Result["GateExitDateTime"].ToString(),
        ...
        public void EditViewExitThroughGateCBT(int ExitId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Hdb_GateExitCBT ObjExitThroughGate = new Hdb_GateExitCBT();
            try
            {
                while (Result.Read())
                {
