...
{
    public class Kdl_ReportRepository
    {
        ...
        public void ServiceCodeWiseInvDtls(string PeriodFrom,string PeriodTo,string SAC)
        {
           // var PeriodFrom = ''; var PeriodTo='';
           // DateTime dtfrom = DateTime.ParseExact(PeriodFrom, "dd/MM/yyyy", CultureInfo.InvariantCulture);
           // String PeriodFrom = dtfrom.ToString("yyyy/MM/dd");
           // DateTime dtTo = DateTime.ParseExact(PeriodTo, "dd/MM/yyyy", CultureInfo.InvariantCulture);
           // String PeriodTo = dtTo.ToString("yyyy/MM/dd");
            //ConsumerList ObjStatusDtl = null;in_Status
         ...
         //   IDataParameter[] DParam = { };
          ...
          //  DataSet Result = DataAccess.ExecuteDataSet("Importdestuffexl", CommandType.StoredProcedure, DParam);
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            DataSet Result   = DataAccess.ExecuteDataSet("ServiceCodeWiseInvDtls", CommandType.StoredProcedure, DParam);
            List<Kdl_ServiceCodeWiseInvDtls> LstInvoiceReportDetails = new List<Kdl_ServiceCodeWiseInvDtls>();
                ...
                /*   while (Result.Read())
                   {
                       ...
                       LstInvoiceReportDetails.Add(new Kdl_ServiceCodeWiseInvDtls
                       {
                           SAC = Result["SAC"].ToString(),
                           InvoiceNumber = Result["InvoiceNo"].ToString(),
                           Date = Result["Date"].ToString(),
                           ...
                           PartyName= Result["PartyName"].ToString(),
                           GSTNo = Result["Gstno"].ToString(),
                           Taxable= Result["TaxableValue"].ToString(),
                           Totalgst = Result["totalgst"].ToString(),
                           supplytype= Result["SupplyType"].ToString(),
                           partystate= Result["partystate"].ToString(),
        ...
        public void ContainerArrivalReport(ContainerArrivalReport ObjContainerArrivalReport)
        {
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstContainerArrivalReport.Add(new ContainerArrivalReport
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        ShippingLine = Result["ShippingLine"].ToString(),
        ...
        public void GetInvoiceList(string FromDate, string ToDate)
        {
        ...
        public void ContainerOutport(ContainerOutReport ObjContainerOutReport)
        {
            ...
            LstParam.Add(new MySqlParameter { ParameterName = "in_PeriodFrom", MySqlDbType = MySqlDbType.DateTime, Value = PeriodFrom });
            LstParam.Add(new MySqlParameter { ParameterName = "in_PeriodTo", MySqlDbType = MySqlDbType.DateTime, Value = PeriodTo });
            LstParam.Add(new MySqlParameter { ParameterName = "in_LoadedEmpty", MySqlDbType = MySqlDbType.VarChar, Size = 20, Value = ObjContainerOutReport.ImportExport == null ? "" : ObjContainerOutReport.ImportExport });
            //LstParam.Add(new MySqlParameter { ParameterName = "in_partyNameId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = ObjDebtorReport.partyNameId });
            ...
            IList<ContainerOutReport> LstContainerOutReport = new List<ContainerOutReport>();
            // CollectionReportTotal objCollectionReportTotal = new CollectionReportTotal();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstContainerOutReport.Add(new ContainerOutReport
                    {
        ...
        public void GetAllPartyForSDDet(string PartyCode, int Page)
        {
            ...
            DParam = LstParam.ToArray();
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            IDataReader Result = DataAccess.ExecuteDataReader("GetAllPartyForLedger", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
        ...
        public void GetSDDetStatement(int PartyId, string Fdt, String Tdt)
        {
            ...
            _DBResponse = new DatabaseResponse();
            Kdl_SDDetailsStatement SDResult = new Kdl_SDDetailsStatement();
            try
            {
        ...
        /*public void GetRegisterofOutwardSupply(DateTime date1, DateTime date2)
        {
            try
            {
                ...
                DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
                _DBResponse = new DatabaseResponse();
                var objRegOutwardSupply = (RegisterOfOutwardSupplyModel)DataAccess.ExecuteDynamicSet<RegisterOfOutwardSupplyModel>("GetRegisterofOutwardSupply", DParam);
                _DBResponse.Status = 0;
                _DBResponse.Message = "No Data";
                _DBResponse.Data = RegisterofOutwardSupplyExcel(objRegOutwardSupply);
            }
            catch (Exception ex)
            {
                _DBResponse.Status = 0;
        ...
        private string RegisterofOutwardSupplyExcel(RegisterOfOutwardSupplyModel model)
        {
        ...
        */
            ...
            try
            {
                while (Result.Read())
                {
                    ...
                    LstVCCapacity.Add(new VCCapacityModel
                    {
                        ...
                        cfscap = (Result["cfscap"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["cfscap"])),
                        bndcap = (Result["bndcap"] == DBNull.Value ? 0 : Convert.ToDecimal(Result["bndcap"])),
        ...
        public void GetPDAStatement(int Month, int Year)
        {
            ...
            try
            {
                ...
                if (Result.NextResult())
                {
                    while (Result.Read())
                    {
                        ObjPDA.closingAmount = Convert.ToDecimal((Result["closingAmount"] == null ? 0 : Result["closingAmount"]).ToString());
                    }
                }
                if (Status == 1)
                {
        ...
        public void GetRegisterofEInvoice(DateTime date1, DateTime date2)
        {
            ...
            List<KDLRegisterOfEInvoiceModel> model = new List<KDLRegisterOfEInvoiceModel>();
            try
            {
        ...
        private string RegisterofEInvoiceExcel(List<KDLRegisterOfEInvoiceModel> model, DataTable dt)
        {
            if (!System.IO.Directory.Exists(HttpContext.Current.Server.MapPath("~/Docs/Excel")))
            {
                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/Docs/Excel"));
        ...
        public void GetBulkIrnDetails()
        {
            ...
            DataAccessLayerBaseClass DataAccess = DataAccessLayerFactory.GetDataAccessLayer();
            _DBResponse = new DatabaseResponse();
            KDL_BulkIRN objInvoice = new KDL_BulkIRN();
            ...
            try
            {
                while (Result.Read())
                {
                    objInvoice.lstPostPaymentChrg.Add(new KDL_BulkIRNDetails
                    {
        ...
        public void GetE04DetailById(int ID)
        {
            ...
            _DBResponse = new DatabaseResponse();
            int Status = 0;
            Kdl_E04Report objE04Report = new Kdl_E04Report();
            try
            {
                while (Result.Read())
                {
        ...
        public void GetE04DetailSearch(string SB_No, string SB_Date, string Exp_Name)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Kdl_E04Report> LstE04Report = new List<Kdl_E04Report>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    LstE04Report.Add(new Kdl_E04Report
                    {
                        ID = Convert.ToInt32(Result["ID"]),
                        CUSTOM_CD = Result["CUSTOM_CD"].ToString(),
                        SB_NO = Result["SB_NO"].ToString(),
        ...
        public void GetAllContainerNoForContstufserach(string cont, int Page = 0)
        {
            ...
            List<Kdl_ContStufAckSearch> LstStuffing = new List<Kdl_ContStufAckSearch>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstStuffing.Add(new Kdl_ContStufAckSearch
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString(),
                    });
        ...
        public void GetAllShippingBillNoForContstufserach(string shipbill, int Page)
        {
            ...
            _DBResponse = new DatabaseResponse();
            // List<StuffingRequestDtl> LstStuffing = new List<StuffingRequestDtl>();
            List<Kdl_ContStufAckSearch> LstStuff = new List<Kdl_ContStufAckSearch>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstStuff.Add(new Kdl_ContStufAckSearch
                    {
                        shippingbillno = Result["ShippingBillNo"].ToString(),
        ...
        public void GetStufAckResult(string container, string shipbill, string cfscode)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    Lststufack.Add(new Kdl_ContStufAckRes
                    {
        ...
        public void GetGatePassNoDPForAckSearch(string GatePassNo, int Page = 0)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDPGPAck.Add(new Kdl_GatePassDPAckSearch
                    {
        ...
        public void GetContainerNoForDPAckSearch(string ContainerNo, int Page)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDPContACK.Add(new Kdl_ContDPAckSearch
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString(),
        ...
        public void GetDPAckSearch(int GatePassId, string ContainerNo, int GatePassDetailId)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Kdl_DPAckRes> Lststufack = new List<Kdl_DPAckRes>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    Lststufack.Add(new Kdl_DPAckRes
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
        ...
        public void GetGatePassNoDTForAckSearch(string GatePassNo, int Page = 0)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDTGPAck.Add(new Kdl_GatePassDTAckSearch
                    {
                        GatePassId = Convert.ToInt32(Result["GatePassId"]),
                        GatePassNo = Convert.ToString(Result["GatePassNo"])
                    });
        ...
        public void GetContainerNoForDTAckSearch(string ContainerNo, int Page)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    lstDTContACK.Add(new Kdl_ContDTAckSearch
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        CFSCode = Result["CFSCode"].ToString(),
                    });
        ...
        public void GetDTAckSearch(int GatePassId, string ContainerNo)
        {
            ...
            _DBResponse = new DatabaseResponse();
            List<Kdl_DTAckRes> Lststufack = new List<Kdl_DTAckRes>();
            try
            {
                while (Result.Read())
                {
                    Status = 1;
                    Lststufack.Add(new Kdl_DTAckRes
                    {
                        ContainerNo = Result["ContainerNo"].ToString(),
                        Reason = Result["Reason"].ToString(),
                        Status = Result["Status"].ToString(),
        ...
        public void GetStufloadResult(string jobno)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    Lststufack.Add(new Kdl_loadstuf
                    {
        ...
        public void GetStufloadasrResult(string jobasrno)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    Lststufack.Add(new Kdl_loadstufasr
                    {
        ...
        public void GetStufloaddpResult(string jobdpno)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    Lststufack.Add(new Kdl_loadstufdp
                    {
        ...
        public void GetStufloaddtResult(string jobdtno)
        {
            ...
            try
            {
                ...
                {
                    Status = 1;
                    Lststufack.Add(new Kdl_loadstufdt
                    {
        ...
        public void DailySDCollection(DailyCashBook ObjDailyCashBook)
        {
            ...
            DParam = LstParam.ToArray();
            IDataReader Result = DataAccess.ExecuteDataReader("DailySDCollectionReport", CommandType.StoredProcedure, DParam);
            IList<PdSummary> LstDailyCashBook = new List<PdSummary>();
            // CollectionReportTotal objCollectionReportTotal = new CollectionReportTotal();
            _DBResponse = new DatabaseResponse();
            try
            {
                while (Result.Read())
                {
                    ...
                    LstDailyCashBook.Add(new PdSummary
                    {
                        PartyName=Convert.ToString(Result["EximTraderName"]),
                        Amount= Convert.ToString(Result["Amount"]),
                         ReceiptDate = Convert.ToString(Result["PdaTransDate"]),
                         PeriodFrom = Convert.ToString(Result["ReceiptDate"]),
        ...
        public void GetAllPartyForSDDetail(string PartyCode, int Page)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            //LstParam.Add(new MySqlParameter { ParameterName = "in_CountryId", MySqlDbType = MySqlDbType.Int32, Size = 11, Value = 0 });
            ...
            _DBResponse = new DatabaseResponse();
            List<PartyForSDDetail> LstParty = new List<PartyForSDDetail>();
            try
            {
                bool State = false;
                while (Result.Read())
                {
                    Status = 1;
                    LstParty.Add(new PartyForSDDetail
                    {
                        Party = Result["Party"].ToString(),
                        PartyId = Convert.ToInt32(Result["PartyId"]),
                        PartyCode = Result["PartyCode"].ToString()
        ...
        public void GetSDDetailStatement(int PartyId, string Fdt, String Tdt)
        {
            int Status = 0;
            List<MySqlParameter> LstParam = new List<MySqlParameter>();
            LstParam.Add(new MySqlParameter { ParameterName = "in_SDPartyId", MySqlDbType = MySqlDbType.Int32, Value = PartyId });
            ...
            IDataReader Result = DataAccess.ExecuteDataReader("GetSDDetailsStatement", CommandType.StoredProcedure, DParam);
            _DBResponse = new DatabaseResponse();
            KdlSDDetailsStatement SDResult = new KdlSDDetailsStatement();
            try
            {
