...
{
    public class AMD_ContainerStuffing
    {
        ...
        public List<AMD_ContainerStuffingDtl> LstStuffingDtl = new List<AMD_ContainerStuffingDtl>();
        public List<AMD_ShippingBillNo> LstppgShipDtl = new List<AMD_ShippingBillNo>();
        public List<AMD_ShippingBillNoGen> LstppgShipDtlgen = new List<AMD_ShippingBillNoGen>();
        ...
        public List<AMD_ContainerStuffingSCMTR> LstSCMTR { get; set; } = new List<AMD_ContainerStuffingSCMTR>();
        public string CustodianCode { get; set; }
        public int CustodianId { get; set; }
        public string AmendmentDate { get; set; }
    }

    public class AMD_ShippingBillNo
    {
    ...
    public class AMD_ContainerStuffingDtl
    {
        ...
        public List<AMD_ContainerStuffingDtl> LstStuffing { get; set; } = new List<AMD_ContainerStuffingDtl>();
        public string ForeignLiner { get; set; }
        public string Vessel { get; set; }
        public string Voyage { get; set; }
    ...
    public class AMD_ShippingBillNoGen
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
    ...
    public class AMD_ContainerStuffingSCMTR
    {
    ...
    public class AMD_FinalDestination
    {
        public int CustodianId { get; set; }
        public string CustodianCode { get; set; }
