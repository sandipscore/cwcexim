...
namespace CwcExim.Areas.Export.Models
{
    public class DSR_InvoiceBase
    {
        ...
        // public List<DSRInvoiceContainerBase> ContainersList { get; set; } = new List<DSRInvoiceContainerBase>();
        //  public List<DSRInvoiceChargeBase> ChargesList { get; set; } = new List<DSRInvoiceChargeBase>();
    ...
    public class DSRInvoiceContainerBase
    {
    ...
    public class DSRInvoiceChargeBase
    {
