...
namespace CwcExim.Areas.Export.Models
{
    public class VLDA_InvoiceBase
    {
        ...
        // public List<WFLDInvoiceContainerBase> ContainersList { get; set; } = new List<WFLDInvoiceContainerBase>();
        //  public List<WFLDInvoiceChargeBase> ChargesList { get; set; } = new List<WFLDInvoiceChargeBase>();
    ...
    public class VLDAInvoiceContainerBase
    {
    ...
    public class VLDAInvoiceChargeBase
    {
