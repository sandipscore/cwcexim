...
{
    public class VIZ_CartingRegister
    {
        public int ShippingLineId { get; set; }
        public string ShippingLineName { get; set; }
        public string SpaceType { get; set; }
        public int IsShortCargo { get; set; }
        public List<VIZ_ShortCargoDetails> lstShortCargoDetails { get; set; } = new List<VIZ_ShortCargoDetails>();
        ...
        public IList<VIZ_CartingRegisterDtl> lstRegisterDtl { get; set; } = new List<VIZ_CartingRegisterDtl>();
        public IList<VIZApplicationNoDet> lstAppNo { get; set; } = new List<VIZApplicationNoDet>();
        public IList<VIZGodownWiseLocation> lstGdnWiseLctn { get; set; } = new List<VIZGodownWiseLocation>();
    ...
    public class VIZ_ShortCargoDetails
    {
    ...
    public class VIZApplicationNoDet
    {
        public string ApplicationNo { get; set; }
        public int CartingAppId { get; set; }
    }

    public class VIZGodownWiseLocation
    {
