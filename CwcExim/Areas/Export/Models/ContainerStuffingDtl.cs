...
{
    public class ContainerStuffingDtl
    {
        ...
        public List<ContainerStuffingDtl> LstStuffing { get; set; } = new List<ContainerStuffingDtl>();
        public List<Kol_ContainerStuffingSCMTR> LstSCMTR { get; set; } = new List<Kol_ContainerStuffingSCMTR>();
        ...
        public string StuffingCargoType { get; set; }
        public string StuffingMethod { get; set; }
    ...
    public class Kol_ContainerStuffingSCMTR
    {
