...
{
    public class WFLDExportJobOrder
    {
    ...
    public class WFLDexportjobordersum
    {
        public string POL { get; set; }
        public int SZ20 { get; set; }
        public int SZ40 { get; set; }
    }
    public class WFLD_TransformList
    {
        public int PortId { get; set; }
    ...
    public class WFLD_ShippingLineForPage
    {
        public int ShippingLineId { get; set; }
        public string ShippingLineName { get; set; }
    ...
    public class WFLDFormOneForImpJO
    {
        public string FormOneDate { get; set; }
        public int ShippingLineId { get; set; }
        public string ShippingLineName { get; set; }
