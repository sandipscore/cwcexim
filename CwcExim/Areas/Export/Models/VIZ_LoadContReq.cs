...
namespace CwcExim.Areas.Export.Models
{
    public class VIZ_LoadContReq
    {
        ...
        public List<VIZLoadContReqDtl> lstContDtl { get; set; } = new List<VIZLoadContReqDtl>();
    ...
    public class VIZLoadContReqDtl
    {
    ...
    public class VIZListLoadContReq
    {
        public int LoadContReqId { get; set; }
        public string LoadContReqNo { get; set; }
        public string LoadContReqDate { get; set; }
