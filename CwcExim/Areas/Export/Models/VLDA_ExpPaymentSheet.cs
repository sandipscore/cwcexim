...
{  
    public class VLDA_ExpPaymentSheet : ChnExpInvoiceBase
    {
        public IList<VLDAExpInvoiceContainerBase> lstPostPaymentCont { get; set; } = new List<VLDAExpInvoiceContainerBase>();
        public IList<VLDA_ExpContainer> lstPSCont { get; set; } = new List<VLDA_ExpContainer>();
        public IList<VLDAExpInvoiceChargeBase> lstPostPaymentChrg { get; set; } = new List<VLDAExpInvoiceChargeBase>();
        public IList<VLDA_ExpContWiseAmount> lstContwiseAmt { get; set; } = new List<VLDA_ExpContWiseAmount>();
        public IList<VLDA_ExpOperationContWiseCharge> lstOperationContwiseAmt { get; set; } = new List<VLDA_ExpOperationContWiseCharge>();
    ...
    public class VLDA_ContainerStuffingPSReq
    {
    ...
    public class VLDA_ContainerDetails
    {
        public string ContainerNo { get; set; }
    ...
    public class VLDAExpInvoiceBase
    {
    ...
    public class VLDAExpInvoiceContainerBase
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class VLDAExpInvoiceChargeBase
    {
    ...
    public class VLDA_ExpContainer
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class VLDAListOfContMovementInvoice
    {
        public int InvoiceId { get; set; }
        public string InvoiceNo { get; set; }
        public string InvoiceDate { get; set; }
