...
{
    public class VIZ_ExpPaymentSheet : VIZ_ExpInvoiceBase
    {
        public IList<VIZ_ExpInvoiceContainerBase> lstPostPaymentCont { get; set; } = new List<VIZ_ExpInvoiceContainerBase>();
        public IList<VIZ_ExpContainer> lstPSCont { get; set; } = new List<VIZ_ExpContainer>();
        public IList<VIZ_ExpInvoiceChargeBase> lstPostPaymentChrg { get; set; } = new List<VIZ_ExpInvoiceChargeBase>();
    ...
    public class VIZ_ListOfExpInvoice
    {
    ...
    public class VIZ_ExpInvoiceBase
    {
    ...
    public class VIZ_ExpInvoiceContainerBase
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class VIZ_ExpInvoiceChargeBase
    {
    ...
    public class VIZ_ListOfContMovementInvoice
    {
        public int InvoiceId { get; set; }
        public string InvoiceNo { get; set; }
        public string InvoiceDate { get; set; }
