...
{
    public class VRN_BTTCargoEntry
    {
        ...
        public IList<VRN_BTTCargoEntryDtl> lstBTTCargoEntryDtl { get; set; } = new List<VRN_BTTCargoEntryDtl>();
        public string BTTCargoEntryDtlJS { get; set; }
        public IList<VRN_BTTCartingList> lstCartingList { get; set; } = new List<VRN_BTTCartingList>();
        public string BTTCartingListJS { get; set; }
        public IList<VRN_BTTCartingDetailList> lstCartingDetailList { get; set; } = new List<VRN_BTTCartingDetailList>();
        public IList<CHAList> lstCHAList { get; set; } = new List<CHAList>();
    }

    public class VRN_BTTCargoEntryDtl
    {
    ...
    public class VRN_BTTCartingList
    {
        public int CartingId { get; set; }
        public string CartingNo { get; set; }
        public string CartingDate { get; set; }
        public string CartingNoWithSB { get; set; }

    }
    public class VRN_BTTCartingDetailList
    {
        public int CartingDetailId { get; set; }
        public string ShippingBillNo { get; set; }
        public string ShippingBillDate { get; set; }
