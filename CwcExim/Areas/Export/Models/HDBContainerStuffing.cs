...
{
    public class HDBContainerStuffing
    {
       ...
       // public decimal CBM { get; set; }
        ...
        public List<HDBContainerStuffingDtl> LstStuffingDtl = new List<HDBContainerStuffingDtl>();
    ...
    public class HDBContainerDtl
    {
        ...
        public int StuffingReqId { get; set; }
        public int StuffWeight { get; set; }
    ...
    //public class HDBGREOperationCFSCodeWiseAmt
    //{
    //    public string ContainerNo { get; set; }
    //    public string Size { get; set; }
    //    public string CFSCode { get; set; }
    ...
    //public class HDBGREContainerWiseAmt
    //{
    //    public string CFSCode { get; set; }
