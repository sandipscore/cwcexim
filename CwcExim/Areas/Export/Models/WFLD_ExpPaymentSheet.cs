...
{
    public class WFLD_ExpPaymentSheet : ChnExpInvoiceBase
    {
        public IList<WFLDExpInvoiceContainerBase> lstPostPaymentCont { get; set; } = new List<WFLDExpInvoiceContainerBase>();
        public IList<WFLD_ExpContainer> lstPSCont { get; set; } = new List<WFLD_ExpContainer>();
        public IList<WFLDExpInvoiceChargeBase> lstPostPaymentChrg { get; set; } = new List<WFLDExpInvoiceChargeBase>();
    ...
    public class WFLD_ContainerStuffingPSReq
    {
    ...
    public class WFLD_ContainerDetails
    {
        public string ContainerNo { get; set; }
    ...
    public class WFLDExpInvoiceBase
    {
    ...
    public class WFLDExpInvoiceContainerBase
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class WFLDExpInvoiceChargeBase
    {
    ...
    public class WFLD_ExpContainer
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class WFLDListOfContMovementInvoice
    {
        public int InvoiceId { get; set; }
        public string InvoiceNo { get; set; }
        public string InvoiceDate { get; set; }
