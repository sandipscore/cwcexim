...
{
    public class DND_ExpPaymentSheet : DNDExpInvoiceBase
    {
        public IList<DNDExpInvoiceContainerBase> lstPostPaymentCont { get; set; } = new List<DNDExpInvoiceContainerBase>();
        public IList<DND_ExpContainer> lstPSCont { get; set; } = new List<DND_ExpContainer>();
        public IList<DNDExpInvoiceChargeBase> lstPostPaymentChrg { get; set; } = new List<DNDExpInvoiceChargeBase>();
        public IList<DND_ExpContWiseAmount> lstContwiseAmt { get; set; } = new List<DND_ExpContWiseAmount>();
        public IList<DND_ExpOperationContWiseCharge> lstOperationContwiseAmt { get; set; } = new List<DND_ExpOperationContWiseCharge>();
        public List<Dnd_PreInvoiceContainer> lstPreInvoiceCargo { get; set; } = new List<Dnd_PreInvoiceContainer>();
        ...
        public int IsGroundRent { get; set; }       
    }
    public class DND_ContainerStuffingPSReq
    {
    ...
    public class DND_ContainerDetails
    {
    ...
    public class DNDListOfExpInvoice
    {
    ...
    public class DNDExpInvoiceBase
    {
    ...
    public class DNDExpInvoiceContainerBase
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
        ...
        public int ODC { get; set; } = 0;
        public string PayMode { get; set; }
        public string ExportType { get; set; }
        public decimal SDBalance { get; set; }
    }
    public class DNDExpInvoiceChargeBase
    {
    ...
    public class DND_ExpContWiseAmount
    {
        public string CFSCode { get; set; }
    ...
    public class DND_ExpOperationContWiseCharge
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class Dnd_PreInvoiceContainer
    {
        public string ApproveOn { get; set; } = string.Empty;
        public string ContainerNo { get; set; }
        public string CFSCode { get; set; }
