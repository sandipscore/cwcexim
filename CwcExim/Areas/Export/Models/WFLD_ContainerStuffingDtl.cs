...
{
    public class WFLD_ContainerStuffingDtlBase
    {
        ...
        public List<WFLD_ContainerStuffingDtlBase> LstStuffing { get; set; } = new List<WFLD_ContainerStuffingDtlBase>();
        public List<WFLD_ContainerStuffingSCMTR> LstSCMTR { get; set; } = new List<WFLD_ContainerStuffingSCMTR>();
        public string ForeignLiner { get; set; }
        public string Vessel { get; set; }
        public string Voyage { get; set; }

        public string ContClass { get; set; }
        public int OutGauge { get; set; }
    ...
    public class WFLD_ContainerStuffingSCMTR
    {
