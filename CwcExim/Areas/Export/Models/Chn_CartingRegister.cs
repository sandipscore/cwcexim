...
{
    public class Chn_CartingRegister
    {
        ...
        public IList<Chn_CartingRegisterDtl> lstRegisterDtl { get; set; } = new List<Chn_CartingRegisterDtl>();
    ...
    public class Chn_CartingRegisterDtl: CartingRegisterDtl
    {
