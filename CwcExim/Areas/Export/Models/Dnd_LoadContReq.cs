...
namespace CwcExim.Areas.Export.Models
{
    public class Dnd_LoadContReq
    {
        ...
        public List<Dnd_LoadContReqDtl> lstContDtl { get; set; } = new List<Dnd_LoadContReqDtl>();
    ...
    public class Dnd_LoadContReqDtl
    {
        ...
        public bool IsCustomExam { get; set; }
