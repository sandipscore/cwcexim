...
{
    public class PPG_ContainerMovement
    {
        ...
        public IList<PPG_ShippingBill> ShipBill { get; set; } = new List<PPG_ShippingBill>();
    ...
    public class PPG_ShippingBill
    {
        public string shippingBillNo { get; set; }
        public decimal CargoWeight { get; set; }
        public int CargoType { get; set; }
    }
    public class PPG_GodownList
    {
