...
{
    public class VRN_StuffingRequest
    {
        ...
        public List<VRN_StuffingRequestDtl> LstStuffing { get; set; } = new List<VRN_StuffingRequestDtl>();
        public List<VRN_StuffingReqContainerDtl> LstStuffingContainer { get; set; } = new List<VRN_StuffingReqContainerDtl>();
    ...
    public class VRN_StuffingRequestDtl
    {
    ...
    public class VRN_StuffingReqContainerDtl
    {
