...
{
    public class VLDA_ContainerMovement
    {
        ...
        public IList<VLDA_ShippingBill> ShipBill { get; set; } = new List<VLDA_ShippingBill>();
    ...
    public class VLDA_ShippingBill
    {
        public string shippingBillNo { get; set; }
        public decimal CargoWeight { get; set; }
        public int CargoType { get; set; }
    }
    public class VLDA_GodownList
    {
         public int GodownId { get; set; }
         public string GodownName { get; set; }
         public string GodownNo { get; set; }
     }
    public class VLDA_Charges_inv
    {
