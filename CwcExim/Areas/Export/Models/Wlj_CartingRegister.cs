...
{
    public class Wlj_CartingRegister
    {
        ...
        public IList<Wlj_CartingRegisterDtl> lstRegisterDtl { get; set; } = new List<Wlj_CartingRegisterDtl>();
        ...
        public List<Wlj_ShortCargoDetails> lstShortCargoDetails { get; set; } = new List<Wlj_ShortCargoDetails>();
        public string ShippingBill { get; set; }
    }

    public class Wlj_CartingRegisterDtl
    {
    ...
    public class Wlj_ShortCargoDetails
    {
