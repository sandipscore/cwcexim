...
{
    public class Wlj_ContainerStuffing
    {
        ...
        public List<Wlj_ContainerStuffingDtl> LstStuffingDtl = new List<Wlj_ContainerStuffingDtl>();
        public List<Wlj_ShippingBillNo> LstppgShipDtl = new List<Wlj_ShippingBillNo>();
        public List<Wlj_ShippingBillNoGen> LstppgShipDtlgen = new List<Wlj_ShippingBillNoGen>();
        ...
        public List<WLJContainerStuffingSCMTR> LstSCMTRDtl = new List<WLJContainerStuffingSCMTR>();
        public string CustodianCode { get; set; }
        public int CustodianId { get; set; }
        public string AmendmentDate { get; set; }
    }

    public class Wlj_ShippingBillNo
    {
    ...
    public class Wlj_ContainerStuffingDtl
    {
        ...
        public List<Wlj_ContainerStuffingDtl> LstStuffing { get; set; } = new List<Wlj_ContainerStuffingDtl>();
        public string ForeignLiner { get; set; }
        public string Vessel { get; set; }
        public string Voyage { get; set; }
    ...
    public class Wlj_ShippingBillNoGen
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
    ...
    public class WLJContainerStuffingSCMTR
    {
    ...
    public class WLJ_FinalDestination
    {
        public int CustodianId { get; set; }
        public string CustodianCode { get; set; }
