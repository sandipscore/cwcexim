...
namespace CwcExim.Areas.Export.Models
{
    ...
    public class AMD_ExpPaymentSheet : WLJExpInvoiceBase
    {
        public IList<AMDExpInvoiceContainerBase> lstPostPaymentCont { get; set; } = new List<AMDExpInvoiceContainerBase>();
        public IList<AMD_ExpContainer> lstPSCont { get; set; } = new List<AMD_ExpContainer>();
        public IList<AMDExpInvoiceChargeBase> lstPostPaymentChrg { get; set; } = new List<AMDExpInvoiceChargeBase>();
        public IList<AMD_ExpContWiseAmount> lstContwiseAmt { get; set; } = new List<AMD_ExpContWiseAmount>();
        public IList<AMD_ExpOperationContWiseCharge> lstOperationContwiseAmt { get; set; } = new List<AMD_ExpOperationContWiseCharge>();
        public IList<string> ActualApplicable { get; set; } = new List<string>();

        public decimal CfsToFactory { get; set; }
    ...
    public class AMD_ContainerDetails
    {
    ...
    public class AMDListOfExpInvoice
    {
    ...
    public class AMDExpInvoiceBase
    {
    ...
    public class AMDExpInvoiceContainerBase
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class AMDExpInvoiceChargeBase
    {
    ...
    public class AMD_ExpContWiseAmount
    {
        public string CFSCode { get; set; }
    ...
    public class AMD_ExpOperationContWiseCharge
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
