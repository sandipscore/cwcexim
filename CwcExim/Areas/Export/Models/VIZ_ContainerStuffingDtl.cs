...
{
    public class VIZ_ContainerStuffingDtlBase
    {
        ...
        public List<VIZ_ContainerStuffingDtlBase> LstStuffing { get; set; } = new List<VIZ_ContainerStuffingDtlBase>();
        public List<VIZ_ContainerStuffingSCMTR> LstSCMTR { get; set; } = new List<VIZ_ContainerStuffingSCMTR>();
    ...
    public class VIZ_ContainerStuffingSCMTR
    {
