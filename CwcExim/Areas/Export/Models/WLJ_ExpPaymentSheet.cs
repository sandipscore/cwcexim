...
namespace CwcExim.Areas.Export.Models
{
    ...
    public class WLJ_ExpPaymentSheet : WLJExpInvoiceBase
    {
        public IList<WLJExpInvoiceContainerBase> lstPostPaymentCont { get; set; } = new List<WLJExpInvoiceContainerBase>();
        public IList<WLJ_ExpContainer> lstPSCont { get; set; } = new List<WLJ_ExpContainer>();
        public IList<WLJExpInvoiceChargeBase> lstPostPaymentChrg { get; set; } = new List<WLJExpInvoiceChargeBase>();
        public IList<WLJ_ExpContWiseAmount> lstContwiseAmt { get; set; } = new List<WLJ_ExpContWiseAmount>();
        public IList<WLJ_ExpOperationContWiseCharge> lstOperationContwiseAmt { get; set; } = new List<WLJ_ExpOperationContWiseCharge>();
        public IList<string> ActualApplicable { get; set; } = new List<string>();
        public string SEZ { get; set; }
    }
    public class WLJ_ContainerStuffingPSReq
    {
    ...
    public class WLJ_ContainerDetails
    {
    ...
    public class WLJListOfExpInvoice
    {
    ...
    public class WLJExpInvoiceBase
    {
    ...
    public class WLJExpInvoiceContainerBase
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class WLJExpInvoiceChargeBase
    {
    ...
    public class WLJ_ExpContWiseAmount
    {
        public string CFSCode { get; set; }
    ...
    public class WLJ_ExpOperationContWiseCharge
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
