...
{
    public class WFLD_ContainerMovement
    {
        ...
        public IList<WFLD_ShippingBill> ShipBill { get; set; } = new List<WFLD_ShippingBill>();
    ...
    public class WFLD_ShippingBill
    {
        public string shippingBillNo { get; set; }
        public decimal CargoWeight { get; set; }
        public int CargoType { get; set; }
    }
    public class WFLD_GodownList
    {
