...
{ 
    public class WFLD_LoadedContainerInvoice: WFLD_MovementInvoice
    {
        ...
        public List<WFLD_PaySheetStuffingRequest> lstPaySheetStuffingRequest { get; set; } = new List<WFLD_PaySheetStuffingRequest>();
        public List<WFLD_PaymentSheetContainer> lstPaySheetContainer { get; set; } = new List<WFLD_PaymentSheetContainer>();
        public string GateEntryDate { get; set; }
    }

    public class WFLD_PaySheetStuffingRequest
    {
    ...
    public class WFLD_PaymentSheetContainer
    {
