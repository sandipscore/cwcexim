...
namespace CwcExim.Areas.Export.Models
{
    public class DSRInvoiceRCTSealing : DSRInvoiceBase
    {
        ...
        public List<DSRPreInvoiceShipbillRCTSealing> lstPrePaymentShipbill { get; set; } = new List<DSRPreInvoiceShipbillRCTSealing>();
        public List<DSRPostInvoiceShipbillRCTSealing> lstPostPaymentShipbill { get; set; } = new List<DSRPostInvoiceShipbillRCTSealing>();
    ...
    public class DSRPreInvoiceShipbillRCTSealing 
    {
    ...
    public class DSRPostInvoiceShipbillRCTSealing
    {
        public string ShipbillNo { get; set; }
        public string ShipbillDate { get; set; }
        public int NoOfPkg { get; set; }
