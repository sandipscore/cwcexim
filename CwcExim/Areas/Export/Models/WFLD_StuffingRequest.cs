...
{
    public class WFLD_StuffingRequest
    {
        ...
        public List<WFLD_StuffingRequestDtl> LstStuffing { get; set; } = new List<WFLD_StuffingRequestDtl>();
        public List<WFLD_StuffingReqContainerDtl> LstStuffingContainer { get; set; } = new List<WFLD_StuffingReqContainerDtl>();
        public List<ForwarderList> LstForwarder { get; set; } = new List<ForwarderList>();
        public List<WFLD_ContainerListStuffingRequest> ContainerNo { get; set; } = new List<WFLD_ContainerListStuffingRequest>();
    ...
    public class WFLDCHN_StuffingRequest : WFLD_StuffingRequest
    {
   ...
   public class WFLD_ContainerListStuffingRequest
    {
