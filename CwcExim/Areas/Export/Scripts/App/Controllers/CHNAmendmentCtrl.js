(function () {
    ...
    controller('CHN_AmendmentCtrl', function ($scope, CHN_AmendmentService) {
        $scope.InvoiceNo = '';
        $scope.InvoiceId = 0;
        $scope.InvoiceDate = '';
        $scope.tabInvoiceNo = '';
        ...
        $scope.searchCommodity = function () {
            ...
            CHN_AmendmentService.loadMoreCommodity($scope.partyCode, 0).then(function (res) {
                debugger;
        ...
        $scope.LoadMoreCommodity = function () {
            ...
            CHN_AmendmentService.loadMoreCommodity($scope.partyCode, page).then(function (res) {
                debugger;
                if (res.data.Status == 1) {
        ...
        $scope.GetCBDetailsBySbIdDate = function (SbNo, SbDate) {
            ...
            CHN_AmendmentService.GetSBDetails(SbNo, SbDate).then(function (res) {
                debugger;
            ...
            if ($scope.AmendDate == '' || $scope.AmendDate == null || $scope.AmendDate == 'undefined') {
                ...
                if ($scope.OldData.length == 0) {
                    ...
                    if (confirm('Are you sure to save?')) {
                        ...
                        CHN_AmendmentService.saveAmendment($scope.OldData, $scope.NewData, $scope.AmendDate, $scope.AmendmentNO, $scope.InvoiceId, $scope.InvoiceNo, $scope.InvoiceDate, $scope.FlagMerger, $scope.NoOfGround).then(function (res) {
                            ...
                            if (res.data != '') {
                                ...
                                if (res.data.Status != 0) {
                                    ...
                                    $scope.InvoiceNo = '';
                                    $scope.InvoiceDate = '';
                                    setTimeout(function () { $('#DivBody').load('/Export/CHN_CWCExport/Amendment'); }, 5000);
                                }
                                else {
        ...
        $scope.ViewAmendDetails = function (AmendNo) {
            $scope.OldData = [];
            $scope.NewData = [];
            CHN_AmendmentService.GetAmendDetailsByAmendNo(AmendNo).then(function (res) {
                //console.log(res.data);
        ...
        $scope.ResetAlltab = function () {
            ...
            $('#DivBody').load('/Export/CHN_CWCExport/Amendment');
        }
        ...
        $scope.SubmitTabData = function () {
            ...
            if ($scope.ValidationTab()) {
                ...
                if (confirm('Are you sure to save?')) {
                    ...
                    CHN_AmendmentService.savetabAmendment($scope.vmData).then(function (res) {
                        //console.log(res.data);
                        debugger;
                        if (res.data.Status == '1') {
                            debugger;
                            ...
                            //$scope.GetAmendList();
                            setTimeout(function () { $('#DivBody').load('/Export/CHN_CWCExport/Amendment'); }, 500);
                        }
                        else {
        ...
        $scope.GetAllCommodity = function () {
            debugger;
            CHN_AmendmentService.GetAllCommodityName('', $scope.PageFlag).then(function (res) {
                debugger;
                if (res.data != '') {
                    $scope.ListOfCommodityForAmendment = res.data.Data;
                }
        ...
        $scope.tabGetAllCommodity = function () {
            debugger;
            CHN_AmendmentService.GetAllCommodityName('', $scope.tabPageFlag).then(function (res) {
                debugger;
                if (res.data != '') {
                    $scope.tabListOfCommodityForAmendment = res.data.Data;
                }
        ...
        $scope.GetAmendList = function () {
            ...
            CHN_AmendmentService.GetAmendLst().then(function (res) {
                debugger;
