(function () {
    ...
    controller('PpgBTTContInvoiceEditCtrl', function ($scope, PpgBTTContInvoiceEditService) {
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgBTTContInvoiceEditService.GetAppNoForYard("BTT").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            $('.modalloader').show();
            PpgBTTContInvoiceEditService.GetYardInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                $('.modalloader').show();
                if (c > 0) {
                    PpgBTTContInvoiceEditService.ContainerSelect($scope.InvoiceId, $('#InvoiceDate').val(), $scope.StuffingReqId, $scope.TaxType, $scope.PartyId, $scope.conatiners).then(function (res) {
                        $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgBTTContInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
