(function () {
    ...
    controller('Dnd_AmendmentWICtrl', function ($scope, Dnd_AmendmentWIService) {
        $scope.InvoiceNo = '';
        $scope.InvoiceId = 0;
        $scope.InvoiceDate = '';
        $scope.tabInvoiceNo = '';
       ...
       /* if ($('#hdnListInvoice').val() != '') {
        ...
        $scope.searchCommodity = function () {
            ...
            Dnd_AmendmentWIService.loadMoreCommodity($scope.partyCode, 0).then(function (res) {
                debugger;
        ...
        $scope.LoadMoreCommodity = function () {
            ...
            Dnd_AmendmentWIService.loadMoreCommodity($scope.partyCode, page).then(function (res) {
                debugger;
                if (res.data.Status == 1)
                {
        ...
        $scope.LoadMoreCommoditytab = function () {
            ...
            Dnd_AmendmentWIService.loadMoreCommodity($scope.tabCommodityBox, $scope.tabPageFlag).then(function (res) {
                debugger;
        ...
        $scope.searchCha = function () {
            ...
            Dnd_AmendmentWIService.LoadMoreCha($scope.partyCode, 0).then(function (res) {
                debugger;
                if (res.data.Status == 1) {
        ...
        $scope.LoadMoreCha = function () {
            ...
            Dnd_AmendmentWIService.LoadMoreCha($scope.partyCode, page).then(function (res) {
                debugger;
                if (res.data.Status == 1) {
        ...
        $scope.GetCBDetailsBySbIdDate = function (SbNo, SbDate) {
            ...
            Dnd_AmendmentWIService.GetSBDetails(SbNo, SbDate).then(function (res) {
                debugger;
            ...
            if ($scope.AmendDate == '' || $scope.AmendDate == null || $scope.AmendDate == 'undefined') {
                ...
                if ($scope.OldData.length == 0) {
                    ...
                    if (confirm('Are you sure to save?')) {
                        ...
                        Dnd_AmendmentWIService.saveAmendment($scope.OldData, $scope.NewData, $scope.AmendDate, $scope.AmendmentNO, $scope.InvoiceId, $scope.InvoiceNo, $scope.InvoiceDate, $scope.FlagMerger).then(function (res) {
                            ...
                            if (res.data != '') {
                                ...
                                if (res.data.Status != 0)
                                {
                                    ...
                                    $scope.InvoiceNo = '';
                                    $scope.InvoiceDate = '';
                                    setTimeout(function () { $('#DivBody').load('/Export/Dnd_CWCExport/AmendmentWI'); }, 5000);
                                }
        ...
        $scope.ViewAmendDetails = function (AmendNo) {
            $scope.OldData = [];
            $scope.NewData = [];
            Dnd_AmendmentWIService.GetAmendDetailsByAmendNo(AmendNo).then(function (res) {
                //console.log(res.data);
           ...
           /* if ($scope.tabInvoiceNo == '') {
            ...
            if ($scope.ValidationTab()) {
                ...
                if (confirm('Are you sure to save?')) {
                    ...
                    Dnd_AmendmentWIService.savetabAmendment($scope.vmData).then(function (res) {
                        //console.log(res.data);
                        debugger;
                        if (res.data.Status == '1') {
                            debugger;
                          ...
                          //  $scope.tabExporterFlag = false;
                            ...
                            //$scope.GetAmendList();
                            setTimeout(function () { $('#DivBody').load('/Export/Dnd_CWCExport/AmendmentWI'); }, 500);
                        }
                        else {
                            $scope.TabSaveinfo = res.data.Message;
                        }
        ...
        {
            debugger;
            Dnd_AmendmentWIService.GetAllCommodityName('', $scope.PageFlag).then(function (res) {
                debugger;
                if(res.data != '')
                {
                    $scope.ListOfCommodityForAmendment = res.data.Data;
        ...
        $scope.tabGetAllCommodity = function () {
            debugger;
            Dnd_AmendmentWIService.GetAllCommodityName('', $scope.tabPageFlag).then(function (res) {
                debugger;
                if (res.data != '') {
                    $scope.tabListOfCommodityForAmendment = res.data.Data;
                }
        ...
        $scope.GetAmendList = function () {
            ...
            Dnd_AmendmentWIService.GetAmendLst().then(function (res) {
                debugger;
