(function () {
    ...
    controller('Dnd_ExpDestuffCtrl', function ($scope, Dnd_ExpDestuffService) {
        ...
        $scope.onLocationSearch = function () {
            ...
            Dnd_ExpDestuffService.GetLocation(GodownId).then(function (response) {
                debugger;
        ...
        $scope.GetSBDetails = function () {
            ...
            Dnd_ExpDestuffService.GetSBDetails(CFSCodeVal).then(function (response) {
                debugger;
        ...
        $scope.DestuffingSave = function () {
            ...
            if (confirm('Are you sure to save Destuffing Entry?')) {
                ...
                Dnd_ExpDestuffService.DestuffingEntrySave(Obj, JSON.stringify($scope.DestuffDetails)).then(function (res) {
                    console.log(res);
