(function () {
    ...
    controller('VRN_AmendmentCtrl', function ($scope, VRN_AmendmentService) {
        $scope.InvoiceNo = '';
        $scope.InvoiceId = 0;
        $scope.InvoiceDate = '';
        $scope.tabInvoiceNo = '';
        ...
        $scope.searchCommodity = function () {
            ...
            VRN_AmendmentService.loadMoreCommodity($scope.partyCode, 0).then(function (res) {
                debugger;
        ...
        $scope.LoadMoreCommodity = function () {
            ...
            VRN_AmendmentService.loadMoreCommodity($scope.partyCode, page).then(function (res) {
                debugger;
                if (res.data.Status == 1) {
        ...
        $scope.LoadMoreCommoditytab = function () {
            ...
            VRN_AmendmentService.loadMoreCommodity($scope.tabCommodityBox, $scope.tabPageFlag).then(function (res) {
                debugger;
        ...
        $scope.GetCBDetailsBySbIdDate = function (SbNo, SbDate) {
            ...
            VRN_AmendmentService.GetSBDetails(SbNo, SbDate).then(function (res) {
                debugger;
            ...
            if ($scope.AmendDate == '' || $scope.AmendDate == null || $scope.AmendDate == 'undefined') {
                ...
                if ($scope.OldData.length == 0) {
                    ...
                    if (confirm('Are you sure to save?')) {
                        ...
                        VRN_AmendmentService.saveAmendment($scope.OldData, $scope.NewData, $scope.AmendDate, $scope.AmendmentNO, $scope.InvoiceId, $scope.InvoiceNo, $scope.InvoiceDate, $scope.FlagMerger).then(function (res) {
                            ...
                            if (res.data != '') {
                                ...
                                if (res.data.Status != 0) {
                                    ...
                                    $scope.InvoiceNo = '';
                                    $scope.InvoiceDate = '';
                                    setTimeout(function () { $('#DivBody').load('/Export/VRN_CWCExport/Amendment'); }, 5000);
                                }
        ...
        $scope.ViewAmendDetails = function (AmendNo) {
            $scope.OldData = [];
            $scope.NewData = [];
            VRN_AmendmentService.GetAmendDetailsByAmendNo(AmendNo).then(function (res) {
                //console.log(res.data);
        ...
        $scope.ResetAlltab = function () {
            ...
            $('#DivBody').load('/Export/VRN_CWCExport/Amendment');
        }
        ...
        $scope.SubmitTabData = function () {
            ...
            if ($scope.ValidationTab()) {
                ...
                if (confirm('Are you sure to save?')) {
                    ...
                    VRN_AmendmentService.savetabAmendment($scope.vmData).then(function (res) {
                        //console.log(res.data);
                        debugger;
                        if (res.data.Status == '1') {
                            debugger;
                            ...
                            //$scope.GetAmendList();
                            setTimeout(function () { $('#DivBody').load('/Export/VRN_CWCExport/Amendment'); }, 500);
                        }
                        else {
                            $scope.TabSaveinfo = res.data.Message;
                        }
        ...
        $scope.GetAllCommodity = function () {
            debugger;
            VRN_AmendmentService.GetAllCommodityName('', $scope.PageFlag).then(function (res) {
                debugger;
                if (res.data != '') {
                    $scope.ListOfCommodityForAmendment = res.data.Data;
                }
        ...
        $scope.tabGetAllCommodity = function () {
            debugger;
            VRN_AmendmentService.GetAllCommodityName('', $scope.tabPageFlag).then(function (res) {
                debugger;
                if (res.data != '') {
                    $scope.tabListOfCommodityForAmendment = res.data.Data;
                }
        ...
        $scope.GetAmendList = function () {
            ...
            VRN_AmendmentService.GetAmendLst().then(function (res) {
                debugger;
