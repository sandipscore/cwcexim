(function () {
    ...
    controller('Dnd_ExpDestuffCtrlSpl', function ($scope, Dnd_ExpDestuffServiceSpl) {
        ...
        $scope.onNewSBChange = function (index) {
            debugger;
            ind = index;
        }
        ...
        $scope.SelectCCINSb = function (CCIN, CCINSB) {
            debugger;
            $scope.DestuffDetails[ind].NewSpCCIN =CCINSB ;
            $scope.DestuffDetails[ind].NewSBNo = CCIN;
            $('#NewSbBox').val('');
            $("#NewSbModal").modal("hide");
            $scope.$applyAsync();
            $("#NewSbModal").modal("hide");
        }
        ...
        $scope.onLocationSearch = function () {
            ...
            Dnd_ExpDestuffServiceSpl.GetLocation(GodownId).then(function (response) {
                debugger;
        ...
        $scope.GetSBDetails = function () {
            ...
            Dnd_ExpDestuffServiceSpl.GetSBDetails(CFSCode).then(function (response) {
                debugger;
        ...
        $scope.DestuffingSave = function () {
            ...
            if ($('#ShippingLineName').val() == null || $('#ShippingLineName').val() == '') {
            ...
            if (confirm('Are you sure to save Destuffing Entry?')) {
                ...
                Dnd_ExpDestuffServiceSpl.DestuffingEntrySave(Obj, JSON.stringify($scope.DestuffDetails)).then(function (res) {
                    console.log(res);
        ...
        function LoadDestuffingEntry() {
            $('#DivBody').load('/Export/Dnd_CWCExport/CreateExportDestuffingSpl');
        }
                ...
                angular.forEach(SerializedData, function (item) {
                    ...
                    $scope.DestuffDetails.push
                     ({
                         ...
                         "SBNo": item.SBNo,
                         "NewSpCCIN": item.NewSpCCIN,
                         "NewSBNo":item.NewSpCCIN,
                         "SBDate": item.SBDate,
                         "EXPId": item.EXPId,
