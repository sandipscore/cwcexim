(function () {
    ...
    controller('DSRAmendmentCtrl', function ($scope, DSR_AmendmentService) {
        $scope.InvoiceNo = '';
        $scope.InvoiceId = 0;
        $scope.InvoiceDate = '';
        $scope.tabInvoiceNo = '';
        ...
        $scope.searchCommodity = function () {
            ...
            DSR_AmendmentService.loadMoreCommodity($scope.partyCode, 0).then(function (res) {
                debugger;
        ...
        $scope.LoadMoreCommodity = function () {
            ...
            DSR_AmendmentService.loadMoreCommodity($scope.partyCode, page).then(function (res) {
                debugger;
                if (res.data.Status == 1) {
        ...
        $scope.LoadMoreCommoditytab = function () {
            ...
            DSR_AmendmentService.loadMoreCommodity($scope.tabCommodityBox, $scope.tabPageFlag).then(function (res) {
                debugger;
        ...
        $scope.GetCBDetailsBySbIdDate = function (SbNo, SbDate) {
            ...
            DSR_AmendmentService.GetSBDetails(SbNo, SbDate).then(function (res) {
                debugger;
                ...
                if ($scope.SBDetails.length > 0) {
                    ...
                    $scope.ManualWT = $scope.SBDetails[0].ManualWT;
                    $scope.MechanicalWT = $scope.SBDetails[0].MechanicalWT;
            ...
            if ($scope.CCINId != "") {
                ...
                if ($scope.OldData.length > 0) {
                    ...
                    $scope.OldData.push({
                        ...
                        'OldManualWT': $scope.ManualWT,
                        'OldMechanicalWT': $scope.MechanicalWT,
                        'OldPkg': $scope.Pkg,
        ...
        $scope.PushValueArrayNewInfo = function () {
            if ($scope.txtNewPartyName != '' && $scope.txtNewShipBillNo != '' && $scope.txtNewShipBillDate != '' && $scope.txtWeight > 0 && $scope.txtPkg > 0 && $scope.txtFOB > 0 && $scope.txtArea >= 0) {
                ...
                $scope.NewData.push(
             {
                 ...
                 'NewInfoManualWT': $scope.txtManualWT,
                 'NewInfoMechanicalWT': $scope.txtMechanicalWT,
            ...
            if ($scope.AmendDate == '' || $scope.AmendDate == null || $scope.AmendDate == 'undefined') {
                ...
                if ($scope.OldData.length == 0) {
                    ...
                    if (confirm('Are you sure to save?')) {
                        ...
                        DSR_AmendmentService.saveAmendment($scope.OldData, $scope.NewData, $scope.AmendDate, $scope.AmendmentNO, $scope.InvoiceId, $scope.InvoiceNo, $scope.InvoiceDate, $scope.FlagMerger).then(function (res) {
                            ...
                            if (res.data != '') {
                                ...
                                if (res.data.Status != 0) {
                                    ...
                                    $scope.InvoiceNo = '';
                                    $scope.InvoiceDate = '';
                                    setTimeout(function () { $('#DivBody').load('/Export/DSR_CWCExport/Amendment'); }, 5000);
                                }
        ...
        $scope.ViewAmendDetails = function (AmendNo) {
            $scope.OldData = [];
            $scope.NewData = [];
            DSR_AmendmentService.GetAmendDetailsByAmendNo(AmendNo).then(function (res) {
                //console.log(res.data);
        ...
        $scope.tabGetCBDetailsBySbIdDate = function (SbNo, SbDate) {
            ...
            DSR_AmendmentService.GetSBDetails(SbNo, SbDate).then(function (res) {
                ...
                if ($scope.SBDetails.length > 0) {
                    ...
                    $scope.txttabManualWT = parseFloat($scope.SBDetails[0].ManualWT);
                    $scope.txttabMechanicalWT = parseFloat($scope.SBDetails[0].MechanicalWT);
        ...
        $scope.ResetAlltab = function () {
            ...
            $('#DivBody').load('/Export/DSR_CWCExport/Amendment');
        }
        ...
        $scope.SubmitTabData = function () {
            ...
            if ($scope.ValidationTab()) {
                $scope.vmData =
                {
                    ...
                    'ManualWT': $scope.txttabManualWT,
                    'MechanicalWT': $scope.txttabMechanicalWT,
                    'Pkg': $scope.txttabPkg,
                ...
                if (confirm('Are you sure to save?')) {
                    ...
                    DSR_AmendmentService.savetabAmendment($scope.vmData).then(function (res) {
                        //console.log(res.data);
                        debugger;
                        if (res.data.Status == '1') {
                            debugger;
                            ...
                            $scope.txttabCargo = '';
                            $scope.txttabWeight = 0;
                            $scope.txttabManualWT = 0;
                            $scope.txttabMechanicalWT = 0;
                            $scope.txttabPkg = 0;
                            $scope.Area = '';
                            $scope.txttabFOB = '';
                            $scope.txttabCCINID = '';
                            ...
                            //$scope.GetAmendList();
                            setTimeout(function () { $('#DivBody').load('/Export/DSR_CWCExport/Amendment'); }, 500);
                        }
                        else {
                            $scope.TabSaveinfo = res.data.Message;
                        }
        ...
        $scope.GetAllCommodity = function () {
            debugger;
            DSR_AmendmentService.GetAllCommodityName('', $scope.PageFlag).then(function (res) {
                debugger;
                if (res.data != '') {
                    $scope.ListOfCommodityForAmendment = res.data.Data;
                }
        ...
        $scope.tabGetAllCommodity = function () {
            debugger;
            DSR_AmendmentService.GetAllCommodityName('', $scope.tabPageFlag).then(function (res) {
                debugger;
                if (res.data != '') {
                    $scope.tabListOfCommodityForAmendment = res.data.Data;
                }
        ...
        $scope.GetAmendList = function () {
            ...
            DSR_AmendmentService.GetAmendLst().then(function (res) {
                debugger;
