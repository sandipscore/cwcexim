    ...
    controller('BttInvoiceCtrl', function ($scope, BttInvoiceService) {
       // $scope.HtCharges = ['LOL', 'LOE', 'SH', 'BTT', 'TPT', 'DTF', 'HND', 'MF'];
        ...
        $scope.ContainerSelect = function () {
            ...
            if (c > 0) {            
                BttInvoiceService.ContainerSelect(0, $('#InvoiceDate').val(), $scope.StuffingReqId,$scope.PartyId, TaxType, $scope.conatiners, $scope.NoOfVehicles, $scope.ExportUnder).then(function (res) {
        ...
        $scope.SubmitInvoice = function () {
            ...
            $scope.InvoiceObj = JSON.parse($('#PaymentSheetModelJson').val());
