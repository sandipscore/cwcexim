(function () {
    ...
    .service('Dnd_AmendmentWIService', function ($http) {
        ...
        this.saveAmendment = function (OldInfoSBNo, NewInfoSBNo, Date, AmendmentNO, InvoiceId, InvoiceNo, InvoiceDate, FlagMerger) {
            ...
            return $http({
                url: "/Export/Dnd_CWCExport/SaveAmendementWI/",
                method: "POST",
                data: postData,
                params: { Date: Date, InvoiceId: 0, InvoiceNo: '', InvoiceDate: '', FlagMerger: FlagMerger },
                headers: {
        ...
        this.savetabAmendment = function (vm) {
            ...
            var Token = $('input[name="__RequestVerificationToken"]').val();
            return $http({
                url: "/Export/Dnd_CWCExport/SubmitAmedDataWI/",
                method: "POST",
                data: vm,
                // params: { Date: Date },
                headers: {
