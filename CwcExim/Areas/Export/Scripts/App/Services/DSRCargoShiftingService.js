(function () {
    ...
    .service('CargoShiftingService', function ($http) {
        this.GetShipBillDetails = function (id, ShiftingType, GodownId) {
            //return $http.get('/Export/DSR_CWCExport/GetShipBillDetails/?ShippingLineId=' + id);
            return $http({
                url: "/Export/DSR_CWCExport/GetShipBillDetails/?ShippingLineId=" + id,
                method: "POST",
        ...
        this.GetShippingLineforCargo = function () {
            return $http.get('/Export/DSR_CWCExport/GetShippingForCargo');
        }

        this.GetPartyforCargo = function () {
            return $http.get('/Export/DSR_CWCExport/GetPartyForCargo');
        }

        this.GetGodownforCargo = function () {
            return $http.get('/Export/DSR_CWCExport/GetFromGodownForCargo');
        }
        
        this.GetGodownforToCargo = function () {
            return $http.get('/Export/DSR_CWCExport/GetToGodownForCargo');
        }
        this.GetCargoShiftingInvoice = function (InvoiceId, InvoiceDate, ShippingLineId, TaxType, lstShipbills, PartyId) {
            ...
            return $http({
                url: "/Export/DSR_CWCExport/GetCargoShiftingPaymentSheet/?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.AddEditCargoShifting = function (InvoiceObj, shipbills, GodownIdF, GodownIdT, ShippingLineIdT, ShiftingType, ShippingLineIdF)
        {
            ...
            return $http({
                url: "/Export/DSR_CWCExport/AddEditCargoShifting",
                method: "POST",
