(function () {
    ...
    .service('JobOrderService', function ($http) {
        this.GetPort = function () {
            return $http({
                url: "/Export/Ppg_CWCExport/GetPort/",
                method: "GET",
            });
        }
        this.GetTrainDetails = function (TSumId) {
            return $http({
                url: "/Export/Ppg_CWCExport/GetTrainDetl/",
                method: "GET",
        ...
        this.OnJobOrderSave = function (Obj, FormOneDetails) {
            return $http({
                url: "/Export/Ppg_CWCExport/AddEditJobOrder/",
                method: "POST",
        ...
        this.GetTrainDetailsOnEditMode = function (ImpJobOrderId) {
            return $http({
                url: "/Export/Ppg_CWCExport/GetTrainDetailsOnEditMode/",
                method: "GET",
