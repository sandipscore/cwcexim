(function () {
    ...
    .service('Ppg_AmendmentService', function ($http) {
        this.GetSBDetails = function (SBNo, SBDate) {
            debugger;
            return $http.get('/Export/Ppg_CWCExport/GetSBDetailsBySBNo/?SBid=' + SBNo + '&SbDate=' + SBDate + '');
        }

        this.GetAllCommodityName=function(CommodityName,Page)
        {
            debugger;
            return $http.get('/Export/Ppg_CWCExport/GetAllCommodityDetailsForAmendmend/?CommodityName=' + CommodityName+'&Page='+Page);
        }
        ...
        this.GetAmendDetailsByAmendNo = function (AmendNo) {
            debugger;
            return $http.get('/Export/Ppg_CWCExport/GetAmendDetailsByAmendNo/?AmendNo=' + AmendNo);
        }

        this.loadMoreCommodity = function (partyCode, pageNo) {
            debugger;
            return $http.get('/Export/Ppg_CWCExport/GetAllCommodityDetailsForAmendmend?CommodityName=' + partyCode + '&Page=' + pageNo);
        }
        ...
        this.saveAmendment = function (OldInfoSBNo, NewInfoSBNo, Date, AmendmentNO, InvoiceId, InvoiceNo, InvoiceDate, FlagMerger) {
            ...
            return $http({
                url: "/Export/Ppg_CWCExport/SaveAmendement/",
                method: "POST",
                data: postData,
        ...
        this.savetabAmendment = function (vm) {
            ...
            var Token = $('input[name="__RequestVerificationToken"]').val();
            return $http({
                url: "/Export/Ppg_CWCExport/SubmitAmedData/",
                method: "POST",
                data: vm,
                // params: { Date: Date },
                headers: {
        ...
        this.GetAmendLst = function () {
            debugger;
            return $http.get('/Export/Ppg_CWCExport/GetAmendList/');
        }
