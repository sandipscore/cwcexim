(function () {
    ...
    .service('PpgContStuffInvoiceEditService', function ($http) {
        this.GetYardInvoiceDetails = function (InvoiceId) {
            return $http.get('/Export/Ppg_CWCExportV2/GetContainerStuffingInvoiceDetails/?InvoiceId=' + InvoiceId);
        }
        ...
        this.GenerateInvoice = function (InvoiceObj) {
            ...
            return $http({
                url: "/Export/Ppg_CWCExportV2/EditContStuffingPaymentSheet",
                method: "POST",
        ...
        */
        ...
        this.GetInvoiceCharges = function (StuffingReqDate, conatiners, PartyId, StuffReqId, InvoiceId) {
            return $http({
                url: "/Export/Ppg_CWCExportV2/CalculateGroundRentEmptyforEdit",
                method: "POST",
                params: {
                    StuffingDate: StuffingReqDate,
                    ArrayOfContainer: JSON.stringify(conatiners),
                    PartyId: PartyId,
                    StuffingReqId: StuffReqId,
                    invoiceid: InvoiceId
                }
            });
        }
