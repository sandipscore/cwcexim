(function () {
    ...
    .service('BttInvoiceService', function ($http) {
        this.SelectReqNo = function (ReqNo) {
            return $http.get('/Export/VIZ_CWCExport/GetPaymentSheetShipBillNo/?StuffingReqId=' + ReqNo);
        }

        this.GetStuffingReq = function () {
            return $http.get('/Export/VIZ_CWCExport/GetStuffindNoForBTT');
        }

        this.GetPartyForBTT = function () {
            return $http.get('/Export/VIZ_CWCExport/GetPartyForBTT');
        }
        ...
        this.ContainerSelect = function (InvoiceId, DeliveryDate, InvoiceDate, AppraisementId, TaxType, conatiners,PartyId,PayeeId,SEZ, NoOfVehicles) {
            return $http({
                url: "/Export/VIZ_CWCExport/GetBTTPaymentSheet/?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.GenerateInvoice = function (InvoiceObj, Vno, VehicleNumber) {
            ...
            return $http({
                url: "/Export/VIZ_CWCExport/AddEditBTTPaymentSheet/",
                method: "POST",
