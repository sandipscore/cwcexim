(function () {
    ...
    .service('ExportDestuffingService', function ($http) {
        this.getDestufcharges = function (stuffingid) {
            return $http.get('/Export/Ppg_CWCExport/GetChargesExportDestuffing/?ContainerStuffingId=' + stuffingid);
        }

        this.ContainerSelect = function (InvoiceId, InvoiceDate, AppraisementId, TaxType, conatiners) {
            return $http({
                url: "/Export/Ppg_CWCExport/GetExportDestuffingPaymentSheet/?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.GenerateInvoice = function (InvoiceObj) {
            ...
            return $http({
                url: "/Export/Ppg_CWCExport/AddEditExportDestuffing/",
                method: "POST",
