(function () {
    ...
    .service('JobOrderService', function ($http) {
        this.GetPort = function () {
            return $http({
                url: "/Export/WFLD_CWCExport/GetPort/",
                method: "GET",
            });
        }
        this.GetTrainDetails = function (TSumId) {
            return $http({
                url: "/Export/WFLD_CWCExport/GetTrainDetl/",
                method: "GET",
        ...
        this.OnJobOrderSave = function (Obj, FormOneDetails) {
            return $http({
                url: "/Export/WFLD_CWCExport/AddEditJobOrder/",
                method: "POST",
        ...
        this.GetTrainDetailsOnEditMode = function (ImpJobOrderId) {
            return $http({
                url: "/Export/WFLD_CWCExport/GetTrainDetailsOnEditMode/",
                method: "GET",
