(function () {
    ...
    .service('Dnd_CargoShiftingService', function ($http) {
        this.GetShipBillDetails = function (id, ShiftingType, GodownId) {
            //return $http.get('/Export/Dnd_CWCExport/GetShipBillDetails/?ShippingLineId=' + id);
            return $http({
                url: "/Export/Dnd_CWCExport/GetShipBillDetails/?ShippingLineId=" + id,
                method: "POST",
        ...
        this.GetShippingLineforCargo = function () {
            return $http.get('/Export/Dnd_CWCExport/GetShippingForCargo');
        }

        this.GetPartyforCargo = function () {
            return $http.get('/Export/Dnd_CWCExport/GetPartyForCargo');
        }

        this.GetGodownforCargo = function () {
            return $http.get('/Export/Dnd_CWCExport/GetFromGodownForCargo');
        }

        this.GetGodownforToCargo = function () {
            return $http.get('/Export/Dnd_CWCExport/GetToGodownForCargo');
        }
        this.GetCargoShiftingInvoice = function (InvoiceId, InvoiceDate, ShippingLineId, TaxType, lstShipbills, PartyId) {
            ...
            return $http({
                url: "/Export/Dnd_CWCExport/GetCargoShiftingPaymentSheet/?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.AddEditCargoShifting = function (InvoiceObj, shipbills, GodownIdF, GodownIdT, ShippingLineIdT, ShiftingType, ShippingLineIdF) {
            ...
            return $http({
                url: "/Export/Dnd_CWCExport/AddEditCargoShifting",
                method: "POST",
