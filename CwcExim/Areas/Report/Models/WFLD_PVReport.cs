...
namespace CwcExim.Areas.Report.Models
{
    ...
    public class WFLD_BondPVReport
    {
        public int SlNo { get; set; }
    ...
    public class WFLD_PVReport
    {
        [Required(ErrorMessage = "Fill Out This Field")]
        public string AsOnDate { get; set; }
    }
    public class WFLD_PVReportImpLoadedCont
    {
    ...
    public class WFLD_PVReportImpEmptyCont
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string EntryDateTime { get; set; }
    ...
    public class WFLD_LongStandingEmptyCont
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string EntryDateTime { get; set; }
    ...
    public class WFLD_LongStandingImpCon
    {
        [Required(ErrorMessage = "Fill Out This Field")]
    ...
    public class WFLD_LongStandingImpConDtl
    {
        public string BOLNo { get; set; }
    ...
    public class WFLD_ImpPVReportViewModel
    {
        public int SlNo { get; set; }
