...
namespace CwcExim.Areas.Report.Models
{
    public class VIZ_ImpPVReport
    {
       public int SlNo { get; set; }
        ...
        public class VIZ_PVReport
        {
            [Required(ErrorMessage = "Fill Out This Field")]
            public string AsOnDate { get; set; }
        }
        public class VIZ_PVReportImpLoadedCont
        {
        ...
        public class VIZ_PVReportImpEmptyCont
        {
            public string CFSCode { get; set; }
            public string ContainerNo { get; set; }
            public string EntryDateTime { get; set; }
        ...
        public class VIZ_LongStandingEmptyCont
        {
            public string CFSCode { get; set; }
            public string ContainerNo { get; set; }
            public string EntryDateTime { get; set; }
        ...
        public class VIZ_LongStandingImpCon
        {
            [Required(ErrorMessage = "Fill Out This Field")]
        ...
        public class VIZ_LongStandingImpConDtl
        {
            public string BOLNo { get; set; }
        ...
        public class VIZ_ImpPVReportViewModel
        {
            public int SlNo { get; set; }
