...
{
    public class LNSM_BulkIRN
    {
        public IList<LNSM_BulkIRNDetails> lstPostPaymentChrg { get; set; } = new List<LNSM_BulkIRNDetails>();
    }

    public class LNSM_BulkIRNDetails
    {
    ...
    public class LNSM_IrnB2CDetails
    {
