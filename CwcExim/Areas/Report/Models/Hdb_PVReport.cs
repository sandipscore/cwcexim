...
namespace CwcExim.Areas.Report.Models
{
    ...
    public class Ppg_PVReport
    {
        [Required(ErrorMessage = "Fill Out This Field")]
        public string AsOnDate { get; set; }
    }
    public class Ppg_PVReportImpLoadedCont
    {
    ...
    public class Ppg_PVReportImpEmptyCont
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string EntryDateTime { get; set; }
    ...
    public class Ppg_LongStandingEmptyCont
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string EntryDateTime { get; set; }
    ...
    public class Ppg_LongStandingImpCon
    {
        [Required(ErrorMessage = "Fill Out This Field")]
    ...
    public class Ppg_LongStandingImpConDtl
    {
        public string BOLNo { get; set; }
        public string BOLDate { get; set; }
