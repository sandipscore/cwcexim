(function () {
    ...
    controller('VRN_BillCumSDLedgerCtrl', function ($scope, VRN_BillCumSDLedgerSvc) {
        ...
        $scope.generate = function () {
            ...
            VRN_BillCumSDLedgerSvc.GetLedgerReport($scope.PartyId, $scope.FromDate, $scope.ToDate).then(function (res) {
