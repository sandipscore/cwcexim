(function () {
    angular.module('CWCApp')
        ...
        .controller('DSREconomyReportCtrl', function ($scope, DSREconomyReportSvc) {
        $scope.Msg = '';
        $scope.months = [
            { "Value": "0", "Text": "--Select--" },
            { "Value": "1", "Text": "Jan" },
        ...
        $scope.GetEconomyReport = function () {
            DSREconomyReportSvc.GetEconomyReport($scope.Month, $scope.Year).then(function (res) {
        ...
        $scope.SaveEcoRpt = function () {
            ...
            if (confirm('Are You Sure To Save?')) {
                debugger;
                DSREconomyReportSvc.SaveEconomyReport($scope.Month, $scope.Year, $scope.EcoRptData).then(function (res) {
                    console.log(res.data.Data);
                    if (res.data.Status == 1) {
