(function () {
    ...
    controller('PPG_BOEQueryCtrl', function ($scope, PPG_BOEQueryService) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        ...
        $scope.GetBOEDetailsForBOEQuery = function () {
            ...
            PPG_BOEQueryService.GetBOEDetailsForBOEQuery(OBLNo, SearchBy).then(function (response) {
                debugger;
                $scope.OblEntryDetails = [];
        ...
        $scope.ResetDet = function () {
            ...
            $('#DivBody').load('/Report/Ppg_ReportCWCV2/TSAGateDetail?SearchBy=' + prm);
