(function () {
    ...
    controller('BillCumSDLedgerCtrl', function ($scope, BillCumSDLedgerSvc) {
        ...
        $scope.generate = function () {
            ...
            BillCumSDLedgerSvc.GetLedgerReport($scope.PartyId, $scope.FromDate, $scope.ToDate).then(function (res) {
                ...
                if (res.data.Status == 1) {
                    ...
                    $scope.Summary = res.data.Data.lstSummary;
