(function () {
    angular.module('CWCApp')
        ...
        .controller('VRN_EconomyReportCtrl', function ($scope, VRN_EconomyReportSvc) {
            $scope.Msg = '';
            $scope.months = [
                { "Value": "0", "Text": "--Select--" },
                { "Value": "1", "Text": "Jan" },
            ...
            $scope.GetEconomyReport = function () {
                VRN_EconomyReportSvc.GetEconomyReport($scope.Month, $scope.Year).then(function (res) {
            ...
            $scope.SaveEcoRpt = function () {
                ...
                if (confirm('Are You Sure To Save?')) {
                    debugger;
                    VRN_EconomyReportSvc.SaveEconomyReport($scope.Month, $scope.Year, $scope.EcoRptData).then(function (res) {
                        console.log(res.data.Data);
                        if (res.data.Status == 1) {
