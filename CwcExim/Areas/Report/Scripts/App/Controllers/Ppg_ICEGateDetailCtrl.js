(function () {
    ...
    controller('Ppg_ICEGateDetailCtrl', function ($scope, Ppg_ICEGateDetailService) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        ...
        $scope.GetOBLDetailsForOBLQuery = function () {
            ...
            Ppg_ICEGateDetailService.GetOBLDetailsForOBLQuery(oblnum, obldate, SearchBy).then(function (response) {
                debugger;
                //$scope.OblEntryDetails = [];
        ...
        $scope.ResetDet = function () {
            ...
            $('#DivBody').load('Report/Ppg_ReportCWCV2/ICEGateDetail?SearchBy=' + prm);
