(function () {
    ...
    controller('ICEGateDetailCtrl', function ($scope, ICEGateDetailService) {
        ...
        $scope.GetOBLDetailsForOBLQuery = function () {
           ...
           // var obl = OBLNo.split('-');
            var oblnum = $('#OBL_No').val();
            var obldate = $('#OBL_Date').val();
          //  var obl=  {{OBLNo.split('-')[0]}};
           ...
           // var OBLDate=
            ...
            ICEGateDetailService.GetOBLDetailsForOBLQuery(oblnum,obldate, SearchBy).then(function (response) {
                debugger;
                $scope.OblEntryDetails = [];
        ...
        $scope.ResetDet = function () {
            ...
            $('#DivBody').load('/Report/WFLD_ReportCWC/ICEGateDetail?SearchBy=' + prm);
