(function () {
    angular.module('CWCApp')
        ...
        .controller('DndEconomyReportCtrl', function ($scope, DndEconomyReportSvc) {
            $scope.Msg = '';
            $scope.months = [
                { "Value": "0", "Text": "--Select--" },
                { "Value": "1", "Text": "Jan" },
            ...
            $scope.GetEconomyReport = function () {
                DndEconomyReportSvc.GetEconomyReport($scope.Month, $scope.Year).then(function (res) {
            ...
            $scope.SaveEcoRpt = function () {
                ...
                if (confirm('Are You Sure To Save?')) {
                    debugger;
                    DndEconomyReportSvc.SaveEconomyReport($scope.Month, $scope.Year, $scope.EcoRptData).then(function (res) {
                        console.log(res.data.Data);
                        if (res.data.Status == 1) {
