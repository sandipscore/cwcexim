(function () {
    ...
    controller('CrInvLedgerCtrl', function ($scope, CrInvLedgerService) {
        ...
        $scope.generate = function () {
            ...
            CrInvLedgerService.GetLedgerReport($scope.PartyId, $scope.FromDate, $scope.ToDate).then(function(res){
