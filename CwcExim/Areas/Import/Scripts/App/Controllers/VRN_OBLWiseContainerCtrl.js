(function () {
    ...
    controller('VRN_OBLWiseContainerEntryCtrl', function ($scope, VRN_OBLWiseContainerService) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        ...
        $scope.GetOBLDetails = function () {
            ...
            VRN_OBLWiseContainerService.GetOBLDetails(OBLNo).then(function (response) {
                debugger;
                $scope.OblEntryDetails = [];
        ...
        $scope.OnOBLEntrySave = function () {
            ...
            if (confirm('Are you sure to save OBL Entry?')) {
                ...
                VRN_OBLWiseContainerService.OBLEntrySave(Obj, JSON.stringify($scope.OblEntryDetails)).then(function (res) {
                    console.log(res);
        ...
        function LoadOblEntry() {
            $('#DivBody').load('/Import/VRN_OblEntry/OBLWiseContainerEntry');
        }
