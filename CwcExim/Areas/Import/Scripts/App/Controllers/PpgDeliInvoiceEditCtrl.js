(function () {
    ...
    controller('PpgDeliInvoiceEditCtrl', function ($scope, PpgDeliInvoiceEditService) {
        debugger;
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgDeliInvoiceEditService.GetAppNoForYard("ImpDeli").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
          ...
          //  $scope.InvoiceNo = obj.InvoiceNo;
            ...
            $('.modalloader').show();
            PpgDeliInvoiceEditService.GetDeliInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
                debugger;
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                if (c > 0) {
                    ...
                    PpgDeliInvoiceEditService.ContainerSelect($('#InvoiceDate').val(), $scope.TaxType, $scope.StuffingReqId, 1, $scope.StuffingReqNo, $scope.StuffingReqDate, $scope.PartyId, $scope.PartyName, $scope.hdnAddress, $scope.hdnState, $scope.hdnStateCode, $scope.GSTNo, $scope.PayeeId, $scope.PayeeName, $scope.conatiners, $scope.OTHours, $scope.InvoiceId).then(function (res) {
                        debugger;
                        $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgDeliInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
