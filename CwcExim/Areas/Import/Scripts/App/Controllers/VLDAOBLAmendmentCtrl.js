(function () {
    ...
    controller('VLDAOBLAmendmentCtrl', function ($scope, VLDAOBLAmendmentService) {
        $scope.InvoiceNo = "";
        $scope.GetOBLDetails = function () {
            debugger;
            var OBLNo = $('#OldOBLNo').val();
            VLDAOBLAmendmentService.GetOBLDetails(OBLNo).then(function (response) {
                debugger;
        ...
        $scope.OnOBLEntrySave = function () {
            ...
            if (confirm('Are you sure to update OBL No?')) {
                ...
                debugger;
                VLDAOBLAmendmentService.OBLEntrySave(Obj).then(function (res) {
                    debugger;
                    console.log(res);
