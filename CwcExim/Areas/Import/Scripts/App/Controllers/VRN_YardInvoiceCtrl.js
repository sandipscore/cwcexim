(function () {
    ...
    controller('VRN_YardInvoiceCtrl', function ($scope, VRN_YardInvoiceService) {
        ...
        $scope.LoadPartyList = function () {
            $scope.PartyPage = 0;
            $scope.SearchPartyText = "";
            VRN_YardInvoiceService.LoadPartyList($scope.PartyPage).then(function (res) {
        ...
        $scope.LoadPayeeList = function () {
            $scope.PayeePage = 0;
            $scope.SearchPayeeText = "";
            VRN_YardInvoiceService.LoadPartyList($scope.PayeePage).then(function (res) {
        ...
        $scope.SearchPartyList = function () {
            VRN_YardInvoiceService.SearchPartyList($scope.SearchPartyText).then(function (res) {
                $scope.PartyList = res.data.lstParty;
            });
            $scope.PartyPage = 0;
            $scope.btnParty = false;
        ...
        $scope.SearchPayeeList = function () {
            VRN_YardInvoiceService.SearchPartyList($scope.SearchPayeeText).then(function (res) {
                $scope.PayeeList = res.data.lstParty;
            });
            $scope.PayeePage = 0;
            $scope.btnPayee = false;
        ...
        $scope.SelectReqNo = function (obj) {
            ...
            */
            VRN_YardInvoiceService.SelectReqNo($scope.StuffingReqId).then(function (res) {
                $scope.conatiners = JSON.parse(res.data);
        ...
        $scope.SelectReqNoTentative = function (obj) {
            ...
            */
            VRN_YardInvoiceService.SelectReqNoTentative($scope.StuffingReqId).then(function (res) {
                $scope.conatiners = JSON.parse(res.data);
                // console.log(res.data);
            });
        ...
        $scope.Print = function () {
            debugger;
            VRN_YardInvoiceService.PrintInvoice($scope.InvoiceObj).then(function (res) {
        ...
        $scope.ContainerSelect = function () {
            ...
            */
            ...
            if (c > 0) {
                ...
                VRN_YardInvoiceService.ContainerSelect(0, $('#InvoiceDate').val(), $scope.StuffingReqId, TaxType, $scope.conatiners, $scope.OTHours, $scope.PartyId, $scope.PayeeId, isdirect, $scope.Movement, $scope.SEZ, $scope.ReeferHours).then(function (res) {
                    debugger;
                    $scope.InvoiceObj = res.data;
        ...
        $scope.GenerateIRN = function () {
            ...
            $('.modalloader').show();
          VRN_YardInvoiceService.GenerateIRNNo($scope.InvoiceNo, $scope.SupplyType).then(function (res) {
                debugger;
        ...
        $scope.SubmitInvoice = function () {
            ...
            if ($scope.InvoiceObj.PaymentMode == "CASH") {
                ...
                if (confirm('Are you sure to Generate Cash Invoice?')) {
                    ...
                    VRN_YardInvoiceService.GenerateInvoice($scope.InvoiceObj, isdirect, $scope.MovementType, $scope.SEZ, $scope.ReeferHours).then(function (res) {
                        debugger;
                        console.log(res);
                        debugger;
        ...
        $scope.GetAppNo = function () {
            ...
            debugger;
            VRN_YardInvoiceService.GetAppNoForYard().then(function (res) {
                debugger;
