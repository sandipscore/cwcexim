(function () {
    ...
    controller('Wlj_OBLEntryCtrl', function ($scope, Wlj_OBLEntryService) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        ...
        $scope.GetOBLDetails = function () {
            ...
            Wlj_OBLEntryService.GetOBLDetails(ContainerNo, CFSCode, ContainerSize, IGM_No, IGM_Date, OBLEntryId).then(function (response) {
                debugger;
                $scope.OblEntryDetails = [];
        ...
        $scope.OnOBLEntrySave = function () {
            ...
            if (confirm('Are you sure to save OBL Entry?')) {
                ...
                Wlj_OBLEntryService.OBLEntrySave(Obj, JSON.stringify($scope.OblEntryDetails)).then(function (res) {
                    console.log(res);
        ...
        function LoadOblEntry() {
            $('#DivBody').load('/Import/Wlj_OblEntry/OBLEntry');
        }
