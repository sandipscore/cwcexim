(function () {
    ...
    angular.module('CWCApp').controller('VLDA_OBLEntryCtrl', function ($scope, VLDA_OBLEntryService, focus) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        focus('focusMe');
        ...
        $scope.GetOBLDetails = function () {
            ...
            VLDA_OBLEntryService.GetOBLDetails(ContainerNo, CFSCode, ContainerSize, IGM_No, IGM_Date, OBLEntryId).then(function (response) {
                debugger;
                $scope.OblEntryDetails = [];
        ...
        $scope.OnOBLEntrySave = function () {
            ...
            if (confirm('Are you sure to save OBL Entry?')) {
                ...
                VLDA_OBLEntryService.OBLEntrySave(Obj, JSON.stringify($scope.OblEntryDetails)).then(function (res) {
                    console.log(res);
        ...
        function LoadOblEntry() {
            $('#DivBody').load('/Import/VLDA_OblEntry/OBLEntry');
        }
