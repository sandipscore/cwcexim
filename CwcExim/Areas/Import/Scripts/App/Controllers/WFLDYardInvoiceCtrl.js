(function () {
    ...
    controller('WFLDYardInvoiceCtrl', function ($scope, WFLDYardInvoiceService) {
      //  $scope.HtCharges = ['LOL', 'LOE', 'SH', 'BTT', 'TPT', 'DTF', 'HND', 'MF'];
        ...
        $scope.LoadPartyList = function () {
            ...
            $scope.PartyPage = 0;
            $scope.SearchPartyText = "";
            WFLDYardInvoiceService.LoadPartyList($scope.PartyPage).then(function (res) {
        ...
        $scope.LoadPayeeList = function () {
            $scope.PayeePage = 0;
            $scope.SearchPayeeText = "";
            WFLDYardInvoiceService.LoadPPayeeList($scope.PayeePage).then(function (res) {
        ...
        $scope.SearchPartyList = function () {
            WFLDYardInvoiceService.SearchPartyList($scope.SearchPartyText).then(function (res) {
                $scope.PartyList = res.data.lstParty;
            });
            $scope.PartyPage = 0;
            $scope.btnParty = false;
        ...
        $scope.SearchPayeeList = function () {
            WFLDYardInvoiceService.SearchPayeeList($scope.SearchPayeeText).then(function (res) {
                $scope.PayeeList = res.data.lstParty;
            });
            $scope.PayeePage = 0;
            $scope.btnPayee = false;
      ...
      //  $scope.LoadPayeeList();
        ...
        $scope.SelectReqNo = function (obj) {
            ...
            */
            WFLDYardInvoiceService.SelectReqNo($scope.StuffingReqId).then(function (res) {
        ...
        $scope.SelectReqNoTentative = function (obj) {
            ...
            */
            WFLDYardInvoiceService.SelectReqNoTentative($scope.StuffingReqId).then(function (res) {
                $scope.conatiners = JSON.parse(res.data);
                // console.log(res.data);
            });
        ...
        $scope.Print = function () {
            debugger;
            WFLDYardInvoiceService.PrintInvoice($scope.InvoiceObj).then(function (res) {
            ...
            if (idt <= ddt && ddt >= idt) {
                ...
                */
                ...
                if (c > 0) {
                    ...
                    WFLDYardInvoiceService.ContainerSelect(0, $('#InvoiceDate').val(), $('#DeliveryDate').val(), $scope.StuffingReqId, TaxType, $scope.conatiners,
        ...
        $scope.SubmitInvoice = function () {
            ...
            if ($scope.InvoiceObj.PaymentMode == "CASH") {
                ...
                if (confirm('Are you sure to Generate Cash Invoice?')) {
                    ...
                    WFLDYardInvoiceService.GenerateInvoice($scope.InvoiceObj, $scope.NoOfVehicles, isdirect, YardBond, SEZ, BillToParty, $scope.Distance, $scope.OTHours, OwnMovement, InsuredParty).then(function (res) {
                        console.log(res);
        ...
        $scope.GetAppNo = function () {
            ...
            debugger;
            WFLDYardInvoiceService.GetAppNoForYard().then(function (res) {
                debugger;
        ...
        {
            $scope.SearchCHAText = '';
            WFLDYardInvoiceService.SearchCHAList('',0).then(function (res) {
                debugger;
        ...
        {
            WFLDYardInvoiceService.SearchCHAList($scope.SearchCHAText, 0).then(function (res) {
                debugger;
        ...
        $scope.LoadMoreCHAList=function()
        {
            ...
            WFLDYardInvoiceService.SearchCHAList('', $scope.CHAPage).then(function (res) {
                debugger;
        ...
        $scope.GenerateIRN = function () {
            ...
            WFLDYardInvoiceService.GenerateIRNNo($scope.InvoiceNo, $scope.SupplyType).then(function (res) {
