(function () {
    ...
    controller('VLDAOBLWiseContainerEntryCtrl', function ($scope, VLDAOBLWiseContainerService) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        ...
        $scope.ChangeCONTCBT = function (index) {
            ...
            VLDAOBLWiseContainerService.GetContCBT(index.CONTCBT).then(function (response) {
                debugger;
        ...
        $scope.GetOBLDetails = function () {
            ...
            VLDAOBLWiseContainerService.GetOBLDetails(OBLNo).then(function (response) {
                debugger;
                $scope.OblEntryDetails = [];
        ...
        $scope.OnOBLEntrySave = function () {
            ...
            if (confirm('Are you sure to save OBL Entry?')) {
                ...
                VLDAOBLWiseContainerService.OBLEntrySave(Obj, JSON.stringify($scope.OblEntryDetails)).then(function (res) {
                    console.log(res);
        ...
        function LoadOblEntry() {
            $('#DivBody').load('/Import/VLDA_OblEntry/OBLWiseContainerEntry');
        }
