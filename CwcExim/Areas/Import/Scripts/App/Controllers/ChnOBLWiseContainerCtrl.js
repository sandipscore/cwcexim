(function () {
    ...
    controller('CHNOBLWiseContainerCtrl', function ($scope, OBLWiseContainerService) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        ...
        $scope.ChangeCONTCBT = function (index) {
            debugger;
            ind = index;
            ind.CONTCBT = index.CONTCBT;
            OBLWiseContainerService.GetContCBT(index.CONTCBT).then(function (response) {
                debugger;
                ...
                $.each(response.data, function (item, elem) {
                    debugger;
                    html += '<tr tabindex=' + tabindex + ' onkeypress="SelectContainer(&quot;' + elem.ContainerNo + '&quot;,&quot;' + elem.ShippingLineId + '&quot;,&quot;' + elem.ShippingLine + '&quot;,&quot;' + elem.NoOfPackages + '&quot;,&quot;' + elem.GrossWeight + '&quot;,&quot;' + elem.Size + '&quot;,&quot;' + elem.CFSCode + '&quot;)"  onclick="SelectContainer(&quot;' + elem.ContainerNo + '&quot;,&quot;' + elem.ShippingLineId + '&quot;,&quot;' + elem.ShippingLine + '&quot;,&quot;' + elem.NoOfPackages + '&quot;,&quot;' + elem.GrossWeight + '&quot;,&quot;' + elem.Size + '&quot;,&quot;' + elem.CFSCode + '&quot;)"><td>' + elem.ContainerNo + '</td></tr>';
                    tabindex++;
                });
        ...
        $scope.SelectContainer = function (Cont, Sid, Sname, NoOfPack, GrossWt, Size,CFSCode) {
            debugger;
        ...
        $scope.AddOblEntry = function () {
            ...
            if (len > 0) {
                ...
                if ($scope.OblEntryDetails[len - 1].GR_WT == '' || $scope.OblEntryDetails[len - 1].GR_WT == null || $scope.OblEntryDetails[len - 1].GR_WT == 0) {
                    alert("Please fillup the row");
                    return false;
                }
                if ($scope.OblEntryDetails[len - 1].NoOfPkg == '' || $scope.OblEntryDetails[len - 1].NoOfPkg == null || $scope.OblEntryDetails[len - 1].NoOfPkg == 0) {
                    alert("Please fillup the row");
                    return false;
                }
        ...
        $scope.OnOBLEntrySave = function () {
            ...
            angular.forEach($scope.OblEntryDetails, function (item) {
                ...
                else if (item.GR_WT == ''||item.GR_WT ==0||item.GR_WT ==0.00) {
                    flag5 = 1;
                }
                else if (item.ShippingLineId == 0) {
                    flag2 = 1;
                }
                else if (item.NoOfPkg == 0 || item.NoOfPkg=='')
                {
                    flag4 = 1;
                }
            });
        ...
        function LoadOblEntry() {
            $('#DivBody').load('/Import/CHN_OblEntry/OBLWiseContainerEntry');
        }
