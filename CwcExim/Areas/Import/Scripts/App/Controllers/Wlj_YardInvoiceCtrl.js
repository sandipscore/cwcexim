(function () {
    ...
    controller('Wlj_YardInvoiceCtrl', function ($scope, Wlj_YardInvoiceService) {
        ...
        $scope.LoadPartyList = function () {
            $scope.PartyPage = 0;
            $scope.SearchPartyText = "";
            Wlj_YardInvoiceService.LoadPartyList($scope.PartyPage).then(function (res) {
        ...
        $scope.LoadPayeeList = function () {
            $scope.PayeePage = 0;
            $scope.SearchPayeeText = "";
            Wlj_YardInvoiceService.LoadPartyList($scope.PayeePage).then(function (res) {
        ...
        $scope.SearchPartyList = function () {
            Wlj_YardInvoiceService.SearchPartyList($scope.SearchPartyText).then(function (res) {
                $scope.PartyList = res.data.lstParty;
            });
            $scope.PartyPage = 0;
            $scope.btnParty = false;
        ...
        $scope.SearchPayeeList = function () {
            Wlj_YardInvoiceService.SearchPartyList($scope.SearchPayeeText).then(function (res) {
                $scope.PayeeList = res.data.lstParty;
            });
            $scope.PayeePage = 0;
            $scope.btnPayee = false;
        ...
        $scope.SelectReqNo = function (obj) {
            ...
            */
            Wlj_YardInvoiceService.SelectReqNo($scope.StuffingReqId).then(function (res) {
                $scope.conatiners = JSON.parse(res.data);
        ...
        $scope.SelectReqNoTentative = function (obj) {
            ...
            */
            Wlj_YardInvoiceService.SelectReqNoTentative($scope.StuffingReqId).then(function (res) {
                $scope.conatiners = JSON.parse(res.data);
                // console.log(res.data);
            });
        ...
        $scope.Print = function () {
            debugger;
            Wlj_YardInvoiceService.PrintInvoice($scope.InvoiceObj).then(function (res) {
        ...
        $scope.ContainerSelect = function () {
            ...
            */
            ...
            if (c > 0) {
                ...
                Wlj_YardInvoiceService.ContainerSelect(0, $('#InvoiceDate').val(), $scope.StuffingReqId, TaxType, $scope.SEZ,$scope.conatiners, $scope.OTHours, $scope.PartyId, $scope.PayeeId, isdirect).then(function (res) {
                    debugger;
                    $scope.InvoiceObj = res.data;
        ...
        $scope.GenerateIRN = function () {
            ...
            $('.modalloader').show();
            Wlj_YardInvoiceService.GenerateIRNNo($('#InvoiceNo').val(), $scope.SupplyType).then(function (res) {
                debugger;
        ...
        $scope.SubmitInvoice = function () {
            ...
            if ($scope.InvoiceObj.PaymentMode == "CASH") {
                ...
                if (confirm('Are you sure to Generate Cash Invoice?')) {
                    ...
                    Wlj_YardInvoiceService.GenerateInvoice($scope.InvoiceObj, isdirect,$scope.SEZ).then(function (res) {
                        console.log(res);
        ...
        $scope.GetAppNo = function () {
            ...
            debugger;
            Wlj_YardInvoiceService.GetAppNoForYard().then(function (res) {
                debugger;
