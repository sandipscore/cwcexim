(function () {
    ...
    controller('CHNOBLEntryCtrl', function ($scope, CHNOBLEntryService) {
        $scope.InvoiceNo = "";
        var t2 = 0;
        ...
        $scope.GetOBLDetails = function () {
            ...
            CHNOBLEntryService.GetOBLDetails(ContainerNo, CFSCode, ContainerSize, IGM_No, IGM_Date, OBLEntryId).then(function (response) {
                debugger;
                $scope.OblEntryDetails = [];
        ...
        $scope.OnOBLEntrySave = function () {
            ...
            if (confirm('Are you sure to save OBL Entry?')) {
                ...
                CHNOBLEntryService.OBLEntrySave(Obj, JSON.stringify($scope.OblEntryDetails)).then(function (res) {
                    console.log(res);
        ...
        function LoadOblEntry() {
            $('#DivBody').load('/Import/Chn_OblEntry/OBLEntry');
        }
