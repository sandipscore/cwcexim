(function () {
    ...
    controller('PpgEmptyContTransferInvoiceEditCtrl', function ($scope, PpgEmptyContTransferInvoiceEditService) {
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgEmptyContTransferInvoiceEditService.GetAppNoForYard("ECTrns").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            $('.modalloader').show();
            PpgEmptyContTransferInvoiceEditService.GetEmptyInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
                debugger;
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                $('.modalloader').show();
                if (c > 0) {
                    PpgEmptyContTransferInvoiceEditService.ContainerSelect($scope.InvoiceId, $('#InvoiceDate').val(), $scope.StuffingReqId, $scope.TaxType, $scope.PartyId, $scope.PayeeId, $scope.StuffingReqDate, $scope.ContainerNo, $scope.CFSCode, $scope.Size, $scope.DestuffingDate).then(function (res) {
                        debugger;
                        $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgEmptyContTransferInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
