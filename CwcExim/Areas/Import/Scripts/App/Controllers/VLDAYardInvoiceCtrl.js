(function () {
    ...
    controller('VLDAYardInvoiceCtrl', function ($scope, VLDAYardInvoiceService) {
        ...
        $scope.LoadPartyList = function () {
            ...
            $scope.PartyPage = 0;
            $scope.SearchPartyText = "";
            VLDAYardInvoiceService.LoadPartyList($scope.PartyPage).then(function (res) {
        ...
        $scope.LoadPayeeList = function () {
            $scope.PayeePage = 0;
            $scope.SearchPayeeText = "";
            VLDAYardInvoiceService.LoadPPayeeList($scope.PayeePage).then(function (res) {
        ...
        $scope.SearchPartyList = function () {
            VLDAYardInvoiceService.SearchPartyList($scope.SearchPartyText).then(function (res) {
                $scope.PartyList = res.data.lstParty;
            });
            $scope.PartyPage = 0;
            $scope.btnParty = false;
        ...
        $scope.SearchPayeeList = function () {
            VLDAYardInvoiceService.SearchPayeeList($scope.SearchPayeeText).then(function (res) {
                $scope.PayeeList = res.data.lstParty;
            });
            $scope.PayeePage = 0;
            $scope.btnPayee = false;
        ...
        $scope.SelectReqNo = function (obj) {
            ...
            */
            VLDAYardInvoiceService.SelectReqNo($scope.StuffingReqId).then(function (res) {
        ...
        $scope.SelectReqNoTentative = function (obj) {
            ...
            */
            VLDAYardInvoiceService.SelectReqNoTentative($scope.StuffingReqId).then(function (res) {
                $scope.conatiners = JSON.parse(res.data);
                // console.log(res.data);
            });
        ...
        $scope.Print = function () {
            debugger;
            VLDAYardInvoiceService.PrintInvoice($scope.InvoiceObj).then(function (res) {
            ...
            if (idt <= ddt && ddt >= idt) {
                ...
                */
                ...
                if (c > 0) {
                    ...
                    var IsOpenYard = 0;
                    if ($('#IsOpenYard').prop("checked") == true) {
                        IsOpenYard = 1;
                    }
                    var Isdestuffed = 0;
                    if ($('#Isdestuffed').prop("checked") == true) {
                        Isdestuffed = 1;
                    }
                    VLDAYardInvoiceService.ContainerSelect(0, $('#InvoiceDate').val(), $('#DeliveryDate').val(), $scope.StuffingReqId, TaxType, $scope.conatiners,
                        $scope.OTHours, $scope.PartyId, $scope.PayeeId, isdirect, IsOpenYard, Isdestuffed, $scope.NoOfVehicles,
                        $scope.Distance, OwnMovement, InsuredParty, YardBond, SEZ).then(function (res) {
                            ...
                            $('#IsOpenYard').attr("disabled", true);
                            $('#Isdestuffed').attr("disabled", true);
        ...
        $scope.SubmitInvoice = function () {
            ...
            if ($scope.InvoiceObj.PaymentMode == "CASH") {
                ...
                if (confirm('Are you sure to Generate Cash Invoice?')) {
                    ...
                    VLDAYardInvoiceService.GenerateInvoice($scope.InvoiceObj, $scope.NoOfVehicles, isdirect, YardBond, SEZ, BillToParty, $scope.Distance, $scope.OTHours, OwnMovement, InsuredParty, IsOpenYard, Isdestuffed).then(function (res) {
                        console.log(res);
        ...
        $scope.GetAppNo = function () {
            ...
            debugger;
            VLDAYardInvoiceService.GetAppNoForYard().then(function (res) {
                debugger;
        ...
        $scope.LoadCHAList = function () {
            $scope.SearchCHAText = '';
            VLDAYardInvoiceService.SearchCHAList('', 0).then(function (res) {
                debugger;
        ...
        $scope.SearchCHAList = function () {
            VLDAYardInvoiceService.SearchCHAList($scope.SearchCHAText, 0).then(function (res) {
                debugger;
        ...
        $scope.LoadMoreCHAList = function () {
            ...
            VLDAYardInvoiceService.SearchCHAList('', $scope.CHAPage).then(function (res) {
                debugger;
        ...
        $scope.GenerateIRN = function () {
            ...
            VLDAYardInvoiceService.GenerateIRNNo($scope.InvoiceNo, $scope.SupplyType).then(function (res) {
