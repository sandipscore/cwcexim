(function () {
    ...
    controller('PpgEmptyContInvoiceEditCtrl', function ($scope, PpgEmptyContInvoiceEditService) {
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgEmptyContInvoiceEditService.GetAppNoForYard("EC").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            $('.modalloader').show();
            PpgEmptyContInvoiceEditService.GetEmptyInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
                debugger;
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                $('.modalloader').show();
                if (c > 0) {
                    PpgEmptyContInvoiceEditService.ContainerSelect($scope.InvoiceId, $('#InvoiceDate').val(), $scope.StuffingReqId, $scope.TaxType, 'Godown', $scope.conatiners, $scope.PartyId, $scope.PayeeId).then(function (res) {
                        debugger;
                        $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgEmptyContInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
