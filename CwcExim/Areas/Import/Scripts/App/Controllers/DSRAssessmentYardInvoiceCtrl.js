        ...
        $scope.SubmitInvoice = function () {
            ...
            if ($scope.InvoiceObj.PaymentMode == "CASH") {
                ...
                if (confirm('Are you sure to Generate Cash Invoice?')) {
                    ...
                    DSRYardInvoiceService.GenerateInvoice($scope.InvoiceObj, isdirect, MovementType, $scope.conatiners, PortName, ExamType, $scope.SEZ, Amendment, InsuredParty).then(function (res) {
                        console.log(res);
                        debugger;                       
