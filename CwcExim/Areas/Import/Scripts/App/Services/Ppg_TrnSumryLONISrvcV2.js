(function () {
    ...
    .service('TrainSummaryLONIService', function ($http) {
        ...
        this.LoadMoreShippingList = function (Page, PartyCode) {
            return $http.get('/Import/Ppg_CWCImportV2/TrainSummryPayeeListLONI?Page=' + Page + '&PartyCode=' + PartyCode);
        }
        this.SaveInvoice = function (InvoiceObj,SEZ) {
            var Token = $('input[name="__RequestVerificationToken"]').val();
            return $http({
                url: "/Import/Ppg_CWCImportV2/SaveUploadDataLONI/",
                method: "POST",
                params: { SEZ: SEZ },
        ...
        this.ViewTrainSummary = function (TrainSummaryUploadId) {
            return $http.get('/Import/Ppg_CWCImportV2/GetTrainSummaryDetailsLONI/?TrainSummaryUploadId=' + TrainSummaryUploadId);
        }
