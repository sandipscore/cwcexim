(function () {
    ...
    .service('TrainSummaryTKDService', function ($http) {
        ...
        this.LoadMoreShippingList = function (Page, PartyCode) {
            return $http.get('/Import/Loni_CWCImportV2/TrainSummryPayeeList?Page=' + Page + '&PartyCode=' + PartyCode);
        }
        this.SaveInvoice = function (InvoiceObj, SEZ) {
            var Token = $('input[name="__RequestVerificationToken"]').val();
            return $http({
                url: "/Import/Loni_CWCImportV2/SaveUploadData/",
                method: "POST",
                params: { SEZ: SEZ },
        ...
        this.ViewTrainSummary = function (TrainSummaryUploadId) {
            return $http.get('/Import/Loni_CWCImportV2/GetTrainSummaryDetailsTKD/?TrainSummaryUploadId=' + TrainSummaryUploadId);
        }
