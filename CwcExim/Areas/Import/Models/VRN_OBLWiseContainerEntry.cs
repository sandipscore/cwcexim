...
{
    public class VRN_OBLWiseContainerEntry
    {
        ...
        public List<VRN_OBLWiseContainerEntryDetails> OblEntryDetailsList = new List<VRN_OBLWiseContainerEntryDetails>();
    }
    public class VRN_OBLWiseContainerEntryDetails
    {
