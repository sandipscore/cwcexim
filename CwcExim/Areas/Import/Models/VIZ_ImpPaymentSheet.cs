...
{
    public class VIZ_ImpPaymentSheet: VIZImpInvoiceBase
    {
        public IList<VIZExpInvoiceContainerBase> lstPostPaymentCont { get; set; } = new List<VIZExpInvoiceContainerBase>();
        public IList<VIZ_ExpContainer> lstPSCont { get; set; } = new List<VIZ_ExpContainer>();
        public IList<VIZExpInvoiceChargeBase> lstPostPaymentChrg { get; set; } = new List<VIZExpInvoiceChargeBase>();
        public IList<VIZExpADDCWCInvoiceChargeBase> lstADDPostPaymentChrg { get; set; } = new List<VIZExpADDCWCInvoiceChargeBase>();
        public IList<VIZ_ExpContWiseAmount> lstContwiseAmt { get; set; } = new List<VIZ_ExpContWiseAmount>();
        public IList<VIZ_ExpOperationContWiseCharge> lstOperationContwiseAmt { get; set; } = new List<VIZ_ExpOperationContWiseCharge>();
    ...
    public class VIZ_ContainerStuffingPSReq
    {
    ...
    public class VIZ_ContainerDetails
    {
    ...
    //}
    public class VIZImpInvoiceBase
    {
    ...
    public class VIZExpInvoiceContainerBase
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class VIZExpInvoiceChargeBase
    {
    ...
    //}
    public class VIZ_ExpOperationContWiseCharge
    {
        public string CFSCode { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class VIZExpADDCWCInvoiceChargeBase
    {
        public int ChargeId { get; set; }
        public string OperationId { get; set; }
        public string Clause { get; set; }
