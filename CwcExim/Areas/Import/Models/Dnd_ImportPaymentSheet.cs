...
{
    public class Dnd_ImportPaymentSheet
    {
    ...
    public class Dnd_PaySheetContainer
    {
    ...
    public class Dnd_PaymentSheetBOE
    {
        public string CFSCode { get; set; }
        public string LineNo { get; set; }
        public string BOENo { get; set; }
