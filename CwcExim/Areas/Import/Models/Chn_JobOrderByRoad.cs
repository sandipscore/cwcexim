...
{
    public class Chn_JobOrderByRoad
    {
        ...
        public List<Chn_ImportJobOrderByRoadDtl> lstFormOneDetail = new List<Chn_ImportJobOrderByRoadDtl>();
    }
    public class Chn_ImportJobOrderByRoadDtl
    {
    ...
    public class Chn_ImportJobOrderByRoadList
    {
        public int FormOneDetailID { get; set; }
        public int FormOneId { get; set; }
        public string FormOneNo { get; set; }
