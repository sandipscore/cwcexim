...
{
    public class WFLD_Internal_Movement
    {
        ...
        public IList<WFLDCharges_inv> Charges { get; set; } = new List<WFLDCharges_inv>();
    ...
    public class WFLDGodownListWithDestiffDetails
    {
