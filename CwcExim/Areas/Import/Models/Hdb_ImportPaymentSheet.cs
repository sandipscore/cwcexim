...
namespace CwcExim.Areas.Import.Models
{
    public class Hdb_PaymentSheet
    {
        ...
        IList<Hdb_PaySheetContainer> lstPaySheetContainer { get; set; } = new List<Hdb_PaySheetContainer>();
        public string PaymentSheetContainerJS { get; set; }

    }
    public class Hdb_PaySheetContainer
    {
    ...
    public class Hdb_PaySheetStuffingRequest
    {
    ...
    public class Hdb_PaymentSheetContainer
    {
    ...
    public class Hdb_PaymentPartyName
    {
        public int PartyId { get; set; }
        public string PartyName { get; set; }
        public string GSTNo { get; set; }
    ...
    public class Hdb_PaymentPayeeName
    {
        public int PayeeId { get; set; }
        public string PayeeName { get; set; }
        public string GSTNo { get; set; }
    ...
    public class Hdb_PaymentSheetBOE
    {
        public string CFSCode { get; set; }
        public string LineNo { get; set; }
        public string BOENo { get; set; }
