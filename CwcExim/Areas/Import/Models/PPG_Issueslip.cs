...
namespace CwcExim.Areas.Import.Models
{
    public class PPG_Issueslip
    {
        ...
        public List<ppg_IssueSlipReport> LstIssueSlipRpt = new List<ppg_IssueSlipReport>();

        public List<ppg_IssueSlipContainer> LstContainer = new List<ppg_IssueSlipContainer>();

        public List<ppg_IssueSlipCargo> LstCargo = new List<ppg_IssueSlipCargo>();
        public decimal TotalCWCDues { get; set; }
        public string CRNoDate { get; set; }
    }

    public class ppg_IssueSlipContainer
    {
    ...
    public class ppg_IssueSlipCargo
    {
    ...
    public class ppg_IssueSlipReport
    {
        public string ContainerNo { get; set; }
        public string Size { get; set; }
