...
{
    public class WljDestuffingEntry
    {
        ...
        public IList<Wlj_DestuffingEntryDtl> lstDtl { get; set; } = new List<Wlj_DestuffingEntryDtl>();
        public IList<GodownLocation> lstLocation { get; set; } = new List<GodownLocation>();
        public string TallySheetDate { get; set; }
    }
    public class Wlj_DestuffingEntryDtl
    {
    ...
    public class Wlj_DestuffingList
    {
        public int DestuffingEntryId { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
    ...
    public class Wlj_DestuffingSheet
    {
        public string StartDate { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
        ...
        public IList<Wlj_DestuffingSheetDtl> lstDtl { get; set; } = new List<Wlj_DestuffingSheetDtl>();
        //public CompanyDetails objCom { get; set; } = new CompanyDetails();
    }
    public class Wlj_DestuffingSheetDtl
    {
