...
{
    public class WFLDFCLtoLCLConversion
    {
        ...
        public List<WFLDFCLPostPaymentChargebreakupdate> lstPostPaymentChrgBreakup { get; set; } = new List<WFLDFCLPostPaymentChargebreakupdate>();

    }
    public class WFLDFCLtoLCLContainerList
    {
        public int? ContainerId { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class WFLDFCLtoLCLForwarderList
    {
        public int? PartyPdaId { get; set; }
        public string PartyPdaCode { get; set; }
        
    }
    public class WFLDFCLtoLCLSLAList
    {
    ...
    public class WFLDFCLPostPaymentChargebreakupdate
    {
