...
{
    public class OBLWiseContainerEntry
    {
        ...
        public List<OBLWiseContainerEntryDetails> OblEntryDetailsList = new List<OBLWiseContainerEntryDetails>();
    }
    public class OBLWiseContainerEntryDetails
    {
