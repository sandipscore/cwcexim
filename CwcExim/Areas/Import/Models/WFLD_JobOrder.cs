...
namespace CwcExim.Areas.Import.Models
{
    public class WFLD_JobOrder
    {
       ...
       [ StringLength(200)]
        ...
        public List<WFLDPickupModel> lstpickup { get; set; }
        public List<WFLDTransformList> lstPort { get; set; }

    }
    public class WFLD_ImportJobOrderDtl
    {
    ...
    public class WFLDTransformList
    {
        public int PortId { get; set; }
        public string PortName { get; set; }
    }
    public class WFLD_ImportJobOrderList
    {
        public int ImpJobOrderId { get; set; }
        public string JobOrderNo { get; set; }
    ...
    public class WFLD_TrainList 
    {
        public int TrainSummaryID { get; set; }
        public string TrainNo { get; set; }
        public string PickUpLoc { get; set; }
    }
    public class WFLD_FormOneForImpJO
    {
        public string FormOneDate { get; set; }
        public int ShippingLineId { get; set; }
        public string ShippingLineName { get; set; }
    ...
    public class WFLD_Yard
    {
        public int YardId { get; set; }
        public string YardName { get; set; }
    }
    public class WFLD_YardWiseLocation
    {
    ...
    /*For Job Order Print*/
    public class WFLD_PrintJOModel
    {
        ...
        public IList<WFLD_PrintJOModelDet> lstDet { get; set; } = new List<WFLD_PrintJOModelDet>();
    }
    public class WFLD_PrintJOModelDet
    {
        public string ContainerNo { get; set; }
        public string ContainerSize { get; set; }
    }

    public class WFLD_ImportJobDel
    {
        public int JobOrderDtlId { get; set; }
    }

    public class WFLD_TrainDateList
    {
        public string TrainDate { get; set; }
