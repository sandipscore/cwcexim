...
{
    public class WFLD_Commodity
    {
        public int CommodityId { get; set; }

        [Required(ErrorMessage = "Fill Out This Field")]
        [Display(Name = "Commodity")]
        [MaxLength(30, ErrorMessage = "Commodity Name Can Be No More Than 30 Characters In Length Including Spaces")]
        ...
        [Required(ErrorMessage = "Fill Out This Field")]
        [Display(Name = "Alias")]
        [MaxLength(5, ErrorMessage = "Commodity Alias Can Be No More Than 5 Characters In Length Including Spaces")]
