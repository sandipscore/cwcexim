...
{
    public class VIZDestuffingEntry
    {   
        ...
        public IList<VIZ_DestuffingEntryDtl> lstDtl { get; set; } = new List<VIZ_DestuffingEntryDtl>();
    ...
    public class VIZ_DestuffingEntryDtl
    {
    ...
    public class VIZ_DestuffingList
    {
        public int DestuffingEntryId { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
    ...
    //}
    public class VIZ_DestuffingSheet
    {
        public string StartDate { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
        ...
        public string GodownName { get; set; }
        public IList<VIZ_DestuffingSheetDtl> lstDtl { get; set; } = new List<VIZ_DestuffingSheetDtl>();
        //public CompanyDetails objCom { get; set; } = new CompanyDetails();
    }
    public class VIZ_DestuffingSheetDtl
    {
    ...
    public class VIZ_DestufGodownDetails
    {
        public int TallySheetId { get; set; }
    ...
    public class VIZ_DestuffingObl
    {
        public int TallySheetDtlId { get; set; }        
        public string BOLNo { get; set; }
    }
    public class VIZ_ReasvetionArea
    {
        public int? ImporterId { get; set; }
