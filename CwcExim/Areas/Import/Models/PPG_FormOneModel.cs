...
namespace CwcExim.Areas.Import.Models
{
    public class PPG_FormOneModel
    {
        ...
        public IList<PPG_FormOneDetail> lstFormOneDetail { get; set; } = new List<PPG_FormOneDetail>();
        ...
        public IList<PPG_Commodity> lstCommodity { get; set; } = new List<PPG_Commodity>();
