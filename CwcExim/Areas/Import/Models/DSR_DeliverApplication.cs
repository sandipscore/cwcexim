...
{
    public class DSR_DeliverApplication
    {
        ...
        public List<DSRDeliveryGodownDtl> LstDeliveryGodownDtl { get; set; } = new List<DSRDeliveryGodownDtl>();
        public List<DSRDeliveryApplicationDtl> LstDeliveryAppDtl { get; set; } = new List<DSRDeliveryApplicationDtl>();
        public List<DSRDeliveryOrdDtl> LstDeliveryordDtl { get; set; } = new List<DSRDeliveryOrdDtl>();
        ...
        [Display(Name = "Private movement")]
        public bool IsTransporter { get; set; }
        [Display(Name = "CWC movement")]
        public bool IsCWCMovement { get; set; }
        [Display(Name = "Amendment")]
        public bool IsAmendment { get; set; }
        public string CargoHandlingType { get; set; }
        public string SEZ { get; set; }
    }
    public class DSRDeliveryApplicationDtl
    {
        public int ImporterId { get; set; }
        public string Importer { get; set; }
        ...
        public int OblAmendFlag { get; set; }
    }
    public class DSRDeliveryGodownDtl
    {
    ...
    public class DSRDeliveryOrdDtl
    { 
    ...
    public class DSRDeliveryApplicationList
    {
        public int DeliveryId { get; set; }
        public string DeliveryNo { get; set; }
        public string DestuffingEntryNo { get; set; }
    ...
    public class DSRMergeDeliveryApplicationList
    {
        public int DeliveryId { get; set; }
        public string DeliveryNo { get; set; }
    ...
    public class DSRDestuffingEntryNoList
    {
        public int DestuffingId { get; set; }
        public string DestuffingEntryNo { get; set; }
    }

    public class DSRBOELineNoList
    {
        public int DestuffingEntryDtlId { get; set; }
        public string BOELineNo { get; set; }
