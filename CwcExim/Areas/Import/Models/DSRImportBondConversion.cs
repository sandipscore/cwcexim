...
{
    public class DSR_ImportBondConversion
    {
        ...
        public int RemainingNoOfPkg { get; set; }
        public decimal RemainingGrWeight { get; set; }
        public decimal RemainingSQM { get; set; }
        public decimal RemainingCUM { get; set; }
        public decimal RemainingCIF { get; set; }
        public decimal RemainingDuty { get; set; }
    }

    public class DSR_OBLNoForBondConversion
    {
        public string OBLNo { get; set; }
        public int DestuffingId { get; set; }
        public int CHAId { get; set; }
    ...
    public class DSR_LocationForBondTransfer
    {
