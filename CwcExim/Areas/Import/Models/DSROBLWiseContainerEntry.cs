...
{
    public class DSROBLWiseContainerEntry
    {        
        ...
        public List<DSROBLWiseContainerEntryDetails> OblEntryDetailsList = new List<DSROBLWiseContainerEntryDetails>();
    }
    public class DSROBLWiseContainerEntryDetails
    {
