...
namespace CwcExim.Areas.Import.Models
{
    public class Wfld_SealCutting
    {
        ...
        public List<Wfld_SealCutting> lstObldt { get; set; } = new List<Wfld_SealCutting>();
        public String ViewBLList { get; set; }
        public string lstPostPaymentChrgBreakupAmt { get; set; }
        public List<Wfld_SealPostPaymentChargebreakupdate> lstPostPaymentChrgBreakup { get; set; } = new List<Wfld_SealPostPaymentChargebreakupdate>();

    }
    public class Wfld_SealCuttingCHA
    {
        public int CHAShippingLineId { get; set; }
        public string CHAShippingLine { get; set; }
        public string FolioNo { get; set; }
    ...
    public class Wfld_SealPostPaymentChargebreakupdate
    {
