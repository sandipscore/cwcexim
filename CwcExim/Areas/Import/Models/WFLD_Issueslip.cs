...
namespace CwcExim.Areas.Import.Models
{
    public class WFLD_Issueslip
    {
        ...
        public List<WFLD_IssueSlipReport> LstIssueSlipRpt = new List<WFLD_IssueSlipReport>();

        public List<WFLD_IssueSlipContainer> LstContainer = new List<WFLD_IssueSlipContainer>();

        public List<WFLD_IssueSlipCargo> LstCargo = new List<WFLD_IssueSlipCargo>();
        public decimal TotalCWCDues { get; set; }
        public string CRNoDate { get; set; }
    }
    public class WFLD_IssueSlipContainer
    {
    ...
    public class WFLD_IssueSlipCargo
    {
    ...
    public class WFLD_IssueSlipReport
    {
        public string ContainerNo { get; set; }
        public string Size { get; set; }
