...
{
    public class Dnd_JobOrderByRoad
    {
        ...
        public List<Dnd_ImportJobOrderByRoadDtl> lstFormOneDetail = new List<Dnd_ImportJobOrderByRoadDtl>();

        }
        public class Dnd_ImportJobOrderByRoadDtl
        {
        ...
        public int ReScanning { get; set; }
    }
        public class Dnd_ImportJobOrderByRoadList
        {
            public int FormOneDetailID { get; set; }
            public int FormOneId { get; set; }
            public string FormOneNo { get; set; }
