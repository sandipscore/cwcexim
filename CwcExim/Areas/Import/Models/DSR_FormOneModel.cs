...
namespace CwcExim.Areas.Import.Models
{
    public class DSR_FormOneModel
    {
        ...
        public IList<DSR_FormOneDetail> lstFormOneDetail { get; set; } = new List<DSR_FormOneDetail>();
        ...
        public IList<DSR_Commodity> lstCommodity { get; set; } = new List<DSR_Commodity>();
