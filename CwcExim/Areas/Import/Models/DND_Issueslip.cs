...
namespace CwcExim.Areas.Import.Models
{
    public class DND_Issueslip
    {
        ...
        public List<DND_IssueSlipReport> LstIssueSlipRpt = new List<DND_IssueSlipReport>();

        public List<DND_IssueSlipContainer> LstContainer = new List<DND_IssueSlipContainer>();

        public List<DND_IssueSlipCargo> LstCargo = new List<DND_IssueSlipCargo>();
    ...
    public class DND_IssueSlipContainer
    {
    ...
    public class DND_IssueSlipCargo
    {
    ...
    public class DND_IssueSlipReport
    {
        public string ContainerNo { get; set; }
        public string Size { get; set; }
