...
{
    public class Hdb_DestuffingEntry
    {
      ...
      public int LocationId { get; set; }
        ...
        public List<Hdb_DestuffingEntry> LstDestuffingEntry = new List<Hdb_DestuffingEntry>();
        ...
        public string Remarksobl { get; set; }

    }


    public class Hdb_DestuffingEntryList
    {
        public string ContainerNo { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
