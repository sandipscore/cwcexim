...
{
    public class WFLDOBLWiseContainerEntry
    {        
        ...
        public string TSA_Date { get; set; }
        ...
        public List<WFLDOBLWiseContainerEntryDetails> OblEntryDetailsList = new List<WFLDOBLWiseContainerEntryDetails>();
    }
    public class WFLDOBLWiseContainerEntryDetails
    {
