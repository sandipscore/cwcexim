...
{
    public class DSRFCLtoLCLConversion
    {
        ...
        public List<DSRFCLPostPaymentChargebreakupdate> lstPostPaymentChrgBreakup { get; set; } = new List<DSRFCLPostPaymentChargebreakupdate>();

    }
    public class DSRFCLtoLCLContainerList
    {
        public int? ContainerId { get; set; }
        public string ContainerNo { get; set; }
        public string Size { get; set; }
    ...
    public class DSRFCLtoLCLForwarderList
    {
        public int? PartyPdaId { get; set; }
        public string PartyPdaCode { get; set; }
        
    }
    public class DSRFCLtoLCLSLAList
    {
    ...
    public class DSRFCLPostPaymentChargebreakupdate
    {
