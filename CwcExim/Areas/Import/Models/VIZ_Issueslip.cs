...
namespace CwcExim.Areas.Import.Models
{
    public class VIZ_Issueslip
    {
        ...
        public List<VIZ_IssueSlipReport> LstIssueSlipRpt = new List<VIZ_IssueSlipReport>();

        public List<VIZ_IssueSlipContainer> LstContainer = new List<VIZ_IssueSlipContainer>();

        public List<VIZ_IssueSlipCargo> LstCargo = new List<VIZ_IssueSlipCargo>();
        public decimal TotalCWCDues { get; set; }
        public string CRNoDate { get; set; }
    }
    public class VIZ_IssueSlipContainer
    {
    ...
    public class VIZ_IssueSlipCargo
    {
    ...
    public class VIZ_IssueSlipReport
    {
        public string ContainerNo { get; set; }
        public string Size { get; set; }
