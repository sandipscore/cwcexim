...
namespace CwcExim.Areas.Import.Models
{
    public class Dnd_SealCutting
    {
        ...
        public List<Dnd_SealCutting> lstObldt { get; set; } = new List<Dnd_SealCutting>();
    ...
    public class Dnd_SealCuttingCHA
    {
        public int CHAShippingLineId { get; set; }
        public string CHAShippingLine { get; set; }
        public string FolioNo { get; set; }
    ...
    public class Dnd_SealPostPaymentChargebreakupdate
    {
