...
namespace CwcExim.Areas.Import.Models
{
    public class IssueSlip
    {
        ...
        public List<IssueSlipReport> LstIssueSlipRpt= new List<IssueSlipReport>();

        public List<IssueSlipContainer> LstContainer = new List<IssueSlipContainer>();

        public List<IssueSlipCargo> LstCargo = new List<IssueSlipCargo>();
        public decimal TotalCWCDues { get; set; }
        public string CRNoDate { get; set; }
    }

    public class IssueSlipContainer
    {
