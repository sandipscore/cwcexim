...
{
    public class Wlj_OBLWiseContainerEntry
    {
        ...
        public List<Wlj_OBLWiseContainerEntryDetails> OblEntryDetailsList = new List<Wlj_OBLWiseContainerEntryDetails>();
    }
    public class Wlj_OBLWiseContainerEntryDetails
    {
