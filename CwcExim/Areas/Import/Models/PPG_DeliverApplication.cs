...
{
    public class PPG_DeliverApplication
    {
        ...
        public List<PPGDeliveryApplicationDtl> LstDeliveryAppDtl { get; set; } = new List<PPGDeliveryApplicationDtl>();
        public List<PPGDeliveryOrdDtl> LstDeliveryordDtl { get; set; } = new List<PPGDeliveryOrdDtl>();
    ...
    public class PPGDeliveryApplicationDtl
    {
        public int ImporterId { get; set; }
        public string Importer { get; set; }
    ...
    public class PPGDeliveryOrdDtl
    { 
    ...
    public class PPGDeliveryApplicationList
    {
        public int DeliveryId { get; set; }
        public string DeliveryNo { get; set; }
        public string DestuffingEntryNo { get; set; }
    ...
    public class PPGMergeDeliveryApplicationList
    {
        public int DeliveryId { get; set; }
        public string DeliveryNo { get; set; }
    ...
    public class PPGDestuffingEntryNoList
    {
        public int DestuffingId { get; set; }
        public string DestuffingEntryNo { get; set; }
    }

    public class PPGBOELineNoList
    {
        public int DestuffingEntryDtlId { get; set; }
        public string BOELineNo { get; set; }
