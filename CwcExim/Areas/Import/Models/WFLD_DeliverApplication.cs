...
{
    public class WFLD_DeliverApplication
    {
        ...
        public List<WFLDDeliveryGodownDtl> LstDeliveryGodownDtl { get; set; } = new List<WFLDDeliveryGodownDtl>();
        public List<WFLDDeliveryApplicationDtl> LstDeliveryAppDtl { get; set; } = new List<WFLDDeliveryApplicationDtl>();
        public List<WFLDDeliveryOrdDtl> LstDeliveryordDtl { get; set; } = new List<WFLDDeliveryOrdDtl>();
    ...
    public class WFLDDeliveryApplicationDtl
    {
        public int ImporterId { get; set; }
        public string Importer { get; set; }
    ...
    public class WFLDDeliveryGodownDtl
    {
    ...
    public class WFLDDeliveryOrdDtl
    { 
    ...
    public class WFLDDeliveryApplicationList
    {
        public int DeliveryId { get; set; }
        public string DeliveryNo { get; set; }
        public string DestuffingEntryNo { get; set; }
    ...
    public class WFLDMergeDeliveryApplicationList
    {
        public int DeliveryId { get; set; }
        public string DeliveryNo { get; set; }
    ...
    public class WFLDDestuffingEntryNoList
    {
        public int DestuffingId { get; set; }
        public string DestuffingEntryNo { get; set; }
    }

    public class WFLDBOELineNoList
    {
        public int DestuffingEntryDtlId { get; set; }
        public string BOELineNo { get; set; }
