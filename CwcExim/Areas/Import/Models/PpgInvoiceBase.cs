...
namespace CwcExim.Areas.Import.Models
{
    public class PpgInvoiceBase
    {
        ...
        // public List<PpgInvoiceContainerBase> ContainersList { get; set; } = new List<PpgInvoiceContainerBase>();
        //  public List<PpgInvoiceChargeBase> ChargesList { get; set; } = new List<PpgInvoiceChargeBase>();
        ...
        public string DirectDestuffing { get; set; }

        public string SEZ { get; set; }
    }

    public class PpgInvoiceContainerBase
    {
    ...
    public class PpgInvoiceChargeBase
    {
