...
namespace CwcExim.Areas.Import.Models
{
    public class SealCutting
    {
        ...
        public List<SealCutting> lstObldt { get; set; } = new List<SealCutting>();
        public String ViewBLList { get; set; }
        public string lstPostPaymentChrgBreakupAmt { get; set; }
        public List<ppgSealPostPaymentChargebreakupdate> lstPostPaymentChrgBreakup { get; set; } = new List<ppgSealPostPaymentChargebreakupdate>();
        

    }
    public class SealCuttingCHA
    {
        public int CHAShippingLineId { get; set; }
        public string CHAShippingLine { get; set; }
        public string FolioNo { get; set; }
    ...
    public class ppgSealPostPaymentChargebreakupdate
    {
