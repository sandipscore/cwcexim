...
{
    public class Chn_OBLWiseContainerEntry
    {
        ...
        public List<CHN_OBLWiseContainerEntryDetails> OblEntryDetailsList = new List<CHN_OBLWiseContainerEntryDetails>();
    }
    public class CHN_OBLWiseContainerEntryDetails
    {
