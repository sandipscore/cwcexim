...
{
    public class DSRDestuffingEntry
    {
        ...
        public IList<DSR_DestuffingEntryDtl> lstDtl { get; set; } = new List<DSR_DestuffingEntryDtl>();

        public IList<DSR_DestuffingEntryDtl> lstOblDtl { get; set; } = new List<DSR_DestuffingEntryDtl>();
        ...
        public int CargoDeliveryType { get; set; }
    ...
    public class DSR_DestuffingEntryDtl
    {
        ...
        public int CustomAppraisementDtlId { get; set; }
        public string OBLCIFValue { get; set; }
        public string OBLGrossDuty { get; set; }

    }
    public class DSR_DestuffingList
    {
        public int DestuffingEntryId { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
    ...
    //}
    public class DSR_DestuffingSheet
    {
        public string StartDate { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
        ...
        public string DestuffingType { get; set; }
        public IList<DSR_DestuffingSheetDtl> lstDtl { get; set; } = new List<DSR_DestuffingSheetDtl>();
        //public CompanyDetails objCom { get; set; } = new CompanyDetails();
    }
    public class DSR_DestuffingSheetDtl
    {
    ...
    public class DSR_DestufGodownDetails
    {
        public int TallySheetId { get; set; }
        public decimal Area { get; set; }//SQM
        public decimal AreaCbm { get; set; }//CBM
    ...
    public class DSR_DestuffingObl
    {
        public int TallySheetDtlId { get; set; }        
        public string BOLNo { get; set; }
    }
