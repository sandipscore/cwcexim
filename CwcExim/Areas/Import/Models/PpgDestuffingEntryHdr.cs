...
{
    public class PpgDestuffingEntry
    {
        ...
        public IList<Ppg_DestuffingEntryDtl> lstDtl { get; set; } = new List<Ppg_DestuffingEntryDtl>();
        public IList<GodownLocation> lstLocation { get; set; } = new List<GodownLocation>();
        public string TallySheetDate { get; set; }
    }
    public class Ppg_DestuffingEntryDtl
    {
    ...
    public class Ppg_DestuffingList
    {
        public int DestuffingEntryId { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
    ...
    public class Ppg_DestuffingSheet
    {
        public string StartDate { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
        ...
        public IList<Ppg_DestuffingSheetDtl> lstDtl { get; set; } = new List<Ppg_DestuffingSheetDtl>();
        //public CompanyDetails objCom { get; set; } = new CompanyDetails();
    }
    public class Ppg_DestuffingSheetDtl
    {
