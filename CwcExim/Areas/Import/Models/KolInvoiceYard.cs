...
{
    public class KolInvoiceYard: KolInvoiceBase
    {
    

            //--------------------------------------------------------------------------------------------------------------------
            public List<KOLPreInvoiceContainer> lstPrePaymentCont { get; set; } = new List<KOLPreInvoiceContainer>();
            public List<KOLPostPaymentContainer> lstPostPaymentCont { get; set; } = new List<KOLPostPaymentContainer>();
            public List<KOLPostPaymentChrg> lstPostPaymentChrg { get; set; } = new List<KOLPostPaymentChrg>();
            public IList<KOLContainerWiseAmount> lstContWiseAmount { get; set; } = new List<KOLContainerWiseAmount>();
            public List<KOLPostPaymentChargebreakupdate> lstPostPaymentChrgBreakup { get; set; } = new List<KOLPostPaymentChargebreakupdate>();

            public List<KOLOperationCFSCodeWiseAmount> lstOperationCFSCodeWiseAmount { get; set; } = new List<KOLOperationCFSCodeWiseAmount>();
        ...
        public class KOLPostPaymentContainer : PostPaymentContainer
        {
        ...
        public class KOLPostPaymentChrg : PostPaymentCharge
        {
            //public int OperationId { get; set; }
        }

        public class KOLContainerWiseAmount
    {
        ...
        public class KOLPreInvoiceContainer : PreInvoiceContainer
        {
        ...
        public class KOLListOfExpInvoice
    {
            public int InvoiceId { get; set; }
        ...
        public class KOLOperationCFSCodeWiseAmount
    {
            //public int InvoiceId { get; set; }
            //public string CFSCode { get; set; }
            //public string ContainerNo { get; set; }
        ...
        public class KOL_ExpContWiseAmount
    {
            public string CFSCode { get; set; }
        ...
        //    public string Clause { get; set; }
        //}
        public class KOLPostPaymentChargebreakupdate
    {
        ...
        public class KOLPaySheetStuffingRequest
    {
