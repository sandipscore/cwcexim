...
{
    public class WFLDDestuffingEntry
    {
        ...
        public IList<WFLD_DestuffingEntryDtl> lstDtl { get; set; } = new List<WFLD_DestuffingEntryDtl>();
    ...
    public class WFLD_DestuffingEntryDtl
    {
        ...
        public decimal RevArea { get; set; }//SQM
    ...
    public class WFLD_DestuffingList
    {
        public int DestuffingEntryId { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
    ...
    //}
    public class WFLD_DestuffingSheet
    {
        public string StartDate { get; set; }
        public string DestuffingEntryNo { get; set; }
        public string DestuffingEntryDate { get; set; }
        ...
        public string GodownName { get; set; }
        public IList<WFLD_DestuffingSheetDtl> lstDtl { get; set; } = new List<WFLD_DestuffingSheetDtl>();
        //public CompanyDetails objCom { get; set; } = new CompanyDetails();
    }
    public class WFLD_DestuffingSheetDtl
    {
        ...
        public decimal Area { get; set; }
        public decimal revArea { get; set; }
    ...
    public class WFLD_DestufGodownDetails
    {
        public int TallySheetId { get; set; }
    ...
    public class WFLD_DestuffingObl
    {
        public int TallySheetDtlId { get; set; }        
        public string BOLNo { get; set; }
    }
    public class WFLD_ReasvetionArea
    {
        public int? ImporterId { get; set; }
        public decimal ResvArea { get; set; }
        public int IsReserved { get; set; }
    }
}
