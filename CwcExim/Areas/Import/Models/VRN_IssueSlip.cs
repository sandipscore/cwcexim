...
namespace CwcExim.Areas.Import.Models
{
    public class VRN_IssueSlip
    {
        ...
        public List<VRN_IssueSlipReport> LstIssueSlipRpt = new List<VRN_IssueSlipReport>();

        public List<VRN_IssueSlipContainer> LstContainer = new List<VRN_IssueSlipContainer>();

        public List<VRN_IssueSlipCargo> LstCargo = new List<VRN_IssueSlipCargo>();
    ...
    public class VRN_IssueSlipContainer
    {
    ...
    public class VRN_IssueSlipCargo
    {
    ...
    public class VRN_IssueSlipReport
    {
        public string ContainerNo { get; set; }
        public string Size { get; set; }
