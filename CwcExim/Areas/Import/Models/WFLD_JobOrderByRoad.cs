...
{
    public class WFLD_JobOrderByRoad
    {
        ...
        public List<WFLD_ImportJobOrderByRoadDtl> lstFormOneDetail = new List<WFLD_ImportJobOrderByRoadDtl>();

    }
    public class WFLD_ImportJobOrderByRoadDtl
    {
    ...
    public class WFLD_ImportJobOrderByRoadList
    {
        public int FormOneDetailID { get; set; }
        public int FormOneId { get; set; }
        public string FormOneNo { get; set; }
