...
{ 
    public partial class VRN_CWCImportController
    {
        [HttpGet]
        ...
        [HttpPost]
        public JsonResult GetSingleClickDeliveryPaymentSheet(string InvoiceType, int DestuffingAppId,string DeliveryDate, string ExportUnder, int InvoiceId,List<VRN_DeliveryApplicationDtl> DeliveryXML,
           int PartyId, int PayeeId, int OTHours = 0,int OblFlag=0, int Movement = 0, int Distance = 0 ,int IsBond=0)
        {
            ...
            objChrgRepo.GetDeliveryPaymentSheetSingle(InvoiceType, DestuffingAppId, DeliveryDate, ExportUnder,InvoiceId, XMLText, PartyId,PayeeId, OTHours, OblFlag, Movement, Distance, IsBond);
        ...
        public JsonResult AddEditSingleMergeDeliveryApplication(VRN_MergeDeliveryIssueViewModel ObjDelivery)
        {
