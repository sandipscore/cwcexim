...
{
    public partial class VLDA_CWCImportController : BaseController
    {
        private string CompanyEmail = "";
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        WFLDInvoiceGodown objreport;
        // GET: Import/VLDA_CWCImport
        ...
        {
           VLDA_ImportRepository ObjOBL = new VLDA_ImportRepository();
        ...
        public JsonResult GetReservationValidate(int ImporterId, string DestuffingDate)
        {
           ...
           VLDA_ImportRepository objResValidate = new VLDA_ImportRepository();
        ...
        public string GeneratePDFForDestuffSheet(WFLD_DestuffingSheet ObjDestuff, int DestuffingEntryId)
        {
            ...
            objSB.Append("<span style='font-size: 7pt; padding-bottom: 10px;'>Village-Valvada,NH-8,Taluka Umbargaon,Distt,Valsad-396105</span>");
        ...
        public ActionResult CreateYardPaymentSheet(string type = "Tax")
        {
            ...
            /*VLDA_ImportRepository objimp = new VLDA_ImportRepository();
        ...
        public JsonResult GetContainerPaymentSheet(string InvoiceDate, string DeliveryDate, int AppraisementId, string TaxType,
            ...
            int InvoiceId = 0, int isdirect = 0, int IsOpenYard = 0, int Isdestuffed = 0 , int NoOfVehicles = 1, int Distance = 0, int OwnMovement = 0, int InsuredParty = 0, int YardToBond = 0)
        {
            string XMLText = "";
            ...
            VLDA_ImportRepository objPpgRepo = new VLDA_ImportRepository();
            ...
            objPpgRepo.GetYardPaymentSheet(InvoiceDate, DeliveryDate, AppraisementId, TaxType, XMLText, InvoiceId, OTHours, PartyId,
                PayeeId, isdirect, IsOpenYard, Isdestuffed, NoOfVehicles, Distance, OwnMovement, InsuredParty, YardToBond, SEZ);
            var Output = (VLDAInvoiceYard)objPpgRepo.DBResponse.Data;
        ...
        [HttpPost]
        [CustomValidateAntiForgeryToken]
        public JsonResult AddEditContPaymentSheet(String InvoiceObj, int Vehicle, int IsDirect, int IsYardtoBond, string SEZ, int BillToParty, int Distance, int OTHours, int IsTransporter, int IsInsured, int IsOpenYard, int Isdestuffed)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<VLDAInvoiceYard>(InvoiceObj);
                string ContainerXML = "";
                string ChargesXML = "";
                ...
                {
                    invoiceData.lstPostPaymentCont = JsonConvert.DeserializeObject<List<VLDAPostPaymentContainer>>(invoiceData.lstPostPaymentContXML);
                ...
                if (invoiceData.lstPostPaymentChrgXML != null)
                {
                    ...
                    invoiceData.lstPostPaymentChrg = JsonConvert.DeserializeObject<List<VLDAPostPaymentChrg>>(invoiceData.lstPostPaymentChrgXML);
                    ChargesXML = Utility.CreateXML(invoiceData.lstPostPaymentChrg);
                }
                if (invoiceData.lstContWiseAmountXML != null)
                {
                    ...
                    invoiceData.lstContWiseAmount = JsonConvert.DeserializeObject<List<VLDAContainerWiseAmount>>(invoiceData.lstContWiseAmountXML);
                    ContWiseCharg = Utility.CreateXML(invoiceData.lstContWiseAmount);
                ...
                if (invoiceData.lstOperationCFSCodeWiseAmountXML != null)
                {
                    ...
                    invoiceData.lstOperationCFSCodeWiseAmount = JsonConvert.DeserializeObject<List<VLDAOperationCFSCodeWiseAmount>>(invoiceData.lstOperationCFSCodeWiseAmountXML);
                ...
                if (invoiceData.lstPostPaymentChrgBreakupXML != null)
                {
                    ...
                    invoiceData.lstPostPaymentChrgBreakup = JsonConvert.DeserializeObject<List<VLDAPostPaymentChargebreakupdate>>(invoiceData.lstPostPaymentChrgBreakupXML);
                    ChargesBreakupXML = Utility.CreateXML(invoiceData.lstPostPaymentChrgBreakup);
                    //ChargesBreakupXML = Utility.CreateXML(invoiceData.lstPostPaymentChrgBreakup);
                }
                VLDA_ImportRepository objChargeMaster = new VLDA_ImportRepository();
                objChargeMaster.AddEditInvoice(invoiceData, ContainerXML, ChargesXML, ContWiseCharg, OperationCfsCodeWiseAmtXML, ChargesBreakupXML, BranchId, Vehicle, ((Login)(Session["LoginUser"])).Uid, IsDirect, IsYardtoBond, SEZ, BillToParty, Distance, OTHours, IsTransporter, IsInsured, IsOpenYard, Isdestuffed, "IMPYard", "");
        ...
        */
        ...
        public JsonResult GetCHANameForYardPaymentSheet(string PartyCode, int Page)
        {
            ...
            VLDA_ImportRepository obj = new VLDA_ImportRepository();
        ...
        {
            VLDA_ImportRepository objcash = new VLDA_ImportRepository();
        ...
        */
        ...
        public JsonResult GetDeliveryPaymentSheet(string InvoiceDate, string InvoiceType, int AppraisementId, int DeliveryType, string AppraisementNo, string AppraisementDate,
            ...
            string PayeeName, List<VLDAPaymentSheetBOE> lstPaySheetBOE, string SEZ, int OTHours = 0, int InvoiceId = 0)
        {
            string XMLText = "";
        ...
        public JsonResult AddEditDeliveryPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<VLDAInvoiceGodown>(objForm["PaymentSheetModelJson"].ToString());
                string ContainerXML = "";
                string ChargesXML = "";
                string ContWiseCharg = "";
        ...
        {
            VLDA_InvoiceRepository objGPR = new VLDA_InvoiceRepository();
            objGPR.GetInvoiceDetailsForGodownPrintByNo(InvoiceNo, "IMPDeli");
            VLDAInvoiceYard objGP = new VLDAInvoiceYard();
            string FilePath = "";
            if (objGPR.DBResponse.Data != null)
            {
                objGP = (VLDAInvoiceYard)objGPR.DBResponse.Data;
        ...
        private string GeneratingPDFInvoiceGodown(VLDAInvoiceYard objGP, int InvoiceId)
        {
            // string html = "";
            CurrencyToWordINR ctwObj = new CurrencyToWordINR();
            ...
            html.Append("<tr><td style='text-align: center;'><h1 style='font-size: 20px; line-height: 30px;margin: 0; padding: 0;'>" + objGP.CompanyName + "</h1>");
            html.Append("<label style='display: block; font-size: 13px; line-height: 22px;'>(A Govt. of India Undertaking) </label><br />");
            html.Append("<span style='display: block; font-size: 13px; line-height: 22px; text-transform: uppercase; padding-bottom: 10px;'>Village-Valvada,NH-8,Taluka Umbargaon,Distt,Valsad-396105</span>");
        ...
        public JsonResult GetEditReAssessmentDeliveryPaymentSheet(string InvoiceDate, string InvoiceType, int AppraisementId, int DeliveryType, string AppraisementNo, string AppraisementDate,
            int PartyId, string PartyName, string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId,
            string PayeeName, List<VLDAPaymentSheetBOE> lstPaySheetBOE, int SEZ, int OTHours = 0, int InvoiceId = 0)
        {
            string XMLText = "";
            if (lstPaySheetBOE != null)
            {
        ...
        [HttpPost]
        public JsonResult GetEditSingleClickDeliveryPaymentSheet(string InvoiceType, int AppraisementId, string DeliveryDate, string InvoiceDate, int InvoiceId, List<VLDADeliveryApplicationDtl> DeliveryXML,
           int PartyId, int PayeeId, int vehicleNo, int vehicleNoUn, int IsInsured, int BillToParty, int Transporter, int ImportToBond, int Cargo, List<VLDADeliveryGodownDtl> GodownXML, int OTHours = 0, int OblFlag = 0, int SEZ = 0)
        {
            string XMLText = "";
            if (DeliveryXML != null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult UpdateSingleMergeDeliveryApplication(VLDA_DeliverApplication ObjDelivery)

        {
            ...
            {
                ObjDelivery.LstDeliveryAppDtl = JsonConvert.DeserializeObject<List<VLDADeliveryApplicationDtl>>(ObjDelivery.DeliveryAppDtlXml);
            ...
            {
                ObjDelivery.LstDeliveryGodownDtl = JsonConvert.DeserializeObject<List<VLDADeliveryGodownDtl>>(ObjDelivery.DeliveryGodownDtlXml);
            ...
            {
                ObjDelivery.lstPrePaymentCont = JsonConvert.DeserializeObject<List<VLDAPreInvoiceContainer>>(ObjDelivery.lstPrePaymentContXML);
            ...
            {
                ObjDelivery.lstPostPaymentCont = JsonConvert.DeserializeObject<List<VLDAPostPaymentContainer>>(ObjDelivery.lstPostPaymentContXML);
            ...
            {
                ObjDelivery.lstPostPaymentChrg = JsonConvert.DeserializeObject<List<VLDAPostPaymentChrg>>(ObjDelivery.lstPostPaymentChrgXML);
            ...
            {
                ObjDelivery.lstContWiseAmount = JsonConvert.DeserializeObject<List<VLDAContainerWiseAmount>>(ObjDelivery.lstContWiseAmountXML);
            ...
            {
                ObjDelivery.lstOperationCFSCodeWiseAmount = JsonConvert.DeserializeObject<List<VLDAOperationCFSCodeWiseAmount>>(ObjDelivery.lstOperationCFSCodeWiseAmountXML);
            ...
            {
                ObjDelivery.lstPostPaymentChrgBreakup = JsonConvert.DeserializeObject<List<VLDADeliPostPaymentChargebreakupdate>>(ObjDelivery.lstPostPaymentChrgBreakupXML);
            ...
            {
                ObjDelivery.lstInvoiceCargo = JsonConvert.DeserializeObject<List<VLDAInvoiceCargo>>(ObjDelivery.lstInvoiceCargoXML);
        ...
        public ActionResult GetFormOneList(string ContainerName = "")
        {
            if (ContainerName == null || ContainerName == "")
            {
                ...
                VLDA_ImportRepository objImportRepo = new VLDA_ImportRepository();
        ...
        {
            VLDA_ImportRepository ObjIR = new VLDA_ImportRepository();
            ObjIR = new VLDA_ImportRepository();
        ...
        public JsonResult AddEditIRRPaymentSheet(WFLDIrrInvoice InvoiceObj)
        {
            try
            {
                ...
                int BranchId = Convert.ToInt32(Session["BranchId"]);
                VLDA_ImportRepository objChe = new VLDA_ImportRepository();
        ...
        */
            ...
            List<PaymentSheetContainer> lstPaySheetContainer, string InvoiceFor, string SEZ)
        {
            ...
            var Output = (VLDAInvoiceYard)objImport.DBResponse.Data;
        ...
        public JsonResult AddEditECDeliveryPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<VLDAInvoiceYard>(objForm["PaymentSheetModelJson"].ToString());
                string ContainerXML = "";
                string ChargesXML = "";
                string ContWiseCharg = "";
                string OperationCfsCodeWiseAmtXML = "";
        ...
        [NonAction]
        public string GeneratingTentativePDFforYard(VLDAInvoiceYard invoiceDataobj)
        {
            ...
            foreach (VLDAPreInvoiceContainer obj in invoiceDataobj.lstPrePaymentCont)
            {
                html.Append("<tr><td style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 12px; text-align: center;'>" + i.ToString() + "</td>");
            ...
            foreach (VLDAPostPaymentChrg obj in invoiceDataobj.lstPostPaymentChrg)
            {
        ...
        [HttpPost]
        [CustomValidateAntiForgeryToken]
        public JsonResult PrintTentativeYardInvoice(VLDAInvoiceYard objForm)
        {
        ...
        public JsonResult GetOBLStatus(int DestuffingId)
        {
            ...
            VLDA_ImportRepository impobj = new VLDA_ImportRepository();
