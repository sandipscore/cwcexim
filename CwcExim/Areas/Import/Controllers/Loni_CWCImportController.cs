...
namespace CwcExim.Areas.Import.Controllers
{
    ...
    public partial class Loni_CWCImportController : BaseController
    {
        ...
        {
            Loni_ExportRepository ObjRR = new Loni_ExportRepository();
                    ...
                    if (dt != null)
                    {
                        if (dt.Rows.Count > 0)
                        {
                            try
                            {
                                ...
                                Loni_ImportRepository objImport = new Loni_ImportRepository();
        ...
        {
            Loni_ImportRepository objER = new Loni_ImportRepository();
        ...
        {
            Loni_ImportRepository ObjIR = new Loni_ImportRepository();
        ...
        {
            Loni_ImportRepository objRepo = new Loni_ImportRepository();
        ...
        public ActionResult GetBOEDetail(String BOENo)
        {
            ...
            Loni_ImportRepository rep = new Loni_ImportRepository();
        ...
        {
            Loni_ImportRepository ObjCR = new Loni_ImportRepository();
        ...
        public string GeneratedTallySheetPrint(TallySheetPrintHeader objTS, int TallySheetId)
        {
            ...
            html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>";
            html += "<tr><td valign='top'><img align='right' src='IMGSRC' width='90'/></td>";
            html += "<td width='300%' valign='top' align='center'><h1 style='font-size: 28px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><label style='font-size: 14px;'>(A Govt. of India Undertaking)</label><br/><label style='font-size: 14px;'>ICD Loni</label><br/><label style='font-size: 16px; font-weight:bold;'>TALLY SHEET</label></td></tr>";
            html += "</tbody></table>";
            html += "</td></tr>";
        ...
        {
            Loni_ExportRepository ObjER = new Loni_ExportRepository();
            Loni_ImportRepository ObjIR = new Loni_ImportRepository();
        ...
        public string GeneratePDFForDestuffSheet(Ppg_DestuffingSheet ObjDestuff, int DestuffingEntryId)
        {
            ...
            objSB.Append("<td width='300%' valign='top' align='center'><h1 style='font-size: 28px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><label style='font-size: 14px;'>(A Govt. of India Undertaking)</label><br/><label style='font-size: 14px;'>ICD Loni</label><br/><label style='font-size: 16px; font-weight:bold;'>DESTUFFING SHEET</label></td></tr>");
        ...
        {
            Loni_ExportRepository objRepo = new Loni_ExportRepository();
        ...
        public ActionResult CreateYardPaymentSheet(string type = "Tax")
        {
            ...
            /*Loni_ImportRepository objimp = new Loni_ImportRepository();
            ...
            int InvoiceId = 0, int isdirect = 0, string SEZ = "")
        {
            ...
            Loni_ImportRepository objPpgRepo = new Loni_ImportRepository();
        ...
        public JsonResult AddEditContPaymentSheet(String InvoiceObj, int IsDirect, string SEZ)
        {
            try
            {
                ...
                Loni_ImportRepository objChargeMaster = new Loni_ImportRepository();
        ...
        */
            ...
            string InvoiceType, int DestLocationIdiceId, int InvoiceId = 0)
        {
            ...
            Loni_ImportRepository objChrgRepo = new Loni_ImportRepository();
            //objChrgRepo.GetAllCharges();
        ...
        {
            Loni_ImportRepository objcash = new Loni_ImportRepository();
        ...
        */
        ...
        public ActionResult GetFormOneList(string ContainerName = "")
        {
            if (ContainerName == null || ContainerName == "")
            {
                ...
                Loni_ImportRepository objImportRepo = new Loni_ImportRepository();
        ...
        {
            Loni_ImportRepository ObjIR = new Loni_ImportRepository();
            ObjIR = new Loni_ImportRepository();
        ...
        public JsonResult AddEditIRRPaymentSheet(PpgIrrInvoice InvoiceObj)
        {
            try
            {
                ...
                int BranchId = Convert.ToInt32(Session["BranchId"]);
                Loni_ImportRepository objChe = new Loni_ImportRepository();
        ...
        */
        ...
        public JsonResult GetYardInvoiceDetails(int InvoiceId)
        {
            try
            {
                ...
                Loni_ImportRepository objCashManagement = new Loni_ImportRepository();
