...
namespace CwcExim.Areas.Import.Controllers
{
    ...
    public partial class Ppg_CWCImportController : BaseController
    {
        ...
        public ActionResult CreateCustomAppraisement()
        {
            ...
            if (ObjIR.DBResponse.Data != null)
            {
                ViewBag.ContainerList = new SelectList((List<PpgCustomAppraisementDtl>)ObjIR.DBResponse.Data, "CFSCode", "ContainerNo");
            }
        ...
        {
            PpgCustomAppraisement objOBLContainer = new PpgCustomAppraisement();
        ...
        public ActionResult GetOBLContainer(String OBlNo)
        {
            ...
            {
                List<PPGCustomAppraisementOBLCont> obj = (List<PPGCustomAppraisementOBLCont>)rep.DBResponse.Data;
                if (obj.Count > 0)
                {
                    ViewBag.ContainerList = new SelectList((List<PPGCustomAppraisementOBLCont>)rep.DBResponse.Data, "CFSCode", "ContainerNo");
                }
                else
                {
                    ...
                    if (rep.DBResponse.Data != null)
                    {
                        ViewBag.ContainerList = new SelectList((List<PpgCustomAppraisementDtl>)rep.DBResponse.Data, "CFSCode", "ContainerNo");
                    }
                }
            }
        ...
        public JsonResult AddEditCustomAppraisement(PpgCustomAppraisement ObjAppraisement)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    List<PPGCustomAppraisementOrdDtl> LstCAOrd = JsonConvert.DeserializeObject<List<PPGCustomAppraisementOrdDtl>>(ObjAppraisement.CAOrdDtlXml);
        ...
        public ActionResult ViewCustomAppraisement(int CustomAppraisementId)
        {
            ...
            if (CustomAppraisementId > 0)
            {
                ...
                if (ObjIR.DBResponse.Data != null)
                {
                    ObjAppraisement = (PpgCustomAppraisement)ObjIR.DBResponse.Data;
                }
            }
        ...
        //[HttpGet]
        //public ActionResult SearchCustomAppraisement(int containerno)
        //{
        //    PpgCustomAppraisement ObjAppraisement = new PpgCustomAppraisement();
        //    if (containerno > 0)
        //    {
        //        Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
        //        ObjIR.SarchbyCustomAppraisementNo(containerno);
        //        if (ObjIR.DBResponse.Data != null)
        //        {
        //            ObjAppraisement = (PpgCustomAppraisement)ObjIR.DBResponse.Data;
        //        }
        ...
        public ActionResult GetCustomAppraisementList()
        {
            ...
            if (ObjIR.DBResponse.Data != null)
            {
                LstAppraisement = (List<PpgCustomAppraisement>)ObjIR.DBResponse.Data;
            }
        ...
        public ActionResult CreateJobOrder()
        {
            ...
            PPG_JobOrder objJO = new PPG_JobOrder();
        ...
        public ActionResult EditJobOrder(int ImpJobOrderId)
        {
            ...
            PPG_JobOrder objImp = new PPG_JobOrder();
            if (objIR.DBResponse.Data != null)
                objImp = (PPG_JobOrder)objIR.DBResponse.Data;
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public JsonResult AddEditJobOrder(PPG_JobOrder objImp, String FormOneDetails)
        {
        ...
        public JsonResult PrintJO(int ImpJobOrderId)
        {
            ...
            if (objIR.DBResponse.Data != null)
            {
                ...
                //For 3.2 changes
                string Path = GeneratePDFForJOPrint(objMdl, ImpJobOrderId);
        ...
        [NonAction]
        public string GeneratePDFForJOPrint(PPGPrintJOModel objMdl, int ImpJobOrderId)
        {
            string Path = Server.MapPath("~/Docs/") + Session.SessionID + "/JobOrder" + ImpJobOrderId + ".pdf";
            string ContainerNo = "", Size = "", Serial = "", TrainNo = "", TrainDate = "", ContainerLoadType = "", CargoType = ""; int Count = 0;
            int Count40 = 0;
            ...
            {
                Count20 = objMdl.lstDet.Where(x => x.ContainerSize == "20").Count();
                Count40 = objMdl.lstDet.Where(x => x.ContainerSize == "40").Count();
                ...
                Html += "<td width='180%' valign='top' align='center'><h1 style='font-size: 20px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><label style='font-size: 12px;'>(A Govt. of India Undertaking)</label><br/><span style='font-size:12px;'>" + CompanyAddress + "</span><br/><label style='font-size: 14px; font-weight:bold;'>IMPORT JOB ORDER</label></td></tr>";
                Html += "</tbody></table>";
                Html += "</td></tr>";

                Html += "<tr><td colspan='12'>";
                Html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-size:8pt; font-family: Arial, Helvetica, sans-serif; margin: 0;'><tbody>";
                Html += "<tr><td style='text-align:left; width:50%;'>Job Order No.<span style='border-bottom:1px solid #000;'> " + objMdl.JobOrderNo + "</span></td><td style='text-align:right;width:50%;'>Job Order Date<span style='border-bottom:1px solid #000;'> " + objMdl.JobOrderDate + "</span></td></tr>";
                Html += "<tr><td>To,</td></tr>";
                Html += "<tr><td>The Manager(OPERATIONS)</td></tr>";
                Html += "<tr><td>" + objMdl.FromLocation + "</td></tr>";
                Html += "<tr><td><br/><br/>Sir,</td></tr>";
                Html += "<tr><td colspan='12'>Please arrange movement of following Import Loaded container to ICD Pataprganj immediately within free time as per Tender terms.</td></tr>";
                Html += "</tbody></table>";
                Html += "</td></tr>";

                Html += "<tr><td colspan='12'>";
                Html += "<table cellspacing='0' cellpadding='5' style='width:70%;font-size:7pt;font-family:Verdana,Arial,San-serif; border:1px solid #000;'>";
                Html += "<thead><tr><th style='border-right:1px solid #000; width:10%;'>TRAIN NO.</th>";
                Html += "<th style='border-right:1px solid #000; width:10%;'>TRAIN DATE</th>";
                Html += "<th style='border-right:1px solid #000; width:10%;'>PORT</th>";
                Html += "<th style='border-right:1px solid #000; width:6%;'>NO. OF 20 \" CONTAINER</th>";
                Html += "<th style='border-right:1px solid #000; width:6%;'>NO. OF 40 \" CONTAINER</th>";
                Html += "<th style='width:7%;'>TOTAL TEU's</th></tr></thead>";

                Html += "<tbody>";
                Html += "<tr><td style='border-right:1px solid #000; border-top:1px solid #000;'>" + objMdl.TrainNo + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + objMdl.TrainDate + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + objMdl.PortName + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + Count20 + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + Count40 + "</td>";
                Html += "<td style='border-top:1px solid #000;'>" + (Count20 + (Count40 * 2)) + "</td></tr>";
                Html += "</tbody>";
                Html += "</table>";
                Html += "</td></tr>";
                ...
                Html += "<tr><td colspan='12'>";
                Html += "<table cellspacing='0' cellpadding='5' style='width:100%;font-size:7pt;font-family:Verdana,Arial,San-serif; border:1px solid #000;'>";
                Html += "<thead><tr><th style='border-right:1px solid #000;'>S. NO.</th>";
                Html += "<th style='border-right:1px solid #000;'>WAGON NO.</th>";
                Html += "<th style='border-right:1px solid #000;'>CONTAINER NO.</th>";
                Html += "<th style='border-right:1px solid #000;'>SIZE</th>";
                Html += "<th style='border-right:1px solid #000;'>LINE SEAL NO.</th>";
                Html += "<th style='border-right:1px solid #000;'>SHIPPING LINE NAME</th>";
                Html += "<th style='border-right:1px solid #000;'>NET WEIGHT</th>";
                Html += "<th style='border-right:1px solid #000;'>TARE WEIGHT</th>";
                Html += "<th style='border-right:1px solid #000;'>GROSS WEIGHT</th>";
                Html += "<th style='border-right:1px solid #000;'>CONT. STATUS</th>";
                Html += "<th style='border-right:1px solid #000;'>TP NO.</th>";
                Html += "<th style='border-right:1px solid #000;'>TP DATE</th>";
                Html += "<th>CARGO TYPE</th></tr></thead>";

                Html += "<tbody>";
                int i = 1;
                objMdl.lstDet.ToList().ForEach(elem =>
                {
                    Html += "<tr>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + (i++) + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.WagonNo + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.ContainerNo + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.ContainerSize + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.LineSealNo + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.Sline + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.CargoWt.ToString("0.###") + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.TareWt.ToString("0.###") + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + (elem.CargoWt + elem.TareWt).ToString("0.###") + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.ContainerLoadType + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.TPNo + "</td>";
                    Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.TPDate + "</td>";
                    Html += "<td style='border-top:1px solid #000;'>" + elem.CargoType + "</td>";
                    Html += "</tr>";
                });
                ...
                Html += "<tr><td colspan='12'>";
                Html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-size:8pt; font-family: Arial, Helvetica, sans-serif; margin: 0;'><tbody>";
                Html += "<tr><td>Copy to <br/> 1-The Terminal Manager, " + objMdl.FromLocation + "<br/> 2-M/S Rahul Roadways. Ltd - For arranging movement of the Containers/CBT</td></tr>";
                Html += "<tr><td style='width:80%;'></td><td style='width:20%;'><br/><br/><br/>Authorized Signature<br/>ICD Paptparganj</td></tr>";
                Html += "</tbody></table>";
                Html += "</td></tr>";
        ...
        {
            string check = "";
            SealCutting SC = new SealCutting();
        ...
        public ActionResult GetListOfSealCuttingDetails()
        {
            ...
            IList<SealCutting> lstSC = new List<SealCutting>();
            if (objIR.DBResponse.Data != null)
                lstSC = (List<SealCutting>)objIR.DBResponse.Data;
        ...
        public JsonResult LoadListMoreDataForSealCutting(int Page)
        {
            ...
            if (ObjCR.DBResponse.Data != null)
            {
                LstJO = (List<SealCutting>)ObjCR.DBResponse.Data;
            }
            return Json(LstJO, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult EditSealCuttingById(int SealCuttingId)
        {
            ...
            if (objImport.DBResponse.Data != null)
                objImp = (SealCutting)objImport.DBResponse.Data;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditSealCutting(SealCutting objSealCutting)
        {
            try
            {
                int BranchId = Convert.ToInt32(Session["BranchId"]);
                ...
                {
                    var ViewBLList = JsonConvert.DeserializeObject<List<SealCutting>>(objSealCutting.ViewBLList.ToString());
                    if (ViewBLList != null)
                    {
                ...
                Ppg_ImportRepository objImport = new Ppg_ImportRepository();
                objImport.AddEditSealCutting(objSealCutting, ChargesBreakupXML, BranchId, ((Login)(Session["LoginUser"])).Uid, OBLXML, Request.UserHostAddress);
                //ModelState.Clear();
        ...
        {
            Ppg_ImportRepository ObjCR = new Ppg_ImportRepository();
            List<Ppg_DestuffingList> LstJO = new List<Ppg_DestuffingList>();
            ObjCR.GetAllDestuffingEntry(Page, ((Login)(Session["LoginUser"])).Uid);
            if (ObjCR.DBResponse.Data != null)
            {
                LstJO = (List<Ppg_DestuffingList>)ObjCR.DBResponse.Data;
            }
            return Json(LstJO, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult GetDestuffingEntryList()
        {
            ...
            if (ObjIR.DBResponse.Data != null)
            {
                LstDestuffing = (List<Ppg_DestuffingList>)ObjIR.DBResponse.Data;
            }
        ...
        public ActionResult EditDestuffingEntry(int DestuffingEntryId)
        {
            ...
            if (DestuffingEntryId > 0)
            {
                ...
                if (ObjIR.DBResponse.Data != null)
                {
                    ObjDestuffing = (PpgDestuffingEntry)ObjIR.DBResponse.Data;
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditDestuffingEntry(PpgDestuffingEntry ObjDestuffing)
        {
            if (ModelState.IsValid)
            {
                string DestuffingEntryXML = "";
                List<Ppg_DestuffingEntryDtl> LstDestuffingEntry = new List<Ppg_DestuffingEntryDtl>();
                if (ObjDestuffing.DestuffingEntryXML != null)
                {
                    LstDestuffingEntry = Newtonsoft.Json.JsonConvert.DeserializeObject<List<Ppg_DestuffingEntryDtl>>(ObjDestuffing.DestuffingEntryXML);
        ...
        public JsonResult PrintDestuffingSheet(int DestuffingEntryId)
        {
            ...
            if (ObjIR.DBResponse.Data != null)
            {
                Ppg_DestuffingSheet ObjDestuff = new Ppg_DestuffingSheet();
                ObjDestuff = (Ppg_DestuffingSheet)ObjIR.DBResponse.Data;
                string Path = GeneratePDFForDestuffSheet(ObjDestuff, DestuffingEntryId);
                return Json(new { Status = 1, Message = Path });
            }
            else
                return Json(new { Status = 0, Data = "Destuffing sheet(print) should not be generated until the area for all b/l has not been allotted" }, JsonRequestBehavior.AllowGet);
        }
        [NonAction]
        public string GeneratePDFForDestuffSheet(Ppg_DestuffingSheet ObjDestuff, int DestuffingEntryId)
        {
            ...
            ObjDestuff.lstDtl.ToList().ForEach(item =>
            {
                ...
                objSB.Append("<td style='border-bottom: 1px solid #000; text-align: center; padding: 5px; width: 10%;'>" + item.Remarks.Replace("&", " and ").Replace("amp;", " ").ToString() + "</td>");
                objSB.Append("</tr>");
                Serial++;
            });
        ...
        public JsonResult GetContainerPaymentSheet(string InvoiceDate, int AppraisementId, string TaxType,
            ...
            int InvoiceId = 0, int isdirect = 0, string SEZ = "")
        {
            string XMLText = "";
            ...
            var Output = (PpgInvoiceYard)objPpgRepo.DBResponse.Data;
        ...
        public JsonResult AddEditContPaymentSheet(String InvoiceObj, int IsDirect, string SEZ)
        {
            try
            {
                ...
                objChargeMaster.AddEditInvoice(invoiceData, ContainerXML, ChargesXML, ContWiseCharg, OperationCfsCodeWiseAmtXML, ChargesBreakupXML, BranchId, ((Login)(Session["LoginUser"])).Uid, IsDirect, "IMPYard", SEZ, "");
        ...
        */
        ...
        [HttpGet]
        public JsonResult DeliveryNoBinding()
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
            objImport.GetDeliveryApplicationForImpPaymentSheet();
            if (objImport.DBResponse.Status > 0)
        ...
        */
        ...
        [HttpGet]
        public JsonResult GetPartyPdaDetailsForFCLtoLCL(string Size, int PartyPdaId, int ContainerClassId, String CFSCode, string SEZ)
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
            objImport.GetPartyPdaDetailsForFCLtoLCL(Size, PartyPdaId, ContainerClassId, CFSCode, SEZ);
        ...
        [HttpPost]
        public JsonResult CalculateFCLToLCLInvEdit(string Size, int PartyPdaId, int ContainerClassId, String CFSCode, String InvoiceDate, int InvoiceId = 0)
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
            objImport.CalculateFCLToLCLInv(Size, PartyPdaId, ContainerClassId, CFSCode, InvoiceId);
            var Output = (PpgInvoiceYard)objImport.DBResponse.Data;

            Output.InvoiceDate = InvoiceDate;
            Output.Module = "IMPFCLLCL";
        ...
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
            objImport.GetListOfFCLToLCLConversionDtl(0);
        ...
        [HttpGet]
        public ActionResult GetListOfFCLToLCLConversionDtlforpage( int Page)
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
            objImport.GetListOfFCLToLCLConversionDtl(Page);
            List<FCLtoLCLConversion> objImp = new List<FCLtoLCLConversion>();
            if (objImport.DBResponse.Data != null)
                objImp = (List<FCLtoLCLConversion>)objImport.DBResponse.Data;
            return Json(objImp, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult CreateIssueSlip()
        {
            ...
            if (ObjIR.DBResponse.Data != null)
            {
                ViewBag.InvoiceNoList = new SelectList((List<PPG_Issueslip>)ObjIR.DBResponse.Data, "InvoiceId", "InvoiceNo");
            }
            else
            {
        ...
        public ActionResult GetIssueSlipList()
        {
            ...
            if (ObjIR.DBResponse.Data != null)
            {
                LstIssueSlip = (List<PPG_Issueslip>)ObjIR.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditIssueSlip(PPG_Issueslip ObjIssueSlip)
        {
            if (ModelState.IsValid)
            {
                Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
        ...
        [NonAction]
        public string GeneratePDFForIssueSlip(PPG_Issueslip ObjIssueSlip, int IssueSlipId)
        {
        ...
        */
        ...
        [HttpPost]
        public JsonResult GetEmptyEditContainerPaymentSheet(string InvoiceDate, string InvoiceType, int AppraisementId, int InvoiceId, int PartyId,
           List<PaymentSheetContainer> lstPaySheetContainer, string InvoiceFor)
        {
            ...
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
            //objChrgRepo.GetAllCharges();
            objImport.GetEmptyEditContPaymentSheet(InvoiceDate, AppraisementId, InvoiceType, XMLText, InvoiceId, InvoiceFor, PartyId);
            var Output = (PpgInvoiceYard)objImport.DBResponse.Data;
        ...
        [HttpPost]
        [CustomValidateAntiForgeryToken]
        public JsonResult AddEditECDeliveryEditPaymentSheet(String InvoiceObj)
        {
            try
            {
                int BranchId = Convert.ToInt32(Session["BranchId"]);
        ...
        public JsonResult CalculateEmptyContTransferInv(string InvoiceDate, string InvoiceType, string CFSCode, string ContainerNo, string Size, string EntryDate,
            string EmptyDate, int RefId, int PartyId, int PayeeId, string SEZ, int InvoiceId = 0)
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
        ...
        [HttpPost]
        public JsonResult CalculateEmptyContTransferInvEdit(string InvoiceDate, string InvoiceType, string CFSCode, string ContainerNo, string Size, string EntryDate,
          string EmptyDate, int RefId, int PartyId, int PayeeId, string SEZ, int InvoiceId = 0)
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();
            objImport.CalculateEmptyContTransferInv(InvoiceDate, InvoiceType, CFSCode, ContainerNo, Size, EntryDate,
        ...
        public ActionResult ImporterNameAmmendment()
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            ObjIR.ListOfImporterPartyCode("", 0);
            if (ObjIR.DBResponse.Data != null)
            {
                var Jobj = Newtonsoft.Json.JsonConvert.SerializeObject(ObjIR.DBResponse.Data);
                var Jobject = Newtonsoft.Json.Linq.JObject.Parse(Jobj);
        ...
        {
            Ppg_ImportRepository objRepo = new Ppg_ImportRepository();
            objRepo.ListOfImporterPartyCode(PartyCode, Page);
            return Json(objRepo.DBResponse, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            Ppg_ImportRepository objRepo = new Ppg_ImportRepository();
            objRepo.ListOfImporterPartyCode(PartyCode, 0);
            return Json(objRepo.DBResponse, JsonRequestBehavior.AllowGet);
        }
        [HttpGet]
        public ActionResult GetAllOBLNoforImporterAmendment()
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            ObjIR.GetAllOBLNoForAmmendent();
            if (ObjIR.DBResponse.Status > 0)
                return Json(ObjIR.DBResponse, JsonRequestBehavior.AllowGet);
            else
                return Json(null, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        public ActionResult GetOBLDetailsForImporterAmmendment(int OBLDtlId)
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            ObjIR.GetAllOBLNoDetForAmmendent(OBLDtlId);
            if (ObjIR.DBResponse.Status > 0)
                return Json(ObjIR.DBResponse, JsonRequestBehavior.AllowGet);
            else
                return Json(null, JsonRequestBehavior.AllowGet);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditImporterAmmendment(Ppg_ImporterAmmendment objImp)
        {
            ...
            objIR.AddEditImpAmmendment(objImp);
            return Json(objIR.DBResponse);
        ...
        [HttpGet]
        public ActionResult ListofImporterAmendData()
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            List<Ppg_ImporterAmmendment> lstdata = new List<Ppg_ImporterAmmendment>();
            objIR.GetAmenSBDetailsByAmendNO("", 0);
            if (objIR.DBResponse.Status == 1)
            {
                lstdata = (List<Ppg_ImporterAmmendment>)objIR.DBResponse.Data;
            }
            return PartialView("ListofImporterAmendData", lstdata);
        }
        [HttpGet]
        public ActionResult ListofImporterAmendDataSearch(string ImporterName)
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            List<Ppg_ImporterAmmendment> lstdata = new List<Ppg_ImporterAmmendment>();
            ObjIR.GetAmenSBDetailsByAmendNO(ImporterName, 0);
            if (ObjIR.DBResponse.Data != null)
            {
                lstdata = (List<Ppg_ImporterAmmendment>)ObjIR.DBResponse.Data;
            }
        ...
        [HttpGet]
        public JsonResult LoadListMoreDataForImportAmendment(int Page)
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            List<Ppg_ImporterAmmendment> lstdata = new List<Ppg_ImporterAmmendment>();
            ObjIR.GetAmenSBDetailsByAmendNO("", Page);
            if (ObjIR.DBResponse.Data != null)
            {
                lstdata = (List<Ppg_ImporterAmmendment>)ObjIR.DBResponse.Data;
            }
        ...
        public ActionResult ContainerByRoadAmmendment()
        {
            //  ppg_ContainerAmendment obj = new ppg_ContainerAmendment();
            //  obj.AmendDate = DateTime.Now.Date.ToString("dd/mm/yyyy");
            return PartialView();
        }
        [HttpGet]
        public ActionResult GetAllContainerforContainerByRoadAmmendment()
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            ObjIR.GetAllContainerNoForAmmendent();
            if (ObjIR.DBResponse.Status > 0)
                return Json(ObjIR.DBResponse, JsonRequestBehavior.AllowGet);
            else
                return Json(null, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        public ActionResult GetContainerDetailsForContainerAmmendment(int FormOneDetailId)
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            ObjIR.GetAlContainernoDetForAmmendent(FormOneDetailId);
            if (ObjIR.DBResponse.Status > 0)
                return Json(ObjIR.DBResponse, JsonRequestBehavior.AllowGet);
            else
                return Json(null, JsonRequestBehavior.AllowGet);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditContainerByRoadAmmendment(ppg_ContainerAmendment objImp)
        {
            ...
            objIR.AddEditContainerAmmendment(objImp);
            return Json(objIR.DBResponse);
        ...
        [HttpGet]
        public ActionResult ListofContainerByRoadAmmendmentData()
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            List<ppg_ContainerAmendment> lstdata = new List<ppg_ContainerAmendment>();
            objIR.GetAmenContainerNoByAmendNO("");
            if (objIR.DBResponse.Status == 1)
            {
                lstdata = (List<ppg_ContainerAmendment>)objIR.DBResponse.Data;
            }
        ...
        [HttpGet]
        public JsonResult GetShippingLineNameForContainerAmendment()
        {
            ...
            ObjIR.ListOfShippingLineForAmendment();

            if (ObjIR.DBResponse.Data != null)
            {
                ((List<ShippingLine>)ObjIR.DBResponse.Data).ToList().ForEach(item =>
                {
                    objImp2.Add(new { ShippingLineId = item.ShippingLineId, ShippingLineName = item.ShippingLineName });
                });
        ...
        public ActionResult EditYardInvoice()
        {
            ...
            //   objImport.GetInvoiceForEdit("IMPYard");
            //  if (objImport.DBResponse.Status > 0)
        ...
        public JsonResult GetYardInvoiceDetails(int InvoiceId)
        {
            try
            {
                ...
                Ppg_ImportRepository objCashManagement = new Ppg_ImportRepository();
        ...
        [HttpGet]
        public JsonResult GetInvoiceForEdit(String Module)
        {
            Ppg_ImportRepository objImport = new Ppg_ImportRepository();

            objImport.GetInvoiceForEdit(Module);
            if (objImport.DBResponse.Status > 0)
                ViewBag.InvoiceList = JsonConvert.SerializeObject(objImport.DBResponse.Data);
            else
                ViewBag.InvoiceList = null;
            return Json(ViewBag.InvoiceList, JsonRequestBehavior.AllowGet);
        }
        ...
        #region Delivery Invoice (Godown ) Edit
        ...
        public JsonResult GetDeliInvoiceDetails(int InvoiceId)
        {
            try
            {
                ...
                //objCharge.GetAllCharges();
                Ppg_ImportRepository objImport = new Ppg_ImportRepository();
                objImport.GetDeliInvoiceDetailsForEdit(InvoiceId);
                if (objImport.DBResponse.Status == 1)
                {
                    //PpgInvoiceYard objPostPaymentSheet = (PpgInvoiceYard)objCashManagement.DBResponse.Data;
                    PPGInvoiceGodown objPostPaymentSheet = (PPGInvoiceGodown)objImport.DBResponse.Data; //new PPGInvoiceGodown();
        ...
        #region Empty Container Invoice Edit
        [HttpGet]
        public ActionResult EditEmptyContainerInvoice()
        {
            AccessRightsRepository ACCR = new AccessRightsRepository();
            ACCR.GetMenuWiseAccessRight(Convert.ToInt32(Session["MenuId"]), ((Login)Session["LoginUser"]).Role.RoleId, Convert.ToInt32(Session["ModuleId"]), Convert.ToInt32(Session["BranchId"]));
            ViewBag.RightsList = JsonConvert.SerializeObject(ACCR.DBResponse.Data);
            ...
            //  objImport.GetInvoiceForEdit("EC");
            //if (objImport.DBResponse.Status > 0)
            //  ViewBag.InvoiceList = JsonConvert.SerializeObject(objImport.DBResponse.Data);
            // else
            //   ViewBag.InvoiceList = null;
        ...
        public JsonResult GetEmptyContInvoiceDetails(int InvoiceId)
        {
            try
            {
                ...
                //objCharge.GetAllCharges();
                Ppg_ImportRepository objCashManagement = new Ppg_ImportRepository();
                objCashManagement.GetEmptyContInvoiceDetailsForEdit(InvoiceId);
                if (objCashManagement.DBResponse.Status == 1)
                {
                    PpgInvoiceYard objPostPaymentSheet = (PpgInvoiceYard)objCashManagement.DBResponse.Data;
                    ...
                    //******Get Container By ReqId****************************************************//
                    List<PaymentSheetContainer> containersAll = new List<PaymentSheetContainer>();
                    objImportRepo.GetCFSCodeForEdit(objPostPaymentSheet.RequestId, "EC");
                    if (objImportRepo.DBResponse.Status == 1)
                    {
        ...
        #region Empty Container Transfer Invoice Edit
        [HttpGet]
        public ActionResult EditEmptyContainerTransferInvoice()
        {
            AccessRightsRepository ACCR = new AccessRightsRepository();
            ACCR.GetMenuWiseAccessRight(Convert.ToInt32(Session["MenuId"]), ((Login)Session["LoginUser"]).Role.RoleId, Convert.ToInt32(Session["ModuleId"]), Convert.ToInt32(Session["BranchId"]));
            ViewBag.RightsList = JsonConvert.SerializeObject(ACCR.DBResponse.Data);
            ...
            //   objImport.GetInvoiceForEdit("ECTrns");
            //   if (objImport.DBResponse.Status > 0)
            //     ViewBag.InvoiceList = JsonConvert.SerializeObject(objImport.DBResponse.Data);
            //  else
            //    ViewBag.InvoiceList = null;
        ...
        [HttpGet]
        public JsonResult GetEmptyContTransferInvoiceDetails(int InvoiceId)
        {
            try
            {
                ChargeMasterRepository objCharge = new ChargeMasterRepository();
                ...
                //objCharge.GetAllCharges();
                Ppg_ImportRepository objCashManagement = new Ppg_ImportRepository();
                objCashManagement.GetEmptyContTransferInvoiceDetailsForEdit(InvoiceId);
                if (objCashManagement.DBResponse.Status == 1)
                {
                    PpgInvoiceYard objPostPaymentSheet = (PpgInvoiceYard)objCashManagement.DBResponse.Data;
                    ...
                    //******Get Container By ReqId****************************************************//
                    List<PaymentSheetContainer> containersAll = new List<PaymentSheetContainer>();
                    objImportRepo.GetCFSCodeForEdit(objPostPaymentSheet.RequestId, "ECTrns");
                    if (objImportRepo.DBResponse.Status == 1)
                    {
        ...
        [HttpGet]
        public ActionResult EditFCLLCLContainerInvoice()
        {
            AccessRightsRepository ACCR = new AccessRightsRepository();
            ACCR.GetMenuWiseAccessRight(Convert.ToInt32(Session["MenuId"]), ((Login)Session["LoginUser"]).Role.RoleId, Convert.ToInt32(Session["ModuleId"]), Convert.ToInt32(Session["BranchId"]));
            ViewBag.RightsList = JsonConvert.SerializeObject(ACCR.DBResponse.Data);
            ...
            //   objImport.GetInvoiceForEdit("IMPFCLLCL");
            //  if (objImport.DBResponse.Status > 0)
            //    ViewBag.InvoiceList = JsonConvert.SerializeObject(objImport.DBResponse.Data);
            //   else
            //   ViewBag.InvoiceList = null;

            objImport.GetPaymentPartyForEditImportFCL();
            if (objImport.DBResponse.Status > 0)
                ViewBag.PaymentParty = JsonConvert.SerializeObject(objImport.DBResponse.Data);
            else
                ViewBag.PaymentParty = null;
        ...
        [HttpGet]
        public JsonResult GetFCLLCLInvoiceDetails(int InvoiceId)
        {
            try
            {
                ChargeMasterRepository objCharge = new ChargeMasterRepository();
                ...
                //objCharge.GetAllCharges();
                Ppg_ImportRepository objCashManagement = new Ppg_ImportRepository();
                objCashManagement.GetFCLLCLInvoiceDetailsForEdit(InvoiceId);
                if (objCashManagement.DBResponse.Status == 1)
                {
                    PpgInvoiceYard objPostPaymentSheet = (PpgInvoiceYard)objCashManagement.DBResponse.Data;
        ...
        [HttpPost]
        [CustomValidateAntiForgeryToken]
        public JsonResult AddEditFCLToLCLPaymentSheet(String InvoiceObj)
        {
            try
            {
                int BranchId = Convert.ToInt32(Session["BranchId"]);
                ...
                //objImport.AddEditContainerInvoice(formData, ContainerXML, ChargesXML, BranchId, ((Login)(Session["LoginUser"])).Uid);
                //return Json(objImport.DBResponse);
                var invoiceFor = "IMPFCLLCL"; //objForm["InvoiceFor"].ToString();
                var invoiceData = JsonConvert.DeserializeObject<PpgInvoiceYard>(InvoiceObj); ;
                string ContainerXML = "";
                string ChargesXML = "";
                string ContWiseCharg = "";
                ...
                Ppg_ImportRepository objImport = new Ppg_ImportRepository();
                // objChargeMaster.AddEditInvoice(invoiceData, ContainerXML, ChargesXML, ContWiseCharg, OperationCfsCodeWiseAmtXML, BranchId, ((Login)(Session["LoginUser"])).Uid, InvoiceFor);
                objImport.AddEditFCLToLCLPaymentSheetForEdit(invoiceData, ContainerXML, ChargesXML, ContWiseCharg, OperationCfsCodeWiseAmtXML, ChargesBreakupXML, BranchId, ((Login)(Session["LoginUser"])).Uid, InvoiceFor);
        ...
        #region Job Order By New

        public ActionResult JobOrderNewFormat()
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            int RoleId = ((CwcExim.Models.Login)Session["LoginUser"]).Role.RoleId;
            int BranchId = Convert.ToInt32(Session["BranchId"]);
            ...
            objJO.JobOrderDate = DateTime.Now;
            ViewBag.strTime = DateTime.Now.ToString("HH:mmtt");

            return PartialView(objJO);
        }

        [HttpGet]
        public ActionResult GetAllContainerNo()
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            ObjIR.GetAllContainerNo();
            if (ObjIR.DBResponse.Status > 0)
                return Json(ObjIR.DBResponse, JsonRequestBehavior.AllowGet);
            else
                return Json(null, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        public ActionResult GetContainerNoDetails(string ContainerNo, int TrainSummaryID)
        {
            Ppg_ImportRepository ObjIR = new Ppg_ImportRepository();
            ObjIR.GetAllContainerNoDetails(ContainerNo, TrainSummaryID);
            if (ObjIR.DBResponse.Status > 0)
                return Json(ObjIR.DBResponse, JsonRequestBehavior.AllowGet);
            else
                return Json(null, JsonRequestBehavior.AllowGet);
        ...
        public JsonResult AddEditJobOrderNew(PPG_JobOrder objImp, String FormOneDetails)
        {
            ...
            objIR.AddEditImpJONewFormat(objImp, XML);
            return Json(objIR.DBResponse);
        ...
        [HttpGet]
        public ActionResult ListOfJobOrderDetailsNewFormat()
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            IList<PPG_ImportJobOrderList> lstIJO = new List<PPG_ImportJobOrderList>();
            objIR.GetAllImpJONewFormat(0);
            if (objIR.DBResponse.Data != null)
                lstIJO = ((List<PPG_ImportJobOrderList>)objIR.DBResponse.Data);
            return PartialView(lstIJO);
        }
        ...
        [HttpGet]
        public ActionResult SearchListOfJobOrderDetailsNewFormat(string ContainerNo)
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            IList<PPG_ImportJobOrderList> lstIJO = new List<PPG_ImportJobOrderList>();
            objIR.GetAllImpJONewFormat(ContainerNo);
            if (objIR.DBResponse.Data != null)
                lstIJO = ((List<PPG_ImportJobOrderList>)objIR.DBResponse.Data);
            return PartialView("ListOfJobOrderDetailsNewFormat", lstIJO);
        }

        [HttpGet]
        public JsonResult LoadListMoreDataNewFormat(int Page)
        {
            Ppg_ImportRepository ObjCR = new Ppg_ImportRepository();
            List<PPG_ImportJobOrderList> LstJO = new List<PPG_ImportJobOrderList>();
            ObjCR.GetAllImpJONewFormat(Page);
            if (ObjCR.DBResponse.Data != null)
            {
                LstJO = (List<PPG_ImportJobOrderList>)ObjCR.DBResponse.Data;
            }
        ...
        [HttpGet]
        public ActionResult EditJobOrderNewFormat(int ImpJobOrderId)
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            objIR.GetImpJODetailsNewformat(ImpJobOrderId);
            PPG_JobOrder objImp = new PPG_JobOrder();
            if (objIR.DBResponse.Data != null)
                objImp = (PPG_JobOrder)objIR.DBResponse.Data;
            ViewBag.jdate = objImp.JobOrderDate;
            ViewBag.JobOrderTime = objImp.JobOrderTime;
            objIR.GetAllPickupLocation();
            if (objIR.DBResponse.Data != null)
            {
                objImp.lstpickup = (List<PPGPickupModel>)objIR.DBResponse.Data;
        ...
        [HttpGet]
        public ActionResult ViewJobOrderNewFormat(int ImpJobOrderId)
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            objIR.GetImpJODetailsNewformat(ImpJobOrderId);
            PPG_JobOrder objImp = new PPG_JobOrder();
        ...
        [HttpPost]
        [CustomValidateAntiForgeryToken]
        public JsonResult DeleteJobOrderNewFormat(int ImpJobOrderId)
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            objIR.DeleteImpJONewFormat(ImpJobOrderId);
            return Json(objIR.DBResponse);
        }
        [HttpGet]
        public JsonResult GetTrainDetailsOnEditModeNewFormat(int ImpJobOrderId)
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            objIR.GetImpJODetailsNewformat(ImpJobOrderId);
            object data = null;
        ...
        [HttpPost]
        [CustomValidateAntiForgeryToken]
        public JsonResult PrintJONewFormat(int ImpJobOrderId)
        {
            Ppg_ImportRepository objIR = new Ppg_ImportRepository();
            objIR.GetImportJODetailsFrPrintNewFormat(ImpJobOrderId);
            if (objIR.DBResponse.Data != null)
            {
                PPGPrintJOModel objMdl = new PPGPrintJOModel();
                objMdl = (PPGPrintJOModel)objIR.DBResponse.Data;
                //string Path = GeneratePDFForJO(objMdl, ImpJobOrderId);
                //For 3.2 changes
                string Path = GeneratePDFForJOPrintNewFormat(objMdl, ImpJobOrderId);
                return Json(new { Status = 1, Message = Path });
            }
            else
                return Json(new { Status = -1, Message = "Error" });
        ...
        [NonAction]
        public string GeneratePDFForJOPrintNewFormat(PPGPrintJOModel objMdl, int ImpJobOrderId)
        {
            string Path = Server.MapPath("~/Docs/") + Session.SessionID + "/JobOrder" + ImpJobOrderId + ".pdf";
            string ContainerNo = "", Size = "", Serial = "", TrainNo = "", TrainDate = "", ContainerLoadType = "", CargoType = ""; int Count = 0;
            int Count40 = 0;
            ...
            Html += "<tr><td style='text-align:left; width:50%;'>Job Order No.<span style='border-bottom:1px solid #000;'> " + objMdl.JobOrderNo + "</span></td><td style='text-align:right;width:50%;'>Job Order Date<span style='border-bottom:1px solid #000;'> " + objMdl.JobOrderDate + "</span></td></tr>";
            Html += "<tr><td>To,</td></tr>";
            Html += "<tr><td>M/s Rahul Roadways</td></tr>";
            Html += "<tr><td>ICD-Patparganj, Delhi</td></tr>";
            Html += "<tr><td><br/><br/></td></tr>";
            Html += "<tr><td colspan='12' style='text-align:center;'>Please arrange to movement Import Loaded Containers from ICD- Tughlakabad </td></tr>";
            Html += "</tbody></table>";
            Html += "</td></tr>";
            ...
            Html += "<th style='border-right:1px solid #000;'>SEAL NO.</th>";
            Html += "<th style='border-right:1px solid #000;'>SHIPPING LINE NAME</th>";
            Html += "<th style='border-right:1px solid #000;'>TARE WEIGHT</th>";
            Html += "<th style='border-right:1px solid #000;'>NET WEIGHT</th>";
            Html += "<th style='border-right:1px solid #000;'>GROSS WEIGHT</th>";
            Html += "<th style='border-right:1px solid #000;'>TYPE</th>";
            Html += "<th style='border-right:1px solid #000;'>DESTINATION</th>";
            Html += "<th style='border-right:1px solid #000;'>TP NO.</th>";
            Html += "<th style='border-right:1px solid #000;'>TP DATE</th></tr></thead>";
            ...
            objMdl.lstDet.ToList().ForEach(elem =>
            {
                ...
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.ContainerNo + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.ContainerSize + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.CargoDescription + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.LineSealNo + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.Sline + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.TareWt.ToString("0.###") + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.CargoWt.ToString("0.###") + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + (elem.Gross_Wt).ToString("0.###") + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.ContainerLoadType + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.Destination + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.TPNo + "</td>";
                Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + elem.TPDate + "</td>";
            ...
            Html += "<table cellspacing='0' cellpadding='5' style='width:70%;font-size:7pt;font-family:Verdana,Arial,San-serif; border:1px solid #000;'>";
            Html += "<thead>";
            Html += "<tr><th colspan='3' style='text-align: center; border-bottom: 1px solid #000;'>Summary</th></tr>";
            //Html += "<th style='border-right:1px solid #000; width:10%;'>TRAIN NO.</th>";
            //Html += "<th style='border-right:1px solid #000; width:10%;'>TRAIN DATE</th>";
            //Html += "<th style='border-right:1px solid #000; width:10%;'>PORT</th>";
            Html += "<tr><th style='border-right:1px solid #000; width:6%;'>NO. OF 20 \" CONTAINER</th>";
            Html += "<th style='border-right:1px solid #000; width:6%;'>NO. OF 40 \" CONTAINER</th>";
            Html += "<th style='width:7%;'>TOTAL TEU's</th></tr></thead>";

            Html += "<tbody>";
            Html += "<tr>";
            //Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + objMdl.TrainNo + "</td>";
            //Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + objMdl.TrainDate + "</td>";
            //Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + objMdl.PortName + "</td>";
            Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + Count20 + "</td>";
            Html += "<td style='border-right:1px solid #000; border-top:1px solid #000;'>" + Count40 + "</td>";
            ...
            Html += "<tr><td><span><br/><br/><br/><br/></span></td></tr>";

            Html += "<tr>";
            Html += "<th colspan='6' width='50%'>Sign Of M/s Rahul Roadways</th>";
            Html += "<th colspan='6' width='50%' align='right'>For Manager ICD-Patparganj</th>";
            Html += "</tr>";
            ...
            Html += "<tr><td colspan='12'>";
            Html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-size:8pt; font-family: Arial, Helvetica, sans-serif; margin: 0;'><tbody>";
            Html += "<tr><td>Copy to <br/> 1. Terminal Manager " + objMdl.FromLocation + " with request to advise opeartions staff to arrange for loading of containers onto the trailers of H&T contractor ICD-Patpargan<br/>  2. The Security Agency ICD-Patparganj</td></tr>";
            Html += "<tr><td style='width:80%;'></td><td style='width:20%;'><br/><br/><br/></td></tr>";
            Html += "</tbody></table>";
            Html += "</td></tr>";
        ...
        //Susmita - 30-05-2023
        #region Search by Container No
        [HttpGet]
        public ActionResult SearchbyContainer(string containerno)
        {
           
                Ppg_ImportRepository objRepo = new Ppg_ImportRepository();
                objRepo.SearchbyContainer(containerno);
               List<PpgCustomAppraisement> LstAppraisement = new List<PpgCustomAppraisement>();
           
            if (objRepo.DBResponse.Data != null)
            {
                LstAppraisement = (List<PpgCustomAppraisement>)objRepo.DBResponse.Data;
            }
                return PartialView("CustomAppraisementList", LstAppraisement);
