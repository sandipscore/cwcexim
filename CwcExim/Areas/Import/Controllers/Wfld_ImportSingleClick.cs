...
{  
    public partial class Wfld_CWCImportController
    {
        [HttpGet]
       ...
       // [HttpPost]
        ...
        public JsonResult GetSingleClickDeliveryPaymentSheet(string InvoiceType, int DestuffingAppId,string DeliveryDate, string InvoiceDate,int InvoiceId,List<WFLDDeliveryApplicationDtl> DeliveryXML,
           int PartyId ,int PayeeId,int vehicleNo, int vehicleNoUn, bool IsInsured,bool BillToParty, bool Transporter, bool ImportToBond,int Cargo, List<WFLDDeliveryGodownDtl> GodownXML, int OTHours = 0,int OblFlag=0,string SEZ="")
        {
            string XMLText = "";
            if (DeliveryXML != null)
            {
        ...
        public JsonResult AddEditSingleMergeDeliveryApplication(WFLDMergeDeliveryIssueViewModel ObjDelivery)
           // WFLDMergeDeliveryIssueViewModel ObjDelivery)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ObjDelivery.DeliApp.LstDeliveryGodownDtl = JsonConvert.DeserializeObject<List<WFLDDeliveryGodownDtl>>(ObjDelivery.DeliApp.DeliveryGodownDtlXml);
                ...
                {
                    ObjDelivery.DeliApp.lstPrePaymentCont = JsonConvert.DeserializeObject<List<WFLDPreInvoiceContainer>>(ObjDelivery.DeliApp.lstPrePaymentContXML);
                ...
                {
                    ObjDelivery.DeliApp.lstPostPaymentChrg = JsonConvert.DeserializeObject<List<WFLDPostPaymentChrg>>(ObjDelivery.DeliApp.lstPostPaymentChrgXML);
                ...
                {
                    ObjDelivery.DeliApp.lstContWiseAmount = JsonConvert.DeserializeObject<List<WFLDContainerWiseAmount>>(ObjDelivery.DeliApp.lstContWiseAmountXML);
                ...
                {
                    ObjDelivery.DeliApp.lstOperationCFSCodeWiseAmount = JsonConvert.DeserializeObject<List<WFLDOperationCFSCodeWiseAmount>>(ObjDelivery.DeliApp.lstOperationCFSCodeWiseAmountXML);
                ...
                {
                    ObjDelivery.DeliApp.lstPostPaymentChrgBreakup = JsonConvert.DeserializeObject<List<WFLDDeliPostPaymentChargebreakupdate>>(ObjDelivery.DeliApp.lstPostPaymentChrgBreakupXML);
                ...
                {
                    ObjDelivery.DeliApp.lstInvoiceCargo = JsonConvert.DeserializeObject<List<WFLDInvoiceCargo>>(ObjDelivery.DeliApp.lstInvoiceCargoXML);
