...
namespace CwcExim.Areas.Import.Controllers
{
    ...
    public partial class VRN_CWCImportController : BaseController
    {
        ...
        {
            VRN_ImportRepository objimp = new VRN_ImportRepository();
        ...
        public JsonResult GetContainerPaymentSheet(string InvoiceDate, int AppraisementId, string TaxType,string SEZ, 
            ...
            int InvoiceId = 0, int isdirect = 0, int ReeferHours = 0)
        {
            string XMLText = "";
            ...
            objPpgRepo.GetYardPaymentSheet(InvoiceDate, AppraisementId, TaxType, XMLText, Movement, InvoiceId, OTHours, PartyId, PayeeId, isdirect, SEZ, ReeferHours);
        ...
        [HttpPost]
        [CustomValidateAntiForgeryToken]
        public JsonResult AddEditContPaymentSheet(String InvoiceObj, int IsDirect,string Movement, string SEZ,int ReeferHours=0)
        {
            try
            {
                ...
                objChargeMaster.AddEditInvoice(invoiceData, ContainerXML, ChargesXML, ContWiseCharg, OperationCfsCodeWiseAmtXML, ChargesBreakupXML, BranchId, ((Login)(Session["LoginUser"])).Uid, IsDirect, SEZ, "IMPYard", Movement, ReeferHours);
