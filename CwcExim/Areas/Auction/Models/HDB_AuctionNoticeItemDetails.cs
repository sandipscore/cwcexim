...
{
    public class HDB_AuctionNoticeItemDetails
    {
    ...
    public class HDB_SavedAuctionNotice
    {
        public int AuctionNoticeDtlId { get; set; }
        public string NoticeNo { get; set; }
        public string AuctionNoticeDate { get; set; }
        public string PartyName { get; set; }
        public string Type { get; set; }
        public List<HDB_SavedAuctionNoticeDetails> SavedAuctionNoticeDetailsList { get; set; }
    }

    public class HDB_SavedAuctionNoticeDetails
    {
        public string CommodityName { get; set; }
        public string BOENo { get; set; }
    ...
    public class HDB_AuctionNoticePrintViewModel
    {
        ...
        public List<HDB_ParticularsOfGoods> ParticularsOfGoodsList { get; set; }
    }

    public class HDB_ParticularsOfGoods
    {
        public string ContainerNo { get; set; }
