...
{
    public class Dnd_AuctionInvoice
    {
    ...
    public class Dnd_AuctionInvoicePrint
    {
        ...
        public List<Dnd_AuctionAccDetails> AuctionAccDetailsList { get; set; } = new List<Dnd_AuctionAccDetails>();
        public List<Dnd_ContainerDetails> ContainerDetailsList { get; set; } = new List<Dnd_ContainerDetails>();
        public List<Dnd_ConatinerCharge> ConatinerChargeList { get; set; } = new List<Dnd_ConatinerCharge>();
    }

    public class Dnd_AuctionAccDetails
    {
    ...
    public class Dnd_ConatinerCharge
    {
