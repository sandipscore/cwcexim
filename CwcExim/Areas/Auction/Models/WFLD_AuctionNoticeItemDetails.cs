...
{
    public class WFLD_AuctionNoticeItemDetails
    {
        ...
        public int SecondNotice { get; set; }

        public int ThirdNotice { get; set; }

        public int NoOfNotice { get; set; }
    ...
    public class WFLD_SavedAuctionNotice
    {
        public int AuctionNoticeDtlId { get; set; }
        public string NoticeNo { get; set; }
        public string AuctionNoticeDate { get; set; }
        ...
        public int ThirdNotice { get; set; }
        public int NoOfNotice { get; set; }
        public List<WFLD_SavedAuctionNoticeDetails> SavedAuctionNoticeDetailsList { get; set; }
    }

    public class WFLD_SavedAuctionNoticeDetails
    {
        public string CommodityName { get; set; }
        public string BOENo { get; set; }
    ...
    public class WFLD_AuctionNoticePrintViewModel
    {
        ...
        public List<WFLD_ParticularsOfGoods> ParticularsOfGoodsList { get; set; }
    }

    public class WFLD_ParticularsOfGoods
    {
        public string ContainerNo { get; set; }
