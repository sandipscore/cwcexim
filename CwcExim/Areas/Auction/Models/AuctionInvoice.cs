...
namespace CwcExim.Areas.Auction.Models
{
    ...
    public class AuctionInvoicePrint
    {
        ...
        public List<AuctionAccDetails> AuctionAccDetailsList { get; set; } = new List<AuctionAccDetails>();
        public List<ContainerDetails> ContainerDetailsList { get; set; } = new List<ContainerDetails>();
        public List<ConatinerCharge> ConatinerChargeList { get; set; } = new List<ConatinerCharge>();
    }

    public class AuctionAccDetails
    {
