...
{
    public class AuctionNoticeItemDetails
    {
    ...
    public class SavedAuctionNotice
    {
        public int AuctionNoticeDtlId { get; set; }
        public string NoticeNo { get; set; }
        public string AuctionNoticeDate { get; set; }
        public string PartyName { get; set; }
        public string Type { get; set; }
        public List<SavedAuctionNoticeDetails> SavedAuctionNoticeDetailsList { get; set; }
    }

    public class SavedAuctionNoticeDetails
    {
        public string CommodityName { get; set; }
        public string BOENo { get; set; }
    ...
    public class AuctionNoticePrintViewModel
    {
        ...
        public List<ParticularsOfGoods> ParticularsOfGoodsList { get; set; }
    }

    public class ParticularsOfGoods
    {
        public string ContainerNo { get; set; }
