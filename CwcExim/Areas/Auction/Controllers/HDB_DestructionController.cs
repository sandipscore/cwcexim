...
{
    public class HDB_DestructionController : BaseController
    {
        // GET: Auction/HDB_Destruction
        ...
        public HDB_DestructionController()
        {
            /*
        ...
        public JsonResult GetRefNoForDestruction(int Flag)
        {
            ...
            List<HDB_DestructionViewModel> LstRefDetails = new List<HDB_DestructionViewModel>();
            LstRefDetails = (List<HDB_DestructionViewModel>)obj.DBResponse.Data;
        ...
        {
            HDB_AuctionRepository objER = new HDB_AuctionRepository();
        ...
        [HttpPost]
        public JsonResult SaveDestruction(HDB_DestructionViewModel vm)
        {
            try
            {
                Login ObjLogin = (Login)Session["LoginUser"];
        ...
        public JsonResult GetDestructionList(int id)
        {
            try
            {
                ...
                lstDestruction = (List<HDB_DestructionViewModel>)obj.DBResponse.Data;
        ...
        public JsonResult GetPreviewDestruction(int id)
        {
            ...
            lstDestruction = (List<HDB_DestructionGatepassViewModel>)obj.DBResponse.Data;
        ...
        [NonAction]
        private string GeneratingPDF(List<HDB_DestructionGatepassViewModel> objGP)
        {
            string html = "";
