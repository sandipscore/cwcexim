...
{
    public class Dnd_DestructionController : BaseController
    {
        ...
        public Dnd_DestructionController()
        {
            /*
        ...
        public JsonResult GetRefNoForDestruction(int Flag)
        {
            ...
            List<Dnd_DestructionViewModel> LstRefDetails = new List<Dnd_DestructionViewModel>();
            LstRefDetails = (List<Dnd_DestructionViewModel>)obj.DBResponse.Data;
        ...
        {
            Dnd_AuctionRepository objER = new Dnd_AuctionRepository();
        ...
        [HttpPost]
        public JsonResult SaveDestruction(Dnd_DestructionViewModel vm)
        {
            try
            {
                Login ObjLogin = (Login)Session["LoginUser"];
        ...
        public JsonResult GetDestructionList(int id)
        {
            try
            {
                ...
                lstDestruction = (List<Dnd_DestructionViewModel>)obj.DBResponse.Data;
        ...
        public JsonResult GetPreviewDestruction(int id)
        {
            ...
            List<Dnd_DestructionGatepassViewModel> lstDestruction = new List<Dnd_DestructionGatepassViewModel>();
            lstDestruction = (List<Dnd_DestructionGatepassViewModel>)obj.DBResponse.Data;
        ...
        [NonAction]
        private string GeneratingPDF(List<Dnd_DestructionGatepassViewModel> objGP)
        {
            string html = "";
