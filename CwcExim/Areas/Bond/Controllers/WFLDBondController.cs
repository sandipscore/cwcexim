...
{
    public class WFLDBondController : BaseController
    {
        ...
        {
            WFLDBondRepository obj = new WFLDBondRepository();
        ...
        {
            WFLDBondRepository objRepo = new WFLDBondRepository();
        ...
        public ActionResult EditBondApp(int SpaceappId)
        {
            ...
            WFLDBondRepository objHdb = new WFLDBondRepository();            
            WFLDBondApp objBA = new WFLDBondApp();
        ...
        public string GeneratePDFForSpaceAvailAppCert(WFLDSpaceAvailAppCertPdf ObjSpaceAvail, int SpaceappId)
        {
            ...
            html.Append("<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>");
            html.Append("<tr><td valign='top'><img align='right' src='IMGSRC' width='90'/></td>");
            html.Append("<td width='70%' valign='top' align='center'><h1 style='font-size: 16px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><label style='font-size: 7pt;'>(A Govt. of India Undertaking)</label><br/><label style='font-size: 7pt;'>CFS Whitefield</label><br/><label style='font-size: 7pt;'>Email - " + ObjSpaceAvail.EmailAddress + "</label><br/><label style='font-size: 7pt; font-weight:bold;'>APPLICATION FOR AVAILABILITY OF SPACE</label></td>");
            html.Append("<td valign='top'><img align='right' src='ISO' width='100'/></td></tr>");
            html.Append("</tbody></table>");
            html.Append("</td></tr>");
        ...
        {
            WFLDBondRepository ObjCR = new WFLDBondRepository();
        ...
        public ActionResult CreateBondAdvPaymentSheet(string type = "Tax")
        {
            ...
            WFLDBondRepository objBond = new WFLDBondRepository();
        ...
        public JsonResult AddEditBondAdvPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                WFLDBondRepository objChargeMaster = new WFLDBondRepository();
        ...
        {
            WFLDBondRepository objExport = new WFLDBondRepository();
