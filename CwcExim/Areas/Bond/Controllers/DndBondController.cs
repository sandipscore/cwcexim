...
{
    public class DndBondController : Controller
    {
        ...
        {
            DndBondRepository ObjBR = new DndBondRepository();
        ...
        {
            DndBondRepository ObjBR = new DndBondRepository();
            DndSpaceAvailableCert ObjSpaceAvail = new DndSpaceAvailableCert();
            ObjBR.GetSpaceAvailCertById(SpaceappId, Status);
            if (ObjBR.DBResponse.Data != null)
            {
                ObjSpaceAvail = (DndSpaceAvailableCert)ObjBR.DBResponse.Data;
            }
        ...
        public ActionResult AddEditSpaceAvailCert(DndSpaceAvailableCert ObjSpaceAvail)
        {
        ...
        public ActionResult PrintSpaceAvailCertApprove(int SpaceappId)
        {
            ...
            if (ObjBR.DBResponse.Data != null)
            {
                DndSpaceAvailCertPdf ObjSpaceAvail = new DndSpaceAvailCertPdf();
                ObjSpaceAvail = (DndSpaceAvailCertPdf)ObjBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailCertForApprove(DndSpaceAvailCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
            ...
            html.Append("<tr><td colspan='12'>");
            html.Append("<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>");
            html.Append("<tr><td style='font-size:7pt; width:50%;'><b>SAC No :</b><u>" + ObjSpaceAvail.SacNo + "</u></td>");
            html.Append("<td style='font-size:7pt; text-align:right; width:50%;'> <b>Central Warehouse :</b> <u>" + ObjSpaceAvail.Location + "</u></td></tr>");
            html.Append("</tbody></table>");
            html.Append("</td></tr>");

            html.Append("<tr><td colspan='12' style='font-size:7.5pt; text-align:right;'> <b>Date</b> <u>" + ObjSpaceAvail.SacDate + "</u></td></tr>");
            ...
            //html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:13px;'>(i)</td><td colspan='2' width='85%' style='font-size:14px; line-height:22px;'>No objection to receive the stock belonging to Mr./ Mrs./ Ms./ Miss " + ((ObjSpaceAvail.Importer == "" || ObjSpaceAvail.Importer == null) ? "_______________________" : "<u>" + ObjSpaceAvail.Importer + "</u>") + " (importer) and covered under BOL No. " + ((ObjSpaceAvail.BOLAWBNo == "" || ObjSpaceAvail.BOLAWBNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.BOLAWBNo + "</u>") + "  and BOL Date. " + ((ObjSpaceAvail.BOLAWBDate == "" || ObjSpaceAvail.BOLAWBDate == null) ? "_______________________" : " <u> " + ObjSpaceAvail.BOLAWBDate + " </u> ") + " and AWB No. " + ((ObjSpaceAvail.AWBNo == "" || ObjSpaceAvail.AWBNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.AWBNo + "</u>") + " and AWB Date " + ((ObjSpaceAvail.AWBDate == "" || ObjSpaceAvail.AWBDate == null) ? "_______________________" : "<u>" + ObjSpaceAvail.AWBDate + "</u>") + " and BOE No. " + ((ObjSpaceAvail.BOENo == "" || ObjSpaceAvail.BOENo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.BOENo + "</u>") + " Date " + ((ObjSpaceAvail.BOENoDate == "" || ObjSpaceAvail.BOENoDate == null) ? "_______________________" : "<u>" + ObjSpaceAvail.BOENoDate + "</u>") + " (if available)."+"InvoiceNo"+ ((ObjSpaceAvail.InvoiceNo == "" || ObjSpaceAvail.InvoiceNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.InvoiceNo + "</u>)+Invoice Date"+((ObjSpaceAvail.InvoiceDate == "" || ObjSpaceAvail.InvoiceDate == null) ? "_______________________" : " < u > " + ObjSpaceAvail.InvoiceDate)+"(/u)")+"Clause"+ ((ObjSpaceAvail.Clause == "" || ObjSpaceAvail.Clause == null) ? "_______________________" : " < u > " + ObjSpaceAvail.Clause  + "(/u)") +"</td></tr>");
            // html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:13px;'>(i)</td><td colspan='2' width='85%' style='font-size:14px; line-height:22px;'>No objection to receive the stock belonging to Mr./ Mrs./ Ms./ Miss " + ((ObjSpaceAvail.Importer == "" || ObjSpaceAvail.Importer == null) ? "_______________________" : "<u>" + ObjSpaceAvail.Importer + "</u>") + " (importer) and covered under BOL No. " + ((ObjSpaceAvail.BOLAWBNo == "" || ObjSpaceAvail.BOLAWBNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.BOLAWBNo + "</u>") + "  and BOL Date. " + ((ObjSpaceAvail.BOLAWBDate == "" || ObjSpaceAvail.BOLAWBDate == null) ? "_______________________" : " <u> " + ObjSpaceAvail.BOLAWBDate + " </u> ") + " and AWB No. " + ((ObjSpaceAvail.AWBNo == "" || ObjSpaceAvail.AWBNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.AWBNo + "</u>") + " and AWB Date " + ((ObjSpaceAvail.AWBDate == "" || ObjSpaceAvail.AWBDate == null) ? "_______________________" : "<u>" + ObjSpaceAvail.AWBDate + "</u>") + " Invoice No. " + ((ObjSpaceAvail.InvoiceNo == "" || ObjSpaceAvail.InvoiceNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.InvoiceNo + "</u>") and BOE No. " + ((ObjSpaceAvail.BOENo == "" || ObjSpaceAvail.BOENo == null) ? "_______________________" : " < u > " + ObjSpaceAvail.BOENo + " </ u > ") + " Date " + ((ObjSpaceAvail.BOENoDate == "" || ObjSpaceAvail.BOENoDate == null) ? "_______________________" : " < u > " + ObjSpaceAvail.BOENoDate)+ " </u> "+ "(if available).+</td></tr>");
            html.Append("<tr><td width='10%' valign='top' align='right' style='font-size:8pt;'>(i)</td><td colspan='10' width='95%' style='font-size:8pt;'>Demand for space noted for the stock belonging to Mr./ Mrs./ Ms./ Miss " + ((ObjSpaceAvail.Importer == "" || ObjSpaceAvail.Importer == null) ? "_______________________" : "<u>" + ObjSpaceAvail.Importer + "</u>") + " (Imported) under BOL No. " + ((ObjSpaceAvail.BOLAWBNo == "" || ObjSpaceAvail.BOLAWBNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.BOLAWBNo + "</u>") + "  and BOL Date. " + ((ObjSpaceAvail.BOLAWBDate == "" || ObjSpaceAvail.BOLAWBDate == null) ? "_______________________" : " <u> " + ObjSpaceAvail.BOLAWBDate + " </u> ") + " and AWB No. " + ((ObjSpaceAvail.AWBNo == "" || ObjSpaceAvail.AWBNo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.AWBNo + "</u>") + " and AWB Date " + ((ObjSpaceAvail.AWBDate == "" || ObjSpaceAvail.AWBDate == null) ? "_______________________" : "<u>" + ObjSpaceAvail.AWBDate + "</u>") + " and BOE No. " + ((ObjSpaceAvail.BOENo == "" || ObjSpaceAvail.BOENo == null) ? "_______________________" : "<u>" + ObjSpaceAvail.BOENo + "</u>") + " and BOE Date " + ((ObjSpaceAvail.BOENoDate == "" || ObjSpaceAvail.BOENoDate == null) ? "_______________________" : "<u>" + ObjSpaceAvail.BOENoDate + "</u>") + "(if available) and Invoice No " + ((ObjSpaceAvail.InvoiceNo == "" || ObjSpaceAvail.InvoiceNo == null) ? "_______________________" : " <u>" + ObjSpaceAvail.InvoiceNo + "</u>") + "and Invoice Date " + ((ObjSpaceAvail.InvoiceDate == "" || ObjSpaceAvail.InvoiceDate == null) ? "_______________________" : "<u>" + ObjSpaceAvail.InvoiceDate + "</u>")+"</td></tr>");
            html.Append("<tr><td><span><br/></span></td></tr>");
            html.Append("<tr><td width='10%' valign='top' align='right' style='font-size:8pt;'>(ii)</td><td colspan='10' width='95%' style='font-size:8pt; line-height:22px;'>Area Reserved <u>" + ObjSpaceAvail.AreaReserved + "</u> sq.mtr. (Gross / Net)</td></tr>");
            html.Append("<tr><td><span><br/></span></td></tr>");
            html.Append("<tr><td width='10%' valign='top' align='right' style='font-size:8pt;'>(iii)</td><td colspan='10' width='95%' style='font-size:8pt; line-height:22px; margin-bottom:15px;'>Valid upto <u>" + ObjSpaceAvail.ValidUpto + "</u></td></tr>");
            html.Append("<tr><td width='10%' valign='top' align='right' style='font-size:8pt;'>(iv)</td><td colspan='10' width='95%' style='font-size:8pt; line-height:22px; margin-bottom:15px;'>Clause <u>" + ObjSpaceAvail.Clause + "</u></td></tr>");
            ...
            html.Append("<tr><td style='font-size:8pt; text-align: right; font-weight:bold;'>Signature of Warehouse Manager / <br/>Authorised Person</td></tr></tbody></table></td></tr>");
            html.Append("</tbody></table>");
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailCertForReject(DndSpaceAvailCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
            string Path = Server.MapPath("~/Docs/") + Session.SessionID + "/SpaceAvailCert" + SpaceappId + ".pdf";
            if (!Directory.Exists(Server.MapPath("~/Docs/") + Session.SessionID))
        ...
        {
            DndBondRepository obj = new DndBondRepository();
        ...
        public ActionResult CreateBondApp()
        {
            ...
            DndBondApp objBA = new DndBondApp();
        ...
        public ActionResult EditBondApp(int SpaceappId)
        {
            ...
            DndBondRepository objHdb = new DndBondRepository();
            DndBondApp objBA = new DndBondApp();
            //ViewData["cha"] = ((Login)Session["LoginUser"]).CHA;
            //if (Convert.ToBoolean(ViewData["cha"]) == false)
            //{
            ...
            if (objHdb.DBResponse.Data != null)
                objBA = (DndBondApp)objHdb.DBResponse.Data;
            return PartialView(objBA);
        }
        [HttpGet]
        public ActionResult ViewBondApp(int SpaceappId)
        {
            ...
            if (objBR.DBResponse.Data != null)
                objBA = (DndBondApp)objBR.DBResponse.Data;
            return PartialView(objBA);
        }
        [HttpGet]
        ...
        public JsonResult PrintBondApp(int SpaceappId)
        {
            ...
            if (objBR.DBResponse.Data != null)
            {
                DndSpaceAvailAppCertPdf ObjSpaceAvail = new DndSpaceAvailAppCertPdf();
                ObjSpaceAvail = (DndSpaceAvailAppCertPdf)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailAppCert(DndSpaceAvailAppCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
            ...
            html.Append("<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>");
            html.Append("<tr><td valign='top'><img align='right' src='IMGSRC' width='90'/></td>");
            html.Append("<td width='70%' valign='top' align='center'><h1 style='font-size: 22px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><label style='font-size: 12px;'>(A Govt. of India Undertaking)</label><br/><label style='font-size: 14px;'>Email - " + ObjSpaceAvail.EmailAddress + "</label><br/><label style='font-size: 14px; font-weight:bold;'>APPLICATION FOR AVAILABILITY OF SPACE</label></td>");
            html.Append("<td valign='top'><img align='right' src='ISO' width='100'/></td></tr>");
            html.Append("</tbody></table>");
            html.Append("</td></tr>");
            ...
            html.Append("<td style='font-size:12px; width:10%;'><u>" + ObjSpaceAvail.SysDt + "</u></td></tr></tbody></table></td></tr><tr><td colspan='3' style='font-size: 13px; line-height: 26px;font-weight: bold;'><span>The Warehouse Manager,</span><br/><h5 style='margin:0; line-height: normal;'>" + ObjSpaceAvail.CompanyAddress + "</h5></td></tr>");
            ...
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>2.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Clause</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.Clause + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>3.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>BOL No. & Date</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.BOLAWBNoDate + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>4.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>AWB No. & Date</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.AWBNoDate + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>5.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>In To Bond BOE No. & Date(Wherever available)</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.BOENoDate + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>5.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>In To Bond Invoice No. & Date</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.InvoiceNoDate + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>6.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Description of Cargo</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.CargeDescrip + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>7.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>No. of Units</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.Unit + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>8.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Nature of Packages (Metal, drum, fibre drum, wooden crate, bags, cartoons, etc.)</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.Packages + "," + ObjSpaceAvail.OthersValue + " </td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>9.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Dimensions per unit [UOM]</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.DUnit + " " + ObjSpaceAvail.DimensionUOM + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>10.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Weight [UOM]</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.Weight + " " + ObjSpaceAvail.WeightUOM + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>11.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Requirement of space in Sq. Mts. (gross or net to be specified)</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.AreaReserved + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>12.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Assessable / CIF Value</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.CIF + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>13.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Duty / Amount</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.Duty + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>14.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Nature of material (Non Hazardous, Hazardous, Chemical composition with flash point, if known)</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.NatureMaterial + "</td></tr>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>15.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Expected date of warehousing</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.ExpDateofWarehouse + "</td></tr></tbody>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>16.</td><td colspan='1' valign='top' width='50%' style='font-size:12px;'>Name of CHA</td><td>:</td><td colspan='2' valign='top' width='40%' style='font-size:12px;'>" + ObjSpaceAvail.CHAName + "</td></tr>");
            html.Append("</table></td></tr>");
            html.Append("<tr><td colspan='4'><p style='font-size: 12px;'><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> I / We agree to abide by the provisions of the Customs Act, 1962 with the amendments in force. The terms & Conditions for storage of Bonded goods are also acceptable to me / us.</p></td></tr>");
            ...
            html.Append("<tr><td colspan='4' style='text-align: center;'><h2 style='font-size: 14px; padding-bottom: 10px; text-align: center;margin: 0; padding: 0;'><u>FOR OFFICE USE</u></h2> </td></tr><tr><td colspan='4'>");
            html.Append("<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px; '><tbody>");
            html.Append("<tr><td width='3%' valign='top' align='right' style='font-size:12px;'>1.</td><td colspan='2' width='95%' style='font-size:12px;'>Date of receipt of Application : " + ObjSpaceAvail.SysDt + " </td></tr>");
            ...
            html.Append("<table cellspacing='0' cellpadding='5' style='width:100%;'><tbody><tr><td width='65%' colspan='7'></td><td style='font-size:12px; text-align: center; font-weight:bold;'>Sig. of Warehouse Manager / Authorised Person</td></tr></tbody></table></td></tr></tbody></table>");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditBondApp(DndBondApp objBA)
        {
        ...
        {
            DndSpaceAvailCertExtend ObjSpaceAvail = new DndSpaceAvailCertExtend();
            ObjSpaceAvail.ExtendOn = DateTime.Now.ToString("dd/MM/yyyy");
            DndBondRepository ObjBR = new DndBondRepository();
            ObjBR.GetSacNo();
            if (ObjBR.DBResponse.Data != null)
            {
                ViewBag.SacNoList = new SelectList((List<DndSpaceAvailableCert>)ObjBR.DBResponse.Data, "SpaceappId", "SacNo");
            }
            else
            {
        ...
        public ActionResult EditSpaceAvailCertExtend(int SpaceAvailCertExtId)
        {
            ...
            if (SpaceAvailCertExtId > 0)
            {
                ...
                if (ObjBR.DBResponse.Data != null)
                {
                    ObjSpaceAvail = (DndSpaceAvailCertExtend)ObjBR.DBResponse.Data;
                }
            }
        ...
        public ActionResult GetSpaceAvailCertExtendList()
        {
            ...
            List<DndSpaceAvailCertExtend> LstSpaceAvail = new List<DndSpaceAvailCertExtend>();
            if (ObjBR.DBResponse.Data != null)
            {
                LstSpaceAvail = (List<DndSpaceAvailCertExtend>)ObjBR.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditSpaceAvailCertExtend(DndSpaceAvailCertExtend ObjSpaceAvail)
        {
        ...
        {
            DndBondRepository objBR = new DndBondRepository();
            DndBondAppExtendDetails objBD = new DndBondAppExtendDetails();
            objBR.GetSpaceAvailabilityExt(SpaceAvailCertExtId);
            if (objBR.DBResponse.Data != null)
                objBD = (DndBondAppExtendDetails)objBR.DBResponse.Data;
        ...
        {
            DndBondRepository objBR = new DndBondRepository();
            DndSpaceAvailCertPdf objSAC = new DndSpaceAvailCertPdf();
            objBR.PrintSACExt(SpaceAvailCertExtId, Convert.ToInt32(Session["BranchId"]));
            if (objBR.DBResponse.Data != null)
            {
                objSAC = (DndSpaceAvailCertPdf)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GenerateExtSAC(DndSpaceAvailCertPdf objSAC, int SpaceAvailCertExtId)
        {
            string Html = "";
        ...
        {
            DndDepositApp ObjDepositApp = new DndDepositApp();
            ...
            if (ObjHDB.DBResponse.Data != null)
            {
                // ViewBag.SacNoList = new SelectList((List<DndDepositApp>)ObjHDB.DBResponse.Data, "SpaceappId", "SacNo","EntryId");
                //ViewBag.SacNoList =(List<DndDepositApp>)ObjHDB.DBResponse.Data;
        ...
        {
            DndBondRepository ObjCR = new DndBondRepository();
        ...
        public ActionResult ViewDepositApp(int DepositAppId)
        {
            ...
            if (DepositAppId > 0)
            {
                ...
                if (ObjHDB.DBResponse.Data != null)
                {
                    ObjDepositApp = (DndDepositApp)ObjHDB.DBResponse.Data;
                    ObjBR.ListOfImporter();
                    if (ObjBR.DBResponse.Data != null)
                        ViewBag.ListOfImporter = ObjBR.DBResponse.Data;
                    else ViewBag.ListOfImporter = null;
        ...
        [HttpGet]
        public ActionResult GetSacNoDepositDetails(int SpaceappId)
        {
            DndBondRepository ObjBR = new DndBondRepository();
            ObjBR.GetSacNodepositDet(SpaceappId);
            return Json(ObjBR.DBResponse, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult GetDepositAppList()
        {
            ...
            List<DndDepositApp> LstDepositApp = new List<DndDepositApp>();
            if (ObjHDB.DBResponse.Data != null)
            {
                LstDepositApp = (List<DndDepositApp>)ObjHDB.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditDepositApp(DndDepositApp ObjDepositApp)
        {
            ModelState.Remove("SacNo");
            if (ModelState.IsValid)
            {
        ...
        public JsonResult PrintDepositeApp(int DepositAppId)
        {
            if (DepositAppId > 0)
            {
                BondRepository objBR = new BondRepository();
                DndBondRepository ObjHdb = new DndBondRepository();
                DndPrintDA objDA = new DndPrintDA();
                ObjHdb.PrintDA(DepositAppId);
                if (ObjHdb.DBResponse.Data != null)
                {
                    objDA = (DndPrintDA)ObjHdb.DBResponse.Data;
        ...
        [HttpPost]
        public JsonResult DeleteBondDeposit(int DepositAppId)
        {
            if (DepositAppId > 0)
            {
                DndBondRepository ObjER = new DndBondRepository();
                ObjER.DeleteBondDeposit(DepositAppId);
        ...
        {
            DndBondRepository objBR = new DndBondRepository();
            DndBondWODeli objBond = new DndBondWODeli();
            objBR.ListOfWODeliDetails(BondWOId);
            if (objBR.DBResponse.Data != null)
                objBond = (DndBondWODeli)objBR.DBResponse.Data;
        ...
        {
            DndBondRepository objBR = new DndBondRepository();
            List<ListOfDndBondWODeli> objList = new List<ListOfDndBondWODeli>();
            objBR.ListOfWODeli(WoType);
            if (objBR.DBResponse.Data != null)
                objList = (List<ListOfDndBondWODeli>)objBR.DBResponse.Data;
        ...
        {
            DndBondRepository objBR = new DndBondRepository();
            DndBondWOUnloading objBond = new DndBondWOUnloading();
            ...
            if (objBR.DBResponse.Data != null)
            {
                ...
                objBond = JsonConvert.DeserializeObject<DndBondWOUnloading>(JsonConvert.SerializeObject(jobject["objBond"]));
            }
            return PartialView(objBond);
        }
        [HttpGet]
        public ActionResult ViewWOUnloading(int UnloadingId)
        {
            ...
            if (objBR.DBResponse.Data != null)
                objBond = (DndBondWOUnloading)objBR.DBResponse.Data;
            return PartialView(objBond);
        }
        [HttpGet]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditWOUnloading(DndBondWOUnloading obj)
        {
            if (ModelState.IsValid)
            {
                DndBondRepository objBR = new DndBondRepository();
        ...
        public JsonResult PrintWOUnloading(int UnloadingId)
        {
            ...
            if (objBR.DBResponse.Data != null)
            {
                DndBondWOUnloadingPDF ObjUnload = new DndBondWOUnloadingPDF();
                ObjUnload = (DndBondWOUnloadingPDF)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForWOUnloading(DndBondWOUnloadingPDF ObjUnload, int UnloadingId)
        {
            string Html = "";
        ...
        public ActionResult CreateBondAdvPaymentSheet(string type = "Tax")
        {
            ...
            DndBondRepository objBond = new DndBondRepository();
            ...
            int PartyId, string PartyName, string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId, string PayeeName)
        {
            ...
            DndBondRepository objBond = new DndBondRepository();
            objBond.GetBondAdvancePaymentSheet(InvoiceDate, StuffingReqId, DeliveryType, StuffingReqNo, UptoDate, PartyId, PartyName, PartyAddress, PartyState,
                    PartyStateCode, PartyGST, PayeeId, PayeeName, InvoiceType, Area);

            var objBondPostPaymentSheet = new Dnd_PostPaymentSheet();
            var Output = (Dnd_PostPaymentSheet)objBond.DBResponse.Data;
        ...
        public JsonResult AddEditBondAdvPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<Dnd_LoadedContainerPayment>(objForm["PaymentSheetModelJson"].ToString());
                string ContainerXML = "";
                string ChargesXML = "";
                ...
                DndBondRepository objChargeMaster = new DndBondRepository();
        ...
        public ActionResult ListOfInvoiceBondAdvance(string InvoiceNo = null, string InvoiceDate = null)
        {
            DndBondRepository objER = new DndBondRepository();
            objER.ListOfBondInvoice("BNDAdv", InvoiceNo, InvoiceDate);
            List<DndListOfBondInvoice> obj = new List<DndListOfBondInvoice>();
            if (objER.DBResponse.Data != null)
                obj = (List<DndListOfBondInvoice>)objER.DBResponse.Data;
            return PartialView("ListOfInvoiceBondAdv", obj);
        }
        ...
        {
            DndBondRepository ObjBR = new DndBondRepository();
            DndDeliveryOrder ObjDeliveryOrder = new DndDeliveryOrder();
            ObjBR.GetDeliveryOrder(DeliveryOrderId);
            if (ObjBR.DBResponse.Data != null)
            {
                ObjDeliveryOrder = (DndDeliveryOrder)ObjBR.DBResponse.Data;
                //var jobj = JsonConvert.SerializeObject(ObjBR.DBResponse.Data);
                //var jobject = Newtonsoft.Json.Linq.JObject.Parse(jobj);
                //ViewBag.Godown = jobject["lstGodown"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditDeliveryOrder(DndDeliveryOrder ObjDeliveryOrder)
        {
            if (ModelState.IsValid)
            {
                DndBondRepository ObjBR = new DndBondRepository();
                ...
                {
                    ObjDeliveryOrder.LstDeliveryOrderhdb = Newtonsoft.Json.JsonConvert.DeserializeObject<List<DndDeliveryOrderDtl>>(ObjDeliveryOrder.DeliveryOrderXml);
        ...
        public JsonResult PrintDeliveryApp(int DeliveryAppId)
        {
            if (DeliveryAppId > 0)
            {
                //  BondRepository objBR = new BondRepository();
                DndBondRepository ObjHdb = new DndBondRepository();
                DndDeliveryOrder objDA = new DndDeliveryOrder();
                ObjHdb.PrintDelivery(DeliveryAppId);
                if (ObjHdb.DBResponse.Data != null)
                {
                    objDA = (DndDeliveryOrder)ObjHdb.DBResponse.Data;
                    ...
                    html += "<tr><td colspan='12'><table style='width:100%;font-size:7pt;font-family:Verdana,Arial,San-serif;border-collapse:collapse;'><thead><tr> <th style='font-weight:600;text-align:center;border:1px solid #000;border-bottom:1px solid #000;padding:3px;width:8%;'>Importer's Name</th> <th style='font-weight:600;text-align:center;border:1px solid #000;border-bottom:1px solid #000;padding:3px;width:8%;'>CHA</th> <th style='font-weight:600;text-align:center;border:1px solid #000;border-bottom:1px solid #000;padding:3px;width:8%;'>Description of Cargo</th>";
                    html += "<th style='font-weight:600;text-align:center;border:1px solid #000;border-bottom:1px solid #000;padding:3px;width:8%;'>No. of Units</th> <th style='font-weight:600;text-align:center;border:1px solid #000;border-bottom:1px solid #000;padding:3px;width:8%;'>Weight<br/>(Qtls/MT)(applicable)</th><th style='font-weight:600;text-align:center;border:1px solid #000;border-bottom:1px solid #000;padding:3px;width:8%;'>SAC No. & Date</th><th style='font-weight:600;text-align:center;border:1px solid #000;border-bottom:1px solid #000;padding:3px;width:12%;'>Remarks</th></tr></thead><tbody>";
                    String sdt = "";
                    String ddt = "";
                    String Dno = "";
                    Decimal sreq = 0;
                    ...
                    html += "<tr> <td colspan='12'> <table style=' border: 1px solid #000; border-bottom: 0; width:100%;' cellspacing='0' cellpadding='5'> <thead><tr><th rowspan='2' style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center; width:8%;'>Description of Cargo</th><th rowspan='2' style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center; width:8%;'>Godown/Stack No.</th><th colspan='2' style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center; width:8%;'>Delivered / Released</th><th colspan='2' style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center; width:8%;'>Balance</th><th rowspan='2' style='border-bottom: 1px solid #000; font-size: 7pt; text-align: center; width:12%;'>Remarks</th></tr>";
                    html += "<tr><th style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center;'>No. of Units <br/>(Net/Gross)</th><th style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center;'>Area <br/>(Net/Gross) </th><th style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center;'>No. of <br/> Units </th><th style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center;'>Area <br/>(Net/Gross) </th></tr></thead> <tbody> <tr>";
                    ...
                    html += "<td style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center;'>" + CUnt + "</td><td style='border-right: 1px solid #000; border-bottom: 1px solid #000; font-size: 7pt; text-align: center;'>" + CWg + "</td><td style='border-bottom: 1px solid #000; font-size: 7pt; text-align: center;'>" + rem + "</td></tr></tbody> </table> </td></tr><tr><td><span><br/><br/>";
            ...
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName, int InvoiceId = 0)
        {
            ...
            DndBondRepository objBond = new DndBondRepository();
            objBond.GetBondDelPaymentSheet(InvoiceDate, InvoiceType, StuffingReqId, DeliveryType, StuffingReqNo, StuffingReqDate, UptoDate, Area,
             PartyId, PartyName, PartyAddress, PartyState, PartyStateCode, PartyGST, PayeeId, PayeeName, weight, CIFValue, Duty,
             Units, IsInsured, DepositDate, BOENo, BOEDate, ImporterExporter, CHAName, InvoiceId);


            var objBondPostPaymentSheet = (DndBondPostPaymentSheet)objBond.DBResponse.Data;
        ...
        public JsonResult AddEditBondDelPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<DndBondPostPaymentSheet>(objForm["PaymentSheetModelJson"].ToString());
                string ChargesXML = "";
        ...
        {
            DndBondRepository objER = new DndBondRepository();
            objER.ListOfBondInvoice("BND", InvoiceNo, InvoiceDate);
            List<DndListOfBondInvoice> obj = new List<DndListOfBondInvoice>();
            if (objER.DBResponse.Data != null)
                obj = (List<DndListOfBondInvoice>)objER.DBResponse.Data;
            return PartialView("ListOfBondDel", obj);
        }
        ...
        public JsonResult GetBondUnloadPaymentSheet(string InvoiceDate, string InvoiceType, int StuffingReqId, int DeliveryType, string StuffingReqNo, string StuffingReqDate, string UptoDate, decimal Area,
            int PartyId, string PartyName, string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId, string PayeeName, decimal weight, decimal CIFValue, decimal Duty,
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, int UnloadingId, int CasualLabour, int InvoiceId = 0)
        {
            DndBondRepository objBond = new DndBondRepository();
            objBond.GetBondUnloadingPaymentSheet(InvoiceDate, StuffingReqId, DeliveryType, StuffingReqNo, UptoDate, PartyId, PartyName, PartyAddress, PartyState,
                    PartyStateCode, PartyGST, PayeeId, PayeeName, CasualLabour, InvoiceType, Area, UnloadingId, InvoiceId);

            var objBondPostPaymentSheet = new Hdb_PostPaymentSheet();
            var Output = (Hdb_PostPaymentSheet)objBond.DBResponse.Data;
        ...
        public JsonResult AddEditBondUnloadPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                DndBondRepository objChargeMaster = new DndBondRepository();
                objChargeMaster.AddEditInvoice(invoiceData, ContainerXML, ChargesXML, ContWiseCharg, CfsWiseCharg, BranchId, ((Login)(Session["LoginUser"])).Uid, "BND");
        ...
        {
            DndBondRepository objExport = new DndBondRepository();
        ...
        [HttpGet]
        public JsonResult GetPayerName(string PartyCode, int Page)
        {
            DndBondRepository objExport = new DndBondRepository();
            objExport.GetPaymentPayerForPage("", Page);
            if (objExport.DBResponse.Data != null)
            {
                return Json(objExport.DBResponse, JsonRequestBehavior.AllowGet);
            }
        ...
        [HttpGet]
        public JsonResult GetPartyName(string PartyCode, int Page)
        {
            DndBondRepository objExport = new DndBondRepository();
            objExport.GetPaymentPartyForPage("", Page);
            if (objExport.DBResponse.Data != null)
            {
                return Json(objExport.DBResponse, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetSACList()
        {
            ...
            if (objBond.DBResponse.Data != null)
            {
                var BondList = (IList<BondSacDetails>)objBond.DBResponse.Data;
                TempData["SACList"] = BondList;
                return Json(objBond.DBResponse.Data, JsonRequestBehavior.AllowGet);
            }
            return Json("", JsonRequestBehavior.AllowGet);
        }
        [HttpGet]
        public JsonResult FName()
        {
            DndBondRepository objExport = new DndBondRepository();
            objExport.GetPaymentPartyForPage("", 0);
            if (objExport.DBResponse.Data != null)
