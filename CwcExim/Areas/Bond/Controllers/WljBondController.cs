...
{
    public class WljBondController : Controller
    {
        ...
        {
            WljBondRepository objBR = new WljBondRepository();
        ...
        public JsonResult AddEditBondApp(WljBondApp objBA)
        {
        ...
        public ActionResult EditBondApp(int SpaceappId)
        {
            ...
            WljBondRepository objHdb = new WljBondRepository();
            WljBondApp objBA = new WljBondApp();
            ViewData["cha"] = ((Login)Session["LoginUser"]).CHA;
            if (Convert.ToBoolean(ViewData["cha"]) == false)
            {
            ...
            if (objHdb.DBResponse.Data != null)
                objBA = (WljBondApp)objHdb.DBResponse.Data;
            return PartialView(objBA);
        }
        [HttpGet]
        public ActionResult ViewBondApp(int SpaceappId)
        {
            ...
            if (objBR.DBResponse.Data != null)
                objBA = (WljBondApp)objBR.DBResponse.Data;
            return PartialView(objBA);
        }
        [HttpGet]
        public ActionResult ListOfBondApp()
        {
            ...
            if (objBR.DBResponse.Data != null)
                lstApp = (List<WljListOfBondApp>)objBR.DBResponse.Data;
        ...
        public JsonResult PrintBondApp(int SpaceappId)
        {
            ...
            if (objBR.DBResponse.Data != null)
            {
                WljSpaceAvailAppCertPdf ObjSpaceAvail = new WljSpaceAvailAppCertPdf();
                ObjSpaceAvail = (WljSpaceAvailAppCertPdf)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailAppCert(WljSpaceAvailAppCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
        ...
        public ActionResult LoadSpaceAvailCert(int SpaceappId, int Status)
        {
            ...
            if (ObjBR.DBResponse.Data != null)
            {
                ObjSpaceAvail = (WljSpaceAvailableCert)ObjBR.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditSpaceAvailCert(WljSpaceAvailableCert ObjSpaceAvail)
        {
        ...
        public ActionResult PrintSpaceAvailCertApprove(int SpaceappId)
        {
            ...
            if (ObjBR.DBResponse.Data != null)
            {
                ...
                ObjSpaceAvail = (WljSpaceAvailCertPdf)ObjBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailCertForApprove(WljSpaceAvailCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailCertForReject(WljSpaceAvailCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
            string Path = Server.MapPath("~/Docs/") + Session.SessionID + "/SpaceAvailCert" + SpaceappId + ".pdf";
            if (!Directory.Exists(Server.MapPath("~/Docs/") + Session.SessionID))
        ...
        {
            WljBondRepository obj = new WljBondRepository();
        ...
        public ActionResult CreateBondAdvPaymentSheet(string type = "Tax")
        {
            ...
            WljBondRepository objBond = new WljBondRepository();
          ...
          )
        {
            ...
            objBond.GetBondAdvancePaymentSheet(InvoiceDate, StuffingReqId, DeliveryType,SEZ, StuffingReqNo, UptoDate, PartyId, PartyName, PartyAddress, PartyState,
                    PartyStateCode, PartyGST, PayeeId, PayeeName, CasualLabour, InvoiceType, Area, 0, NoOfPrinting);

            var objBondPostPaymentSheet = new WljPostPaymentSheet();
            var Output = (WljPostPaymentSheet)objBond.DBResponse.Data;
        ...
        public JsonResult AddEditBondAdvPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<WljPostPaymentSheet>(objForm["PaymentSheetModelJson"].ToString());
                string ContainerXML = "";
                string ChargesXML = "";
                ...
                WljBondRepository objChargeMaster = new WljBondRepository();
        ...
        {
            WljBondRepository objER = new WljBondRepository();
            objER.ListOfBondInvoice("BNDAdv", InvoiceNo, InvoiceDate);
            List<WljListOfBondInvoice> obj = new List<WljListOfBondInvoice>();
            if (objER.DBResponse.Data != null)
                obj = (List<WljListOfBondInvoice>)objER.DBResponse.Data;
        ...
        public ActionResult CreateDepositApp()
        {
            ...
            WljBondRepository ObjWlB = new WljBondRepository();
            ObjWlB.GetSacNoForDepositApp();
            if (ObjWlB.DBResponse.Data != null)
            {
                // ViewBag.SacNoList = new SelectList((List<WljDepositApp>)ObjHDB.DBResponse.Data, "SpaceappId", "SacNo","EntryId");
                //ViewBag.SacNoList =(List<WljDepositApp>)ObjHDB.DBResponse.Data;
        ...
        {
            WljBondRepository ObjCR = new WljBondRepository();
        ...
        public ActionResult ViewDepositApp(int DepositAppId)
        {
            ...
            if (DepositAppId > 0)
            {
                ...
                if (ObjWlB.DBResponse.Data != null)
                {
                    ObjDepositApp = (WljDepositApp)ObjWlB.DBResponse.Data; 
                }
            }
        ...
        public ActionResult GetDepositAppList()
        {
            ...
            if (ObjWlB.DBResponse.Data != null)
            {
                LstDepositApp = (List<WljDepositApp>)ObjWlB.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditDepositApp(WljDepositApp ObjDepositApp)
        {
            if (ModelState.IsValid)
            {
        ...
        public JsonResult PrintDepositeApp(int DepositAppId)
        {
            ...
            {
                WljBondRepository ObjWlb = new WljBondRepository();
                WljPrintDA objDA = new WljPrintDA();
                ObjWlb.PrintDA(DepositAppId);
                if (ObjWlb.DBResponse.Data != null)
                {
                    objDA = (WljPrintDA)ObjWlb.DBResponse.Data;
        ...
        public ActionResult EditWOUnloading(int UnloadingId)
        {
            ...
            if (objBR.DBResponse.Data != null)
            {
                ...
                objBond = JsonConvert.DeserializeObject<WljBondWOUnloading>(JsonConvert.SerializeObject(jobject["objBond"]));
            }
        ...
        public ActionResult ViewWOUnloading(int UnloadingId)
        {
            ...
            if (objBR.DBResponse.Data != null)
                objBond = (WljBondWOUnloading)objBR.DBResponse.Data;
            return PartialView(objBond);
        }
        [HttpGet]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditWOUnloading(WljBondWOUnloading obj)
        {
            if (ModelState.IsValid)
            {
                WljBondRepository objBR = new WljBondRepository();
        ...
        public JsonResult PrintWOUnloading(int UnloadingId)
        {
            ...
            if (objBR.DBResponse.Data != null)
            {
                WljBondWOUnloadingPDF ObjUnload = new WljBondWOUnloadingPDF();
                ObjUnload = (WljBondWOUnloadingPDF)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForWOUnloading(WljBondWOUnloadingPDF ObjUnload, int UnloadingId)
        {
            string Html = "";
        ...
        public ActionResult EditDeliveryOrder(int DeliveryOrderId)
        {
            ...
            if (ObjBR.DBResponse.Data != null)
            {
                ObjDeliveryOrder = (WljDeliveryOrder)ObjBR.DBResponse.Data;
                //var jobj = JsonConvert.SerializeObject(ObjBR.DBResponse.Data);
                //var jobject = Newtonsoft.Json.Linq.JObject.Parse(jobj);
                //ViewBag.Godown = jobject["lstGodown"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditDeliveryOrder(WljDeliveryOrder ObjDeliveryOrder)
        {
            if (ModelState.IsValid)
            {
                WljBondRepository ObjBR = new WljBondRepository();
                ...
                {
                    ObjDeliveryOrder.LstDeliveryOrderhdb = Newtonsoft.Json.JsonConvert.DeserializeObject<List<WljDeliveryOrderDtl>>(ObjDeliveryOrder.DeliveryOrderXml);
        ...
        public JsonResult PrintDeliveryApp(int DeliveryAppId)
        {
            if (DeliveryAppId > 0)
            {
                //  BondRepository objBR = new BondRepository();
                WljBondRepository ObjHdb = new WljBondRepository();
                WljDeliveryOrder objDA = new WljDeliveryOrder();
                ObjHdb.PrintDelivery(DeliveryAppId);
                if (ObjHdb.DBResponse.Data != null)
                {
                    objDA = (WljDeliveryOrder)ObjHdb.DBResponse.Data;
        ...
        public ActionResult CreateSpaceAvailCertExtend()
        {
            ...
            if (ObjBR.DBResponse.Data != null)
            {
                ViewBag.SacNoList = new SelectList((List<WljSpaceAvailableCert>)ObjBR.DBResponse.Data, "SpaceappId", "SacNo");
            }
            else
            {
                ViewBag.SacNoList = null;
        ...
        public ActionResult EditSpaceAvailCertExtend(int SpaceAvailCertExtId)
        {
            ...
            if (SpaceAvailCertExtId > 0)
            {
                ...
                if (ObjBR.DBResponse.Data != null)
                {
                    ObjSpaceAvail = (WljSpaceAvailCertExtend)ObjBR.DBResponse.Data;
                }
            }
        ...
        public ActionResult GetSpaceAvailCertExtendList()
        {
            ...
            if (ObjBR.DBResponse.Data != null)
            {
                LstSpaceAvail = (List<WljSpaceAvailCertExtend>)ObjBR.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditSpaceAvailCertExtend(WljSpaceAvailCertExtend ObjSpaceAvail)
        {
        ...
        {
            WljBondRepository objBR = new WljBondRepository();
            WljBondAppExtendDetails objBD = new WljBondAppExtendDetails();
            objBR.GetSpaceAvailabilityExt(SpaceAvailCertExtId);
            if (objBR.DBResponse.Data != null)
                objBD = (WljBondAppExtendDetails)objBR.DBResponse.Data;
        ...
        {
            WljBondRepository objBR = new WljBondRepository();
            WljSpaceAvailCertPdf objSAC = new WljSpaceAvailCertPdf();
            objBR.PrintSACExt(SpaceAvailCertExtId, Convert.ToInt32(Session["BranchId"]));
            if (objBR.DBResponse.Data != null)
            {
                objSAC = (WljSpaceAvailCertPdf)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GenerateExtSAC(WljSpaceAvailCertPdf objSAC, int SpaceAvailCertExtId)
        {
            string Html = "";
        ...
        public ActionResult CreateBondAdvPaymentSheetInterim(string type = "Tax")
        {
            ...
            if (objBond.DBResponse.Status > 0)
                ...
                ViewBag.SACList = null;
            WljBondRepository objWBond = new WljBondRepository();
        ...
        public ActionResult BondDeliPaymentSheet(string type = "Tax")
        {
            ...
            if (objBond.DBResponse.Status > 0)
            {
                var BondList = (IList<WljBondSacDetails>)objBond.DBResponse.Data;
                TempData["SACList"] = BondList;

                IList<WljBondSacDetails> DistinctSacList = new List<WljBondSacDetails>();
            ...
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName, int InvoiceId = 0)
        {
            ...
            var objBondPostPaymentSheet = (WljBondPostPaymentSheet)objBond.DBResponse.Data;
            var objBondList = ((IList<WljBondSacDetails>)TempData.Peek("SACList")).Where(o => o.DepositAppId == StuffingReqId).ToList();
        ...
        public JsonResult AddEditBondDelPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<WljBondPostPaymentSheet>(objForm["PaymentSheetModelJson"].ToString());
                string ChargesXML = "";
