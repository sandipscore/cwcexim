...
{
    public class HdbBondController : BaseController
    {
        ...
        {
            HdbBondRepository ObjBR = new HdbBondRepository();
        ...
        {
            HdbBondRepository ObjBR = new HdbBondRepository();
            HdbSpaceAvailableCert ObjSpaceAvail = new HdbSpaceAvailableCert();
            ObjBR.GetSpaceAvailCertById(SpaceappId,Status);
            if (ObjBR.DBResponse.Data != null)
            {
                ObjSpaceAvail = (HdbSpaceAvailableCert)ObjBR.DBResponse.Data;
            }
        ...
        public ActionResult AddEditSpaceAvailCert(HdbSpaceAvailableCert ObjSpaceAvail)
        {
        ...
        public ActionResult PrintSpaceAvailCertApprove(int SpaceappId)
        {
            ...
            if (ObjBR.DBResponse.Data != null)
            {
                HdbSpaceAvailCertPdf ObjSpaceAvail = new HdbSpaceAvailCertPdf();
                ObjSpaceAvail = (HdbSpaceAvailCertPdf)ObjBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailCertForApprove(HdbSpaceAvailCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "",Htmlnew;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailCertForReject(HdbSpaceAvailCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
            string Path = Server.MapPath("~/Docs/") + Session.SessionID + "/SpaceAvailCert" + SpaceappId + ".pdf";
            if (!Directory.Exists(Server.MapPath("~/Docs/") + Session.SessionID))
        ...
        {
            HdbBondRepository obj = new HdbBondRepository();
        ...
        {
            HdbBondRepository objBR = new HdbBondRepository();
            HdbBondApp objBA = new HdbBondApp();
        ...
        public ActionResult EditBondApp(int SpaceappId)
        {
           // BondRepository objBR = new BondRepository();
            HdbBondRepository objHdb= new HdbBondRepository();
            HdbBondApp objBA = new HdbBondApp();
            ViewData["cha"] = ((Login)Session["LoginUser"]).CHA;
            if (Convert.ToBoolean(ViewData["cha"]) == false)
            {
            ...
            if (objHdb.DBResponse.Data != null)
                objBA = (HdbBondApp)objHdb.DBResponse.Data;
            return PartialView(objBA);
        }
        [HttpGet]
        public ActionResult ViewBondApp(int SpaceappId)
        {
            ...
            if (objBR.DBResponse.Data != null)
                objBA = (HdbBondApp)objBR.DBResponse.Data;
            return PartialView(objBA);
        }
        [HttpGet]
        ...
        public JsonResult PrintBondApp(int SpaceappId)
        {
            ...
            if (objBR.DBResponse.Data != null)
            {
                HdbSpaceAvailAppCertPdf ObjSpaceAvail = new HdbSpaceAvailAppCertPdf();
                ObjSpaceAvail = (HdbSpaceAvailAppCertPdf)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForSpaceAvailAppCert(HdbSpaceAvailAppCertPdf ObjSpaceAvail, int SpaceappId)
        {
            string Html = "", Htmlnew;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditBondApp(HdbBondApp objBA)
        {
        ...
        {
            HdbSpaceAvailCertExtend ObjSpaceAvail = new HdbSpaceAvailCertExtend();
            ObjSpaceAvail.ExtendOn = DateTime.Now.ToString("dd/MM/yyyy");
            HdbBondRepository ObjBR = new HdbBondRepository();
            ObjBR.GetSacNo();
            if (ObjBR.DBResponse.Data != null)
            {
                ViewBag.SacNoList = new SelectList((List<HdbSpaceAvailableCert>)ObjBR.DBResponse.Data, "SpaceappId", "SacNo");
            }
            else
            {
        ...
        public ActionResult EditSpaceAvailCertExtend(int SpaceAvailCertExtId)
        {
            ...
            if (SpaceAvailCertExtId > 0)
            {
                ...
                if (ObjBR.DBResponse.Data != null)
                {
                    ObjSpaceAvail = (HdbSpaceAvailCertExtend)ObjBR.DBResponse.Data;
                }
            }
        ...
        public ActionResult GetSpaceAvailCertExtendList()
        {
            ...
            List<HdbSpaceAvailCertExtend> LstSpaceAvail = new List<HdbSpaceAvailCertExtend>();
            if (ObjBR.DBResponse.Data != null)
            {
                LstSpaceAvail = (List<HdbSpaceAvailCertExtend>)ObjBR.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditSpaceAvailCertExtend(HdbSpaceAvailCertExtend ObjSpaceAvail)
        {
        ...
        {
            HdbBondRepository objBR = new HdbBondRepository();
            HdbBondAppExtendDetails objBD = new HdbBondAppExtendDetails();
            objBR.GetSpaceAvailabilityExt(SpaceAvailCertExtId);
            if (objBR.DBResponse.Data != null)
                objBD = (HdbBondAppExtendDetails)objBR.DBResponse.Data;
        ...
        {
            HdbBondRepository objBR = new HdbBondRepository();
            HdbSpaceAvailCertPdf objSAC = new HdbSpaceAvailCertPdf();
            objBR.PrintSACExt(SpaceAvailCertExtId, Convert.ToInt32(Session["BranchId"]));
            if (objBR.DBResponse.Data != null)
            {
                objSAC = (HdbSpaceAvailCertPdf)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GenerateExtSAC(HdbSpaceAvailCertPdf objSAC, int SpaceAvailCertExtId)
        {
            string Html = "";
            ...
            html.Append("<tr><td colspan='4' style='text-align: center;'><h2 style='font-size: 16px; padding-bottom: 10px; text-align: center;margin: 0; padding: 0;'><u>SPACE AVAILABILITY CERTIFICATE(SAC)</u></h2> </td></tr>");
            html.Append("<tr><td><span><br/></span></td></tr>");  
            html.Append("<tr><td colspan='4'><table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>");
        ...
        {
            HdbDepositApp ObjDepositApp = new HdbDepositApp();
           ...
           // ObjDepositApp.CustomBondDate = DateTime.Now.ToString("dd/MM/yyyy");
            ...
            if (ObjHDB.DBResponse.Data != null)
            {
                // ViewBag.SacNoList = new SelectList((List<HdbDepositApp>)ObjHDB.DBResponse.Data, "SpaceappId", "SacNo","EntryId");
                //ViewBag.SacNoList =(List<HdbDepositApp>)ObjHDB.DBResponse.Data;
        ...
        [HttpGet]
        public ActionResult GetAllVehicle(string SacNo,int SacId)
        {
            HdbBondRepository ObjCR = new HdbBondRepository();
            ObjCR.GetAllVehicle(SacNo,SacId);
        ...
        public ActionResult ViewDepositApp(int DepositAppId)
        {
            ...
            if (DepositAppId > 0)
            {
                ...
                if (ObjHDB.DBResponse.Data != null)
                {
                    ObjDepositApp = (HdbDepositApp)ObjHDB.DBResponse.Data;
                    ObjBR.ListOfImporter();
                    if (ObjBR.DBResponse.Data != null)
                        ViewBag.ListOfImporter = ObjBR.DBResponse.Data;
                    else ViewBag.ListOfImporter = null;
        ...
        public ActionResult GetDepositAppList()
        {
            ...
            List<HdbDepositApp> LstDepositApp = new List<HdbDepositApp>();
            if (ObjHDB.DBResponse.Data != null)
            {
                LstDepositApp = (List<HdbDepositApp>)ObjHDB.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditDepositApp(HdbDepositApp ObjDepositApp)
        {
            if (ModelState.IsValid)
            {
        ...
        public JsonResult PrintDepositeApp(int DepositAppId)
        {
            if (DepositAppId > 0)
            {
                BondRepository objBR = new BondRepository();
                HdbBondRepository ObjHdb = new HdbBondRepository();
                HdbPrintDA objDA = new HdbPrintDA();
                ObjHdb.PrintDA(DepositAppId);
                if (ObjHdb.DBResponse.Data != null)
                {
                    objDA = (HdbPrintDA)ObjHdb.DBResponse.Data;
        ...
        {
            HdbBondRepository objBR = new HdbBondRepository();
            HdbBondWODeli objBond = new HdbBondWODeli();
            objBR.ListOfWODeliDetails(BondWOId);
            if (objBR.DBResponse.Data != null)
                objBond = (HdbBondWODeli)objBR.DBResponse.Data;
        ...
        {
            HdbBondRepository objBR = new HdbBondRepository();
            List<ListOfHdbBondWODeli> objList = new List<ListOfHdbBondWODeli>();
            objBR.ListOfWODeli(WoType);
            if (objBR.DBResponse.Data != null)
                objList = (List<ListOfHdbBondWODeli>)objBR.DBResponse.Data;
        ...
        {
            HdbBondRepository objBR = new HdbBondRepository();
            HdbBondWOUnloading objBond = new HdbBondWOUnloading();
            ...
            if (objBR.DBResponse.Data != null)
            {
                ...
                objBond = JsonConvert.DeserializeObject<HdbBondWOUnloading>(JsonConvert.SerializeObject(jobject["objBond"]));
            }
            return PartialView(objBond);
        }
        [HttpGet]
        public ActionResult ViewWOUnloading(int UnloadingId)
        {
            ...
            if (objBR.DBResponse.Data != null)
                objBond = (HdbBondWOUnloading)objBR.DBResponse.Data;
            return PartialView(objBond);
        }
        [HttpGet]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditWOUnloading(HdbBondWOUnloading obj)
        {
            if (ModelState.IsValid)
            {
                HdbBondRepository objBR = new HdbBondRepository();
        ...
        public JsonResult PrintWOUnloading(int UnloadingId)
        {
            ...
            if (objBR.DBResponse.Data != null)
             {
            HdbBondWOUnloadingPDF ObjUnload = new HdbBondWOUnloadingPDF();
            ObjUnload = (HdbBondWOUnloadingPDF)objBR.DBResponse.Data;
        ...
        [NonAction]
        public string GeneratePDFForWOUnloading(HdbBondWOUnloadingPDF ObjUnload, int UnloadingId)
        {
            string Html = "";
        ...
        public JsonResult GetBondAdvPaymentSheet(string InvoiceDate, string InvoiceType, int StuffingReqId, int DeliveryType, string StuffingReqNo, string StuffingReqDate, string UptoDate, decimal Area,
            int PartyId, string PartyName, string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId, string PayeeName,int CasualLabour=0,int NoOfPrinting=0,
            string ExportUnder="")
        {
            ...
            objBond.GetBondAdvancePaymentSheet(InvoiceDate, StuffingReqId, DeliveryType, StuffingReqNo, UptoDate, PartyId, PartyName, PartyAddress, PartyState,
                    PartyStateCode, PartyGST, PayeeId, PayeeName, CasualLabour, InvoiceType, Area,0, NoOfPrinting, ExportUnder);
        ...
        public JsonResult AddEditBondAdvPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                HdbBondRepository objChargeMaster = new HdbBondRepository();
        ...
        {
            HdbBondRepository ObjBR = new HdbBondRepository();
            HdbDeliveryOrder ObjDeliveryOrder = new HdbDeliveryOrder();
            ObjBR.GetDeliveryOrder(DeliveryOrderId);
            if (ObjBR.DBResponse.Data != null)
            {
                ObjDeliveryOrder = (HdbDeliveryOrder)ObjBR.DBResponse.Data;
                //var jobj = JsonConvert.SerializeObject(ObjBR.DBResponse.Data);
                //var jobject = Newtonsoft.Json.Linq.JObject.Parse(jobj);
                //ViewBag.Godown = jobject["lstGodown"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditDeliveryOrder(HdbDeliveryOrder ObjDeliveryOrder)
        {
            if (ModelState.IsValid)
            {
                HdbBondRepository ObjBR = new HdbBondRepository();
                ...
                {
                    ObjDeliveryOrder.LstDeliveryOrderhdb = Newtonsoft.Json.JsonConvert.DeserializeObject<List<HdbDeliveryOrderDtl>>(ObjDeliveryOrder.DeliveryOrderXml);
        ...
        public JsonResult PrintDeliveryApp(int DeliveryAppId)
        {
            if (DeliveryAppId > 0)
            {
              //  BondRepository objBR = new BondRepository();
                HdbBondRepository ObjHdb = new HdbBondRepository();
                HdbDeliveryOrder objDA = new HdbDeliveryOrder();
                ObjHdb.PrintDelivery(DeliveryAppId);
                if (ObjHdb.DBResponse.Data != null)
                {
                    objDA = (HdbDeliveryOrder)ObjHdb.DBResponse.Data;
        ...
        public JsonResult GetBondDelPaymentSheet(string InvoiceDate, string InvoiceType, int StuffingReqId, int DeliveryType, string StuffingReqNo, string StuffingReqDate, string UptoDate, decimal Area,
            ...
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName,string ExportUnder,  int InvoiceId=0)
        {
            ...
            objBond.GetBondDelPaymentSheet(InvoiceDate, InvoiceType,StuffingReqId,  DeliveryType,  StuffingReqNo,  StuffingReqDate,  UptoDate,  Area,
             ...
             Units,  IsInsured,  DepositDate,  BOENo,  BOEDate, ImporterExporter, CHAName, ExportUnder,  InvoiceId);

           
            var objBondPostPaymentSheet = (HdbBondPostPaymentSheet)objBond.DBResponse.Data;
        ...
        public JsonResult AddEditBondDelPaymentSheet(FormCollection objForm)
        {
            try
            {
                ...
                var invoiceData = JsonConvert.DeserializeObject<HdbBondPostPaymentSheet>(objForm["PaymentSheetModelJson"].ToString());
                string ChargesXML = "";
        ...
        #region CheckCreditLimitPeriod


        public JsonResult GetCheckCreditLimit(int PartyId,int PayeeId)
        {
            HdbBondRepository ObjBR = new HdbBondRepository();            
            ObjBR.GetCheckCreditPeriod(PartyId, PayeeId);
            return Json(ObjBR.DBResponse, JsonRequestBehavior.AllowGet);
        }
        #endregion

        #region Bond Sac Extend Payment Sheet

        [HttpGet]
        public ActionResult CreateBondSACExtendPaymentSheet(string type = "Tax")
        {
            ViewData["InvType"] = type;
            //HdbBondRepository objBond = new HdbBondRepository();
            //objBond.GetBondNoForSacExtendPaymentSheet();
            //if (objBond.DBResponse.Status > 0)
            //    ViewBag.SACList = JsonConvert.SerializeObject(objBond.DBResponse.Data);
            //else
            //    ViewBag.SACList = null;
        ...
        [HttpGet]
        public JsonResult GetBondSACExtendPaymentSheet(string InvoiceDate, string InvoiceType, int StuffingReqId, int DeliveryType, string StuffingReqNo, string StuffingReqDate, string UptoDate, decimal Area,
            int PartyId, string PartyName, string PartyAddress, string PartyState, string PartyStateCode, string PartyGST, int PayeeId, string PayeeName, int CasualLabour, int NoOfPrinting, decimal weight, decimal CIFValue, decimal Duty,
            int Units, int IsInsured, string DepositDate, string BOENo, string BOEDate, string ImporterExporter, string CHAName, string ExportUnder, string CalcType, int InvoiceId = 0)
        {

            HdbBondRepository objBond = new HdbBondRepository();
            objBond.GetBondSACExtendPaymentSheet(InvoiceDate, InvoiceType, StuffingReqId, DeliveryType, StuffingReqNo, StuffingReqDate, UptoDate, Area,
             PartyId, PartyName, PartyAddress, PartyState, PartyStateCode, PartyGST, PayeeId, PayeeName, CasualLabour, NoOfPrinting, weight, CIFValue, Duty,
             Units, IsInsured, DepositDate, BOENo, BOEDate, ImporterExporter, CHAName, ExportUnder, CalcType, InvoiceId);

            var objBondPostPaymentSheet = (HdbBondPostPaymentSheet)objBond.DBResponse.Data;
            var objBondList = ((IList<HdbBondSacDetails>)TempData.Peek("SACList")).Where(o => o.DepositAppId == StuffingReqId).ToList();
        ...
        [HttpGet]
        public JsonResult GetBondList()
        {
            HdbBondRepository objBond = new HdbBondRepository();
            objBond.GetBondNoForSacExtendPaymentSheet();
            if (objBond.DBResponse.Data != null)
            {
                var BondList = (IList<HdbBondSacDetails>)objBond.DBResponse.Data;
                TempData["SACList"] = BondList;
                return Json(objBond.DBResponse.Data, JsonRequestBehavior.AllowGet);
            }
            return Json("", JsonRequestBehavior.AllowGet);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditInvoiceBondExtend(FormCollection objForm)
        {
            try
            {
                int BranchId = Convert.ToInt32(Session["BranchId"]);
                ...
                HdbBondRepository objChargeMaster = new HdbBondRepository();
                objChargeMaster.AddEditInvoiceBondExtend(invoiceData, ChargesXML, BranchId, ((Login)(Session["LoginUser"])).Uid, "BNDExtend", Convert.ToDecimal(TempData.Peek("TotalValueofCargo")));
                //objChargeMaster.AddEditInvoice(invoiceData, "", ChargesXML, "", "", BranchId, ((Login)(Session["LoginUser"])).Uid, "BND");
