...
{
    public class HdbDeliveryOrder: DeliveryOrder
    {
        ...
        public List<HdbDeliveryOrderforPrint> LstDeliveryPrintOrder { get; set; } = new List<HdbDeliveryOrderforPrint>();
        public List<HdbDeliveryOrderDtl> LstDeliveryOrderhdb { get; set; } = new List<HdbDeliveryOrderDtl>();
        public List<HdbDeliveryOrderPaymentPrint> LstDeliveryOrderPayment { get; set; } = new List<HdbDeliveryOrderPaymentPrint>();

        public List<HdbDeliveryGSTCharge> LstGst { get; set; } = new List<HdbDeliveryGSTCharge>();

    }


    public class HdbDeliveryOrderforPrint
    {
    ...
    public class HdbDeliveryOrderDtl
    {
    ...
    public class HdbDeliveryOrderPaymentPrint
    {
        public string SacDate { get; set; }
    ...
    public class HdbWorkOrderDetails
    {
