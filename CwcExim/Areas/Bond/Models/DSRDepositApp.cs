...
namespace CwcExim.Areas.Bond.Models
{
    public class DSRDepositApp
    {
     ...
     //   [Range(0, 99999999.99, ErrorMessage = "Weight Cannot Be More Than 99999999.99")]
        ...
        public Int64 IsOnlyForReserved { get; set; }
    ...
    public class DSRPrintDA
    {
        ...
        public string BondBOEDate { get; set; }
        public string GodownName { get; set; }
        public List<DSRSACDet> lstSAC { get; set; } = new List<DSRSACDet>();
        public List<DSRGodDet> lstGodown { get; set; } = new List<DSRGodDet>();
        public string CompanyAddress { get; set; }
        public string EmailAddress { get; set; }
        public string Location { get; set; }
    }
    public class DSRSACDet
    {
        public string SacNo { get; set; }
        public string SacDate { get; set; }
