...
namespace CwcExim.Areas.Bond.Models
{
    public class WljDeliveryOrder
    {
        ...
        public List<WljDeliveryOrderforPrint> LstDeliveryPrintOrder { get; set; } = new List<WljDeliveryOrderforPrint>();
        public List<WljDeliveryOrderDtl> LstDeliveryOrderhdb { get; set; } = new List<WljDeliveryOrderDtl>();
        public List<WljDeliveryOrderPaymentPrint> LstDeliveryOrderPayment { get; set; } = new List<WljDeliveryOrderPaymentPrint>();

        public List<WljDeliveryGSTCharge> LstGst { get; set; } = new List<WljDeliveryGSTCharge>();

    }
        public class WljDeliveryOrderforPrint
        {
            public string Importer { get; set; }
        ...
        public class WljDeliveryOrderDtl
        {
        ...
        public class WljDeliveryOrderPaymentPrint
        {
            public string SacDate { get; set; }
        ...
        public class WljWorkOrderDetails
        {
