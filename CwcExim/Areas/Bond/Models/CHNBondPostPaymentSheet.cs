...
{
    public class CHNBondPostPaymentSheet
    {
        ...
        public IList<CHNBondPostPaymentCharge> lstPostPaymentChrg { get; set; } = new List<CHNBondPostPaymentCharge>();
        public IList<Chn_ADDCWCBondPostPaymentCharge> lstADDPostPaymentChrg { get; set; } = new List<Chn_ADDCWCBondPostPaymentCharge>();
        public int ParkingDays { get; set; } = 0;
        public bool SealCharge { get; set; }
        public decimal Discount { get; set; } = 0M;

    }

    public class CHNBondPostPaymentCharge
    {
        ...
        public int ADDCWC { get; set; } = 0;
    }
    public class Chn_ADDCWCBondPostPaymentCharge
    {
        public int ADDCWC { get; set; }= 0;
        public int ChargeId { get; set; } = 0;
        public string Clause { get; set; } = string.Empty;
