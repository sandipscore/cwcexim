...
{
    public class DSRDeliveryOrder : DeliveryOrder
    {
        ...
        public List<DSRGetGWDeliveryOrderDtl> lstGodownWiseDtl { get; set; } = new List<DSRGetGWDeliveryOrderDtl>();

        public List<DSRDeliveryOrderforPrint> LstDeliveryPrintOrder { get; set; } = new List<DSRDeliveryOrderforPrint>();
        public List<DSRDeliveryOrderDtl> LstDeliveryOrderhdb { get; set; } = new List<DSRDeliveryOrderDtl>();
        public List<DSRDeliveryOrderPaymentPrint> LstDeliveryOrderPayment { get; set; } = new List<DSRDeliveryOrderPaymentPrint>();

        public List<DSRDeliveryGSTCharge> LstGst { get; set; } = new List<DSRDeliveryGSTCharge>();

    }


    public class DSRDeliveryOrderforPrint
    {
    ...
    public class DSRDeliveryOrderDtl
    {
        ...
        public decimal DeliveryHandlingChrManual { get; set; }
        public decimal DeliveryHandlingChrMechanical { get; set; }
        ...
        public List<DSRGodownWiseDeliveryOrder> lstGodownWiseDtl { get; set; } = new List<DSRGodownWiseDeliveryOrder>();
    }


    public class DSRDeliveryOrderPaymentPrint
    {
        public string SacDate { get; set; }
    ...
    public class DSRWorkOrderDetails
    {
