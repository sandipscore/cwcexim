...
namespace CwcExim.Areas.Bond.Models
{
    public class HdbDepositApp
    {
        ...
        //    [Required(ErrorMessage = "Fill Out This Field")]
            ...
            [Range(0, 999999999.99, ErrorMessage = "Weight Cannot Be More Than 999999999.99")]
            public decimal Weight { get; set; }

            [Range(0, 999999999.99, ErrorMessage = "Value Cannot Be More Than 999999999.99")]
            public decimal Value { get; set; }

            [Range(0, 999999999.99, ErrorMessage = "Duty Cannot Be More Than 999999999.99")]
    ...
    public class VehicleForBondDeposit
    {
        public string VehicleNo { get; set; }
        public int EntryId { get; set; }
        public int SpaceappId { get; set; }
        ...
        public class HdbPrintDA
        {
            ...
            public string BondBOEDate { get; set; }
            public string GodownName { get; set; }
            public List<HdbSACDet> lstSAC { get; set; } = new List<HdbSACDet>();
        public List<HdbGodDet> lstGodown { get; set; } = new List<HdbGodDet>();
        public string CompanyAddress { get; set; }
        public string EmailAddress { get; set; }
        public string Location { get; set; }

    }
        public class HdbSACDet
        {
            public string SacNo { get; set; }
            public string SacDate { get; set; }
