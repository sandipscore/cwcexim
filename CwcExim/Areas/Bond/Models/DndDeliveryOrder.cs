...
{
    public class DndDeliveryOrder: DeliveryOrder
    {
        ...
        public string GodownName_print { get; set; }
        ...
        public List<DndDeliveryOrderforPrint> LstDeliveryPrintOrder { get; set; } = new List<DndDeliveryOrderforPrint>();
        public List<DndDeliveryOrderDtl> LstDeliveryOrderhdb { get; set; } = new List<DndDeliveryOrderDtl>();
        public List<DndDeliveryOrderPaymentPrint> LstDeliveryOrderPayment { get; set; } = new List<DndDeliveryOrderPaymentPrint>();

        public List<DndDeliveryGSTCharge> LstGst { get; set; } = new List<DndDeliveryGSTCharge>();

    }


    public class DndDeliveryOrderforPrint
    {
    ...
    public class DndDeliveryOrderDtl
    {
    ...
    public class DndDeliveryOrderPaymentPrint
    {
        public string SacDate { get; set; }
    ...
    public class DndWorkOrderDetails
    {
