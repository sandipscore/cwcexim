...
namespace CwcExim.Areas.Bond.Models
{
    ...
    public class CHNPrintDA
    {
        ...
        public string BondBOEDate { get; set; }
        public string GodownName { get; set; }
        public List<CHNSACDet> lstSAC { get; set; } = new List<CHNSACDet>();
        public List<CHNGodDet> lstGodown { get; set; } = new List<CHNGodDet>();

    }
    public class CHNSACDet
    {
        public string SacNo { get; set; }
        public string SacDate { get; set; }
