...
namespace CwcExim.Areas.Bond.Models
{
    public class DndDepositApp
    {
        ...
        [Range(0, 99999999.99, ErrorMessage = "Value Cannot Be More Than 99999999.99")]
        public decimal Value { get; set; }

        [Range(0, 99999999.99, ErrorMessage = "Duty Cannot Be More Than 99999999.99")]
    ...
    public class DndPrintDA
    {
        ...
        public string BondBOEDate { get; set; }
        public string GodownName { get; set; }
        public List<DndSACDet> lstSAC { get; set; } = new List<DndSACDet>();
        public List<DndGodDet> lstGodown { get; set; } = new List<DndGodDet>();
        public string CompanyAddress { get; set; }
        public string EmailAddress { get; set; }
        public string Location { get; set; }

    }
    public class DndSACDet
    {
        public string SacNo { get; set; }
        public string SacDate { get; set; }
