...
namespace CwcExim.Areas.Bond.Models
{
    public class WFLDDepositApp
    {
        ...
        [Range(0, 9999999999.99, ErrorMessage = "Value Cannot Be More Than 9999999999.99")]
        public decimal Value { get; set; }

        [Range(0, 9999999999.99, ErrorMessage = "Duty Cannot Be More Than 9999999999.99")]
        ...
        public decimal AppliedDuty { get; set; }
    ...
    public class WFLDPrintDA
    {
        ...
        public string BondBOEDate { get; set; }
        public string GodownName { get; set; }
        public List<WFLDSACDet> lstSAC { get; set; } = new List<WFLDSACDet>();
        public List<WFLDGodDet> lstGodown { get; set; } = new List<WFLDGodDet>();
        public string CompanyAddress { get; set; }
        public string EmailAddress { get; set; }
        public string Location { get; set; }

    }
    public class WFLDSACDet
    {
        public string SacNo { get; set; }
        public string SacDate { get; set; }
