...
{
    public class Loni_IcegateController : BaseController
    {
        ...
        private IList<IcegateManualI02> I02FileCreate(IList<IcegateManualI02> lstData, int FileCode)
        {
            try
            {
                ...
                tw.Write("ZZ");
                tw.Write(k1);
                tw.Write("INPPG6CWC1");//Receiver Id
                tw.Write(k1);
                tw.Write("ZZ");
                tw.Write(k1);
                tw.Write("INPPG6");//Sender Id
                tw.Write(k1);
