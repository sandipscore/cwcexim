...
{
    public class Wfld_GateOperationController : Controller
    {
        #region Entry Through Gate Wfld
        ...
        //    ACCR.GetMenuWiseAccessRight(Convert.ToInt32(Session["MenuId"]), ((Login)Session["LoginUser"]).Role.RoleId, Convert.ToInt32(Session["ModuleId"]), Convert.ToInt32(Session["BranchId"]));
         //   ViewBag.RightsList = JsonConvert.SerializeObject(ACCR.DBResponse.Data);
            ...
            //--------------------------------------------------------------------------------
            Wfld_EntryThroughGateRepository ObjETR = new Wfld_EntryThroughGateRepository();
          ...
          //  ViewBag.LstTransport = LstPort;
            ...
            ImpRep.ListOfPortCodeOriginForPage("", 0);
        ...
        public ActionResult ViewEntryThroughGateBond(int EntryId)
        {
            ...
            Wfld_EntryThroughGateRepository ObjEtGateR = new Wfld_EntryThroughGateRepository();
            if (EntryId > 0)
            {
       ...
       //     ACCR.GetMenuWiseAccessRight(Convert.ToInt32(Session["MenuId"]), ((Login)Session["LoginUser"]).Role.RoleId, Convert.ToInt32(Session["ModuleId"]), Convert.ToInt32(Session["BranchId"]));
        ...
        public ActionResult CreateEntryThroughGateExportCBT()
        {
         ...
         //   if (ObjETR.DBResponse.Data != null)
          ...
          //  ViewBag.LstTransport = LstPort;
            ...
            Wfld_EntryThroughGateRepository objImportFor = new Wfld_EntryThroughGateRepository();
        ...
        public JsonResult GetFieldsForContainer(string ContainerName, int TransportMode = 2)
        {
            if (ContainerName != "")
            {
                Wfld_EntryThroughGateRepository ObjGOR = new Wfld_EntryThroughGateRepository();
                if (TransportMode == 2)
                {
...

        {
            ...
            {
                Wfld_EntryThroughGateRepository ObjEntryThroughGateRepositories = new Wfld_EntryThroughGateRepository();
        ...
        public ActionResult AddEditEntryThroughGate(WfldEntryThroughGate ObjEntryThroughGate)
        {
            ...
            if (ObjEntryThroughGate.OperationType == "Import" && ObjEntryThroughGate.ContainerType == "Loaded")
            {
                ...
                ModelState.Remove("ShippingLine");
                ModelState.Remove("ShippingLineId");
                ModelState.Remove("PortOfCallCode");
        ...
        public int SendEntryMail(string ContainerNo, int lastInsertedId)
        {
            try
            {
                ...
                Wfld_EntryThroughGateRepository objEntry = new Wfld_EntryThroughGateRepository();
                ...
                if (objEntry.DBResponse.Data != null)
                {
                    ...
                    if (status == "Success")
                    {
                        Wfld_EntryThroughGateRepository etgr = new Wfld_EntryThroughGateRepository();
        ...
        public ActionResult AddExportVehicle(int EntryId)
        {
            ...
            Wfld_EntryThroughGateRepository ObjDR = new Wfld_EntryThroughGateRepository();
        ...
        {
            Wfld_ImportRepository objExport = new Wfld_ImportRepository();
        ...
        {
            Wfld_EntryThroughGateRepository obj = new Wfld_EntryThroughGateRepository();
            obj.SACDetails(Id);
