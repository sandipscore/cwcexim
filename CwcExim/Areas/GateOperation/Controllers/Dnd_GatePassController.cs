...
{
    public class Dnd_GatePassController : Controller
    {
        #region Gate Pass
        [HttpGet]
        public ActionResult CreateGatePass()
        {
            Dnd_GatePassRepository objGPR = new Dnd_GatePassRepository();
            ...
            Dnd_GatePass objGP = new Dnd_GatePass();
        ...
        public ActionResult EditGatePass(int GatePassId)
        {
            ...
            if (objGPR.DBResponse.Data != null)
                objGP = (Dnd_GatePass)objGPR.DBResponse.Data;
            return PartialView(objGP);
        }
        [HttpGet]
        ...
        public JsonResult AddEditGatePass(Dnd_GatePass objGP)
        {
        ...
        {
            Dnd_GatePassRepository objGPR = new Dnd_GatePassRepository();
            List<ListOfDndGP> lstGP = new List<ListOfDndGP>();
            objGPR.ListOfGatePass();
            if (objGPR.DBResponse.Data != null)
                lstGP = (List<ListOfDndGP>)objGPR.DBResponse.Data;
        ...
        public JsonResult GatePassPrint(int GatePassId)
        {
            ...
            Dnd_GPHdr objGP = new Dnd_GPHdr();
            string FilePath = "";
            if (objGPR.DBResponse.Data != null)
            {
                objGP = (Dnd_GPHdr)objGPR.DBResponse.Data;
                if (objGP.Module == "bnd" || objGP.Module == "bndadv")
                    FilePath = GeneratingPDFForBond(objGP, GatePassId);
                else if (objGP.Module == "exp"  || objGP.Module == "itpexp")
                    FilePath = GeneratingPDFExport(objGP, GatePassId);
                else if ( objGP.Module == "explod")
                    FilePath = GeneratingPDFExportlod(objGP, GatePassId);
                else if (objGP.Module == "btt" )
                    FilePath = GeneratingPDFBTT(objGP, GatePassId);
                else if (objGP.Module == "impdeli")
                    FilePath = GeneratingPDFForImpdeli(objGP, GatePassId);
                else if (objGP.Module == "impyard")
                    FilePath = GeneratingPDFForYard(objGP, GatePassId);
        ...
        [NonAction]
        private string GeneratingPDF(Dnd_GPHdr objGP, int GatePassId)
        {
            string html = ""; int SerialNo = 1;
            string Vessel = "", Voyage = "", Rotation = "", ShippingSealNo = "", CustomSealNo = "", LineNo = "", NoOfUnits = "", Weight = "", CargoType = "", Location = "", Container = "", ShippingBillNo = "";
            ...
            objGP.lstCont.Select(x => new { Container = x.Container }).Distinct().ToList().ForEach(item =>
            {
                if (Container == "")
            ...
            objGP.lstCont.Select(x => new { ShippingBillNo = x.ShippingBillNo }).Distinct().ToList().ForEach(item =>
            {
                if (ShippingBillNo == "")
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>Driver Name : <span style='font-weight:normal;'>" + objGP.DriverName + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Contact No : <span style='font-weight:normal;'>" + objGP.ContactNo + "</span></th></tr>";
            ...
            html += "<tr><td colspan='12'>";
            html += "<table cellpadding='0' cellspacing='0' style='width:100%;font-size:8pt;font-family:verdana,arial,san-serif; border:1px solid #000;'>";
            html += "<thead><tr><th cellpadding='10' style='border-right:1px solid #000; width:5%;'>S. No.</th>";
            html += "<th cellpadding='10' style='border-right:1px solid #000; width:20%;'>Container No.</th>";
            html += "<th cellpadding='10'>Shipping Bill No.</th></tr></thead>";
            html += "<tbody>";
            objGP.lstCont.ToList().ForEach(item =>
            {
                html += "<tr><td cellpadding='10' style='border-top:1px solid #000; border-right:1px solid #000;'>" + SerialNo++ + "</td>";
                html += "<td cellpadding='10' style='border-top:1px solid #000; border-right:1px solid #000;'>" + item.Container + "</td>";
                html += "<td cellpadding='10' style='border-top:1px solid #000;'>" + item.ShippingBillNo + "</td></tr>";
            });
            html += "</tbody>";
            html += "</table>";
            html += "</td></tr>";
            ...
            //html += "<th style='border-bottom:1px solid #000;padding:3px;text-align:left;width:8%;'>Container No</th>";
            //html += "<th style='border-bottom:1px solid #000;padding:3px;text-align:left;width:10%;'>ShippingBill No</th></tr>";
            //html += "</thead>";
            //html += "<tbody>";
            //objGP.lstCont.ToList().ForEach(item =>
            //{
            //    html += "<tr><td style='border-bottom:1px solid #000;padding:3px;text-align:center;width:5%;'>" + SerialNo++ + "</td>";
            //    html += "<td style='border-bottom:1px solid #000;padding:3px;text-align:left;width:8%;'>" + item.Container + "</td>";
            //    html += "<td style='border-bottom:1px solid #000;padding:3px;text-align:left;width:30%;'>" + item.ShippingBillNo + "</td></tr>";
            //});
        ...
        [NonAction]
        private string GeneratingPDFForImpdeli(Dnd_GPHdr objGP, int GatePassId)
        {
            string html = ""; int SerialNo = 1;
            string Vessel = "", Voyage = "", OBLDate="", Via = "", Commodity="", Rotation = "", ShippingSealNo = "", CustomSealNo = "", LineNo = "", NoOfUnits = "", Weight = "", CargoType = "", Location = "", Container = "", ShippingBillNo = "";
            var ContainerNo = ""; var VehicleNo = "";
            objGP.lstDet.Select(x => new { ContainerNo = x.ContainerNo }).Distinct().ToList().ForEach(item =>
            {
                if (ContainerNo == "")
            ...
            objGP.lstDet.Select(x => new { OBLDate = x.OBLDate }).Distinct().ToList().ForEach(item =>
            {
                if (OBLDate == "")
            ...
            objGP.lstDet.Select(x => new { Via = x.Via }).Distinct().ToList().ForEach(item =>
            {
                if (Via == "")
                    Via = item.Via;
                else
            ...
            html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>";
            html += "<tr><td valign='top'><img align='right' src='IMGSRC' width='90'/></td>";
            html += "<td width='300%' valign='top' align='center'><h1 style='font-size: 22px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><span style='font-size:12px;'>(A Govt. of India Undertaking)</span><br/><span style='font-size:12px;'>" + objGP.CompanyAdrress + "</span><br/><span style='font-size:12px;'>Email - " + objGP.CompanyMail + "</span><br/><label style='font-size: 14px; font-weight:bold;'>IMPORT LCL GATE PASS</label></td></tr>";
            html += "</tbody></table>";
            html += "</td></tr>";
            ...
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Contact No : <span style='font-weight:normal;'>" + objGP.ContactNo + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Vessel Name : <span style='font-weight:normal;'>" + Vessel + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Via : <span style='font-weight:normal;'>" + Via + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping Seal no. : <span style='font-weight:normal;'>" + ShippingSealNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Customs Seal No. : <span style='font-weight:normal;'>" + CustomSealNo + "</span></th></tr>";
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping Line :  <span style='font-weight:normal;'>" + objGP.ShippingLineName + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>OBL : <span style='font-weight:normal;'>" + ContainerNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>OBL Date : <span style='font-weight:normal;'>" + OBLDate + "</span></th></tr>";
            ...
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Date : <span style='font-weight:normal;'>" + objGP.BOEDate + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>Cargo : <span style='font-weight:normal;'>" + Commodity + "</span></th>";
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Godown :  <span style='font-weight:normal;'>" + Location + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>No. of Packages : <span style='font-weight:normal;'>" + NoOfUnits + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Weight : <span style='font-weight:normal;'>" + Weight + "</span></th></tr>";
            ...
            //html += "<tr><td colspan='12'>";
            //html += "<table cellpadding='0' cellspacing='0' style='width:100%; display:none;font-size:8pt;font-family:verdana,arial,san-serif; border:1px solid #000;'>";
            //html += "<thead><tr><th cellpadding='10' style='border-right:1px solid #000; width:5%;'>S. No.</th>";
            //html += "<th cellpadding='10' style='border-right:1px solid #000; width:20%;'>Container No.</th>";
            //html += "<th cellpadding='10'>Shipping Bill No.</th></tr></thead>";
            //html += "<tbody>";
        ...
        [NonAction]
        private string GeneratingPDFForYard(Dnd_GPHdr objGP, int GatePassId)
        {
            string html = ""; int SerialNo = 1;
            string Vessel = "", Voyage = "", OBLDate = "", CFSCode = "", Via = "", Commodity = "", Rotation = "", ShippingSealNo = "", CustomSealNo = "", LineNo = "", NoOfUnits = "", Weight = "", CargoType = "", Location = "", Container = "", ShippingBillNo = "";
            var ContainerNo = ""; var VehicleNo = "";
            objGP.lstDet.Select(x => new { ContainerNo = x.ContainerNo }).Distinct().ToList().ForEach(item =>
            {
                if (ContainerNo == "")
            ...
            objGP.lstDet.Select(x => new { CFSCode = x.CFSCode }).Distinct().ToList().ForEach(item =>
            {
                if (CFSCode == "")
            ...
            html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>";
            html += "<tr><td valign='top'><img align='right' src='IMGSRC' width='90'/></td>";
            html += "<td width='300%' valign='top' align='center'><h1 style='font-size: 22px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><span style='font-size:12px;'>(A Govt. of India Undertaking)</span><br/><span style='font-size:12px;'>" + objGP.CompanyAdrress + "</span><br/><span style='font-size:12px;'>Email - " + objGP.CompanyMail + "</span><br/><label style='font-size: 14px; font-weight:bold;'>IMPORT FCL GATE PASS</label></td></tr>";
            html += "</tbody></table>";
            html += "</td></tr>";
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping Line :  <span style='font-weight:normal;'>" + objGP.ShippingLineName + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Container No: <span style='font-weight:normal;'>" + ContainerNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>CFS Code : <span style='font-weight:normal;'>" + CFSCode + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>BOE No. : <span style='font-weight:normal;'>" + objGP.BOENo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Date : <span style='font-weight:normal;'>" + objGP.BOEDate + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>Cargo : <span style='font-weight:normal;'>" + Commodity + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Nature Of Goods <span style='font-weight:normal;'>" + CargoType + "</span></th></tr>";
        ...
        [NonAction]
        private string GeneratingPDFForBond(Dnd_GPHdr objGP, int GatePassId)
        {
            string html = ""; int SerialNo = 1;
            string Vessel = "", Voyage = "", OBLDate = "", CFSCode = "", Via = "", Commodity = "", Rotation = "", ShippingSealNo = "", CustomSealNo = "", LineNo = "", NoOfUnits = "", Weight = "", CargoType = "", Location = "", Container = "", ShippingBillNo = "";
            var ContainerNo = ""; var VehicleNo = "";
            ...
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping Line :  <span style='font-weight:normal;'>" + objGP.ShippingLineName + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Bond No : <span style='font-weight:normal;'>" + objGP.BondNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Bond Date : <span style='font-weight:normal;'>" + objGP.BondDate + "</span></th></tr>";
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Container No: <span style='font-weight:normal;'>" + ContainerNo + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>CFS Code : <span style='font-weight:normal;'>" + CFSCode + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>BOE No. : <span style='font-weight:normal;'>" + objGP.BOENo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Date : <span style='font-weight:normal;'>" + objGP.BOEDate + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>Cargo Description : <span style='font-weight:normal;'>" + objGP.CargoDescription+ "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Cargo Type :<span style='font-weight:normal;'>" + CargoType + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Godown :  <span style='font-weight:normal;'>" + Location + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>No. of Packages : <span style='font-weight:normal;'>" + NoOfUnits + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Weight : <span style='font-weight:normal;'>" + Weight + "</span></th></tr>";
        ...
        [NonAction]
        private string GeneratingBondPDF(Dnd_GPHdr objGP, int GatePassId)
        {
            //  string html = "";
        ...
        public JsonResult CancelGatePass(int GatePassId)
        {
            if (GatePassId > 0)
            {
                Dnd_GatePassRepository objGP = new Dnd_GatePassRepository();
        ...
        [NonAction]
        private string GeneratingPDFExport(Dnd_GPHdr objGP, int GatePassId)
        {
            string html = ""; int SerialNo = 1;
            string Vessel = "",Entryno="",  Voyage = "", Rotation = "", ShippingSealNo = "", CustomSealNo = "", LineNo = "", NoOfUnits = "", Weight = "", CargoType = "", Location = "", Container = "", ShippingBillNo = "", Commodity="";
            var ContainerNo = ""; var VehicleNo = ""; var Via = ""; var POD = ""; var CFSCode = ""; var MoveNo = ""; var POL = "";
            objGP.lstDet.Select(x => new { ContainerNo = x.ContainerNo }).Distinct().ToList().ForEach(item =>
            {
                if (ContainerNo == "")
                    ContainerNo = item.ContainerNo;
            ...
            objGP.lstDet.Select(x => new { Entryno = x.EntryNo }).Distinct().ToList().ForEach(item =>
            {
                if (Entryno == "")
            ...
            objGP.lstDet.Select(x => new { MoveNo = x.MoveNo }).Distinct().ToList().ForEach(item =>
            {
                if (MoveNo == "")
                    MoveNo = item.MoveNo;
                else
            ...
            objGP.lstDet.Select(x => new { POL = x.POL }).Distinct().ToList().ForEach(item =>
            {
                if (POL == "")
                    POL = item.POL;
                else
            ...
            objGP.lstDet.Select(m => new { Commodity = m.Commodity }).Distinct().ToList().ForEach(item =>
            {
                if (Commodity == "")
                    Commodity =item.Commodity;
                else 
            ...
            NoOfUnits = objGP.lstDet[0].NoOfUnits.ToString();
            Weight = objGP.lstDet[0].Weight.ToString();
            ...
            html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>";
            html += "<tr><td valign='top'><img align='right' src='IMGSRC' width='90'/></td>";
            html += "<td width='300%' valign='top' align='center'><h1 style='font-size: 22px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><span style='font-size:12px;'>(A Govt. of India Undertaking)</span><br/><span style='font-size:12px;'>" + objGP.CompanyAdrress + "</span><br/><span style='font-size:12px;'>Email - " + objGP.CompanyMail + "</span><br/><label style='font-size: 14px; font-weight:bold;'>Export GATE PASS</label></td></tr>";
            html += "</tbody></table>";
            html += "</td></tr>";
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Container No. & size : <span style='font-weight:normal;'>" + ContainerNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>CFS Code : <span style='font-weight:normal;'>" + CFSCode + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Exporter : <span style='font-weight:normal;'>" + objGP.ImpExpName + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>CHA Name : <span style='font-weight:normal;'>" + objGP.CHAName + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping Line : <span style='font-weight:normal;'>" + objGP.ShippingLineName + "</span></th>";
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping  Seal no. : <span style='font-weight:normal;'>" + ShippingSealNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Customs Seal No. : <span style='font-weight:normal;'>" + CustomSealNo + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Vessel : <span style='font-weight:normal;'>" + Vessel + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Via : <span style='font-weight:normal;'>" + Via + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Move No : <span style='font-weight:normal;'>" + MoveNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>S.B. No. : <span style='font-weight:normal;'>" + objGP.BOENo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>S.B. Date : <span style='font-weight:normal;'>" + objGP.BOEDate + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Godown. :<span style='font-weight:normal;'>" + Location + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'><span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Port Of Loading. : <span style='font-weight:normal;'>" + POL + "</span></th>";
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Cargo: <span style='font-weight:normal;'>" + Commodity + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Nature of Goods. : <span style='font-weight:normal;'>" + CargoType + "</span></th></tr>";
            ...
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>CFS Code : <span style='font-weight:normal;'>" + CFSCode + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Move No : <span style='font-weight:normal;'>" + MoveNo + "</span></th></tr>";

            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Container No. & size : <span style='font-weight:normal;'>" + ContainerNo + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Port Of Loading : <span style='font-weight:normal;'>" + POL + "</span></th></tr>";
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Via no. : <span style='font-weight:normal;'>" + Via + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>POD. : <span style='font-weight:normal;'>" + POD + "</span></th></tr>";
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Vessel Name : <span style='font-weight:normal;'>" + Vessel + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Voyage No. : <span style='font-weight:normal;'>" + Voyage + "</span></th></tr>";
            ...
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>CHA Name : <span style='font-weight:normal;'>" + objGP.CHAName + "</span></th></tr>";
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping Line : <span style='font-weight:normal;'>" + objGP.ShippingLineName + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>S.B. No. : <span style='font-weight:normal;'>" + objGP.BOENo + "</span></th></tr>";
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Date : <span style='font-weight:normal;'>" + objGP.BOEDate + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>No. of Packages : <span style='font-weight:normal;'>" + NoOfUnits + "</span></th></tr>";
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>Weight : <span style='font-weight:normal;'>" + Weight + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Location Name : <span style='font-weight:normal;'>" + Location + "</span></th></tr>";
            ...
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>Cargo Type : <span style='font-weight:normal;'>" + CargoType + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Remarks : <span style='font-weight:normal;'>" + objGP.Remarks + "</span></th></tr>";
        ...
        [NonAction]
        private string GeneratingPDFExportlod(Dnd_GPHdr objGP, int GatePassId)
        {
            string html = ""; int SerialNo = 1;
            string Vessel = "", Entryno = "", Voyage = "", Rotation = "", ShippingSealNo = "", CustomSealNo = "", LineNo = "", NoOfUnits = "", Weight = "", CargoType = "", Location = "", Container = "", ShippingBillNo = "", Commodity = "";
            var ContainerNo = ""; var VehicleNo = ""; var Via = ""; var POD = ""; var CFSCode = ""; var MoveNo = ""; var POL = "";
        ...
        [NonAction]
        private string GeneratingPDFBTT(Dnd_GPHdr objGP, int GatePassId)
        {
            string html = ""; int SerialNo = 1;
            string Vessel = "", Voyage = "",  Rotation = "", ShippingSealNo = "", CustomSealNo = "", LineNo = "", NoOfUnits = "", Weight = "", CargoType = "", Location = "", Container = "", ShippingBillNo = "", Commodity="", EntryNo="";
            var ContainerNo = ""; var VehicleNo = ""; var Via = ""; var POD = ""; var CFSCode = ""; var MoveNo = ""; var POL = "";decimal FobValue = 0;
            objGP.lstDet.Select(x => new { ContainerNo = x.ContainerNo }).Distinct().ToList().ForEach(item =>
            {
                if (ContainerNo == "")
                    ContainerNo = item.ContainerNo;
            ...
            objGP.lstDet.Select(x => new { FobValue = x.FobValue }).Distinct().ToList().ForEach(item =>
            {
                if (FobValue==0)
            ...
            html += "<table cellspacing='0' cellpadding='5' style='width:100%; font-family: Arial, Helvetica, sans-serif; margin: 0; padding: 5px;'><tbody>";
            html += "<tr><td valign='top'><img align='right' src='IMGSRC' width='90'/></td>";
            html += "<td width='300%' valign='top' align='center'><h1 style='font-size: 22px; margin: 0; padding: 0;'>CENTRAL WAREHOUSING CORPORATION</h1><span style='font-size:12px;'>(A Govt. of India Undertaking)</span><br/><span style='font-size:12px;'>" + objGP.CompanyAdrress + "</span><br/><span style='font-size:12px;'>Email - " + objGP.CompanyMail + "</span><br/><label style='font-size: 14px; font-weight:bold;'>Back To Town GATE PASS</label></td></tr>";
            html += "</tbody></table>";
            html += "</td></tr>";
           ...
           // html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Container No. & size : <span style='font-weight:normal;'>" + (CFSCode==""?"":ContainerNo) + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>CFS Code : <span style='font-weight:normal;'>" + CFSCode + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Exporter : <span style='font-weight:normal;'>" + objGP.ImpExpName + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>CHA Name : <span style='font-weight:normal;'>" + objGP.CHAName + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + " " + "</span></th></tr>";
            ...
            //html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Shipping Line Seal no. : <span style='font-weight:normal;'>" + ShippingSealNo + "</span></th>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Customs Seal No. : <span style='font-weight:normal;'>" + CustomSealNo + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>Entry No : <span style='font-weight:normal;'>" + EntryNo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'><span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>S.B. No : <span style='font-weight:normal;'>" + objGP.BOENo + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>S.B. Date: <span style='font-weight:normal;'>" + objGP.BOEDate + "</span></th></tr>";
            //html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Port Of Loading : <span style='font-weight:normal;'>" + POL + "</span></th></tr>";
            ...
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>NoOfUnits <span style='font-weight:normal;'>" + NoOfUnits + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Weight: <span style='font-weight:normal;'>" + objGP.Weight + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000; border-right:1px solid #000;'>FobValue : <span style='font-weight:normal;'>" + FobValue + "</span></th>";
            html += "<th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'> <span style='font-weight:normal;'>" + "" + "</span></th></tr>";
            html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word;'>Remarks : <span style='font-weight:normal;'>" + objGP.Remarks + "</span></th></tr>";
            // html += "<tr><th cellpadding='10' align='left' colspan='6' width='50%' style='overflow:hidden; word-wrap:break-word; border-right:1px solid #000; border-bottom:1px solid #000;'>Cargo Type : <span style='font-weight:normal;'>" + CargoType + "</span></th>";
            // html += "<th cellpadding='10' align='left' colspan='12' width='100%' style='overflow:hidden; word-wrap:break-word; border-bottom:1px solid #000;'>Remarks : <span style='font-weight:normal;'>" + objGP.Remarks + "</span></th></tr>";
