...
{
    public class Loni_GateExitController : Controller
    {
        ...
        {
            Loni_ExitThroughGateRepository ObjETR = new Loni_ExitThroughGateRepository();
        ...
        {
            Loni_ExitThroughGateRepository ObjGOR = new Loni_ExitThroughGateRepository();
        ...
        {
            Loni_ExitThroughGateRepository ETGR = new Loni_ExitThroughGateRepository();
        ...
        public ActionResult AddEditExitThroughGate(ExitThroughGateHeader objETG)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Loni_ExitThroughGateRepository objETGR = new Loni_ExitThroughGateRepository();
        ...
        {
            ExitThroughGateHeader ObjExitThroughGateHeader = new ExitThroughGateHeader();
            Loni_ExitThroughGateRepository ObjExitR = new Loni_ExitThroughGateRepository();
            if (ExitIdHdr > 0)
            {
        ...
        public ActionResult ViewExitThroughGate(int ExitIdHdr)
        {
            ...
            ExitThroughGateHeader ObjExitThroughGateHeader = new ExitThroughGateHeader();
            Loni_ExitThroughGateRepository ObjExittGateR = new Loni_ExitThroughGateRepository();
            if (ExitIdHdr > 0)
            {
        ...
        public int SendExitMail(string ShippingLineId)//string ContainerNo
        {
            try
            {
                ...
                Loni_ExitThroughGateRepository objExit = new Loni_ExitThroughGateRepository();
        ...
        public async Task<JsonResult> SendDT(int ExitId = 0)
        {
            int k = 0;
            int j = 1;
            Loni_ExitThroughGateRepository ObjER = new Loni_ExitThroughGateRepository();
            ...
            if (ObjER.DBResponse.Status == 1)
            {
                ...
                foreach (DataRow dr in ds.Tables[7].Rows)
                {
                    ...
                    Loni_ExitThroughGateRepository objExport = new Loni_ExitThroughGateRepository();
