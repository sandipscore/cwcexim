...
{
    public class VLDA_GateExitController : Controller
    {
        ...
        {
            VLDAExitThroughGateRepository ObjETR = new VLDAExitThroughGateRepository();
        ...
        {
            VLDAExitThroughGateRepository ObjGOR = new VLDAExitThroughGateRepository();
        ...
        {
            VLDAExitThroughGateRepository ETGR = new VLDAExitThroughGateRepository();
        ...
        public ActionResult AddEditExitThroughGate(WFLDExitThroughGateHeader objETG)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                VLDAExitThroughGateRepository objETGR = new VLDAExitThroughGateRepository();
        ...
        {
            WFLDExitThroughGateHeader ObjExitThroughGateHeader = new WFLDExitThroughGateHeader();
            VLDAExitThroughGateRepository ObjExitR = new VLDAExitThroughGateRepository();
            if (ExitIdHdr > 0)
            {
        ...
        public ActionResult ViewExitThroughGate(int ExitIdHdr)
        {
            ...
            WFLDExitThroughGateHeader ObjExitThroughGateHeader = new WFLDExitThroughGateHeader();
            VLDAExitThroughGateRepository ObjExittGateR = new VLDAExitThroughGateRepository();
            if (ExitIdHdr > 0)
            {
        ...
        public int SendExitMail(string ShippingLineId)//string ContainerNo
        {
            try
            {
                ...
                VLDAExitThroughGateRepository objExit = new VLDAExitThroughGateRepository();
        ...
        public async Task<JsonResult> SendDT(int ExitId = 0)
        {
            int k = 0;
            int j = 1;
            VLDAExitThroughGateRepository ObjER = new VLDAExitThroughGateRepository();
            ...
            if (ObjER.DBResponse.Status == 1)
            {
                ...
                foreach (DataRow dr in ds.Tables[7].Rows)
                {
                    ...
                    VLDAExitThroughGateRepository objExport = new VLDAExitThroughGateRepository();
