...
namespace CwcExim.Areas.GateOperation.Controllers
{
    ...
    public class HDB_CWCGateExitController : BaseController
    {
        ...
        public ActionResult CreateExitThroughGate(string date = "")
        {
          ...
          //  objExitThroughGateHeader.expectedTimeOfArrival = DateTime.Now.ToString("dd/MM/yyyy HH:mm");
        ...
        {
            HdbExitThroughGateRepository ObjETR = new HdbExitThroughGateRepository();
        ...
        {
            HdbExitThroughGateRepository ETGR = new HdbExitThroughGateRepository();
            ETGR.GetAllExitThroughGate(0);
            List<HDB_ExitThroughGateHeader> ListExitThroughGateHeader = new List<HDB_ExitThroughGateHeader>();

            if (ETGR.DBResponse.Data != null)
            {
                ListExitThroughGateHeader = (List<HDB_ExitThroughGateHeader>)ETGR.DBResponse.Data;
            }
        ...
        {
            HdbExitThroughGateRepository ObjETR = new HdbExitThroughGateRepository();
            Hdb_GateExitCBT ObjCBT = new Hdb_GateExitCBT();
            HDB_ExitThroughGateHeader objExitThroughGateHeader = new HDB_ExitThroughGateHeader();
            ObjETR.GetTime();
            if (ObjETR.DBResponse.Data != null)
            {
                objExitThroughGateHeader = (HDB_ExitThroughGateHeader)ObjETR.DBResponse.Data;
                string ExitTime = objExitThroughGateHeader.GateExitDateTime;
                string[] ExitTimeArray = ExitTime.Split(' ');
                objExitThroughGateHeader.GateExitDateTime = ExitTimeArray[0];
                ViewBag.strTime = objExitThroughGateHeader.Time;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditExitThroughGateCBT(Hdb_GateExitCBT objETG)
        {
            if (ModelState.IsValid)
            {
                string ExitTime = objETG.Time;
                ...
                HdbExitThroughGateRepository objETGR = new HdbExitThroughGateRepository();
        ...
        public ActionResult GetAllCBTExitThroughGate()
        {
            ...
            List<Hdb_GateExitCBT> ListExitThroughGateHeader = new List<Hdb_GateExitCBT>();

            if (ETGR.DBResponse.Data != null)
            {
                ListExitThroughGateHeader = (List<Hdb_GateExitCBT>)ETGR.DBResponse.Data;
            }
        ...
        {
           Hdb_GateExitCBT ObjExitThroughGateHeader = new Hdb_GateExitCBT();
            HdbExitThroughGateRepository ObjExitR = new HdbExitThroughGateRepository();
            if (ExitId > 0)
            {
                ObjExitR.EditViewExitThroughGateCBT(ExitId);
                if (ObjExitR.DBResponse.Data != null)
                {
                    ObjExitThroughGateHeader = (Hdb_GateExitCBT)ObjExitR.DBResponse.Data;
                    string strDateTime = ObjExitThroughGateHeader.GateExitDateTime;
                    string[] dateTimeArray = strDateTime.Split(' ');
                    string strDtae = dateTimeArray[0];
        ...
        public ActionResult ViewExitThroughGateCBT(int ExitId)
        {
            ...
            Hdb_GateExitCBT ObjExitThroughGateHeader = new Hdb_GateExitCBT();
            HdbExitThroughGateRepository ObjExittGateR = new HdbExitThroughGateRepository();
            if (ExitId > 0)
            {
                ObjExittGateR.EditViewExitThroughGateCBT(ExitId);
                if (ObjExittGateR.DBResponse.Data != null)
                {
                    ObjExitThroughGateHeader = (Hdb_GateExitCBT)ObjExittGateR.DBResponse.Data;
                    string strDateTime = ObjExitThroughGateHeader.GateExitDateTime;
                    string[] dateTimeArray = strDateTime.Split(' ');
                    string strDtae = dateTimeArray[0];
        ...
        public JsonResult DeleteExitThroughGateCBT(int ExitId)
        {
            if (ExitId > 0)
            {
                HdbExitThroughGateRepository ObjGOR = new HdbExitThroughGateRepository();
        ...
        public async Task<JsonResult> SendDT(int ExitId = 0)
        {
            int k = 0;
            int j = 1;
            HdbExitThroughGateRepository ObjER = new HdbExitThroughGateRepository();
            ...
            if (ObjER.DBResponse.Status == 1)
            {
                ...
                foreach (DataRow dr in ds.Tables[7].Rows)
                {
                    ...
                    HdbExitThroughGateRepository objExport = new HdbExitThroughGateRepository();
