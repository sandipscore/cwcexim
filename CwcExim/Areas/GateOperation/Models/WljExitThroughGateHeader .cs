...
{
    public class WljExitThroughGateHeader
    {
        ...
        public IList<WljcontainerExit> containerList { get; set; } = new List<WljcontainerExit>();
        ...
        public List<WLJGateExitSCMTR> LstSCMTR { get; set; } = new List<WLJGateExitSCMTR>();
    }


    public class WljcontainerExit
    {
