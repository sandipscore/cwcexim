...
{
    public class VRN_EntryThroughGate
    {
       ...
       // [MaxLength(1000)]
        ...
        public IList<VRN_AddMoreRefForCCIN> listAddRef = new List<VRN_AddMoreRefForCCIN>();
    }

    public class VRNcontainer
    {
        public string ContainerName { get; set; }


    }
    public class VRNSearchCont
    {
        public List<VRN_container> lstConatiner { get; set; } = new List<VRN_container>();
    ...
    public class VRN_EntryThroughGateShipping
    {
    ...
    public class VRN_LoadedContainerListWithData
    {
    ...
    public class VRN_EntryThroughGateCHA
    {
        public string CHAName { get; set; }
        public int CHAId { get; set; }
    }
    public class VRN_ContainerAgainstGp
    {
    ...
    public class VRN_EntryThroughGateBond
    {
        public int EntryId { get; set; }
        public string OperationType { get; set; }
        public string ContainerType { get; set; }
    ...
    public class VRN_ReferenceNumberCCIN
    {

        public IList<VRN_CCINList> ReferenceList = new List<VRN_CCINList>();        

        public IList<ShippingLineList> listShippingLine = new List<ShippingLineList>();
    }

    public class VRN_CCINList
    {
    ...
    public class VRN_AddMoreRefForCCIN
    {
