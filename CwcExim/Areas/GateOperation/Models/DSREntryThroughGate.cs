...
{
    public class DSREntryThroughGate
    {
        ...
        [Display(Name = "Jorder No")]
        public string JorderNo { get; set; }

        [Display(Name = "Jorder Date")]
        public string JorderDate { get; set; }
       ...
       [Required(ErrorMessage = "Select Shipping Line")]
        ...
        public string OCFSCode { get; set; }
    ...
    public class DSRSearchCont
    {
        public List<DSRcontainer> lstConatiner { get; set; } = new List<DSRcontainer>();
        public string State { get; set; }
    }
    public class DSREntryThroughGateShipping
    {
    ...
    public class DSRLoadedContainerListWithData
    {
    ...
    public class DSREntryThroughGateCHA
    {
        public string CHAName { get; set; }
        public int CHAId { get; set; }
    }
    public class DSRcontainerAgainstGp
    {
    ...
    public class DSR_EntryThroughGateBond
    {
        public int EntryId { get; set; }
        public string OperationType { get; set; }
        public string ContainerType { get; set; }
