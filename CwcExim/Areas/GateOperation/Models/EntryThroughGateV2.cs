...
{
    public class EntryThroughGateV2
    {
    ...
    public class ReferenceNumberListV2
    {
    ...
    public class LoadContainerReferenceNumberListV2
    {
    ...
    public class ShippingLineListV2
    {
        public string ShippingLine { get; set; }
    ...
    public class LoadedContainerV2
    {
    ...
    public class ReferenceNumberV2
    {

        public IList<ReferenceNumberListV2> ReferenceList = new List<ReferenceNumberListV2>();

        public IList<GateEntryExportV2> listExport = new List<GateEntryExportV2>();

        public IList<ShippingLineListV2> listShippingLine = new List<ShippingLineListV2>();
    }


    public class GateEntryExportV2
    {
    ...
    public class LoadedContainerListWithDataV2
    {
    ...
    public class ReferenceNumberCCINV2
    {

        public IList<CCINListV2> ReferenceList = new List<CCINListV2>();
    ...
    public class containerAgainstGp_PPGV2
    {
        public string ContainerName { get; set; }
