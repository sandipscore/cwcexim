...
{
    public class AMD_EntryThroughGate
    {
        ...
        [StringLength(1000, ErrorMessage = "The CargoDescription field maximum length of '1000'")]
        // [MaxLength(1000)]
        ...
        [StringLength(1000, ErrorMessage = "The Remarks field maximum length of '1000'")]
        ...
        public IList<AMD_AddMoreRefForCCIN> listAddRef = new List<AMD_AddMoreRefForCCIN>();
    }

    public class AMDcontainer
    {
        public string ContainerName { get; set; }


    }
    public class AMDSearchCont
    {
        public List<AMD_container> lstConatiner { get; set; } = new List<AMD_container>();
        public string State { get; set; }
    }
   
    public class AMD_container
    {
        public string ContainerName { get; set; }


    }
    public class AMD_EntryThroughGateShipping
    {
    ...
    public class AMD_LoadedContainerListWithData
    {
    ...
    public class AMD_EntryThroughGateCHA
    {
        public string CHAName { get; set; }
        public int CHAId { get; set; }
    }
    public class AMD_ContainerAgainstGp
    {
    ...
    public class AMD_EntryThroughGateBond
    {
        public int EntryId { get; set; }
        public string OperationType { get; set; }
        public string ContainerType { get; set; }
    ...
    public class AMD_ReferenceNumberCCIN
    {

        public IList<AMD_CCINList> ReferenceList = new List<AMD_CCINList>();

        public IList<ShippingLineList> listShippingLine = new List<ShippingLineList>();
    }

    public class AMD_CCINList
    {
    ...
    public class AMD_AddMoreRefForCCIN
    {
