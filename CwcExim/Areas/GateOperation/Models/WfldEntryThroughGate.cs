...
{
    public class WfldEntryThroughGate
    {
    ...
    public class WFLDLoadedContainerListWithData
    {
    ...
    public class WfldEntryThroughGateCHA
    {
        public string CHAName { get; set; }
        public int CHAId { get; set; }
    }
    public class WFLDcontainerAgainstGp
    {
    ...
    public class Wfld_EntryThroughGateBond
    {
        public int EntryId { get; set; }
        public string OperationType { get; set; }
        public string ContainerType { get; set; }
