(function () {
    ...
    controller('PpgEmptyGateInvoiceEditCtrl', function ($scope, PpgEmptyGateInvoiceEditService) {
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgEmptyGateInvoiceEditService.GetAppNoForYard("EXPGERD").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            $('.modalloader').show();
            PpgEmptyGateInvoiceEditService.GetYardInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
                ...
                $scope.GF = $scope.InvoiceObj.GF;
                $scope.MF = $scope.InvoiceObj.MF;
                $scope.TotalSpace = $scope.InvoiceObj.TotalSpace;
                $scope.GodownName = $scope.InvoiceObj.GodownName;
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                PpgEmptyGateInvoiceEditService.ContainerSelect($('#InvoiceDate').val(), $scope.InvoiceId, $scope.FumigationType, $scope.TaxType, $scope.PartyId, $scope.Size, $scope.ChargeDtl).then(function (res) {
                    $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgEmptyGateInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
