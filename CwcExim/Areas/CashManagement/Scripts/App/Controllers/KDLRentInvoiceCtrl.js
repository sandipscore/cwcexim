    ...
    controller('RentInvoiceCtrl', function ($scope, RentInvoiceService) {
        ...
        $scope.AddRent = function () {
            ...
            if ($('#PartyName').val() == "") {
                ...
                detail.Address = $scope.hdnAddress;
                detail.State = $scope.hdnState;
                detail.StateCode = $scope.hdnStateCode;
                ...
                detail.InvoiceNo = $('#InvoiceNo').val();
                detail.InvoiceHtml = "";
                var flag = 0;
        ...
        $scope.EditRentDet = function (i) {
            ...
            $('#hdnAddress').val( $scope.AddRentDetails[i].Address);
            $('#hdnState').val($scope.AddRentDetails[i].State);
            $('#hdnStateCode').val($scope.AddRentDetails[i].StateCode)
            $('#InvoiceNo').val($scope.AddRentDetails[i].InvoiceNo)
        ...
        $scope.AddChargeToRent = function () {
            ...
            if ($scope.SEZ == "SEZWP") {
                detailCharge.igst = ($scope.txtAddChargeAmount * 18) / 100;
                detailCharge.cgst = 0;
                detailCharge.sgst = 0;
            }
            ...
            detailCharge.InvoiceNo = $('#InvoiceNo').val();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if ($scope.AddRentDetails.length == 0) {
                ...
                if (conf == true) {
                    ...
                    for (i = 0; i < $scope.AddRentDetails.length; i++) {
                        $scope.AddRentDetails[i].InvoiceHtml = InvoiceHtml($scope.AddRentDetails[i])
                    }

                    $scope.ExportUnder = $('#SEZValue').val();

                    $scope.InvoiceObj.addeditflg = $scope.addeditflag;
                //    $scope.InvoiceObj.lstPrePaymentCont = $scope.AddRentDetails;
                       $scope.InvoiceObj.lstPrePaymentContt = $scope.AddRentDetails;
                  ...
                  //  $scope.InvoiceObj.InvoiceHtml = InvoiceHtml($scope.InvoiceObj)
                    RentInvoiceService.GenerateInvoice($scope.InvoiceObj, mon, yearv, $scope.AllChargesLst, $scope.ExportUnder).then(function (res) {
                        console.log(res);
                        debugger;
                       // $scope.InvoiceNo = res.data.Data.InvoiceNo;
                        ...
                        for (i = 0; i < $scope.AddRentDetails.length; i++) {
                            ...
                            $scope.CallInvoiceNo.push({ 'InvoiceNo': arr[i].split("#")[0], 'SupplyType': arr[i].split("#")[1] });
                            if (i == 0)
                            {
                                $scope.INV = arr[i].split("#")[0];

                            }
                            else
                            {
                                $scope.INV = $scope.INV + ',' + arr[i].split("#")[0];
                            }
                           
                        }
                        $('#BtnGenerateIRN').removeAttr('disabled');
                        $scope.Message = res.data.Message;
                        $scope.invoice = $scope.INV;
                        $('#btnSave').attr("disabled", true);
        ...
        $scope.GenerateIRN = function () {
            for (var i = 0; i < $scope.CallInvoiceNo.length; i++) {
                RentInvoiceService.GenerateIRNNo($scope.CallInvoiceNo[i].InvoiceNo, $scope.CallInvoiceNo[i].SupplyType).then(function (res) {
...
function InvoiceHtml(actualJson) {
    debugger;
    var RoAdd = "Regional  Office(Ahmedabad),<br/>Regional Manager,<br/>Central Warehousing Corporation,<br/>Mahalaxmi Char Rasta,<br/>Opp.Unnati Vidyalaya, Paladi,<br/>Ahmedabad-380 007";
    var CompanyName = "CONTAINER FREIGHT STATION";
    var CompanyAddress = "opp:Custom, Boundary of KPT,<br/>Near West Gate No.2.<br/>P.B.No.1,Kandla-317 310";
    var EmailAddress = "cwccfs-kpt@cewacor.nic.in";
    var InvoiceType = "Tax";
    var CompGST = "24AAACC1206D1ZM";
    var CompPAN = "AAACC1206D";
    var CompStateCode = "24";
    var Amt = 0;
    Amt = Number(actualJson.amount) + Number(actualJson.cgst) + Number(actualJson.sgst) + Number(actualJson.igst);
    var amtt = Amt.toFixed(2);

    var html1 = "<table style='width:100%;font-size:8pt;font-family:Verdana,Arial,San-serif;'><thead><tr><th style='width:20%;'><img style='width:50%;' src='IMGLeft' /></th><th style='width:60%;'></th><th style='width:20%;'><img style='width:70%;' src='IMGRight' /></th></tr><tr><th colspan='3' style='text-align:center;vertical-align:bottom;'>CENTRAL WAREHOUSING CORPORATION<br />(A GOVT. OF INDIA UNDERTAKING)<br/><span style='font-size:7pt;'>Rent Invoice</span></th></tr></thead><tbody><tr><td colspan='2' style='font-weight:600;'>" + RoAdd + "</td><td style='font-weight:600;'>" + CompanyName + "<br />" + CompanyAddress + "<br />" + EmailAddress + "</td></tr><tr><td colspan='3' style='text-align:center;padding-bottom:20pt;'><span style='border-bottom:1px solid #000;font-weight:600;'>" + (InvoiceType == "Tax" ? "TAX INVOICE" : "BILL OF SUPPLY") + "</span></td></tr><tr><td colspan='3'><table style='width:100%;font-size:8pt;font-family:Verdana,Arial,San-serif;'><tbody><tr><td style='width:30%;'>GSTIN-<span>" + CompGST + "</span><br />PAN NO.- <span>" + CompPAN + "</span><br />STATE CODE : <span>" + CompStateCode + "</span></td><td style='width:50%;'><table style='width:100%;font-size:8pt;font-family:Verdana,Arial,San-serif;'><thead><tr><th colspan='2' style='text-align:left;'>Details of Receiver ( Billed to)</th></tr></thead><tbody><tr><td style='width:45%;'>Name</td>";
    ...
    html1 += "<td><span>" + actualJson.PartyName + "</span></td></tr><tr><td>Address</td><td><span>" + actualJson.Address + "</span></td></tr><tr><td>State</td><td><span>" + actualJson.State + "</span></td></tr><tr><td>State Code</td><td><span>" + actualJson.StateCode + "</span></td></tr><tr><td>GSTIN/ Unique ID</td><td><span>" + actualJson.GSTNo + "</span></td></tr></tbody></table>";
    html1 += "</td><td></td></tr><tr><td colspan='2'><b>Invoice No. <span></span></b></td><td style='vertical-align:top;text-align: center;'><b>Date: <span>" + (new Date()).getDate() + "/" + ((new Date()).getMonth() + 1) + "/" + (new Date()).getFullYear() + "</span></b></td>";
   ...
   // });
    ...
    html1 += "Shipping Line. <span></span><br/>CFS Code No. <span></span><br/>Date & Time of Arrival (FN/AN): <span></span><br/>Date & Time of Destuffing (FN/AN)/ Delivery. <span></span><br/>Name of Importer. <span></span><br/>BOE No./Date <span></span><br/>BOL No./Date <span></span><br/>Name of CHA. <span></span><br/>No of Packages. <span></span><br/>Total Gross Weight. <span></span><br/>Gross Weight per Package. <span></span><br/>Storage space occupied <span></span><br/>Chargeable period for Storage space.";
   ...
   // $.each(cwcCharges, function (i, item) {
    html2 += "<tr><td style='border:1px solid #000;'>Rent</td><td style='border:1px solid #000;'><span>996929</span></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.amount + "</span></td><td style='border:1px solid #000;text-align:right;'><span></span></td><td style='border:1px solid #000;text-align:center;'><span>0.00</span></td><td style='border:1px solid #000;text-align:right;'><span>9%</span></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.cgst + "</span></td><td style='border:1px solid #000;text-align:right;'><span>9%</span></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.sgst + "</span></td><td style='border:1px solid #000;text-align:right;'><span>18%</span></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.igst + "</span></td><td style='border:1px solid #000;text-align:right;'><span>" + amtt + "</span></td></tr>";
   ...
   // });
    html2 += "<tr><td style='border:1px solid #000;padding-left:25px;'>CWC TDS</td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;text-align:center;'>0</td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td></tr>";
 //   var htCharges = $.grep(actualJson.lstPostPaymentChrg, function (item) { return item.ChargeType == 'HT' && item.Total > 0; });
  ...
  //  html2 += "<tr><td style='border:1px solid #000;padding-left:25px;'>H&T TDS</td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;text-align:center;'>" + actualJson.HTTDS.toFixed(2) + "</td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;'></td></tr>";
    ...
    html2 += "<tr><td colspan='12'>&nbsp;</td></tr><tr><td>Grand Total</td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.amount + "</span></td><td style='border:1px solid #000;text-align:right;'><span>" + /*actualJson.TDS.toFixed(2) +*/ "</span></td><td style='border:1px solid #000;text-align:right;'>0</td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.cgst + "</span></td><td style='border:1px solid #000;'></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.sgst + "</span></td><td style='border:1px solid #000;text-align:right;'><span></span></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.igst + "</span></td><td style='border:1px solid #000;text-align:right;'><span>" + amtt + "</span></td></tr>";
    ...
    html2 += "<tr><td>Round Up</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.round_up + "</span></td></tr>";
    html2 += "<tr><td>Grand Total(Rounded)</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td style='border:1px solid #000;text-align:right;'><span>" + actualJson.total + "</span></td></tr>";
    html2 += "<tr><td colspan='12'>TDS Deduction : 0<br/>TDS Collection : 0 <br/><br/>FIGURE IN WORDS: <span>" + CurrentcyToWord(actualJson.total).toUpperCase() + "</span></td></tr><tr><td colspan='12' style='padding:50pt 0pt;'><b>REMARKS:<span></span></b></td></tr>";
