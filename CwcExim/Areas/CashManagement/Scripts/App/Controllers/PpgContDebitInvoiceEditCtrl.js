(function () {
    ...
    controller('PpgContDebitInvoiceEditCtrl', function ($scope, PpgContDebitInvoiceEditService) {
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgContDebitInvoiceEditService.GetAppNoForYard("INVDEBT").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            $('.modalloader').show();
            PpgContDebitInvoiceEditService.GetYardInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                PpgContDebitInvoiceEditService.ContainerSelect($('#InvoiceDate').val(), $scope.InvoiceId, $scope.FumigationType, $scope.TaxType, $scope.PartyId, $scope.Size, $scope.ChargeDtl).then(function (res) {
                    $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgContDebitInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
