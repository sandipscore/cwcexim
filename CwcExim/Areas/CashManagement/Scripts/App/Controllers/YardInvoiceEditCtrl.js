(function () {
    ...
    controller('YardInvoiceEditCtrl', function ($scope, YardInvoiceEditService) {
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.ContainerSelect = function () {
            ...
            if (c > 0) {
                YardInvoiceEditService.ContainerSelect($scope.InvoiceId, $('#InvoiceDate').val(), $scope.StuffingReqId, $scope.TaxType, $scope.conatiners, $scope.OTHours, $scope.PartyId, $scope.PayeeId).then(function (res) {
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                YardInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
