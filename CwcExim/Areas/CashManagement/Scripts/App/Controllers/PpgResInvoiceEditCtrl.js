(function () {
    ...
    controller('PpgResInvoiceEditCtrl', function ($scope, PpgResInvoiceEditService) {
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgResInvoiceEditService.GetAppNoForYard("RESERV").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            $('.modalloader').show();
            PpgResInvoiceEditService.GetYardInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                if ($('#InvoiceNo').val() == '') {
                    ...
                    PpgResInvoiceEditService.ContainerSelect($('#InvoiceDate').val(), $scope.InvoiceId, $scope.FumigationType, $scope.TaxType, $scope.PartyId, $scope.Size, $scope.ChargeDtl).then(function (res) {
                        $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgResInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
