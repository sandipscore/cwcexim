(function () {
    ...
    controller('PpgFumigationInvoiceEditCtrl', function ($scope, PpgFumigationInvoiceEditService) {
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.GetInvNo = function () {
            ...
            debugger;
            PpgFumigationInvoiceEditService.GetAppNoForYard("Fumigation").then(function (res) {
                debugger;
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            $('.modalloader').show();
            PpgFumigationInvoiceEditService.GetYardInvoiceDetails($scope.InvoiceId).then(function (res) {
                $('.modalloader').hide();
                ...
                $scope.ChemicalId = $scope.InvoiceObj.ChemicalId;
                $scope.Chemical_Name = $scope.InvoiceObj.Chemical_Name;
                $scope.Area = $scope.InvoiceObj.Chemical_Name;
                $scope.Remarks = $scope.InvoiceObj.Remarks;

                var ChemicalDetails = {
                    "ChemicalId": $scope.ChemicalId,
                    "ChemicalName": $scope.Chemical_Name,
                    "Quantity": $scope.Area

                };
                $scope.conatiners = ChemicalDetails;
        ...
        $scope.ContainerSelect = function () {
            ...
            if ($('#InvoiceNo').val() == '') {
                ...
                PpgFumigationInvoiceEditService.ContainerSelect($('#InvoiceDate').val(), $scope.InvoiceId, $scope.FumigationType, $scope.TaxType, $scope.PartyId, $scope.Size, $scope.conatiners).then(function (res) {
                    $('.modalloader').hide();
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                PpgFumigationInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
