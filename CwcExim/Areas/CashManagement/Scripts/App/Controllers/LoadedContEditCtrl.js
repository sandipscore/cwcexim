(function () {
    ...
    controller('LoadedContInvoiceEditCtrl', function ($scope, LoadedContInvoiceEditService) {
        $scope.InvoiceNo = "";
        $scope.conatiners = [];
        $scope.Message = '';
        ...
        $scope.SelectInvoice = function (obj) {
            ...
            LoadedContInvoiceEditService.GetYardInvoiceDetails($scope.InvoiceId).then(function (res) {
        ...
        $scope.ContainerSelect = function () {
            ...
            if (c > 0) {
                LoadedContInvoiceEditService.ContainerSelect($scope.InvoiceId, $('#InvoiceDate').val(), $scope.StuffingReqId, $scope.TaxType, $scope.conatiners).then(function (res) {
        ...
        $scope.SubmitInvoice = function () {
            ...
            if (confirm('Are you sure to Update this Invoice?')) {
                ...
                LoadedContInvoiceEditService.GenerateInvoice($scope.InvoiceObj).then(function (res) {
