(function () {
    ...
    .service('PpgResInvoiceEditService', function ($http) {
        this.GetYardInvoiceDetails = function (InvoiceId) {
            return $http.get('/CashManagement/Ppg_CashManagement/GetResInvoiceDetails/?InvoiceId=' + InvoiceId);
        }
        this.ContainerSelect = function (InvoiceDate, InvoiceId, FumiType, TaxType, PartyId, Size, conatiners) {
            return $http({
                url: "/CashManagement/Ppg_CashManagement/GetResInvPaymentSheetForEdit?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.GenerateInvoice = function (InvoiceObj) {
            ...
            return $http({
                url: "/CashManagement/Ppg_CashManagement/EditResInvPaymentSheet/",
                method: "POST",
