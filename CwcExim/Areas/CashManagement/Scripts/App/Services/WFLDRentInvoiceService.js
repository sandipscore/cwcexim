(function () {
    ...
    .service('RentInvoiceService', function ($http) {
        this.GetYardInvoiceDetails = function (InvoiceId) {
            return $http.get('/CashManagement/WFLD_CashManagement/GetYardInvoiceDetails/?InvoiceId=' + InvoiceId);
        }
        ...
        this.PopulateMonthYear = function (month, year, flg, PayeeId) {
            return $http({
                url: "/CashManagement/WFLD_CashManagement/GetMonthYearRentData",
                method: "POST",
        ...
        this.GenerateInvoice = function (InvoiceObj, mon, yr, vm) {
            ...
            return $http({
                url: "/CashManagement/WFLD_CashManagement/AddEditRentInvoice/",
                method: "POST",
        ...
        this.GeneratePrint = function (InvoiceObj) {
            ...
            var Token = $('input[name="__RequestVerificationToken"]').val();
            return $http({
                url: "/Report/WFLD_ReportCWC/GetBulkInvoiceReport/",
                method: "POST",
                data: {
                    InvoiceNumber: invno,
                    InvoiceModule: 'Rent',
