(function () {
    ...
    .service('PpgContDebitInvoiceEditService', function ($http) {
        this.GetYardInvoiceDetails = function (InvoiceId) {
            return $http.get('/CashManagement/Ppg_CashManagement/GetContDebitInvoiceDetails/?InvoiceId=' + InvoiceId);
        }
        this.ContainerSelect = function (InvoiceDate, InvoiceId, FumiType, TaxType, PartyId, Size, conatiners) {
            return $http({
                url: "/CashManagement/Ppg_CashManagement/GetContDebitPaymentSheetForEdit?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.GenerateInvoice = function (InvoiceObj) {
            ...
            return $http({
                url: "/CashManagement/Ppg_CashManagement/EditContDebitPaymentSheet/",
                method: "POST",
