(function () {
    ...
    .service('PpgFumigationInvoiceEditService', function ($http) {
        this.GetYardInvoiceDetails = function (InvoiceId) {
            return $http.get('/CashManagement/Ppg_CashManagement/GetFumigationInvoiceDetails/?InvoiceId=' + InvoiceId);
        }
        this.ContainerSelect = function (InvoiceDate,InvoiceId,FumiType,  TaxType, PartyId, Size, conatiners) {
            return $http({
                url: "/CashManagement/Ppg_CashManagement/GetFumigationPaymentSheetForEdit?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.GenerateInvoice = function (InvoiceObj) {
            ...
            return $http({
                url: "/CashManagement/Ppg_CashManagement/EditFumiPaymentSheet/",
                method: "POST",
