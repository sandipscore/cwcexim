(function () {
    ...
    .service('RentInvoiceService', function ($http) {
        ...
        this.ContainerSelect = function (InvoiceId, InvoiceDate, AppraisementId, TaxType, conatiners) {
            return $http({
                url: "/Import/Ppg_CashManagement/GetContainerPaymentSheet/?InvoiceId=" + InvoiceId,
                method: "POST",
        ...
        this.PopulateMonthYear = function (month, year,flg,PayeeId) {
            return $http({
                url: "/CashManagement/Ppg_CashManagement/GetMonthYearRentData",
                method: "POST",
        ...
        this.GenerateInvoice = function (InvoiceObj, mon, yr,vm) {
            ...
            return $http({
                url: "/CashManagement/Ppg_CashManagement/AddEditRentInvoice/",
                method: "POST",
        ...
        this.GeneratePrint = function (InvoiceObj) {
           ...
           // for (i = 0; i < InvoiceObj.length; i++) {
                ...
                var Token = $('input[name="__RequestVerificationToken"]').val();
                return $http({
                    url: "/Report/Ppg_ReportCWC/GetBulkInvoiceReport/",
                    method: "POST",
                    data: {
                        InvoiceNumber: invno,
                        InvoiceModule: 'Rent',
