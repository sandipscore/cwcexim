...
namespace CwcExim.Areas.CashManagement.Models
{
    public class DSR_DebitInvoice
    {
       ...
       public int PayeeId { get; set; } = 0;
        ...
        public IList<DSRCharge> ChargeDetails { get; set; } = new List<DSRCharge>();
    ...
    public class DSRSearchEximTraderContainerDebit
    {
        public List<DSRPartyDet> lstExim { get; set; } = new List<DSRPartyDet>();
