...
{
    public class VRN_PostPaymentSheet
    {
        ...
        public IList<VRN_PostPaymentContainer> lstPostPaymentCont { get; set; } = new List<VRN_PostPaymentContainer>();
        public IList<VRN_PostPaymentContainer> lstStorPostPaymentCont { get; set; } = new List<VRN_PostPaymentContainer>();
        ...
        public IList<VRN_PreContainerWiseAmount> lstPreContWiseAmount { get; set; } = new List<VRN_PreContainerWiseAmount>();
        public IList<VRN_PreInvoiceCargo> lstPreInvoiceCargo { get; set; } = new List<VRN_PreInvoiceCargo>();
        public IList<VRN_PreInvoiceContainer> lstPrePaymentCont { get; set; } = new List<VRN_PreInvoiceContainer>();
        public List<VRN_CashReceipt> CashReceiptDetails { get; set; } = new List<VRN_CashReceipt>();
        ...
        public List<CfsCodewiseRateHT> lstCfsCodewiseRateHT = new List<CfsCodewiseRateHT>();
        ...
        //    {
        //        this.lstContWiseAmount.Add(new VRN_ContainerWiseAmount()
        //        {
        ...
        //        this.lstPostPaymentChrg.Add(new VRN_PostPaymentCharge()
        //        {
        ...
        //                        .ToList().ForEach(c =>
        //                    {
        //                        this.lstCfsCodewiseRateHT.Add(new CfsCodewiseRateHT
        //                        {
        //                            CFSCode = c.CFSCode,
        ...
        //        this.lstPostPaymentChrg = JsonConvert.DeserializeObject<IList<VRN_PostPaymentCharge>>(sortedString);
        //    }
        //    catch (Exception ex)
        //    {
    ...
    public class VRN_PostPaymentContainer
    {
        public string CFSCode { get; set; } = string.Empty;
    ...
    public class VRN_PostPaymentCharge
    {
    ...
    public class VRN_ContainerWiseAmount
    {
        ...
        public decimal CustomExamCharge { get; set; } = 0M;
    }


   
    public class VRN_ClauseTypeForHT
    {
    ...
    public class VRN_CfsCodewiseRateHT
    {
        public string CFSCode { get; set; } = string.Empty;
        public string Clause { get; set; } = string.Empty;      
        public string Size { get; set; } = string.Empty;
    ...
    public class VRN_OperationCFSCodeWiseAmount
    {
        public int InvoiceId { get; set; }
