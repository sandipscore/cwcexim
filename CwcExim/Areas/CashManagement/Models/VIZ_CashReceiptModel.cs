...
{
    public class VIZ_CashReceiptModel
    {
        ...
        public IList<VIZ_Invoice> InvoiceDetail { get; set; } = new List<VIZ_Invoice>();
        public IList<VIZ_PayBy> PayByDetail { get; set; } = new List<VIZ_PayBy>();

        public List<VIZ_Party> PartyDetail { get; set; } = new List<VIZ_Party>();

        public List<VIZ_CashReceiptInvoiveMapping> CashReceiptInvoiveMappingList { get; set; } = new List<VIZ_CashReceiptInvoiveMapping>();

        public int PayByPdaId { get; set; }
        public string PayBy { get; set; }
        public IList<VIZ_CashReceipt> CashReceiptDetail { get; set; } = new List<VIZ_CashReceipt>();
        ...
        public IList<VIZ_CwcChargesType> CWCChargeType { get; set; } = new List<VIZ_CwcChargesType>();
        public decimal TotalCwcCharges { get; set; } = 0;

        public IList<VIZ_HTChargesType> HTChargeType { get; set; } = new List<VIZ_HTChargesType>();
        public decimal TotalHTCharges { get; set; } = 0;

       
        public IList<VIZ_Container> ContainerDetail { get; set; } = new List<VIZ_Container>();
    ...
    public class VIZ_Invoice
    {
        public int InvoiceId { get; set; }
        public string InvoiceNo { get; set; }
    }

    public class VIZ_CashReceiptInvoiveMapping
    {
    ...
    public class VIZ_CwcChargesType
    {       
    ...
    public class VIZ_HTChargesType
    {       
        public string ChargeName { get; set; }
        public decimal Amount { get; set; } = 0;
        public decimal IGSTPer { get; set; } = 0;
