...
namespace CwcExim.Areas.CashManagement.Models
{
    ...
    public class LNSMOAAddMoney
    {
        ...
        public IList<LNSMOAReceiptDetails> Details { get; set; } = new List<LNSMOAReceiptDetails>();
    }

    public class LNSMOAReceiptDetails
    {
    ...
    public class LNSMOAListOfEximTrader
    {
        public int EximTraderId { get; set; }
        public string EximTraderName { get; set; }
        public string PartyCode { get; set; }
    }
    public class LNSMOASearchEximTraderData
    {
        public List<LNSMOAListOfEximTrader> lstExim { get; set; } = new List<LNSMOAListOfEximTrader>();
        public bool State { get; set; }
    }

    public class LNSMListOfOAAddMoney
    {
