...
namespace CwcExim.Areas.CashManagement.Models
{
    ...
    public class WFLDOAAddMoney
    {
        ...
        public IList<WFLDOAReceiptDetails> Details { get; set; } = new List<WFLDOAReceiptDetails>();
    }

    public class WFLDOAReceiptDetails
    {
    ...
    public class WFLDOAListOfEximTrader
    {
        public int EximTraderId { get; set; }
        public string EximTraderName { get; set; }
        public string PartyCode { get; set; }
    }
    public class WFLDOASearchEximTraderData
    {
        public List<WFLDOAListOfEximTrader> lstExim { get; set; } = new List<WFLDOAListOfEximTrader>();
        public bool State { get; set; }
    }

    public class WFLDListOfOAAddMoney
    {
