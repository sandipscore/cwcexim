...
{
    public class Kol_CashReceiptModel
    {
       ...
       // public int BranchId { get; set; }
        ...
        public List<Party> PartyDetail { get; set; } = new List<Party>();
    ...
    public class CashReceiptInvoiveMapping
    {
