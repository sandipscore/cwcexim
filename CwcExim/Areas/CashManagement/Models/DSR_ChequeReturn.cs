...
namespace CwcExim.Areas.CashManagement.Models
{
    ...
    public class DSR_ChequeReturn
    {
       ...
       // [Required(ErrorMessage = "Fill Out This Field")]
        ...
        public List<DSR_ChequeDetails> lstCheque { get; set; } = new List<DSR_ChequeDetails>();
        public bool State;
    }
    public class DSR_ChequeDetail
    {
    ...
    public class DSR_Cheques
    {
        public string ChequeDate { get; set; }
        public string DraweeBank { get; set; }
        public string Amount { get; set; }
    }
    public class DSR_ChequeDetails
    {
        public int PartyId { get; set; }
        public string PartyName { get; set; }
