...
{
    public class WFLD_WithdrawalMoneyPD
    {
    ...
    public class WFLD_AddMoneyToPDModelRefund
    {
        ...
        public IList<HDB_ReceiptDetailsRefund> Details { get; set; } = new List<HDB_ReceiptDetailsRefund>();
    ...
    public class WFLD_ReceiptDetailsRefund
    {
    ...
    public class WFLD_SDRefundList
    {
    ...
    public class WFLD_ViewSDRefund
    {
        public int PDAACId { get; set; }
        public int PartyId { get; set; }
        public string PartyName { get; set; }
