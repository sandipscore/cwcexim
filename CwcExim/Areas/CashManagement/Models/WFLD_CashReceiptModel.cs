...
{
    public class WFLD_CashReceiptModel
    {
        ...
        public IList<WFLDInvoice> InvoiceDetail { get; set; } = new List<WFLDInvoice>();
        public IList<WFLDPayBy> PayByDetail { get; set; } = new List<WFLDPayBy>();

        public List<WFLDParty> PartyDetail { get; set; } = new List<WFLDParty>();

        public List<WFLDCashReceiptInvoiveMapping> CashReceiptInvoiveMappingList { get; set; } = new List<WFLDCashReceiptInvoiveMapping>();

        public int PayByPdaId { get; set; }
        public string PayBy { get; set; }
        public IList<WFLDCashReceipt> CashReceiptDetail { get; set; } = new List<WFLDCashReceipt>();
        ...
        public IList<WFLDCwcChargesType> CWCChargeType { get; set; } = new List<WFLDCwcChargesType>();
        public decimal TotalCwcCharges { get; set; } = 0;

        public IList<WFLDHTChargesType> HTChargeType { get; set; } = new List<WFLDHTChargesType>();
        public decimal TotalHTCharges { get; set; } = 0;

        public IList<WFLDPdaAdjust> PdaAdjustdetail { get; set; } = new List<WFLDPdaAdjust>();
        public IList<WFLDContainer> ContainerDetail { get; set; } = new List<WFLDContainer>();
    ...
    public class WFLDInvoice
    {
        public int InvoiceId { get; set; }
        public string InvoiceNo { get; set; }
    }

    public class WFLDCashReceiptInvoiveMapping
    {
    ...
    public class WFLDCwcChargesType
    {
    ...
    public class WFLDHTChargesType
    {
        // public int DBChargeID { get; set; }
        // public string ChargeId { get; set; }
        // public string ChargeType { get; set; }
