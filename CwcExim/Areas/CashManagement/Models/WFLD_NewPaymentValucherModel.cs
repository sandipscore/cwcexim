...
{
    public class WFLD_NewPaymentValucherModel
    {
        ...
        public IList<WFLDExpensesDetails> expcharges { get; set; } = new List<WFLDExpensesDetails>();
       ...
       // [Display(Name = "Invoice No:")]
        //[Range(minimum: 0, maximum: int.MaxValue, ErrorMessage = "InitialReading must be greater than or Equal to 0.")]
        [RegularExpression("^[a-zA-Z0-9/-]*$", ErrorMessage = "Invalid charactes found")]
        [StringLength(maximumLength: 50, ErrorMessage = "maximum 120 character long")]
    ...
    public class WFLDExpensesDetails
    {
