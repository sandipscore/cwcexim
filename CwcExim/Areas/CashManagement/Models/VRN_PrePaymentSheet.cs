...
{
    public class VRN_PrePaymentSheet
    {
        public IList<VRN_PreInvoiceHeader> lstPreInvoiceHdr { get; set; } = new List<VRN_PreInvoiceHeader>();
        public IList<VRN_PreInvoiceContainer> lstPreInvoiceCont { get; set; } = new List<VRN_PreInvoiceContainer>();
    ...
    public class VRN_PreInvoiceHeader
    {
    ...
    public class VRN_PreInvoiceContainer
    {
    ...
    public class VRN_PreContainerWiseAmount
    {
    ...
    public class VRN_PreInvoiceCargo
    {
