(function () {
    ...
    controller('WFLDHTChargesCtrl', function ($scope, WFLDHTChargesService, $http) {
        var t2 = 0;
       ...
       // $scope.Size = '';
        ...
        $scope.EditHTCharges = function (HTChargesId) {
            ...
            $('#DivBody').load('/Master/WFLDMaster/EditHTCharges?HTChargesId=' + HTChargesId);
        ...
        $scope.ViewHTCharges = function (HTChargesId) {
            debugger;
            //var HTChargesId = $('#HTChargesId').val();
            $('#DivBody').load('/Master/WFLDMaster/ViewHTCharges?HTChargesId=' + HTChargesId);
        ...
        function GetSlab() {
            ...
            //WFLDHTChargesService.GetSlab($scope.Size, $scope.ChargesFor).then(function (response) {
                ...
                if (HTChargesId > 0) {
                    //WFLDHTChargesService.EditHTChargesOther(HTChargesId).then(function (res) {
                    //    debugger;
                    ...
                    //        $scope.CbmSlab = res.data.CbmSlab == 1 ? true : false
                    ...
                    //    }
                    //});
                    WFLDHTChargesService.GetSlabChargeDtl(HTChargesId).then(function (response) {
                        debugger;
                        console.log(response.data);
        ...
        WFLDHTChargesService.GetAllHTCharges().then(function (response) {
            debugger;
            // console.log(response.data);
        ...
        $scope.AddHTCharges = function () {
            ...
            if ($scope.Slab == 'WithSlab') {
                ...
                //        'FromWtSlabCharge': '0',
                //        'ToWtSlabCharge': '0',
                //        'DisSlabId': '0',//DistanceSlabId,
                //        'FromDisSlabCharge': $('#FromDisSlabCharge').val(),//FromDistanceSlab,
                //        'ToDisSlabCharge': $('#ToDisSlabCharge').val(),//ToDistanceSlab,
                //        'CwcRate': $('#RateCWC').val(),
                //        'ContractorRate': $('#ContractorRate').val(),
                //        'RoundTripRate': $('#RoundTripRate').val(),
                //        'EmptyRate': $('#EmptyRate').val(),
            ...
            if ($scope.ChargeList.length != 0) {
                ...
                Obj = {
                   ...
                   // SlabType: $scope.SlabType,
                    ...
                    IsODC: $('#IsODC').val()// $scope.IsODC //== true ? 1 : 0
                }

                WFLDHTChargesService.SaveHTCharges(Obj, $scope.ChargeList).then(function (res) {
                    debugger;
