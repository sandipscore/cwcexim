(function () {
    ...
    controller('CHNHTChargesCtrl', function ($scope, CHNHTChargesService, $http) {
        ...
        $scope.EditHTCharges = function (HTChargesId) {
            ...
            $('#DivBody').load('/Master/CHNMaster/EditHTCharges?HTChargesId=' + HTChargesId);
        ...
        $scope.ViewHTCharges = function (HTChargesId) {
            debugger;
            //var HTChargesId = $('#HTChargesId').val();
            $('#DivBody').load('/Master/CHNMaster/ViewHTCharges?HTChargesId=' + HTChargesId);
        ...
        $scope.Reset = function () {
            $('#DivBody').load('/Master/CHNMaster/CreateHTCharges');
        }
