(function () {
    ...
    controller('DNDHTChargesCtrl', function ($scope, DNDHTChargesService, $http) {
        var t2 = 0;
        ...
        $scope.EditHTCharges = function (HTChargesId) {
            ...
            $('#DivBody').load('/Master/DNODEMaster/EditHTCharges?HTChargesId=' + HTChargesId);
        ...
        $scope.ViewHTCharges = function (HTChargesId) {
            debugger;
            //var HTChargesId = $('#HTChargesId').val();
            $('#DivBody').load('/Master/DNODEMaster/ViewHTCharges?HTChargesId=' + HTChargesId);
        ...
        function GetSlab() {
            ...
            DNDHTChargesService.GetSlab($scope.Size, $scope.ChargesFor).then(function (response) {
                debugger;
                ...
                if (HTChargesId > 0) {
                    DNDHTChargesService.EditHTChargesOther(HTChargesId).then(function (res) {
                        debugger;
                        ...
                        if (res.data.SlabType == 1) {
                            ...
                            $scope.IsITP = res.data.IsITP == 1 ? true : false
                            $('#chargeslab').show();
                        }
                        else {
                    ...
                    DNDHTChargesService.GetSlabChargeDtl(HTChargesId).then(function (response) {
                        debugger;
        ...
        DNDHTChargesService.GetAllHTCharges().then(function (response) {
            debugger;
            // console.log(response.data);
        ...
        $scope.Reset = function () {
            $('#DivBody').load('/Master/DNODEMaster/CreateHTCharges');
        }
        ...
        $scope.SaveHTCharges = function () {
            ...
            if ($scope.ChargeList.length != 0) {
                Obj = {
                    ...
                    IsITP: $scope.IsITP == true ? 1 : 0
                }

                DNDHTChargesService.SaveHTCharges(Obj, $scope.ChargeList).then(function (res) {
                    debugger;
