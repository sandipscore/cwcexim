(function () {
    ...
    controller('DSRHTChargesCtrl', function ($scope, DSRHTChargesService, $http) {
        var t2 = 0;
        ...
        $scope.EditHTCharges = function (HTChargesId) {
            ...
            $('#DivBody').load('/Master/DSRMaster/EditHTCharges?HTChargesId=' + HTChargesId);
        ...
        $scope.ViewHTCharges = function (HTChargesId) {
            debugger;
            //var HTChargesId = $('#HTChargesId').val();
            $('#DivBody').load('/Master/DSRMaster/ViewHTCharges?HTChargesId=' + HTChargesId);
        ...
        function GetSlab() {
            ...
            if (HTChargesId > 0) {
                ...
                DSRHTChargesService.GetSlabChargeDtl(HTChargesId).then(function (response) {
                    debugger;
        ...
        DSRHTChargesService.GetAllHTCharges().then(function (response) {
            debugger;
            // console.log(response.data);
        ...
        $scope.AddHTCharges = function () {
            ...
            //DSRHTChargesService.GetSlab($scope.Size, $scope.ChargesFor).then(function (response) {
            //    debugger;
            //    //console.log(response.data);
        ...
        $scope.Reset = function () {
            $('#DivBody').load('/Master/DSRMaster/CreateHTCharges');
        }
        ...
        $scope.SaveHTCharges = function () {
            ...
            if ($scope.ChargeList.length != 0) {
                ...
                DSRHTChargesService.SaveHTCharges(Obj, $scope.ChargeList).then(function (res) {
                    debugger;
