(function () {
    ...
    controller('CHNHTChargesCtrl', function ($scope, CHNHTChargesService, $http) {
        var t2 = 0;
        ...
        $scope.EditHTCharges = function (HTChargesId) {
            ...
            $('#DivBody').load('/Master/TTUNMaster/EditHTCharges?HTChargesId=' + HTChargesId);
        ...
        $scope.ViewHTCharges = function (HTChargesId) {
            debugger;
            //var HTChargesId = $('#HTChargesId').val();
            $('#DivBody').load('/Master/TTUNMaster/ViewHTCharges?HTChargesId=' + HTChargesId);
        ...
        function GetSlab() {
            ...
            CHNHTChargesService.GetSlab($scope.Size, $scope.ChargesFor).then(function (response) {
                debugger;
                ...
                if (HTChargesId > 0) {
                    CHNHTChargesService.EditHTChargesOther(HTChargesId).then(function (res) {
                        debugger;
                    ...
                    CHNHTChargesService.GetSlabChargeDtl(HTChargesId).then(function (response) {
                        debugger;
        ...
        CHNHTChargesService.GetAllHTCharges().then(function (response) {
            debugger;
            // console.log(response.data);
        ...
        $scope.Reset = function () {
            $('#DivBody').load('/Master/TTUNMaster/CreateHTCharges');
        }
        ...
        $scope.SaveHTCharges = function () {
            ...
            if ($scope.ChargeList.length != 0) {
                ...
                CHNHTChargesService.SaveHTCharges(Obj, $scope.ChargeList).then(function (res) {
                    debugger;
