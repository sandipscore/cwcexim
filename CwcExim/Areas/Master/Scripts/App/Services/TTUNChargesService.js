(function () {
    ...
    .service('CHNHTChargesService', function ($http) {
        this.GetSlab = function (Size, ChargesFor, OperationCode) {
            debugger;
            return $http.get("/Master/TTUNMaster/GetSlabData?Size=" + Size + "&ChargesFor=" + ChargesFor + "&OperationCode=" + OperationCode);
        }
        this.SaveHTCharges = function (Obj, ChargeList) {
            if (confirm("Are you sure you want to save?")) {
                ...
                console.log(Obj);
                return $http({
                    url: "/Master/TTUNMaster/AddEditHTCharges/",
                    method: "POST",
        ...
        this.EditHTChargesOther = function (HTChargesId) {
            return $http.get("/Master/TTUNMaster/EditHTChargesOther/?HTChargesId=" + HTChargesId);

        }
        this.GetAllHTCharges = function () {
            return $http.get("/Master/TTUNMaster/GetAllHTCharges");
        }
        this.GetSlabChargeDtl = function (HTChargesId) {
            return $http.get("/Master/TTUNMaster/GetHTSlabChargesDtl/?HTChargesId=" + HTChargesId);
        }
    });
})()