...
{
    public class VLDAMasterController : Controller
    {
        ...
        {
            VLDA_RateRepository objCR = new VLDA_RateRepository();
            objCR.ListOfSACCode();
        ...
        public JsonResult AddEditEntryRateFees(WFLDStorageCharge objStorage)
        {
            ...
            {
                VLDA_RateRepository objRepository = new VLDA_RateRepository();
        ...
        public ActionResult EditMiscRateFees(int StorageChargeId)
        {
            ...
            VLDA_RateRepository objRepo = new VLDA_RateRepository();
        ...
        {
            VLD_MasterRepository objCR = new VLD_MasterRepository();
            objCR.ListOfSACCode();
            if (objCR.DBResponse.Data != null)
        ...
        {
            VLD_MasterRepository ObjCC = new VLD_MasterRepository();
            ObjCC.ListOfSACCode();
            ...
            VLD_MasterRepository objMR = new VLD_MasterRepository();
            if (StorageChargeId > 0)
            {
        ...
        public ActionResult EditMiscellaneous(int MiscellaneousId)
        {
            ...
            {
                VLD_MasterRepository ObjCWCR = new VLD_MasterRepository();
                ObjCWCR.ListOfSACCode();
                if (ObjCWCR.DBResponse.Data != null)
                    ViewBag.ListOfSAC = ObjCWCR.DBResponse.Data;
                else
                    ViewBag.ListOfSAC = null;
                VLD_MasterRepository objRR = new VLD_MasterRepository();
        ...
        {
            VLD_MasterRepository ObjETR = new VLD_MasterRepository();
        ...
        {
            VLD_MasterRepository objPort = new VLD_MasterRepository();
        ...
        {
            VLD_MasterRepository objHT = new VLD_MasterRepository();
        ...
        public ActionResult EditHTCharges(int HTChargesId)
        {
            ...
            //    objHT.LstOperation = (IList<Operation>)objOR.DBResponse.Data;
            //}
            VLD_MasterRepository objHTRepo = new VLD_MasterRepository();
        ...
        {
            VLD_MasterRepository ObjPR = new VLD_MasterRepository();
            List<WFLDPort> LstPort = new List<WFLDPort>();
            ObjPR.GetAllPort();
        ...
        {
            VLD_MasterRepository ObjSR = new VLD_MasterRepository();
        ...
        public ActionResult CreateSDopening()
        {
            ...
            VLD_MasterRepository ObjRepo = new VLD_MasterRepository();
        ...
        {
            VLD_MasterRepository ObjSDR = new VLD_MasterRepository();
        ...
        public ActionResult EditYard(int YardId)
        {
            ...
            if (YardId > 0)
            {
                VLD_MasterRepository ObjYR = new VLD_MasterRepository();
        ...
        public ActionResult ViewOperation(int OperationId)
        {
            ...
            if (OperationId > 0)
            {
                VLD_MasterRepository ObjOR = new VLD_MasterRepository();
        ...
        public JsonResult AddEditEntryFees(WFLDCWCEntryFees objEF)
        {
            if (ModelState.IsValid)
            {
                VLD_MasterRepository objRepository = new VLD_MasterRepository();
        ...
        public ActionResult EditWeighment(int WeighmentId)
        {
            ...
            VLD_MasterRepository objCCR = new VLD_MasterRepository();
            if (WeighmentId > 0)
            {
        ...
        public ActionResult EditGodown(int GodownId)
        {
            ...
            if (GodownId > 0)
            {
                VLD_MasterRepository ObjGR = new VLD_MasterRepository();
        ...
        public ActionResult CreatePartyInsurance()
        {
            ...
            VLD_MasterRepository ObjIR = new VLD_MasterRepository();
        ...
        {
            VLD_MasterRepository ObjCh = new VLD_MasterRepository();
        ...
        {
            VLD_MasterRepository objbank = new VLD_MasterRepository();
        ...
        public ActionResult GetBankList()
        {
            ...
            VLD_MasterRepository ObjBR = new VLD_MasterRepository();
            ObjBR.GetAllBank();
        ...
        {
            VLD_MasterRepository objImport = new VLD_MasterRepository();
        ...
        #region CWCChargesForEximTraders

        [HttpGet]
        public ActionResult CreateCWCChargesForEximTraders()
        {
            return PartialView("CreateCWCChargesForEximTraders");
        }
        ...
        [HttpGet]
        public ActionResult CreateStorageChargeForEximTraders()
        {
            VLD_MasterRepository objCR = new VLD_MasterRepository();
            objCR.ListOfSACCode();
            if (objCR.DBResponse.Data != null)
            ...
            return PartialView("CreateStorageChargeForEximTraders");
        }

        public JsonResult GetPartyNameForEximTraders(int Page, string PartyCode)
        {
            VLD_MasterRepository obj = new VLD_MasterRepository();
            obj.GetPartyNameForStorageChargeForEximTraders(Page, PartyCode);
            return Json(obj.DBResponse, JsonRequestBehavior.AllowGet);
        }
        [HttpGet]
        public ActionResult EditStorageChargeForEximTraders(int StorageChargeId)
        {
            VLD_MasterRepository ObjCC = new VLD_MasterRepository();
            ObjCC.ListOfSACCode();
            if (ObjCC.DBResponse.Data != null)
            ...
            if (StorageChargeId > 0)
            {
                objMR.GetStorageChargeForEximTraders(StorageChargeId);
                if (objMR.DBResponse.Data != null)
                {
                    ObjStorageCharge = (WFLDCWCStorageCharge)objMR.DBResponse.Data;
                }
            }
            return PartialView("EditStorageChargeForEximTraders", ObjStorageCharge);
        }

        [HttpGet]
        public ActionResult StorageChargeListForEximTraders()
        {
            VLD_MasterRepository ObjCR = new VLD_MasterRepository();
            List<WFLDCWCStorageCharge> LstStorageCharges = new List<WFLDCWCStorageCharge>();
            ObjCR.GetAllStorageChargeForEximTraders();
            if (ObjCR.DBResponse.Data != null)
            {
                LstStorageCharges = (List<WFLDCWCStorageCharge>)ObjCR.DBResponse.Data;
            }
            return PartialView("StorageChargeListForEximTraders", LstStorageCharges);
        }

        [HttpPost, ValidateAntiForgeryToken]
        public ActionResult AddEditStorageChargeForEximTraders(WFLDCWCStorageCharge ObjStorageCharge)
        {
            if (ModelState.IsValid)
            {
                VLD_MasterRepository ObjCR = new VLD_MasterRepository();
                Login ObjLogin = (Login)Session["LoginUser"];
                ObjStorageCharge.Uid = ObjLogin.Uid;
                ObjCR.AddEditStorageChargeForEximTraders(ObjStorageCharge);
                ModelState.Clear();
                return Json(ObjCR.DBResponse);
            }
            else
        ...
        #region Misc Charges For Exim Traders

        public ActionResult CreateVLDAChargesForEximTraders()
        {
            VLDA_RateRepository objCR = new VLDA_RateRepository();
            objCR.ListOfSACCode();
            if (objCR.DBResponse.Data != null)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditEntryRateFeesForEximTraders(WFLDStorageCharge objStorage)
        {
            if (ModelState.IsValid)
            {
                VLDA_RateRepository objRepository = new VLDA_RateRepository();
                objRepository.AddEditMstRateFeesForEximTraders(objStorage, ((Login)Session["LoginUser"]).Uid);
                return Json(objRepository.DBResponse, JsonRequestBehavior.AllowGet);
            }
            else
            {
        ...
        [HttpGet]
        public ActionResult GetAllMiscRateFeesForEximTraders()
        {
            List<WFLDStorageCharge> lstMiscRateFees = new List<WFLDStorageCharge>();
            VLDA_RateRepository objCR = new VLDA_RateRepository();
            objCR.GetAllMiscRateFeesForEximTraders(0);
            if (objCR.DBResponse.Data != null)
                lstMiscRateFees = (List<WFLDStorageCharge>)objCR.DBResponse.Data;
            return PartialView("MiscRateFeesListForEximTraders", lstMiscRateFees);
        }

        [HttpGet]
        public ActionResult EditMiscRateFeesForEximTraders(int StorageChargeId)
        {
            WFLDStorageCharge objSC = new WFLDStorageCharge();
            VLDA_RateRepository objRepo = new VLDA_RateRepository();
            objRepo.ListOfSACCode();
            ...
            if (StorageChargeId > 0)
            {
                objRepo.GetAllMiscRateFeesForEximTraders(StorageChargeId);
                if (objRepo.DBResponse.Data != null)
                    objSC = (WFLDStorageCharge)objRepo.DBResponse.Data;
            }
            return PartialView("EditMiscRateFeesForEximTraders", objSC);
        }
        ...
        [HttpGet]
        public ActionResult CreateWeighmentForEximTraders()
        {
            VLD_MasterRepository objCR = new VLD_MasterRepository();
            objCR.ListOfSACCode();
            if (objCR.DBResponse.Data != null)
        ...
        [HttpPost, ValidateAntiForgeryToken]
        public JsonResult AddEditWeighmentForEximTraders(WFLDCWCWeighment objCW)
        {
            if (ModelState.IsValid)
            {
                VLD_MasterRepository objCR = new VLD_MasterRepository();
                objCR.AddEditMstWeighmentForEximTraders(objCW, ((Login)Session["LoginUser"]).Uid);
                return Json(objCR.DBResponse);
            }
            else
            {
        ...
        [HttpGet]
        public ActionResult GetAllWeighmentForEximTraders()
        {
            List<WFLDCWCWeighment> lstWeighment = new List<WFLDCWCWeighment>();
            VLD_MasterRepository objCR = new VLD_MasterRepository();
            objCR.GetWeighmentDetForEximTraders(0);
            if (objCR.DBResponse.Data != null)
                lstWeighment = (List<WFLDCWCWeighment>)objCR.DBResponse.Data;
            return PartialView("WeighmentListForEximTraders", lstWeighment);
        }
        [HttpGet]
        public ActionResult EditWeighmentForEximTraders(int WeighmentId)
        {
            WFLDCWCWeighment objCW = new WFLDCWCWeighment();
            VLD_MasterRepository objCCR = new VLD_MasterRepository();
            if (WeighmentId > 0)
            {
                ...
                if (objCCR.DBResponse.Data != null)
                    ...
                    ViewBag.ListOfSAC = null;
                objCCR.GetWeighmentDetForEximTraders(WeighmentId);
                if (objCCR.DBResponse.Data != null)
                    objCW = (WFLDCWCWeighment)objCCR.DBResponse.Data;
            }
            return PartialView(objCW);
        ...
        #region HTCharges For Exim Traders
        public ActionResult CreateHTChargesForEximTraders()
        {
            VLD_MasterRepository objPort = new VLD_MasterRepository();
            WFLDHTCharges objHT = new WFLDHTCharges();
            List<WFLDPort> LstPort = new List<WFLDPort>();
        ...
        [HttpGet]
        public JsonResult GetSlabDataForEximTraders(string Size, string ChargesFor, string OperationCode)
        {
            VLD_MasterRepository objHT = new VLD_MasterRepository();
            objHT.GetSlabDataForEximTraders(Size, ChargesFor, OperationCode);
            WFLDHTCharges lstSlab = new WFLDHTCharges();
            if (objHT.DBResponse.Data != null)
                lstSlab = (WFLDHTCharges)objHT.DBResponse.Data;
            return Json(lstSlab, JsonRequestBehavior.AllowGet);
        }
        public JsonResult GetHTSlabChargesDtlForEximTraders(int HTChargesID)
        {
            VLD_MasterRepository objHT = new VLD_MasterRepository();
            objHT.GetHTSlabChargesDtlForEximTraders(HTChargesID);
            List<WFLDChargeList> lstSlab = new List<WFLDChargeList>();
            if (objHT.DBResponse.Data != null)
                lstSlab = (List<WFLDChargeList>)objHT.DBResponse.Data;
            return Json(lstSlab, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        public ActionResult EditHTChargesForEximTraders(int HTChargesId)
        {
            ...
            VLD_MasterRepository objHTRepo = new VLD_MasterRepository();
            objHTRepo.GetHTChargesDetailsForEximTraders(HTChargesId);
            if (objHTRepo.DBResponse.Data != null)
            {
                objHT = (WFLDHTCharges)objHTRepo.DBResponse.Data;
                objOR.GetAllMstOperation();
        ...
        [HttpGet]
        public JsonResult EditHTChargesOtherForEximTraders(int HTChargesId)
        {
            WFLDHTCharges objHT = new WFLDHTCharges();
            VLD_MasterRepository objHTRepo = new VLD_MasterRepository();
            objHTRepo.GetHTChargesDetailsForEximTraders(HTChargesId);
        ...
        [HttpGet]
        public ActionResult ViewHTChargesForEximTraders(int HTChargesId)
        {
            WFLDHTCharges objHT = new WFLDHTCharges();
            ContractorRepository objCR = new ContractorRepository();
            OperationRepository objOR = new OperationRepository();
            ...
            return PartialView("ViewHTChargesForEximTraders", objHT);
        }

        [HttpPost]
        public JsonResult AddEditHTChargesForEximTraders(WFLDHTCharges objCharges, String ChargeList)
        {
            string ChargeListXML = "";
            if (ChargeList != null)
            {
            ...
            //{
            int Uid = ((Login)Session["LoginUser"]).Uid;
            objHTRepo.AddEditHTChargesForEximTraders(objCharges, ((Login)Session["LoginUser"]).Uid, ChargeListXML);
            return Json(objHTRepo.DBResponse);
           
        }
       
        [HttpGet]
        public JsonResult GetAllHTChargesForEximTraders()
        {
            VLD_MasterRepository objHT = new VLD_MasterRepository();
            objHT.GetAllHTChargesForEximTraders();
            //IList<HDBHTCharges> lstCharges = new List<HDBHTCharges>();
            WFLDHTCharges lstCharges = new WFLDHTCharges();
            if (objHT.DBResponse.Data != null)
                lstCharges = (WFLDHTCharges)objHT.DBResponse.Data;
        ...
        [HttpGet]
        public ActionResult CreateGroundRentForEximTraders()
        {
            VLD_MasterRepository objCR = new VLD_MasterRepository();
            objCR.ListOfSACCode();
            if (objCR.DBResponse.Data != null)
        ...
        [HttpGet]
        public ActionResult GroundRentListForEximTraders()
        {
            IList<VLDACWCChargesGroundRent> objGR = new List<VLDACWCChargesGroundRent>();
            VLD_MasterRepository objCR = new VLD_MasterRepository();
            objCR.GetAllGroundRentDetForEximTraders();
            if (objCR.DBResponse.Data != null)
                objGR = (List<VLDACWCChargesGroundRent>)objCR.DBResponse.Data;
            return PartialView(objGR);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult AddEditMstGroundRentForEximTraders(VLDACWCChargesGroundRent objCWC)
        {
         
            if (ModelState.IsValid)
            {
                VLD_MasterRepository objCR = new VLD_MasterRepository();
                objCR.AddEditMstGroundRentForEximTraders(objCWC, ((Login)Session["LoginUser"]).Uid);
                return Json(objCR.DBResponse);
            }
            else
            {
        ...
        [HttpGet]
        public ActionResult EditGroundRentForEximTraders(int GroundRentId)
        {
            VLD_MasterRepository objCR = new VLD_MasterRepository();
            VLDACWCChargesGroundRent objCGR = new VLDACWCChargesGroundRent();
            objCR.ListOfSACCode();
            if (objCR.DBResponse.Data != null)
                ViewBag.ListOfSAC = objCR.DBResponse.Data;
            else
            ...
            if (GroundRentId > 0)
            {
                objCR.GetGroundRentDetForEximTraders(GroundRentId);
                if (objCR.DBResponse.Data != null)
                    objCGR = (VLDACWCChargesGroundRent)objCR.DBResponse.Data;
            }
            return PartialView(objCGR);
        }
