...
{
    public class DSRLocationController : Controller 
    {
        // GET: Master/DSRLocation
        ...
        public ActionResult GetLocationList()
        {
            ...
            {
                LstLocation = (List<DSRLocation>)ObjCR.DBResponse.Data;
            }
        ...
        public ActionResult EditLocation(int LocationId)
        {
            ...
            if (LocationId > 0)
            {
                ...
                if (ObjCR.DBResponse.Data != null)
                {
                    ObjLocation = (DSRLocation)ObjCR.DBResponse.Data;
                }
            }
        ...
        public ActionResult AddEditLocationDetail(DSRLocation ObjLocation)
        {
