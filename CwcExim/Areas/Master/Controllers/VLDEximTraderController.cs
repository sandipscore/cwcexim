...
{
    public class VLDEximTraderController : BaseController
    {
        ...
        {
            var objRepo = new VLD_MasterRepository();
        ...
        public JsonResult AddEditPartyWiseTDSDeposit(WFLDPartyWiseTDSDeposit objPartyWiseTDSDeposit)
        {
            if (ModelState.IsValid)
            {
                VLD_MasterRepository objER = new VLD_MasterRepository();
        ...
        public ActionResult CreateEximTraderFncControl()
        {
            ...
            VLD_MasterRepository ObjETFCR = new VLD_MasterRepository();
