...
{
    public class CHNMasterController : Controller
    {
        ...
        {
            CHN_RateRepository objCR = new CHN_RateRepository();
            objCR.ListOfSACCode();
        ...
        public JsonResult AddEditEntryRateFees(CHNStorageCharge objStorage)
        {
            ...
            {
                CHN_RateRepository objRepository = new CHN_RateRepository();
        ...
        public ActionResult EditMiscRateFees(int StorageChargeId)
        {
            ...
            CHN_RateRepository objRepo = new CHN_RateRepository();
        ...
        {
            CHNMasterRepository ObjCC = new CHNMasterRepository();
            ObjCC.ListOfSACCode();
            ...
            CHNMasterRepository objMR = new CHNMasterRepository();
            if (StorageChargeId > 0)
            {
        ...
        {
            CHNMasterRepository objPort = new CHNMasterRepository();
        ...
        {
            CHNMasterRepository objHT = new CHNMasterRepository();
        ...
        public ActionResult EditHTCharges(int HTChargesId)
        {
            ...
            //    objHT.LstOperation = (IList<Operation>)objOR.DBResponse.Data;
            //}
            CHNMasterRepository objHTRepo = new CHNMasterRepository();
        ...
        {
            CHNMasterRepository ObjPR = new CHNMasterRepository();
            List<CHNPort> LstPort = new List<CHNPort>();
            ObjPR.GetAllPort();
            if (ObjPR.DBResponse.Data != null)
            {
                LstPort = (List<CHNPort>)ObjPR.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditPortDetail(CHNPort ObjPort)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult EditPort(int PortId)
        {
            ...
            if (PortId > 0)
            {
                ...
                if (ObjPR.DBResponse.Data != null)
                {
                    ObjPort = (CHNPort)ObjPR.DBResponse.Data;
                }
                CountryRepository ObjCR = new CountryRepository();
                ObjCR.GetAllCountry();
                if (ObjCR.DBResponse.Data != null)
        ...
        public ActionResult CreateSDopening()
        {
            ...
            CHNMasterRepository ObjRepo = new CHNMasterRepository();
            CHNSDOpening ObjSD = new CHNSDOpening();
            ObjRepo.GetEximTrader();
            if (ObjRepo.DBResponse.Data != null)
            {
                ObjSD.LstEximTrader = (List<CHNSDOpening>)ObjRepo.DBResponse.Data;
            }
        ...
        public ActionResult GetSDList()
        {
            ...
            List<CHNSDOpening> LstSD = new List<CHNSDOpening>();
            ObjSDR.GetAllSDOpening();
            if (ObjSDR.DBResponse.Data != null)
            {
                LstSD = (List<CHNSDOpening>)ObjSDR.DBResponse.Data;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddEditSDopening(CHNSDOpening ObjSD)
        {
            if (ModelState.IsValid)
            {
                CHNMasterRepository ObjSDR = new CHNMasterRepository();
        ...
        public JsonResult AddEditEntryFees(CHNCWCEntryFees objEF)
        {
            if (ModelState.IsValid)
            {
                CHNMasterRepository objRepository = new CHNMasterRepository();
        ...
        public ActionResult EditWeighment(int WeighmentId)
        {
            ...
            CHNMasterRepository objCCR = new CHNMasterRepository();
            if (WeighmentId > 0)
            {
