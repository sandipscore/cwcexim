...
namespace CwcExim.Areas.Master.Models
{
    public class DSRHTCharges
    {
        ...
        public IList<DSRWeightSlab> LstWeightSlab { get; set; } = new List<DSRWeightSlab>();
        public IList<DSRDistanceSlab> LstDistanceSlab { get; set; } = new List<DSRDistanceSlab>();

        public IList<DSRChargeList> LstCharge { get; set; } = new List<DSRChargeList>();

        public IList<Contractor> LstContractor { get; set; } = new List<Contractor>();

        public IList<DSRViewList> LstviewList { get; set; } = new List<DSRViewList>();
