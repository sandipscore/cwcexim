...
{
    public class DSREximTraderFinanceControl
    {
    ...
    public class DSRListOfEximTraderFinanceControl
    {
        public int EximTraderId { get; set; }
        public string EximTraderName { get; set; }
        public string PartyCode { get; set; }
    ...
    public class DSRSearchEximTraderDataFinanceControl
    {

        public List<DSRListOfEximTraderFinanceControl> lstExim { get; set; } = new List<DSRListOfEximTraderFinanceControl>();
