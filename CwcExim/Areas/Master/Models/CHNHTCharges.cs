...
namespace CwcExim.Areas.Master.Models
{
    public class CHNHTCharges
    {
        ...
        public IList<CHNWeightSlab> LstWeightSlab { get; set; } = new List<CHNWeightSlab>();
        public IList<CHNDistanceSlab> LstDistanceSlab { get; set; } = new List<CHNDistanceSlab>();

        public IList<CHNChargeList> LstCharge { get; set; } = new List<CHNChargeList>();

        public IList<Contractor> LstContractor { get; set; } = new List<Contractor>();

        public IList<CHNViewList> LstviewList { get; set; } = new List<CHNViewList>();
        public IList<CHNPort> LstPort = new List<CHNPort>();

    }
    public class CHNWeightSlab
    {
