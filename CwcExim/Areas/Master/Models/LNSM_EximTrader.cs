...
{
    public class LNSM_EximTrader //: EximTraderBase
    {
        ...
        [StringLength(100, ErrorMessage = "Exim Trader Name Cannot Be More Than 100 OR Less Than 3 Characters")]
        ...
        [StringLength(20, ErrorMessage = "Exim Trader Alias Cannot Be More Than 20 Characters In Length")]
        ...
        [Display(Name = "RailOperator")]
        public bool RailOperator { get; set; }
        ...
        public string EximAddress { get; set; }
        public bool Forwarder { get; set; }
        public List<LNSM_EximTraderAddress> AddressList { get; set; }
    }
    public class LNSM_EximTraderAddress //: EximTraderBase
    {
