...
{
    public class PpgEximTraderFinanceControl
    {
    ...
    public class ListOfEximTraderFinanceControl
    {
        public int EximTraderId { get; set; }
        public string EximTraderName { get; set; }
        public string PartyCode { get; set; }
    ...
    public class SearchEximTraderDataFinanceControl
    {

        public List<ListOfEximTraderFinanceControl> lstExim { get; set; } = new List<ListOfEximTraderFinanceControl>();
