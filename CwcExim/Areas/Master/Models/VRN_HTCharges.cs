...
namespace CwcExim.Areas.Master.Models
{
    public class VRN_HTCharges
    {
        ...
        public IList<VRN_Operation> LstOperation { get; set; } = new List<VRN_Operation>();
        public IList<VRN_WeightSlab> LstWeightSlab { get; set; } = new List<VRN_WeightSlab>();
        public IList<VRN_DistanceSlab> LstDistanceSlab { get; set; } = new List<VRN_DistanceSlab>();

        public IList<VRN_ChargeList> LstCharge { get; set; } = new List<VRN_ChargeList>();

        public IList<Contractor> LstContractor { get; set; } = new List<Contractor>();

        public IList<VRN_ViewList> LstviewList { get; set; } = new List<VRN_ViewList>();
        public IList<VRN_Port> LstPort = new List<VRN_Port>();

    }
    public class VRN_WeightSlab
    {
