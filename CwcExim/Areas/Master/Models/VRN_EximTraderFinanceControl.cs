...
{
    public class VRN_EximTraderFinanceControl
    {
        ...
        public List<VRN_SearchEximTraderDataFinanceControl> LstEximTraders { get; set; } = new List<VRN_SearchEximTraderDataFinanceControl>();

    }

    public class VRN_ListOfEximTraderFinanceControl
    {
        public int EximTraderId { get; set; }
        public string EximTraderName { get; set; }
        public string PartyCode { get; set; }
    ...
    public class VRN_SearchEximTraderDataFinanceControl
    {

        public List<VRN_ListOfEximTraderFinanceControl> lstExim { get; set; } = new List<VRN_ListOfEximTraderFinanceControl>();
