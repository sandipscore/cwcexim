...
{
    public class WFLDRentReservationModel
    {
        public int PartyId { get; set; }

        [Required(ErrorMessage = "Fill Out This Field")]
        [Display(Name = "Name")]
        [StringLength(150, ErrorMessage = "Rent Or Reservation Party Name Cannot Be More Than 150 Characters In Length")]
        [RegularExpression(@"^[a-zA-Z0-9.//\\_@#,&() -]*$", ErrorMessage = "Rent/Reservation Party Name Can Contain Only Alphabets And Numeric Digits")]
        public string PartyName { get; set; }

        [Display(Name = "Alias")]
        [StringLength(50, ErrorMessage = "Rent Or Reservation Party Alias Cannot Be More Than 50 Characters In Length")]
       // [RegularExpression(@"^[a-zA-Z0-9//\\]*$", ErrorMessage = "Rent Or Reservation Party Alias Can Contain Only Alphabets And Numeric Digits")]
       // [RegularExpression(@"^[a-zA-Z0-9.//\\_@#,&() -]*$", ErrorMessage = "Rent Or Reservation Party Alias Can Contain Only Alphabets,Numeric Digits And Special Character")]
