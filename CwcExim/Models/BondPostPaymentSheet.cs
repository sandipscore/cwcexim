...
{
    public class BondPostPaymentSheet
    {
        ...
        //public IList<BondPaymentSheetContainer> lsPaymentSheetContainer { get; set; } = new List<BondPaymentSheetContainer>();       

    }

    public class BondPaymentSheetContainer
    {
