...
{
    public class EximTrader
    {
        public int EximTraderId { get; set; }

        [Required(ErrorMessage ="Fill Out This Field")]
        [Display(Name ="Name")]
        [StringLength(maximumLength: 100, MinimumLength = 3, ErrorMessage = "Exim Trader Name Cannot Be More Than 100 OR Less Than 3 Characters In Length")]
        ...
        [Display(Name ="Alias")]
        [StringLength(5,ErrorMessage = "Exim Trader Alias Cannot Be More Than 5 Characters In Length")]
       ...
       // [DataType(DataType.Password)]
        ...
        [StringLength(maximumLength: 100, MinimumLength = 3, ErrorMessage = "Address Cannot Be More Than 100 OR Less Than 3 Characters In Length")]
