...
{
    public class KdlPostPaymentSheet
    {
            ...
            public decimal TotalNoOfPackages { get; set; } = 0M;
           public decimal TotalGrossWt { get; set; } = 0M;
            ...
            public IList<KdlCWCPostPaymentContainer> lstPostPaymentCont { get; set; } = new List<KdlCWCPostPaymentContainer>();
            public IList<KdlCWCPostPaymentContainer> lstStorPostPaymentCont { get; set; } = new List<KdlCWCPostPaymentContainer>();
            public IList<PostPaymentCharge> lstPostPaymentChrg { get; set; } = new List<PostPaymentCharge>();
            public IList<ContainerWiseAmount> lstContWiseAmount { get; set; } = new List<ContainerWiseAmount>();
            public IList<PreContainerWiseAmount> lstPreContWiseAmount { get; set; } = new List<PreContainerWiseAmount>();
            public IList<KdlCWCPreInvoiceCargo> lstPreInvoiceCargo { get; set; } = new List<KdlCWCPreInvoiceCargo>();
           // public IList<KdlCWCPreInvoiceCargo> KdlCWClstPreInvoiceCargo { get; set; } = new List<KdlCWCPreInvoiceCargo>();
            ...
            public void CalculateCharges(int Type, GenericChargesModel objGenericCharges, int GodownTypeId)
            {
                ...
                {
                    this.lstContWiseAmount.Add(new ContainerWiseAmount()
                    {
        ...
        private void CalculateYard(GenericChargesModel objGenericCharges)
        {
            ...
            try
            {
                ...
                this.lstPostPaymentChrg = JsonConvert.DeserializeObject<IList<PostPaymentCharge>>(sortedString);
            }
            catch (Exception ex)
            {
    ...
    public class KdlCWCPostPaymentContainer
        {
            public string CFSCode { get; set; } = string.Empty;
